...
// </summary>
public class MutedInfoCsD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCsD
	// </summary>
	// <remarks>
	...
	public MutedInfoCsD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCsD newObject = (schemaLib.MutedInfoCsD)super.clone();

...
// </summary>
public class MutedInfoCkJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCkJ
	// </summary>
	// <remarks>
	...
	public MutedInfoCkJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCkJ newObject = (schemaLib.MutedInfoCkJ)super.clone();

...
// </summary>
public class MutedInfoUG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoUG
	// </summary>
	// <remarks>
	...
	public MutedInfoUG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoUG newObject = (schemaLib.MutedInfoUG)super.clone();

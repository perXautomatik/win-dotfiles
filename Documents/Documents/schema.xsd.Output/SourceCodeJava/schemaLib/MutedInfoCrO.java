...
// </summary>
public class MutedInfoCrO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCrO
	// </summary>
	// <remarks>
	...
	public MutedInfoCrO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCrO newObject = (schemaLib.MutedInfoCrO)super.clone();

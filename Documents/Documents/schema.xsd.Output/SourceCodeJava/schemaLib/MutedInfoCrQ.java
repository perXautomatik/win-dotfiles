...
// </summary>
public class MutedInfoCrQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCrQ
	// </summary>
	// <remarks>
	...
	public MutedInfoCrQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCrQ newObject = (schemaLib.MutedInfoCrQ)super.clone();

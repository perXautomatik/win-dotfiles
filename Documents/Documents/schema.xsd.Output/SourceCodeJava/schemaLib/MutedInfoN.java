...
// </summary>
public class MutedInfoN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoN
	// </summary>
	// <remarks>
	...
	public MutedInfoN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoN newObject = (schemaLib.MutedInfoN)super.clone();

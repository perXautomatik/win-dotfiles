...
// </summary>
public class MutedInfoKA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoKA
	// </summary>
	// <remarks>
	...
	public MutedInfoKA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoKA newObject = (schemaLib.MutedInfoKA)super.clone();

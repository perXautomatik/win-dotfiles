...
// </summary>
public class MutedInfoBcS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBcS
	// </summary>
	// <remarks>
	...
	public MutedInfoBcS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBcS newObject = (schemaLib.MutedInfoBcS)super.clone();

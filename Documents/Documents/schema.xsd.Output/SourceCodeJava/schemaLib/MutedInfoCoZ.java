...
// </summary>
public class MutedInfoCoZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCoZ
	// </summary>
	// <remarks>
	...
	public MutedInfoCoZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCoZ newObject = (schemaLib.MutedInfoCoZ)super.clone();

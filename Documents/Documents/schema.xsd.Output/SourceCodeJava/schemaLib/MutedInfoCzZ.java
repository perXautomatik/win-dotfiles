...
// </summary>
public class MutedInfoCzZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCzZ
	// </summary>
	// <remarks>
	...
	public MutedInfoCzZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCzZ newObject = (schemaLib.MutedInfoCzZ)super.clone();

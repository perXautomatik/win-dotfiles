...
// </summary>
public class MutedInfoSF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoSF
	// </summary>
	// <remarks>
	...
	public MutedInfoSF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoSF newObject = (schemaLib.MutedInfoSF)super.clone();

...
// </summary>
public class MutedInfoQO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoQO
	// </summary>
	// <remarks>
	...
	public MutedInfoQO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoQO newObject = (schemaLib.MutedInfoQO)super.clone();

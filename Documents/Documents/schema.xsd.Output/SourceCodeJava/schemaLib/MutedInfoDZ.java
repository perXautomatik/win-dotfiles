...
// </summary>
public class MutedInfoDZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDZ
	// </summary>
	// <remarks>
	...
	public MutedInfoDZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDZ newObject = (schemaLib.MutedInfoDZ)super.clone();

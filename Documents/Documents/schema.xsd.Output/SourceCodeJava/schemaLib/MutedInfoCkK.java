...
// </summary>
public class MutedInfoCkK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCkK
	// </summary>
	// <remarks>
	...
	public MutedInfoCkK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCkK newObject = (schemaLib.MutedInfoCkK)super.clone();

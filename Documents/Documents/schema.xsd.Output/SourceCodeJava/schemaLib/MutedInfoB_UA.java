...
// </summary>
public class MutedInfoB_UA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_UA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_UA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_UA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_UA newObject = (schemaLib.MutedInfoB_UA)super.clone();

...
// </summary>
public class MutedInfoQA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoQA
	// </summary>
	// <remarks>
	...
	public MutedInfoQA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoQA newObject = (schemaLib.MutedInfoQA)super.clone();

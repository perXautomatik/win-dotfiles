...
// </summary>
public class MutedInfoDŽJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŽJ
	// </summary>
	// <remarks>
	...
	public MutedInfoDŽJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŽJ newObject = (schemaLib.MutedInfoDŽJ)super.clone();

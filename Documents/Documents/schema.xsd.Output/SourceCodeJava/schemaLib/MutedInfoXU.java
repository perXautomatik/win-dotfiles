...
// </summary>
public class MutedInfoXU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoXU
	// </summary>
	// <remarks>
	...
	public MutedInfoXU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoXU newObject = (schemaLib.MutedInfoXU)super.clone();

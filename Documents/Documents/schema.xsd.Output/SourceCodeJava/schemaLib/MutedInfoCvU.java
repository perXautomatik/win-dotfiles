...
// </summary>
public class MutedInfoCvU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCvU
	// </summary>
	// <remarks>
	...
	public MutedInfoCvU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCvU newObject = (schemaLib.MutedInfoCvU)super.clone();

...
// </summary>
public class MutedInfoCoB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCoB
	// </summary>
	// <remarks>
	...
	public MutedInfoCoB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCoB newObject = (schemaLib.MutedInfoCoB)super.clone();

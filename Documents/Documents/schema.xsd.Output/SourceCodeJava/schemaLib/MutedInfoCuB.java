...
// </summary>
public class MutedInfoCuB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCuB
	// </summary>
	// <remarks>
	...
	public MutedInfoCuB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCuB newObject = (schemaLib.MutedInfoCuB)super.clone();

...
// </summary>
public class MutedInfoKW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoKW
	// </summary>
	// <remarks>
	...
	public MutedInfoKW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoKW newObject = (schemaLib.MutedInfoKW)super.clone();

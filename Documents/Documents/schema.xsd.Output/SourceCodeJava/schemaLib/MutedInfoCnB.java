...
// </summary>
public class MutedInfoCnB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCnB
	// </summary>
	// <remarks>
	...
	public MutedInfoCnB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCnB newObject = (schemaLib.MutedInfoCnB)super.clone();

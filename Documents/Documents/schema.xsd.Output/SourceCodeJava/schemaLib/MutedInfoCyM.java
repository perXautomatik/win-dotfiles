...
// </summary>
public class MutedInfoCyM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCyM
	// </summary>
	// <remarks>
	...
	public MutedInfoCyM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCyM newObject = (schemaLib.MutedInfoCyM)super.clone();

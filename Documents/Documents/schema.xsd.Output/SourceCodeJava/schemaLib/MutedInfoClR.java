...
// </summary>
public class MutedInfoClR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoClR
	// </summary>
	// <remarks>
	...
	public MutedInfoClR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoClR newObject = (schemaLib.MutedInfoClR)super.clone();

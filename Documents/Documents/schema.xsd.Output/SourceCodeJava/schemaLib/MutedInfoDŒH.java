...
// </summary>
public class MutedInfoDŒH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŒH
	// </summary>
	// <remarks>
	...
	public MutedInfoDŒH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŒH newObject = (schemaLib.MutedInfoDŒH)super.clone();

...
// </summary>
public class MutedInfoHX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoHX
	// </summary>
	// <remarks>
	...
	public MutedInfoHX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoHX newObject = (schemaLib.MutedInfoHX)super.clone();

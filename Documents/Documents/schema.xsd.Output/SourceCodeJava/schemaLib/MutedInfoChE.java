...
// </summary>
public class MutedInfoChE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoChE
	// </summary>
	// <remarks>
	...
	public MutedInfoChE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoChE newObject = (schemaLib.MutedInfoChE)super.clone();

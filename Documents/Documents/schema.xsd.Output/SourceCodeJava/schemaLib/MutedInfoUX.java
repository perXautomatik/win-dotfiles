...
// </summary>
public class MutedInfoUX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoUX
	// </summary>
	// <remarks>
	...
	public MutedInfoUX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoUX newObject = (schemaLib.MutedInfoUX)super.clone();

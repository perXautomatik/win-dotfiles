...
// </summary>
public class MutedInfoCtU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCtU
	// </summary>
	// <remarks>
	...
	public MutedInfoCtU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCtU newObject = (schemaLib.MutedInfoCtU)super.clone();

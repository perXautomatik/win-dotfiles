...
// </summary>
public class MutedInfoZZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoZZ
	// </summary>
	// <remarks>
	...
	public MutedInfoZZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoZZ newObject = (schemaLib.MutedInfoZZ)super.clone();

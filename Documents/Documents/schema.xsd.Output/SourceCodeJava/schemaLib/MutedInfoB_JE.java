...
// </summary>
public class MutedInfoB_JE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_JE
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_JE() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_JE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_JE newObject = (schemaLib.MutedInfoB_JE)super.clone();

...
// </summary>
public class MutedInfoB_WC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_WC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_WC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_WC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_WC newObject = (schemaLib.MutedInfoB_WC)super.clone();

...
// </summary>
public class MutedInfoBaL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBaL
	// </summary>
	// <remarks>
	...
	public MutedInfoBaL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBaL newObject = (schemaLib.MutedInfoBaL)super.clone();

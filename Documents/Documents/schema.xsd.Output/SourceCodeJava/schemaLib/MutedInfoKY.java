...
// </summary>
public class MutedInfoKY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoKY
	// </summary>
	// <remarks>
	...
	public MutedInfoKY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoKY newObject = (schemaLib.MutedInfoKY)super.clone();

...
// </summary>
public class MutedInfoCoA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCoA
	// </summary>
	// <remarks>
	...
	public MutedInfoCoA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCoA newObject = (schemaLib.MutedInfoCoA)super.clone();

...
// </summary>
public class MutedInfoGD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoGD
	// </summary>
	// <remarks>
	...
	public MutedInfoGD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoGD newObject = (schemaLib.MutedInfoGD)super.clone();

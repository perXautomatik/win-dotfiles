...
// </summary>
public class MutedInfoC_Q extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_Q
	// </summary>
	// <remarks>
	...
	public MutedInfoC_Q(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_Q newObject = (schemaLib.MutedInfoC_Q)super.clone();

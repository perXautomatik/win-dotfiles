...
// </summary>
public class MutedInfo extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfo
	// </summary>
	// <remarks>
	...
	public MutedInfo(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfo newObject = (schemaLib.MutedInfo)super.clone();

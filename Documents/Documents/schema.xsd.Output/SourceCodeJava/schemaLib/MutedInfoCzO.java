...
// </summary>
public class MutedInfoCzO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCzO
	// </summary>
	// <remarks>
	...
	public MutedInfoCzO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCzO newObject = (schemaLib.MutedInfoCzO)super.clone();

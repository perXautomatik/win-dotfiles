...
// </summary>
public class MutedInfoXY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoXY
	// </summary>
	// <remarks>
	...
	public MutedInfoXY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoXY newObject = (schemaLib.MutedInfoXY)super.clone();

...
// </summary>
public class MutedInfoCyL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCyL
	// </summary>
	// <remarks>
	...
	public MutedInfoCyL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCyL newObject = (schemaLib.MutedInfoCyL)super.clone();

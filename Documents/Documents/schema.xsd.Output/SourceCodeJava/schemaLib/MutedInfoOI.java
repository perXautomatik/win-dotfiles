...
// </summary>
public class MutedInfoOI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoOI
	// </summary>
	// <remarks>
	...
	public MutedInfoOI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoOI newObject = (schemaLib.MutedInfoOI)super.clone();

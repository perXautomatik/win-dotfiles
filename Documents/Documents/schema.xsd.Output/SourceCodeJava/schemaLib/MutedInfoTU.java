...
// </summary>
public class MutedInfoTU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoTU
	// </summary>
	// <remarks>
	...
	public MutedInfoTU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoTU newObject = (schemaLib.MutedInfoTU)super.clone();

...
// </summary>
public class MutedInfoCrV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCrV
	// </summary>
	// <remarks>
	...
	public MutedInfoCrV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCrV newObject = (schemaLib.MutedInfoCrV)super.clone();

...
// </summary>
public class MutedInfoCwJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCwJ
	// </summary>
	// <remarks>
	...
	public MutedInfoCwJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCwJ newObject = (schemaLib.MutedInfoCwJ)super.clone();

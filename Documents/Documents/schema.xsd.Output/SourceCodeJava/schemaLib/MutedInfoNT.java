...
// </summary>
public class MutedInfoNT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoNT
	// </summary>
	// <remarks>
	...
	public MutedInfoNT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoNT newObject = (schemaLib.MutedInfoNT)super.clone();

...
// </summary>
public class MutedInfoCnS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCnS
	// </summary>
	// <remarks>
	...
	public MutedInfoCnS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCnS newObject = (schemaLib.MutedInfoCnS)super.clone();

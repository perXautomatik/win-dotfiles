...
// </summary>
public class MutedInfoBeV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBeV
	// </summary>
	// <remarks>
	...
	public MutedInfoBeV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBeV newObject = (schemaLib.MutedInfoBeV)super.clone();

...
// </summary>
public class MutedInfoGS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoGS
	// </summary>
	// <remarks>
	...
	public MutedInfoGS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoGS newObject = (schemaLib.MutedInfoGS)super.clone();

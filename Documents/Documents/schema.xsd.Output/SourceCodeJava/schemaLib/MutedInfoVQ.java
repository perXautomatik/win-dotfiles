...
// </summary>
public class MutedInfoVQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoVQ
	// </summary>
	// <remarks>
	...
	public MutedInfoVQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoVQ newObject = (schemaLib.MutedInfoVQ)super.clone();

...
// </summary>
public class MutedInfoCkG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCkG
	// </summary>
	// <remarks>
	...
	public MutedInfoCkG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCkG newObject = (schemaLib.MutedInfoCkG)super.clone();

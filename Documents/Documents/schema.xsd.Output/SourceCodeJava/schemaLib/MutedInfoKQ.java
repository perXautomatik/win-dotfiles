...
// </summary>
public class MutedInfoKQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoKQ
	// </summary>
	// <remarks>
	...
	public MutedInfoKQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoKQ newObject = (schemaLib.MutedInfoKQ)super.clone();

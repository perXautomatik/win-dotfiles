...
// </summary>
public class MutedInfoDˆV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDˆV
	// </summary>
	// <remarks>
	...
	public MutedInfoDˆV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDˆV newObject = (schemaLib.MutedInfoDˆV)super.clone();

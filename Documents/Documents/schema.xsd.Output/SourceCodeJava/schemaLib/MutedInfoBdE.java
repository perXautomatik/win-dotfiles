...
// </summary>
public class MutedInfoBdE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBdE
	// </summary>
	// <remarks>
	...
	public MutedInfoBdE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBdE newObject = (schemaLib.MutedInfoBdE)super.clone();

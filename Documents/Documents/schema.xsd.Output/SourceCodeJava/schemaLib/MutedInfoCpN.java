...
// </summary>
public class MutedInfoCpN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCpN
	// </summary>
	// <remarks>
	...
	public MutedInfoCpN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCpN newObject = (schemaLib.MutedInfoCpN)super.clone();

...
// </summary>
public class MutedInfoB_BB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_BB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_BB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_BB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_BB newObject = (schemaLib.MutedInfoB_BB)super.clone();

...
// </summary>
public class MutedInfoIP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoIP
	// </summary>
	// <remarks>
	...
	public MutedInfoIP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoIP newObject = (schemaLib.MutedInfoIP)super.clone();

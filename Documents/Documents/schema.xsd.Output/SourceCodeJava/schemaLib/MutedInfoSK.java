...
// </summary>
public class MutedInfoSK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoSK
	// </summary>
	// <remarks>
	...
	public MutedInfoSK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoSK newObject = (schemaLib.MutedInfoSK)super.clone();

...
// </summary>
public class MutedInfoDF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDF
	// </summary>
	// <remarks>
	...
	public MutedInfoDF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDF newObject = (schemaLib.MutedInfoDF)super.clone();

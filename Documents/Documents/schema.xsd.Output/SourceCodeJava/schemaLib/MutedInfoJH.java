...
// </summary>
public class MutedInfoJH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoJH
	// </summary>
	// <remarks>
	...
	public MutedInfoJH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoJH newObject = (schemaLib.MutedInfoJH)super.clone();

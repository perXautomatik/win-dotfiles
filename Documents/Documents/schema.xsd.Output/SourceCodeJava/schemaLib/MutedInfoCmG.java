...
// </summary>
public class MutedInfoCmG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCmG
	// </summary>
	// <remarks>
	...
	public MutedInfoCmG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCmG newObject = (schemaLib.MutedInfoCmG)super.clone();

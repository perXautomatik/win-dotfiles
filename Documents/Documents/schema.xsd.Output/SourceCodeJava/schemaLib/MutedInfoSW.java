...
// </summary>
public class MutedInfoSW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoSW
	// </summary>
	// <remarks>
	...
	public MutedInfoSW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoSW newObject = (schemaLib.MutedInfoSW)super.clone();

...
// </summary>
public class MutedInfoEF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoEF
	// </summary>
	// <remarks>
	...
	public MutedInfoEF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoEF newObject = (schemaLib.MutedInfoEF)super.clone();

...
// </summary>
public class MutedInfoGX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoGX
	// </summary>
	// <remarks>
	...
	public MutedInfoGX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoGX newObject = (schemaLib.MutedInfoGX)super.clone();

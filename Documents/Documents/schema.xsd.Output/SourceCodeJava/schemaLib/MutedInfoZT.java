...
// </summary>
public class MutedInfoZT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoZT
	// </summary>
	// <remarks>
	...
	public MutedInfoZT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoZT newObject = (schemaLib.MutedInfoZT)super.clone();

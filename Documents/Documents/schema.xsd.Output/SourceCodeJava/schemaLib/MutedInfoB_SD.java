...
// </summary>
public class MutedInfoB_SD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_SD
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_SD() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_SD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_SD newObject = (schemaLib.MutedInfoB_SD)super.clone();

...
// </summary>
public class MutedInfoBfV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBfV
	// </summary>
	// <remarks>
	...
	public MutedInfoBfV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBfV newObject = (schemaLib.MutedInfoBfV)super.clone();

...
// </summary>
public class MutedInfoCkI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCkI
	// </summary>
	// <remarks>
	...
	public MutedInfoCkI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCkI newObject = (schemaLib.MutedInfoCkI)super.clone();

...
// </summary>
public class MutedInfoTM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoTM
	// </summary>
	// <remarks>
	...
	public MutedInfoTM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoTM newObject = (schemaLib.MutedInfoTM)super.clone();

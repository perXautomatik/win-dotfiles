...
// </summary>
public class MutedInfoUF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoUF
	// </summary>
	// <remarks>
	...
	public MutedInfoUF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoUF newObject = (schemaLib.MutedInfoUF)super.clone();

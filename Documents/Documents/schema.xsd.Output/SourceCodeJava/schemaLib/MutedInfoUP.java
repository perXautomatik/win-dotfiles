...
// </summary>
public class MutedInfoUP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoUP
	// </summary>
	// <remarks>
	...
	public MutedInfoUP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoUP newObject = (schemaLib.MutedInfoUP)super.clone();

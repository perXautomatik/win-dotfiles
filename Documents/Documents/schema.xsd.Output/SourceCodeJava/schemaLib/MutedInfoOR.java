...
// </summary>
public class MutedInfoOR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoOR
	// </summary>
	// <remarks>
	...
	public MutedInfoOR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoOR newObject = (schemaLib.MutedInfoOR)super.clone();

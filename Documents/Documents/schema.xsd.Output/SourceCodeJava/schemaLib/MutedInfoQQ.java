...
// </summary>
public class MutedInfoQQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoQQ
	// </summary>
	// <remarks>
	...
	public MutedInfoQQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoQQ newObject = (schemaLib.MutedInfoQQ)super.clone();

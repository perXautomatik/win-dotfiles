...
// </summary>
public class MutedInfoC_CB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_CB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_CB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_CB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_CB newObject = (schemaLib.MutedInfoC_CB)super.clone();

...
// </summary>
public class MutedInfoFC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoFC
	// </summary>
	// <remarks>
	...
	public MutedInfoFC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoFC newObject = (schemaLib.MutedInfoFC)super.clone();

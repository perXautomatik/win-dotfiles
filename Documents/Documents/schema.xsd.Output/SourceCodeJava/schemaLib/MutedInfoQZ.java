...
// </summary>
public class MutedInfoQZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoQZ
	// </summary>
	// <remarks>
	...
	public MutedInfoQZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoQZ newObject = (schemaLib.MutedInfoQZ)super.clone();

...
// </summary>
public class MutedInfoB_V extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_V
	// </summary>
	// <remarks>
	...
	public MutedInfoB_V(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_V newObject = (schemaLib.MutedInfoB_V)super.clone();

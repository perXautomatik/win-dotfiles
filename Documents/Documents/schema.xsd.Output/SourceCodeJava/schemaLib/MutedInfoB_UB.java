...
// </summary>
public class MutedInfoB_UB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_UB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_UB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_UB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_UB newObject = (schemaLib.MutedInfoB_UB)super.clone();

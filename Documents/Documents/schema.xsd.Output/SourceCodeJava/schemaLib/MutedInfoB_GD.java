...
// </summary>
public class MutedInfoB_GD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_GD
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_GD() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_GD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_GD newObject = (schemaLib.MutedInfoB_GD)super.clone();

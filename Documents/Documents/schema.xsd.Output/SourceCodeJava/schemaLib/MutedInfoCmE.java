...
// </summary>
public class MutedInfoCmE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCmE
	// </summary>
	// <remarks>
	...
	public MutedInfoCmE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCmE newObject = (schemaLib.MutedInfoCmE)super.clone();

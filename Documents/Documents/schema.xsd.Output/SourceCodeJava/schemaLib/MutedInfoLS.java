...
// </summary>
public class MutedInfoLS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoLS
	// </summary>
	// <remarks>
	...
	public MutedInfoLS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoLS newObject = (schemaLib.MutedInfoLS)super.clone();

...
// </summary>
public class MutedInfoCsJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCsJ
	// </summary>
	// <remarks>
	...
	public MutedInfoCsJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCsJ newObject = (schemaLib.MutedInfoCsJ)super.clone();

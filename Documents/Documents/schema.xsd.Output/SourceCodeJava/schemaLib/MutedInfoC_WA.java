...
// </summary>
public class MutedInfoC_WA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_WA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_WA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_WA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_WA newObject = (schemaLib.MutedInfoC_WA)super.clone();

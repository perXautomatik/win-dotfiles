...
// </summary>
public class MutedInfoCqO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCqO
	// </summary>
	// <remarks>
	...
	public MutedInfoCqO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCqO newObject = (schemaLib.MutedInfoCqO)super.clone();

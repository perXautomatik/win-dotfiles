...
// </summary>
public class MutedInfoCnT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCnT
	// </summary>
	// <remarks>
	...
	public MutedInfoCnT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCnT newObject = (schemaLib.MutedInfoCnT)super.clone();

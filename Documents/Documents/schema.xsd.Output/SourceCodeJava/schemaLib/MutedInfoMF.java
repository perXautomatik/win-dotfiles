...
// </summary>
public class MutedInfoMF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoMF
	// </summary>
	// <remarks>
	...
	public MutedInfoMF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoMF newObject = (schemaLib.MutedInfoMF)super.clone();

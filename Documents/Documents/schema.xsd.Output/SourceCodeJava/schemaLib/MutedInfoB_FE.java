...
// </summary>
public class MutedInfoB_FE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_FE
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_FE() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_FE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_FE newObject = (schemaLib.MutedInfoB_FE)super.clone();

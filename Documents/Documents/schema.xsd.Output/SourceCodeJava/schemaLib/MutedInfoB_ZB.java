...
// </summary>
public class MutedInfoB_ZB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_ZB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_ZB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_ZB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_ZB newObject = (schemaLib.MutedInfoB_ZB)super.clone();

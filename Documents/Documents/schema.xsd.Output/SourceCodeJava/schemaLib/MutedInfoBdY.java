...
// </summary>
public class MutedInfoBdY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBdY
	// </summary>
	// <remarks>
	...
	public MutedInfoBdY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBdY newObject = (schemaLib.MutedInfoBdY)super.clone();

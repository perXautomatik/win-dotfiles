...
// </summary>
public class MutedInfoCwV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCwV
	// </summary>
	// <remarks>
	...
	public MutedInfoCwV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCwV newObject = (schemaLib.MutedInfoCwV)super.clone();

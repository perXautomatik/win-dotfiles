...
// </summary>
public class MutedInfoPM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoPM
	// </summary>
	// <remarks>
	...
	public MutedInfoPM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoPM newObject = (schemaLib.MutedInfoPM)super.clone();

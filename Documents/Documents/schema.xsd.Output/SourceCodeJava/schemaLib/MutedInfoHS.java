...
// </summary>
public class MutedInfoHS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoHS
	// </summary>
	// <remarks>
	...
	public MutedInfoHS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoHS newObject = (schemaLib.MutedInfoHS)super.clone();

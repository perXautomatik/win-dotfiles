...
// </summary>
public class MutedInfoXF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoXF
	// </summary>
	// <remarks>
	...
	public MutedInfoXF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoXF newObject = (schemaLib.MutedInfoXF)super.clone();

...
// </summary>
public class MutedInfoCzN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCzN
	// </summary>
	// <remarks>
	...
	public MutedInfoCzN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCzN newObject = (schemaLib.MutedInfoCzN)super.clone();

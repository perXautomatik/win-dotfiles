...
// </summary>
public class MutedInfoCxQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCxQ
	// </summary>
	// <remarks>
	...
	public MutedInfoCxQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCxQ newObject = (schemaLib.MutedInfoCxQ)super.clone();

...
// </summary>
public class MutedInfoDV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDV
	// </summary>
	// <remarks>
	...
	public MutedInfoDV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDV newObject = (schemaLib.MutedInfoDV)super.clone();

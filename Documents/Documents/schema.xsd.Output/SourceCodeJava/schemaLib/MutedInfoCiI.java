...
// </summary>
public class MutedInfoCiI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCiI
	// </summary>
	// <remarks>
	...
	public MutedInfoCiI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCiI newObject = (schemaLib.MutedInfoCiI)super.clone();

...
// </summary>
public class MutedInfoB_LD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_LD
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_LD() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_LD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_LD newObject = (schemaLib.MutedInfoB_LD)super.clone();

...
// </summary>
public class MutedInfoCE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCE
	// </summary>
	// <remarks>
	...
	public MutedInfoCE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCE newObject = (schemaLib.MutedInfoCE)super.clone();

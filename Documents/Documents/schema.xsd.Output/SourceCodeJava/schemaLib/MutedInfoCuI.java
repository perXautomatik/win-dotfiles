...
// </summary>
public class MutedInfoCuI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCuI
	// </summary>
	// <remarks>
	...
	public MutedInfoCuI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCuI newObject = (schemaLib.MutedInfoCuI)super.clone();

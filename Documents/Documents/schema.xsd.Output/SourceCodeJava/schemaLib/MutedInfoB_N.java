...
// </summary>
public class MutedInfoB_N extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_N
	// </summary>
	// <remarks>
	...
	public MutedInfoB_N(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_N newObject = (schemaLib.MutedInfoB_N)super.clone();

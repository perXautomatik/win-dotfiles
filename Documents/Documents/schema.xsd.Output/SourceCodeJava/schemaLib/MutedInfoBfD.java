...
// </summary>
public class MutedInfoBfD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBfD
	// </summary>
	// <remarks>
	...
	public MutedInfoBfD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBfD newObject = (schemaLib.MutedInfoBfD)super.clone();

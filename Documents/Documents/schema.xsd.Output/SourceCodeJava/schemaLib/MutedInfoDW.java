...
// </summary>
public class MutedInfoDW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDW
	// </summary>
	// <remarks>
	...
	public MutedInfoDW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDW newObject = (schemaLib.MutedInfoDW)super.clone();

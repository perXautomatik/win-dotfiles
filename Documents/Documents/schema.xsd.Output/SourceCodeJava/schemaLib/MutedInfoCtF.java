...
// </summary>
public class MutedInfoCtF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCtF
	// </summary>
	// <remarks>
	...
	public MutedInfoCtF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCtF newObject = (schemaLib.MutedInfoCtF)super.clone();

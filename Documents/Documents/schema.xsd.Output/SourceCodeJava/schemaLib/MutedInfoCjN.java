...
// </summary>
public class MutedInfoCjN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCjN
	// </summary>
	// <remarks>
	...
	public MutedInfoCjN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCjN newObject = (schemaLib.MutedInfoCjN)super.clone();

...
// </summary>
public class MutedInfoLK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoLK
	// </summary>
	// <remarks>
	...
	public MutedInfoLK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoLK newObject = (schemaLib.MutedInfoLK)super.clone();

...
// </summary>
public class MutedInfoCiQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCiQ
	// </summary>
	// <remarks>
	...
	public MutedInfoCiQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCiQ newObject = (schemaLib.MutedInfoCiQ)super.clone();

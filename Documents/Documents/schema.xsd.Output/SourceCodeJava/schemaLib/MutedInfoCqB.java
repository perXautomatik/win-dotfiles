...
// </summary>
public class MutedInfoCqB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCqB
	// </summary>
	// <remarks>
	...
	public MutedInfoCqB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCqB newObject = (schemaLib.MutedInfoCqB)super.clone();

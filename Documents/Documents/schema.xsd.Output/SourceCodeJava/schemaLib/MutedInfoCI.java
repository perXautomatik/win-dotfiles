...
// </summary>
public class MutedInfoCI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCI
	// </summary>
	// <remarks>
	...
	public MutedInfoCI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCI newObject = (schemaLib.MutedInfoCI)super.clone();

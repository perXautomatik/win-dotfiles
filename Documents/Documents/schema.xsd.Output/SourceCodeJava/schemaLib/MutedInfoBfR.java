...
// </summary>
public class MutedInfoBfR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBfR
	// </summary>
	// <remarks>
	...
	public MutedInfoBfR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBfR newObject = (schemaLib.MutedInfoBfR)super.clone();

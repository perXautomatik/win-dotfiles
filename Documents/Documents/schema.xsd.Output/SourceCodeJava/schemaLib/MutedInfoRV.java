...
// </summary>
public class MutedInfoRV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoRV
	// </summary>
	// <remarks>
	...
	public MutedInfoRV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoRV newObject = (schemaLib.MutedInfoRV)super.clone();

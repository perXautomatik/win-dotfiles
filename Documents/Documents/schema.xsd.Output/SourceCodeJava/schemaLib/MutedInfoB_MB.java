...
// </summary>
public class MutedInfoB_MB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_MB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_MB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_MB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_MB newObject = (schemaLib.MutedInfoB_MB)super.clone();

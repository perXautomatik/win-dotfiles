...
// </summary>
public class MutedInfoCiS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCiS
	// </summary>
	// <remarks>
	...
	public MutedInfoCiS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCiS newObject = (schemaLib.MutedInfoCiS)super.clone();

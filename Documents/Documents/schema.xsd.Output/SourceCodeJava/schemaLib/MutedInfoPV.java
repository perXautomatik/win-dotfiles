...
// </summary>
public class MutedInfoPV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoPV
	// </summary>
	// <remarks>
	...
	public MutedInfoPV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoPV newObject = (schemaLib.MutedInfoPV)super.clone();

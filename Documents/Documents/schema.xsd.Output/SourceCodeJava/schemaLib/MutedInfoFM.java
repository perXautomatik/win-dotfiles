...
// </summary>
public class MutedInfoFM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoFM
	// </summary>
	// <remarks>
	...
	public MutedInfoFM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoFM newObject = (schemaLib.MutedInfoFM)super.clone();

...
// </summary>
public class MutedInfoBeU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBeU
	// </summary>
	// <remarks>
	...
	public MutedInfoBeU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBeU newObject = (schemaLib.MutedInfoBeU)super.clone();

...
// </summary>
public class MutedInfoNV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoNV
	// </summary>
	// <remarks>
	...
	public MutedInfoNV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoNV newObject = (schemaLib.MutedInfoNV)super.clone();

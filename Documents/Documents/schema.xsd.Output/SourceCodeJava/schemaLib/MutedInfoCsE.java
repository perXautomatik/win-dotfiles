...
// </summary>
public class MutedInfoCsE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCsE
	// </summary>
	// <remarks>
	...
	public MutedInfoCsE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCsE newObject = (schemaLib.MutedInfoCsE)super.clone();

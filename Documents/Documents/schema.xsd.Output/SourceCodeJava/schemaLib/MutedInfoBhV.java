...
// </summary>
public class MutedInfoBhV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBhV
	// </summary>
	// <remarks>
	...
	public MutedInfoBhV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBhV newObject = (schemaLib.MutedInfoBhV)super.clone();

...
// </summary>
public class MutedInfoLG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoLG
	// </summary>
	// <remarks>
	...
	public MutedInfoLG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoLG newObject = (schemaLib.MutedInfoLG)super.clone();

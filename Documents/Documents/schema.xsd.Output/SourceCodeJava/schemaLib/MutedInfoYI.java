...
// </summary>
public class MutedInfoYI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoYI
	// </summary>
	// <remarks>
	...
	public MutedInfoYI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoYI newObject = (schemaLib.MutedInfoYI)super.clone();

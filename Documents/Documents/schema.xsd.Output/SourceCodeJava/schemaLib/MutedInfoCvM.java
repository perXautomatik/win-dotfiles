...
// </summary>
public class MutedInfoCvM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCvM
	// </summary>
	// <remarks>
	...
	public MutedInfoCvM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCvM newObject = (schemaLib.MutedInfoCvM)super.clone();

...
// </summary>
public class MutedInfoCjW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCjW
	// </summary>
	// <remarks>
	...
	public MutedInfoCjW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCjW newObject = (schemaLib.MutedInfoCjW)super.clone();

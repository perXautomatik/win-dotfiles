...
// </summary>
public class MutedInfoCrS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCrS
	// </summary>
	// <remarks>
	...
	public MutedInfoCrS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCrS newObject = (schemaLib.MutedInfoCrS)super.clone();

...
// </summary>
public class MutedInfoVT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoVT
	// </summary>
	// <remarks>
	...
	public MutedInfoVT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoVT newObject = (schemaLib.MutedInfoVT)super.clone();

...
// </summary>
public class MutedInfoUR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoUR
	// </summary>
	// <remarks>
	...
	public MutedInfoUR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoUR newObject = (schemaLib.MutedInfoUR)super.clone();

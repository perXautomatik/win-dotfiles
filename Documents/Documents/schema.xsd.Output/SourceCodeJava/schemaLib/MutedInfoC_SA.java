...
// </summary>
public class MutedInfoC_SA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_SA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_SA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_SA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_SA newObject = (schemaLib.MutedInfoC_SA)super.clone();

...
// </summary>
public class MutedInfoFK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoFK
	// </summary>
	// <remarks>
	...
	public MutedInfoFK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoFK newObject = (schemaLib.MutedInfoFK)super.clone();

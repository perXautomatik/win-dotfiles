...
// </summary>
public class MutedInfoOJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoOJ
	// </summary>
	// <remarks>
	...
	public MutedInfoOJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoOJ newObject = (schemaLib.MutedInfoOJ)super.clone();

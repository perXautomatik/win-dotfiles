...
// </summary>
public class MutedInfoNI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoNI
	// </summary>
	// <remarks>
	...
	public MutedInfoNI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoNI newObject = (schemaLib.MutedInfoNI)super.clone();

...
// </summary>
public class MutedInfoUT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoUT
	// </summary>
	// <remarks>
	...
	public MutedInfoUT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoUT newObject = (schemaLib.MutedInfoUT)super.clone();

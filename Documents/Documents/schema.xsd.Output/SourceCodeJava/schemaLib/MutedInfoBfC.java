...
// </summary>
public class MutedInfoBfC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBfC
	// </summary>
	// <remarks>
	...
	public MutedInfoBfC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBfC newObject = (schemaLib.MutedInfoBfC)super.clone();

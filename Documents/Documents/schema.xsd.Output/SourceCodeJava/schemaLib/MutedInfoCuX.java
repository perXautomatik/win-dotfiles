...
// </summary>
public class MutedInfoCuX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCuX
	// </summary>
	// <remarks>
	...
	public MutedInfoCuX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCuX newObject = (schemaLib.MutedInfoCuX)super.clone();

...
// </summary>
public class MutedInfoCqR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCqR
	// </summary>
	// <remarks>
	...
	public MutedInfoCqR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCqR newObject = (schemaLib.MutedInfoCqR)super.clone();

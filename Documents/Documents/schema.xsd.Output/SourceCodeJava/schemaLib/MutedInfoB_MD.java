...
// </summary>
public class MutedInfoB_MD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_MD
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_MD() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_MD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_MD newObject = (schemaLib.MutedInfoB_MD)super.clone();

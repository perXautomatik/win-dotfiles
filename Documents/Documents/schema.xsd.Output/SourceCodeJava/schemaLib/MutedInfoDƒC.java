...
// </summary>
public class MutedInfoDƒC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDƒC
	// </summary>
	// <remarks>
	...
	public MutedInfoDƒC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDƒC newObject = (schemaLib.MutedInfoDƒC)super.clone();

...
// </summary>
public class MutedInfoKX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoKX
	// </summary>
	// <remarks>
	...
	public MutedInfoKX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoKX newObject = (schemaLib.MutedInfoKX)super.clone();

...
// </summary>
public class MutedInfoCmD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCmD
	// </summary>
	// <remarks>
	...
	public MutedInfoCmD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCmD newObject = (schemaLib.MutedInfoCmD)super.clone();

...
// </summary>
public class MutedInfoCiZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCiZ
	// </summary>
	// <remarks>
	...
	public MutedInfoCiZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCiZ newObject = (schemaLib.MutedInfoCiZ)super.clone();

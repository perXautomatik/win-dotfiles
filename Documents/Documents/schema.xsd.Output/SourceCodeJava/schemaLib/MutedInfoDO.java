...
// </summary>
public class MutedInfoDO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDO
	// </summary>
	// <remarks>
	...
	public MutedInfoDO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDO newObject = (schemaLib.MutedInfoDO)super.clone();

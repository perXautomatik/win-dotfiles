...
// </summary>
public class MutedInfoBbC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBbC
	// </summary>
	// <remarks>
	...
	public MutedInfoBbC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBbC newObject = (schemaLib.MutedInfoBbC)super.clone();

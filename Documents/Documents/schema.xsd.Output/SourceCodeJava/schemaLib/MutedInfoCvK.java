...
// </summary>
public class MutedInfoCvK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCvK
	// </summary>
	// <remarks>
	...
	public MutedInfoCvK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCvK newObject = (schemaLib.MutedInfoCvK)super.clone();

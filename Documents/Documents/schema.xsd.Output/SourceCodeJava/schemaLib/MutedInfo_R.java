...
// </summary>
public class MutedInfo_R extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfo_R
	// </summary>
	// <remarks>
	...
	public MutedInfo_R(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfo_R newObject = (schemaLib.MutedInfo_R)super.clone();

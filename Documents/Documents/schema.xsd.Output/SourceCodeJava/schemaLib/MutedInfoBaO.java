...
// </summary>
public class MutedInfoBaO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBaO
	// </summary>
	// <remarks>
	...
	public MutedInfoBaO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBaO newObject = (schemaLib.MutedInfoBaO)super.clone();

...
// </summary>
public class MutedInfoB_TC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_TC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_TC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_TC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_TC newObject = (schemaLib.MutedInfoB_TC)super.clone();

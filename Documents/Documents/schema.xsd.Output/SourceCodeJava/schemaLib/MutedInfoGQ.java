...
// </summary>
public class MutedInfoGQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoGQ
	// </summary>
	// <remarks>
	...
	public MutedInfoGQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoGQ newObject = (schemaLib.MutedInfoGQ)super.clone();

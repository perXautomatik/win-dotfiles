...
// </summary>
public class MutedInfoCvY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCvY
	// </summary>
	// <remarks>
	...
	public MutedInfoCvY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCvY newObject = (schemaLib.MutedInfoCvY)super.clone();

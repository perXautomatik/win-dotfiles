...
// </summary>
public class MutedInfoCpQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCpQ
	// </summary>
	// <remarks>
	...
	public MutedInfoCpQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCpQ newObject = (schemaLib.MutedInfoCpQ)super.clone();

...
// </summary>
public class MutedInfoWP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoWP
	// </summary>
	// <remarks>
	...
	public MutedInfoWP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoWP newObject = (schemaLib.MutedInfoWP)super.clone();

...
// </summary>
public class MutedInfoDˆY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDˆY
	// </summary>
	// <remarks>
	...
	public MutedInfoDˆY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDˆY newObject = (schemaLib.MutedInfoDˆY)super.clone();

...
// </summary>
public class MutedInfoCG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCG
	// </summary>
	// <remarks>
	...
	public MutedInfoCG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCG newObject = (schemaLib.MutedInfoCG)super.clone();

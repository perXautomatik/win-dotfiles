...
// </summary>
public class MutedInfoCK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCK
	// </summary>
	// <remarks>
	...
	public MutedInfoCK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCK newObject = (schemaLib.MutedInfoCK)super.clone();

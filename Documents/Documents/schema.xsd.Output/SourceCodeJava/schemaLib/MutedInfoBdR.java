...
// </summary>
public class MutedInfoBdR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBdR
	// </summary>
	// <remarks>
	...
	public MutedInfoBdR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBdR newObject = (schemaLib.MutedInfoBdR)super.clone();

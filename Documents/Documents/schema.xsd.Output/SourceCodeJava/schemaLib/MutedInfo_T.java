...
// </summary>
public class MutedInfo_T extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfo_T
	// </summary>
	// <remarks>
	...
	public MutedInfo_T(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfo_T newObject = (schemaLib.MutedInfo_T)super.clone();

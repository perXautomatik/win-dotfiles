...
// </summary>
public class MutedInfoDˆB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDˆB
	// </summary>
	// <remarks>
	...
	public MutedInfoDˆB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDˆB newObject = (schemaLib.MutedInfoDˆB)super.clone();

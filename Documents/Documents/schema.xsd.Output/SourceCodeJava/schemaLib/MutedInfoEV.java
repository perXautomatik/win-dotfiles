...
// </summary>
public class MutedInfoEV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoEV
	// </summary>
	// <remarks>
	...
	public MutedInfoEV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoEV newObject = (schemaLib.MutedInfoEV)super.clone();

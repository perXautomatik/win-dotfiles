...
// </summary>
public class MutedInfoB_WB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_WB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_WB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_WB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_WB newObject = (schemaLib.MutedInfoB_WB)super.clone();

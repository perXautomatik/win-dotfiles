...
// </summary>
public class MutedInfoCkW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCkW
	// </summary>
	// <remarks>
	...
	public MutedInfoCkW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCkW newObject = (schemaLib.MutedInfoCkW)super.clone();

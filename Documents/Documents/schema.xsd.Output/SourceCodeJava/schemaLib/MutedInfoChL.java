...
// </summary>
public class MutedInfoChL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoChL
	// </summary>
	// <remarks>
	...
	public MutedInfoChL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoChL newObject = (schemaLib.MutedInfoChL)super.clone();

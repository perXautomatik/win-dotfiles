...
// </summary>
public class MutedInfoCwE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCwE
	// </summary>
	// <remarks>
	...
	public MutedInfoCwE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCwE newObject = (schemaLib.MutedInfoCwE)super.clone();

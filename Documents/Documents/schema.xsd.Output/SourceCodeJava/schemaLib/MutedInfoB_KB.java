...
// </summary>
public class MutedInfoB_KB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_KB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_KB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_KB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_KB newObject = (schemaLib.MutedInfoB_KB)super.clone();

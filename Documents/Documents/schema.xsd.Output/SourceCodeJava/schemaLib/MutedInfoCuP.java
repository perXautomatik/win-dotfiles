...
// </summary>
public class MutedInfoCuP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCuP
	// </summary>
	// <remarks>
	...
	public MutedInfoCuP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCuP newObject = (schemaLib.MutedInfoCuP)super.clone();

...
// </summary>
public class MutedInfoDƒV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDƒV
	// </summary>
	// <remarks>
	...
	public MutedInfoDƒV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDƒV newObject = (schemaLib.MutedInfoDƒV)super.clone();

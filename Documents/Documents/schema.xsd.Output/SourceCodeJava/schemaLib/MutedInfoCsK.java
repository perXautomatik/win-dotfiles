...
// </summary>
public class MutedInfoCsK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCsK
	// </summary>
	// <remarks>
	...
	public MutedInfoCsK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCsK newObject = (schemaLib.MutedInfoCsK)super.clone();

...
// </summary>
public class MutedInfoJZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoJZ
	// </summary>
	// <remarks>
	...
	public MutedInfoJZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoJZ newObject = (schemaLib.MutedInfoJZ)super.clone();

...
// </summary>
public class MutedInfoCkS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCkS
	// </summary>
	// <remarks>
	...
	public MutedInfoCkS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCkS newObject = (schemaLib.MutedInfoCkS)super.clone();

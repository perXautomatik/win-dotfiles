...
// </summary>
public class MutedInfoC_KA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_KA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_KA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_KA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_KA newObject = (schemaLib.MutedInfoC_KA)super.clone();

...
// </summary>
public class MutedInfoCqV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCqV
	// </summary>
	// <remarks>
	...
	public MutedInfoCqV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCqV newObject = (schemaLib.MutedInfoCqV)super.clone();

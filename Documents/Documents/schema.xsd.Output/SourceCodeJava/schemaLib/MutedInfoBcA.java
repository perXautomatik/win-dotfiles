...
// </summary>
public class MutedInfoBcA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBcA
	// </summary>
	// <remarks>
	...
	public MutedInfoBcA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBcA newObject = (schemaLib.MutedInfoBcA)super.clone();

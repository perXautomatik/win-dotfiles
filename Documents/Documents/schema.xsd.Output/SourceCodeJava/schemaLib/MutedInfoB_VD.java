...
// </summary>
public class MutedInfoB_VD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_VD
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_VD() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_VD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_VD newObject = (schemaLib.MutedInfoB_VD)super.clone();

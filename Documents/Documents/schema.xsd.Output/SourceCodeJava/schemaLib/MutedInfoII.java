...
// </summary>
public class MutedInfoII extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoII
	// </summary>
	// <remarks>
	...
	public MutedInfoII(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoII newObject = (schemaLib.MutedInfoII)super.clone();

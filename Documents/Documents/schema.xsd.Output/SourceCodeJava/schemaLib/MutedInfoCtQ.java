...
// </summary>
public class MutedInfoCtQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCtQ
	// </summary>
	// <remarks>
	...
	public MutedInfoCtQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCtQ newObject = (schemaLib.MutedInfoCtQ)super.clone();

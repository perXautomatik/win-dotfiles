...
// </summary>
public class MutedInfoCkB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCkB
	// </summary>
	// <remarks>
	...
	public MutedInfoCkB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCkB newObject = (schemaLib.MutedInfoCkB)super.clone();

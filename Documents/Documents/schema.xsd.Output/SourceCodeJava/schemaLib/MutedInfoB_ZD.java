...
// </summary>
public class MutedInfoB_ZD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_ZD
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_ZD() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_ZD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_ZD newObject = (schemaLib.MutedInfoB_ZD)super.clone();

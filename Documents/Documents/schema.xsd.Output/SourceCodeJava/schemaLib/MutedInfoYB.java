...
// </summary>
public class MutedInfoYB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoYB
	// </summary>
	// <remarks>
	...
	public MutedInfoYB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoYB newObject = (schemaLib.MutedInfoYB)super.clone();

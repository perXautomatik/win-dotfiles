...
// </summary>
public class MutedInfoRG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoRG
	// </summary>
	// <remarks>
	...
	public MutedInfoRG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoRG newObject = (schemaLib.MutedInfoRG)super.clone();

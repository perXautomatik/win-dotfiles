...
// </summary>
public class MutedInfoD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoD
	// </summary>
	// <remarks>
	...
	public MutedInfoD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoD newObject = (schemaLib.MutedInfoD)super.clone();

...
// </summary>
public class MutedInfoZY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoZY
	// </summary>
	// <remarks>
	...
	public MutedInfoZY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoZY newObject = (schemaLib.MutedInfoZY)super.clone();

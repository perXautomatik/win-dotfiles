...
// </summary>
public class MutedInfoCwF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCwF
	// </summary>
	// <remarks>
	...
	public MutedInfoCwF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCwF newObject = (schemaLib.MutedInfoCwF)super.clone();

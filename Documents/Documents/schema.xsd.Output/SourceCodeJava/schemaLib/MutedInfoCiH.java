...
// </summary>
public class MutedInfoCiH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCiH
	// </summary>
	// <remarks>
	...
	public MutedInfoCiH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCiH newObject = (schemaLib.MutedInfoCiH)super.clone();

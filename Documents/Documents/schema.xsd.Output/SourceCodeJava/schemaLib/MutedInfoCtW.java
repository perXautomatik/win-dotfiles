...
// </summary>
public class MutedInfoCtW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCtW
	// </summary>
	// <remarks>
	...
	public MutedInfoCtW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCtW newObject = (schemaLib.MutedInfoCtW)super.clone();

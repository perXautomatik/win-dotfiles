...
// </summary>
public class MutedInfoQS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoQS
	// </summary>
	// <remarks>
	...
	public MutedInfoQS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoQS newObject = (schemaLib.MutedInfoQS)super.clone();

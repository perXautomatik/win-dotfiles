...
// </summary>
public class MutedInfoCzQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCzQ
	// </summary>
	// <remarks>
	...
	public MutedInfoCzQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCzQ newObject = (schemaLib.MutedInfoCzQ)super.clone();

...
// </summary>
public class MutedInfoQG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoQG
	// </summary>
	// <remarks>
	...
	public MutedInfoQG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoQG newObject = (schemaLib.MutedInfoQG)super.clone();

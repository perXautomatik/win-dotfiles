...
// </summary>
public class MutedInfoClJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoClJ
	// </summary>
	// <remarks>
	...
	public MutedInfoClJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoClJ newObject = (schemaLib.MutedInfoClJ)super.clone();

...
// </summary>
public class MutedInfoOQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoOQ
	// </summary>
	// <remarks>
	...
	public MutedInfoOQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoOQ newObject = (schemaLib.MutedInfoOQ)super.clone();

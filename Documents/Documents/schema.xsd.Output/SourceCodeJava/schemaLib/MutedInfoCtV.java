...
// </summary>
public class MutedInfoCtV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCtV
	// </summary>
	// <remarks>
	...
	public MutedInfoCtV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCtV newObject = (schemaLib.MutedInfoCtV)super.clone();

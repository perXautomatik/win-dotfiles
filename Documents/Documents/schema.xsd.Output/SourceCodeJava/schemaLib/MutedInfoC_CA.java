...
// </summary>
public class MutedInfoC_CA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_CA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_CA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_CA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_CA newObject = (schemaLib.MutedInfoC_CA)super.clone();

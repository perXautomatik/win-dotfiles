...
// </summary>
public class MutedInfoB_AA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_AA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_AA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_AA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_AA newObject = (schemaLib.MutedInfoB_AA)super.clone();

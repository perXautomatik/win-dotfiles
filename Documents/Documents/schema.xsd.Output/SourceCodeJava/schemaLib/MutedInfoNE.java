...
// </summary>
public class MutedInfoNE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoNE
	// </summary>
	// <remarks>
	...
	public MutedInfoNE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoNE newObject = (schemaLib.MutedInfoNE)super.clone();

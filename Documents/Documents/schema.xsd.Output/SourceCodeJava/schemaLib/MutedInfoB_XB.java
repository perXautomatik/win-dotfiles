...
// </summary>
public class MutedInfoB_XB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_XB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_XB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_XB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_XB newObject = (schemaLib.MutedInfoB_XB)super.clone();

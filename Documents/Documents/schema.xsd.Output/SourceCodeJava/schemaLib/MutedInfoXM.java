...
// </summary>
public class MutedInfoXM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoXM
	// </summary>
	// <remarks>
	...
	public MutedInfoXM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoXM newObject = (schemaLib.MutedInfoXM)super.clone();

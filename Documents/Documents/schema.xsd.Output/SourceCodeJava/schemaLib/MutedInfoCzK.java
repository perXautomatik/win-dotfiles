...
// </summary>
public class MutedInfoCzK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCzK
	// </summary>
	// <remarks>
	...
	public MutedInfoCzK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCzK newObject = (schemaLib.MutedInfoCzK)super.clone();

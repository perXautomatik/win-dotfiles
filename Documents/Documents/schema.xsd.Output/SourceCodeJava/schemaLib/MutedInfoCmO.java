...
// </summary>
public class MutedInfoCmO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCmO
	// </summary>
	// <remarks>
	...
	public MutedInfoCmO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCmO newObject = (schemaLib.MutedInfoCmO)super.clone();

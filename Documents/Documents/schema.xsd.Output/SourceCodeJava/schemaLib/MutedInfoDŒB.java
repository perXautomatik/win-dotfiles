...
// </summary>
public class MutedInfoDŒB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŒB
	// </summary>
	// <remarks>
	...
	public MutedInfoDŒB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŒB newObject = (schemaLib.MutedInfoDŒB)super.clone();

...
// </summary>
public class MutedInfoClH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoClH
	// </summary>
	// <remarks>
	...
	public MutedInfoClH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoClH newObject = (schemaLib.MutedInfoClH)super.clone();

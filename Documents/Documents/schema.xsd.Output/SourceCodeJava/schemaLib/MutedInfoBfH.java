...
// </summary>
public class MutedInfoBfH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBfH
	// </summary>
	// <remarks>
	...
	public MutedInfoBfH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBfH newObject = (schemaLib.MutedInfoBfH)super.clone();

...
// </summary>
public class MutedInfoIS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoIS
	// </summary>
	// <remarks>
	...
	public MutedInfoIS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoIS newObject = (schemaLib.MutedInfoIS)super.clone();

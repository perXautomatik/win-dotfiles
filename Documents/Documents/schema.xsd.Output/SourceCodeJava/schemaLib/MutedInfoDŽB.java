...
// </summary>
public class MutedInfoDŽB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŽB
	// </summary>
	// <remarks>
	...
	public MutedInfoDŽB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŽB newObject = (schemaLib.MutedInfoDŽB)super.clone();

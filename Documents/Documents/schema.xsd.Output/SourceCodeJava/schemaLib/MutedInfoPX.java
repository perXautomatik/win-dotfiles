...
// </summary>
public class MutedInfoPX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoPX
	// </summary>
	// <remarks>
	...
	public MutedInfoPX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoPX newObject = (schemaLib.MutedInfoPX)super.clone();

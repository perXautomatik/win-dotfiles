...
// </summary>
public class MutedInfoCM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCM
	// </summary>
	// <remarks>
	...
	public MutedInfoCM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCM newObject = (schemaLib.MutedInfoCM)super.clone();

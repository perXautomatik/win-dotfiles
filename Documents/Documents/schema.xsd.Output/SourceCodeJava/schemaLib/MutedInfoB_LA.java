...
// </summary>
public class MutedInfoB_LA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_LA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_LA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_LA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_LA newObject = (schemaLib.MutedInfoB_LA)super.clone();

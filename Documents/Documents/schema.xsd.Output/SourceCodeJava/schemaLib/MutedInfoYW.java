...
// </summary>
public class MutedInfoYW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoYW
	// </summary>
	// <remarks>
	...
	public MutedInfoYW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoYW newObject = (schemaLib.MutedInfoYW)super.clone();

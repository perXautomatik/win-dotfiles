...
// </summary>
public class MutedInfoPH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoPH
	// </summary>
	// <remarks>
	...
	public MutedInfoPH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoPH newObject = (schemaLib.MutedInfoPH)super.clone();

...
// </summary>
public class MutedInfo_W extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfo_W
	// </summary>
	// <remarks>
	...
	public MutedInfo_W(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfo_W newObject = (schemaLib.MutedInfo_W)super.clone();

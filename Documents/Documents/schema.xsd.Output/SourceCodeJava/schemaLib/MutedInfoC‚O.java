...
// </summary>
public class MutedInfoC‚O extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC‚O
	// </summary>
	// <remarks>
	...
	public MutedInfoC‚O(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC‚O newObject = (schemaLib.MutedInfoC‚O)super.clone();

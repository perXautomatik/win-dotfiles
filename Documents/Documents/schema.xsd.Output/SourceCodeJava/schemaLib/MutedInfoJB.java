...
// </summary>
public class MutedInfoJB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoJB
	// </summary>
	// <remarks>
	...
	public MutedInfoJB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoJB newObject = (schemaLib.MutedInfoJB)super.clone();

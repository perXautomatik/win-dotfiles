...
// </summary>
public class MutedInfoYO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoYO
	// </summary>
	// <remarks>
	...
	public MutedInfoYO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoYO newObject = (schemaLib.MutedInfoYO)super.clone();

...
// </summary>
public class MutedInfoCyK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCyK
	// </summary>
	// <remarks>
	...
	public MutedInfoCyK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCyK newObject = (schemaLib.MutedInfoCyK)super.clone();

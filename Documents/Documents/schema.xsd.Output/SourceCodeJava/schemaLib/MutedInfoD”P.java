...
// </summary>
public class MutedInfoD”P extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoD”P
	// </summary>
	// <remarks>
	...
	public MutedInfoD”P(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoD”P newObject = (schemaLib.MutedInfoD”P)super.clone();

...
// </summary>
public class MutedInfoDŒC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŒC
	// </summary>
	// <remarks>
	...
	public MutedInfoDŒC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŒC newObject = (schemaLib.MutedInfoDŒC)super.clone();

...
// </summary>
public class MutedInfoZL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoZL
	// </summary>
	// <remarks>
	...
	public MutedInfoZL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoZL newObject = (schemaLib.MutedInfoZL)super.clone();

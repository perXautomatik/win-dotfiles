...
// </summary>
public class MutedInfoCnW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCnW
	// </summary>
	// <remarks>
	...
	public MutedInfoCnW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCnW newObject = (schemaLib.MutedInfoCnW)super.clone();

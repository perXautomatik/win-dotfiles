...
// </summary>
public class MutedInfoCtT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCtT
	// </summary>
	// <remarks>
	...
	public MutedInfoCtT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCtT newObject = (schemaLib.MutedInfoCtT)super.clone();

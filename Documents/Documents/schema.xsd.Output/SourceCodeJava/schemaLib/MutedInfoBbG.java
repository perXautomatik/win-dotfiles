...
// </summary>
public class MutedInfoBbG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBbG
	// </summary>
	// <remarks>
	...
	public MutedInfoBbG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBbG newObject = (schemaLib.MutedInfoBbG)super.clone();

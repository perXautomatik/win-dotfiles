...
// </summary>
public class MutedInfoFD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoFD
	// </summary>
	// <remarks>
	...
	public MutedInfoFD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoFD newObject = (schemaLib.MutedInfoFD)super.clone();

...
// </summary>
public class MutedInfoCjT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCjT
	// </summary>
	// <remarks>
	...
	public MutedInfoCjT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCjT newObject = (schemaLib.MutedInfoCjT)super.clone();

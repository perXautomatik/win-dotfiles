...
// </summary>
public class MutedInfoNJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoNJ
	// </summary>
	// <remarks>
	...
	public MutedInfoNJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoNJ newObject = (schemaLib.MutedInfoNJ)super.clone();

...
// </summary>
public class MutedInfoFL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoFL
	// </summary>
	// <remarks>
	...
	public MutedInfoFL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoFL newObject = (schemaLib.MutedInfoFL)super.clone();

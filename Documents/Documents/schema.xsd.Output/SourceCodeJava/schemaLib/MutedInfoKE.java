...
// </summary>
public class MutedInfoKE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoKE
	// </summary>
	// <remarks>
	...
	public MutedInfoKE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoKE newObject = (schemaLib.MutedInfoKE)super.clone();

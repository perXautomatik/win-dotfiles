...
// </summary>
public class MutedInfoCiU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCiU
	// </summary>
	// <remarks>
	...
	public MutedInfoCiU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCiU newObject = (schemaLib.MutedInfoCiU)super.clone();

...
// </summary>
public class MutedInfoB_RC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_RC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_RC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_RC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_RC newObject = (schemaLib.MutedInfoB_RC)super.clone();

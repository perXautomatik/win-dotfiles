...
// </summary>
public class MutedInfoYR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoYR
	// </summary>
	// <remarks>
	...
	public MutedInfoYR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoYR newObject = (schemaLib.MutedInfoYR)super.clone();

...
// </summary>
public class MutedInfoCjJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCjJ
	// </summary>
	// <remarks>
	...
	public MutedInfoCjJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCjJ newObject = (schemaLib.MutedInfoCjJ)super.clone();

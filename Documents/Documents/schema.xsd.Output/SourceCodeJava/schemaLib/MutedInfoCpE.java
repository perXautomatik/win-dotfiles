...
// </summary>
public class MutedInfoCpE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCpE
	// </summary>
	// <remarks>
	...
	public MutedInfoCpE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCpE newObject = (schemaLib.MutedInfoCpE)super.clone();

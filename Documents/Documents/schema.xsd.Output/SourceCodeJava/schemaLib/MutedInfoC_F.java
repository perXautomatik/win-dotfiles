...
// </summary>
public class MutedInfoC_F extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_F
	// </summary>
	// <remarks>
	...
	public MutedInfoC_F(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_F newObject = (schemaLib.MutedInfoC_F)super.clone();

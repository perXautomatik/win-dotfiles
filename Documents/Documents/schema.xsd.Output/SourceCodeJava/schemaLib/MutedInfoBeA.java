...
// </summary>
public class MutedInfoBeA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBeA
	// </summary>
	// <remarks>
	...
	public MutedInfoBeA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBeA newObject = (schemaLib.MutedInfoBeA)super.clone();

...
// </summary>
public class MutedInfoCsS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCsS
	// </summary>
	// <remarks>
	...
	public MutedInfoCsS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCsS newObject = (schemaLib.MutedInfoCsS)super.clone();

...
// </summary>
public class MutedInfoCwW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCwW
	// </summary>
	// <remarks>
	...
	public MutedInfoCwW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCwW newObject = (schemaLib.MutedInfoCwW)super.clone();

...
// </summary>
public class MutedInfoC_M extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_M
	// </summary>
	// <remarks>
	...
	public MutedInfoC_M(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_M newObject = (schemaLib.MutedInfoC_M)super.clone();

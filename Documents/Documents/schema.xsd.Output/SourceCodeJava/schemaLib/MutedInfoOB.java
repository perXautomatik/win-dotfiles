...
// </summary>
public class MutedInfoOB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoOB
	// </summary>
	// <remarks>
	...
	public MutedInfoOB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoOB newObject = (schemaLib.MutedInfoOB)super.clone();

...
// </summary>
public class MutedInfoDM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDM
	// </summary>
	// <remarks>
	...
	public MutedInfoDM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDM newObject = (schemaLib.MutedInfoDM)super.clone();

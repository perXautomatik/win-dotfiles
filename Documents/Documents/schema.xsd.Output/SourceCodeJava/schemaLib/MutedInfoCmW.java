...
// </summary>
public class MutedInfoCmW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCmW
	// </summary>
	// <remarks>
	...
	public MutedInfoCmW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCmW newObject = (schemaLib.MutedInfoCmW)super.clone();

...
// </summary>
public class MutedInfoGK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoGK
	// </summary>
	// <remarks>
	...
	public MutedInfoGK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoGK newObject = (schemaLib.MutedInfoGK)super.clone();

...
// </summary>
public class MutedInfoJQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoJQ
	// </summary>
	// <remarks>
	...
	public MutedInfoJQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoJQ newObject = (schemaLib.MutedInfoJQ)super.clone();

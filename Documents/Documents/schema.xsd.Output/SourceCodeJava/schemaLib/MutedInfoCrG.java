...
// </summary>
public class MutedInfoCrG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCrG
	// </summary>
	// <remarks>
	...
	public MutedInfoCrG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCrG newObject = (schemaLib.MutedInfoCrG)super.clone();

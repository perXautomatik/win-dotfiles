...
// </summary>
public class MutedInfoBaI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBaI
	// </summary>
	// <remarks>
	...
	public MutedInfoBaI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBaI newObject = (schemaLib.MutedInfoBaI)super.clone();

...
// </summary>
public class MutedInfoCS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCS
	// </summary>
	// <remarks>
	...
	public MutedInfoCS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCS newObject = (schemaLib.MutedInfoCS)super.clone();

...
// </summary>
public class MutedInfoKV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoKV
	// </summary>
	// <remarks>
	...
	public MutedInfoKV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoKV newObject = (schemaLib.MutedInfoKV)super.clone();

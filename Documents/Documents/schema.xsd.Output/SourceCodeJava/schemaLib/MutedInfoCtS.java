...
// </summary>
public class MutedInfoCtS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCtS
	// </summary>
	// <remarks>
	...
	public MutedInfoCtS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCtS newObject = (schemaLib.MutedInfoCtS)super.clone();

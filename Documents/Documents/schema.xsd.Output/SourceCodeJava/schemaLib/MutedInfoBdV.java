...
// </summary>
public class MutedInfoBdV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBdV
	// </summary>
	// <remarks>
	...
	public MutedInfoBdV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBdV newObject = (schemaLib.MutedInfoBdV)super.clone();

...
// </summary>
public class MutedInfoPJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoPJ
	// </summary>
	// <remarks>
	...
	public MutedInfoPJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoPJ newObject = (schemaLib.MutedInfoPJ)super.clone();

...
// </summary>
public class MutedInfoCsA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCsA
	// </summary>
	// <remarks>
	...
	public MutedInfoCsA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCsA newObject = (schemaLib.MutedInfoCsA)super.clone();

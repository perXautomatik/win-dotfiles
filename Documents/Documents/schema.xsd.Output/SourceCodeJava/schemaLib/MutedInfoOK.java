...
// </summary>
public class MutedInfoOK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoOK
	// </summary>
	// <remarks>
	...
	public MutedInfoOK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoOK newObject = (schemaLib.MutedInfoOK)super.clone();

...
// </summary>
public class MutedInfoC_FA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_FA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_FA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_FA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_FA newObject = (schemaLib.MutedInfoC_FA)super.clone();

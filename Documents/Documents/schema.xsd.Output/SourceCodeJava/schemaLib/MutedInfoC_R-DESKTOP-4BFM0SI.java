...
// </summary>
public class MutedInfoCR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCR
	// </summary>
	// <remarks>
	...
	public MutedInfoCR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCR newObject = (schemaLib.MutedInfoCR)super.clone();

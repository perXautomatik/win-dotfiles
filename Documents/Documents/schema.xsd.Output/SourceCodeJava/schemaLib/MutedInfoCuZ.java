...
// </summary>
public class MutedInfoCuZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCuZ
	// </summary>
	// <remarks>
	...
	public MutedInfoCuZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCuZ newObject = (schemaLib.MutedInfoCuZ)super.clone();

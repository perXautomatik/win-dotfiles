...
// </summary>
public class MutedInfoIX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoIX
	// </summary>
	// <remarks>
	...
	public MutedInfoIX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoIX newObject = (schemaLib.MutedInfoIX)super.clone();

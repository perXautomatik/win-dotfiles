...
// </summary>
public class MutedInfoSC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoSC
	// </summary>
	// <remarks>
	...
	public MutedInfoSC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoSC newObject = (schemaLib.MutedInfoSC)super.clone();

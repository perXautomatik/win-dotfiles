...
// </summary>
public class MutedInfoPY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoPY
	// </summary>
	// <remarks>
	...
	public MutedInfoPY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoPY newObject = (schemaLib.MutedInfoPY)super.clone();

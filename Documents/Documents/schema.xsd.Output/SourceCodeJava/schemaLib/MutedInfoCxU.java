...
// </summary>
public class MutedInfoCxU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCxU
	// </summary>
	// <remarks>
	...
	public MutedInfoCxU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCxU newObject = (schemaLib.MutedInfoCxU)super.clone();

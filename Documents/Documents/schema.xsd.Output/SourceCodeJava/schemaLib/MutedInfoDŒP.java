...
// </summary>
public class MutedInfoDŒP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŒP
	// </summary>
	// <remarks>
	...
	public MutedInfoDŒP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŒP newObject = (schemaLib.MutedInfoDŒP)super.clone();

...
// </summary>
public class MutedInfoCvF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCvF
	// </summary>
	// <remarks>
	...
	public MutedInfoCvF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCvF newObject = (schemaLib.MutedInfoCvF)super.clone();

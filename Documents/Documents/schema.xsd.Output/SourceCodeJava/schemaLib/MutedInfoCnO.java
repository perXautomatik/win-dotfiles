...
// </summary>
public class MutedInfoCnO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCnO
	// </summary>
	// <remarks>
	...
	public MutedInfoCnO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCnO newObject = (schemaLib.MutedInfoCnO)super.clone();

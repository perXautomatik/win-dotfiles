...
// </summary>
public class MutedInfoBaP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBaP
	// </summary>
	// <remarks>
	...
	public MutedInfoBaP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBaP newObject = (schemaLib.MutedInfoBaP)super.clone();

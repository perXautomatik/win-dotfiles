...
// </summary>
public class MutedInfoCtG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCtG
	// </summary>
	// <remarks>
	...
	public MutedInfoCtG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCtG newObject = (schemaLib.MutedInfoCtG)super.clone();

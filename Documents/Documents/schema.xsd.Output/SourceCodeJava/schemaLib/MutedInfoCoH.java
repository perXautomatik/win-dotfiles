...
// </summary>
public class MutedInfoCoH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCoH
	// </summary>
	// <remarks>
	...
	public MutedInfoCoH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCoH newObject = (schemaLib.MutedInfoCoH)super.clone();

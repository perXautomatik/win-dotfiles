...
// </summary>
public class MutedInfoXD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoXD
	// </summary>
	// <remarks>
	...
	public MutedInfoXD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoXD newObject = (schemaLib.MutedInfoXD)super.clone();

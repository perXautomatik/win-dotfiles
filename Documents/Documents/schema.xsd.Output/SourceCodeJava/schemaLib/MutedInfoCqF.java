...
// </summary>
public class MutedInfoCqF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCqF
	// </summary>
	// <remarks>
	...
	public MutedInfoCqF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCqF newObject = (schemaLib.MutedInfoCqF)super.clone();

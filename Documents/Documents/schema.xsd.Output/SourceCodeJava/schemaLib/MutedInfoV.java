...
// </summary>
public class MutedInfoV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoV
	// </summary>
	// <remarks>
	...
	public MutedInfoV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoV newObject = (schemaLib.MutedInfoV)super.clone();

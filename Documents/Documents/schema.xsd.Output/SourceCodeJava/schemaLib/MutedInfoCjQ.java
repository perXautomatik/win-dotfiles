...
// </summary>
public class MutedInfoCjQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCjQ
	// </summary>
	// <remarks>
	...
	public MutedInfoCjQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCjQ newObject = (schemaLib.MutedInfoCjQ)super.clone();

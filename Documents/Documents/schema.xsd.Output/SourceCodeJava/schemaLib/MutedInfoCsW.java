...
// </summary>
public class MutedInfoCsW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCsW
	// </summary>
	// <remarks>
	...
	public MutedInfoCsW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCsW newObject = (schemaLib.MutedInfoCsW)super.clone();

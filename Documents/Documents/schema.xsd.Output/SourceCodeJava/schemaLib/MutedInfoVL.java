...
// </summary>
public class MutedInfoVL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoVL
	// </summary>
	// <remarks>
	...
	public MutedInfoVL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoVL newObject = (schemaLib.MutedInfoVL)super.clone();

...
// </summary>
public class MutedInfoC_W extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_W
	// </summary>
	// <remarks>
	...
	public MutedInfoC_W(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_W newObject = (schemaLib.MutedInfoC_W)super.clone();

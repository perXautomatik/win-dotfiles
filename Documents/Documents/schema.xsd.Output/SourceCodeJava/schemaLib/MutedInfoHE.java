...
// </summary>
public class MutedInfoHE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoHE
	// </summary>
	// <remarks>
	...
	public MutedInfoHE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoHE newObject = (schemaLib.MutedInfoHE)super.clone();

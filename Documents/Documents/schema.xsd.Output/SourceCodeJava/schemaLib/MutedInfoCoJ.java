...
// </summary>
public class MutedInfoCoJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCoJ
	// </summary>
	// <remarks>
	...
	public MutedInfoCoJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCoJ newObject = (schemaLib.MutedInfoCoJ)super.clone();

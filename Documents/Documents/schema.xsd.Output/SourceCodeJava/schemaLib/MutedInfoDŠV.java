...
// </summary>
public class MutedInfoDŠV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŠV
	// </summary>
	// <remarks>
	...
	public MutedInfoDŠV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŠV newObject = (schemaLib.MutedInfoDŠV)super.clone();

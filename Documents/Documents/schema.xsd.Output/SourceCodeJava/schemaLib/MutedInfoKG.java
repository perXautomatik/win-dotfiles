...
// </summary>
public class MutedInfoKG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoKG
	// </summary>
	// <remarks>
	...
	public MutedInfoKG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoKG newObject = (schemaLib.MutedInfoKG)super.clone();

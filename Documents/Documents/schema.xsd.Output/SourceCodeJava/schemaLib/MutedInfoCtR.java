...
// </summary>
public class MutedInfoCtR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCtR
	// </summary>
	// <remarks>
	...
	public MutedInfoCtR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCtR newObject = (schemaLib.MutedInfoCtR)super.clone();

...
// </summary>
public class MutedInfoCkO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCkO
	// </summary>
	// <remarks>
	...
	public MutedInfoCkO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCkO newObject = (schemaLib.MutedInfoCkO)super.clone();

...
// </summary>
public class MutedInfoC_G extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_G
	// </summary>
	// <remarks>
	...
	public MutedInfoC_G(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_G newObject = (schemaLib.MutedInfoC_G)super.clone();

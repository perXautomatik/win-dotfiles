...
// </summary>
public class MutedInfoS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoS
	// </summary>
	// <remarks>
	...
	public MutedInfoS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoS newObject = (schemaLib.MutedInfoS)super.clone();

...
// </summary>
public class MutedInfoBgL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBgL
	// </summary>
	// <remarks>
	...
	public MutedInfoBgL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBgL newObject = (schemaLib.MutedInfoBgL)super.clone();

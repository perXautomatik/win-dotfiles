...
// </summary>
public class MutedInfoPR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoPR
	// </summary>
	// <remarks>
	...
	public MutedInfoPR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoPR newObject = (schemaLib.MutedInfoPR)super.clone();

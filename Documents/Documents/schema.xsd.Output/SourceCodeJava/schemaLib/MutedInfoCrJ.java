...
// </summary>
public class MutedInfoCrJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCrJ
	// </summary>
	// <remarks>
	...
	public MutedInfoCrJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCrJ newObject = (schemaLib.MutedInfoCrJ)super.clone();

...
// </summary>
public class MutedInfoCoQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCoQ
	// </summary>
	// <remarks>
	...
	public MutedInfoCoQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCoQ newObject = (schemaLib.MutedInfoCoQ)super.clone();

...
// </summary>
public class MutedInfoCoF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCoF
	// </summary>
	// <remarks>
	...
	public MutedInfoCoF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCoF newObject = (schemaLib.MutedInfoCoF)super.clone();

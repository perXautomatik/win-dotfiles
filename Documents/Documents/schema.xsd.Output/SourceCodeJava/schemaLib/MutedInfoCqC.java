...
// </summary>
public class MutedInfoCqC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCqC
	// </summary>
	// <remarks>
	...
	public MutedInfoCqC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCqC newObject = (schemaLib.MutedInfoCqC)super.clone();

...
// </summary>
public class MutedInfoLN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoLN
	// </summary>
	// <remarks>
	...
	public MutedInfoLN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoLN newObject = (schemaLib.MutedInfoLN)super.clone();

...
// </summary>
public class MutedInfoA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoA
	// </summary>
	// <remarks>
	...
	public MutedInfoA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoA newObject = (schemaLib.MutedInfoA)super.clone();

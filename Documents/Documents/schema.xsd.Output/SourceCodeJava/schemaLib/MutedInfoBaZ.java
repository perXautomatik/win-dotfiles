...
// </summary>
public class MutedInfoBaZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBaZ
	// </summary>
	// <remarks>
	...
	public MutedInfoBaZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBaZ newObject = (schemaLib.MutedInfoBaZ)super.clone();

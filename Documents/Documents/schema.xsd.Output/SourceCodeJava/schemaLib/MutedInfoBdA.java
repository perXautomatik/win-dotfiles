...
// </summary>
public class MutedInfoBdA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBdA
	// </summary>
	// <remarks>
	...
	public MutedInfoBdA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBdA newObject = (schemaLib.MutedInfoBdA)super.clone();

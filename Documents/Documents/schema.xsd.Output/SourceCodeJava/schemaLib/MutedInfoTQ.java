...
// </summary>
public class MutedInfoTQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoTQ
	// </summary>
	// <remarks>
	...
	public MutedInfoTQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoTQ newObject = (schemaLib.MutedInfoTQ)super.clone();

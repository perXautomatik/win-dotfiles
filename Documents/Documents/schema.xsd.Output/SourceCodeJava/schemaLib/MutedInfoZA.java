...
// </summary>
public class MutedInfoZA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoZA
	// </summary>
	// <remarks>
	...
	public MutedInfoZA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoZA newObject = (schemaLib.MutedInfoZA)super.clone();

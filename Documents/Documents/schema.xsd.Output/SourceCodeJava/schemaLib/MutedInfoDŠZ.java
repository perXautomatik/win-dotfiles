...
// </summary>
public class MutedInfoDŠZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŠZ
	// </summary>
	// <remarks>
	...
	public MutedInfoDŠZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŠZ newObject = (schemaLib.MutedInfoDŠZ)super.clone();

...
// </summary>
public class MutedInfoQW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoQW
	// </summary>
	// <remarks>
	...
	public MutedInfoQW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoQW newObject = (schemaLib.MutedInfoQW)super.clone();

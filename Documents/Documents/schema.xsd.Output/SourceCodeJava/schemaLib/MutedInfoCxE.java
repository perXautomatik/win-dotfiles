...
// </summary>
public class MutedInfoCxE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCxE
	// </summary>
	// <remarks>
	...
	public MutedInfoCxE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCxE newObject = (schemaLib.MutedInfoCxE)super.clone();

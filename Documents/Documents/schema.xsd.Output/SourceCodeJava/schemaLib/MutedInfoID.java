...
// </summary>
public class MutedInfoID extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoID
	// </summary>
	// <remarks>
	...
	public MutedInfoID(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoID newObject = (schemaLib.MutedInfoID)super.clone();

...
// </summary>
public class MutedInfoB_EB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_EB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_EB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_EB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_EB newObject = (schemaLib.MutedInfoB_EB)super.clone();

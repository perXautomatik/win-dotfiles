...
// </summary>
public class MutedInfoC_LA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_LA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_LA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_LA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_LA newObject = (schemaLib.MutedInfoC_LA)super.clone();

...
// </summary>
public class MutedInfoCoO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCoO
	// </summary>
	// <remarks>
	...
	public MutedInfoCoO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCoO newObject = (schemaLib.MutedInfoCoO)super.clone();

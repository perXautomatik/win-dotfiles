...
// </summary>
public class MutedInfoCiK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCiK
	// </summary>
	// <remarks>
	...
	public MutedInfoCiK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCiK newObject = (schemaLib.MutedInfoCiK)super.clone();

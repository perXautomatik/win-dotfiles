...
// </summary>
public class MutedInfoBcK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBcK
	// </summary>
	// <remarks>
	...
	public MutedInfoBcK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBcK newObject = (schemaLib.MutedInfoBcK)super.clone();

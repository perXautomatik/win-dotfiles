...
// </summary>
public class MutedInfoPG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoPG
	// </summary>
	// <remarks>
	...
	public MutedInfoPG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoPG newObject = (schemaLib.MutedInfoPG)super.clone();

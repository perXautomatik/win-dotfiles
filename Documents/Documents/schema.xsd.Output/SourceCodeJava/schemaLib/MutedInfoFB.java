...
// </summary>
public class MutedInfoFB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoFB
	// </summary>
	// <remarks>
	...
	public MutedInfoFB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoFB newObject = (schemaLib.MutedInfoFB)super.clone();

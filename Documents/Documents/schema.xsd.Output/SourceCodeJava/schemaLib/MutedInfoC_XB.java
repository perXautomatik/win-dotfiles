...
// </summary>
public class MutedInfoC_XB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_XB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_XB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_XB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_XB newObject = (schemaLib.MutedInfoC_XB)super.clone();

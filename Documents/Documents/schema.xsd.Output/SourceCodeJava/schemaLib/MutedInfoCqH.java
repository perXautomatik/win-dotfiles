...
// </summary>
public class MutedInfoCqH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCqH
	// </summary>
	// <remarks>
	...
	public MutedInfoCqH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCqH newObject = (schemaLib.MutedInfoCqH)super.clone();

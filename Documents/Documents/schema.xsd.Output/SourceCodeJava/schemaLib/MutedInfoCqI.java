...
// </summary>
public class MutedInfoCqI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCqI
	// </summary>
	// <remarks>
	...
	public MutedInfoCqI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCqI newObject = (schemaLib.MutedInfoCqI)super.clone();

...
// </summary>
public class MutedInfoCK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCK
	// </summary>
	// <remarks>
	...
	public MutedInfoCK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCK newObject = (schemaLib.MutedInfoCK)super.clone();

...
// </summary>
public class MutedInfoBbA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBbA
	// </summary>
	// <remarks>
	...
	public MutedInfoBbA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBbA newObject = (schemaLib.MutedInfoBbA)super.clone();

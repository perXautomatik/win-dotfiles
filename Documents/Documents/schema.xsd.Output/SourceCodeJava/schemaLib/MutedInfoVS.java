...
// </summary>
public class MutedInfoVS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoVS
	// </summary>
	// <remarks>
	...
	public MutedInfoVS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoVS newObject = (schemaLib.MutedInfoVS)super.clone();

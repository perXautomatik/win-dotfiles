...
// </summary>
public class MutedInfoWG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoWG
	// </summary>
	// <remarks>
	...
	public MutedInfoWG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoWG newObject = (schemaLib.MutedInfoWG)super.clone();

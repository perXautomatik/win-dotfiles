...
// </summary>
public class MutedInfoLF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoLF
	// </summary>
	// <remarks>
	...
	public MutedInfoLF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoLF newObject = (schemaLib.MutedInfoLF)super.clone();

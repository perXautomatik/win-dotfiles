...
// </summary>
public class MutedInfoJD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoJD
	// </summary>
	// <remarks>
	...
	public MutedInfoJD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoJD newObject = (schemaLib.MutedInfoJD)super.clone();

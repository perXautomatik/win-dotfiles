...
// </summary>
public class MutedInfoSE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoSE
	// </summary>
	// <remarks>
	...
	public MutedInfoSE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoSE newObject = (schemaLib.MutedInfoSE)super.clone();

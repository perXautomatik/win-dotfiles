...
// </summary>
public class MutedInfoCnE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCnE
	// </summary>
	// <remarks>
	...
	public MutedInfoCnE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCnE newObject = (schemaLib.MutedInfoCnE)super.clone();

...
// </summary>
public class MutedInfoGC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoGC
	// </summary>
	// <remarks>
	...
	public MutedInfoGC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoGC newObject = (schemaLib.MutedInfoGC)super.clone();

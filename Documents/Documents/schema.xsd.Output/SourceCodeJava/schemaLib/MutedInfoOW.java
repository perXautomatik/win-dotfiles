...
// </summary>
public class MutedInfoOW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoOW
	// </summary>
	// <remarks>
	...
	public MutedInfoOW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoOW newObject = (schemaLib.MutedInfoOW)super.clone();

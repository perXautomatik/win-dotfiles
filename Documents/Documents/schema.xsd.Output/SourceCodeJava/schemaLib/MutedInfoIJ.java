...
// </summary>
public class MutedInfoIJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoIJ
	// </summary>
	// <remarks>
	...
	public MutedInfoIJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoIJ newObject = (schemaLib.MutedInfoIJ)super.clone();

...
// </summary>
public class MutedInfoCxG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCxG
	// </summary>
	// <remarks>
	...
	public MutedInfoCxG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCxG newObject = (schemaLib.MutedInfoCxG)super.clone();

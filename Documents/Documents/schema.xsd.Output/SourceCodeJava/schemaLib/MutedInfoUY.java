...
// </summary>
public class MutedInfoUY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoUY
	// </summary>
	// <remarks>
	...
	public MutedInfoUY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoUY newObject = (schemaLib.MutedInfoUY)super.clone();

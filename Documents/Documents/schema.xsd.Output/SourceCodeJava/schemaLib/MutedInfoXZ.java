...
// </summary>
public class MutedInfoXZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoXZ
	// </summary>
	// <remarks>
	...
	public MutedInfoXZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoXZ newObject = (schemaLib.MutedInfoXZ)super.clone();

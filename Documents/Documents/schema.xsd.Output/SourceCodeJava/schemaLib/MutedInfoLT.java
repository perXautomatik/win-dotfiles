...
// </summary>
public class MutedInfoLT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoLT
	// </summary>
	// <remarks>
	...
	public MutedInfoLT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoLT newObject = (schemaLib.MutedInfoLT)super.clone();

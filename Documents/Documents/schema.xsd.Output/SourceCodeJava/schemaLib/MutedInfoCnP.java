...
// </summary>
public class MutedInfoCnP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCnP
	// </summary>
	// <remarks>
	...
	public MutedInfoCnP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCnP newObject = (schemaLib.MutedInfoCnP)super.clone();

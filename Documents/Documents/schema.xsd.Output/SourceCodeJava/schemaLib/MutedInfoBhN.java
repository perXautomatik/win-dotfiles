...
// </summary>
public class MutedInfoBhN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBhN
	// </summary>
	// <remarks>
	...
	public MutedInfoBhN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBhN newObject = (schemaLib.MutedInfoBhN)super.clone();

...
// </summary>
public class MutedInfoCmK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCmK
	// </summary>
	// <remarks>
	...
	public MutedInfoCmK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCmK newObject = (schemaLib.MutedInfoCmK)super.clone();

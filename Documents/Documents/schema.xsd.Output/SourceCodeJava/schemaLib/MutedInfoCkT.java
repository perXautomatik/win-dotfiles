...
// </summary>
public class MutedInfoCkT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCkT
	// </summary>
	// <remarks>
	...
	public MutedInfoCkT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCkT newObject = (schemaLib.MutedInfoCkT)super.clone();

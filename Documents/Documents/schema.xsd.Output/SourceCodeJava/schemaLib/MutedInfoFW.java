...
// </summary>
public class MutedInfoFW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoFW
	// </summary>
	// <remarks>
	...
	public MutedInfoFW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoFW newObject = (schemaLib.MutedInfoFW)super.clone();

...
// </summary>
public class MutedInfoC_OB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_OB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_OB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_OB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_OB newObject = (schemaLib.MutedInfoC_OB)super.clone();

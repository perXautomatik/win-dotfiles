...
// </summary>
public class MutedInfoClU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoClU
	// </summary>
	// <remarks>
	...
	public MutedInfoClU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoClU newObject = (schemaLib.MutedInfoClU)super.clone();

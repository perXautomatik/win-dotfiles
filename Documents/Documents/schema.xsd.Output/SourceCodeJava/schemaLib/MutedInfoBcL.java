...
// </summary>
public class MutedInfoBcL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBcL
	// </summary>
	// <remarks>
	...
	public MutedInfoBcL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBcL newObject = (schemaLib.MutedInfoBcL)super.clone();

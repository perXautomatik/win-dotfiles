...
// </summary>
public class MutedInfoCtY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCtY
	// </summary>
	// <remarks>
	...
	public MutedInfoCtY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCtY newObject = (schemaLib.MutedInfoCtY)super.clone();

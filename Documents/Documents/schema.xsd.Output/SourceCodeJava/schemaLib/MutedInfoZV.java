...
// </summary>
public class MutedInfoZV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoZV
	// </summary>
	// <remarks>
	...
	public MutedInfoZV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoZV newObject = (schemaLib.MutedInfoZV)super.clone();

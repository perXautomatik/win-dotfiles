...
// </summary>
public class MutedInfoB_AC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_AC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_AC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_AC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_AC newObject = (schemaLib.MutedInfoB_AC)super.clone();

...
// </summary>
public class MutedInfoLE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoLE
	// </summary>
	// <remarks>
	...
	public MutedInfoLE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoLE newObject = (schemaLib.MutedInfoLE)super.clone();

...
// </summary>
public class MutedInfoXE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoXE
	// </summary>
	// <remarks>
	...
	public MutedInfoXE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoXE newObject = (schemaLib.MutedInfoXE)super.clone();

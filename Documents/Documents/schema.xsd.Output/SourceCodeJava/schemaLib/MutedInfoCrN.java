...
// </summary>
public class MutedInfoCrN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCrN
	// </summary>
	// <remarks>
	...
	public MutedInfoCrN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCrN newObject = (schemaLib.MutedInfoCrN)super.clone();

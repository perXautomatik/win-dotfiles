...
// </summary>
public class MutedInfoLQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoLQ
	// </summary>
	// <remarks>
	...
	public MutedInfoLQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoLQ newObject = (schemaLib.MutedInfoLQ)super.clone();

...
// </summary>
public class MutedInfoOM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoOM
	// </summary>
	// <remarks>
	...
	public MutedInfoOM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoOM newObject = (schemaLib.MutedInfoOM)super.clone();

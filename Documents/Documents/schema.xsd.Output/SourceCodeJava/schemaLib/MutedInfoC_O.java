...
// </summary>
public class MutedInfoC_O extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_O
	// </summary>
	// <remarks>
	...
	public MutedInfoC_O(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_O newObject = (schemaLib.MutedInfoC_O)super.clone();

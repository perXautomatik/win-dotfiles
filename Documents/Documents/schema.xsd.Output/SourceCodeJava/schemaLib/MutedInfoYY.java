...
// </summary>
public class MutedInfoYY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoYY
	// </summary>
	// <remarks>
	...
	public MutedInfoYY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoYY newObject = (schemaLib.MutedInfoYY)super.clone();

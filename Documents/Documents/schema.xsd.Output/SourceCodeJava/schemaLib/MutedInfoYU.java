...
// </summary>
public class MutedInfoYU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoYU
	// </summary>
	// <remarks>
	...
	public MutedInfoYU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoYU newObject = (schemaLib.MutedInfoYU)super.clone();

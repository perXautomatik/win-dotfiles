...
// </summary>
public class MutedInfoB_Z extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_Z
	// </summary>
	// <remarks>
	...
	public MutedInfoB_Z(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_Z newObject = (schemaLib.MutedInfoB_Z)super.clone();

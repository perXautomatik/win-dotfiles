...
// </summary>
public class MutedInfoCyA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCyA
	// </summary>
	// <remarks>
	...
	public MutedInfoCyA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCyA newObject = (schemaLib.MutedInfoCyA)super.clone();

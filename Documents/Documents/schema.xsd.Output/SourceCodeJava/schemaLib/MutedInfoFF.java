...
// </summary>
public class MutedInfoFF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoFF
	// </summary>
	// <remarks>
	...
	public MutedInfoFF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoFF newObject = (schemaLib.MutedInfoFF)super.clone();

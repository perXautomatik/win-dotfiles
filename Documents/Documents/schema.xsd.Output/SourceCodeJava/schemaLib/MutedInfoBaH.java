...
// </summary>
public class MutedInfoBaH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBaH
	// </summary>
	// <remarks>
	...
	public MutedInfoBaH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBaH newObject = (schemaLib.MutedInfoBaH)super.clone();

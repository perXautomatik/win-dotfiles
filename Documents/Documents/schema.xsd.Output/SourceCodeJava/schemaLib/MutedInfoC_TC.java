...
// </summary>
public class MutedInfoC_TC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_TC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_TC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_TC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_TC newObject = (schemaLib.MutedInfoC_TC)super.clone();

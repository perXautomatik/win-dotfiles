...
// </summary>
public class MutedInfoCyU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCyU
	// </summary>
	// <remarks>
	...
	public MutedInfoCyU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCyU newObject = (schemaLib.MutedInfoCyU)super.clone();

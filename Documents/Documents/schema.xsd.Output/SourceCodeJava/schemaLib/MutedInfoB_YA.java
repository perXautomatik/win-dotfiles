...
// </summary>
public class MutedInfoB_YA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_YA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_YA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_YA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_YA newObject = (schemaLib.MutedInfoB_YA)super.clone();

...
// </summary>
public class MutedInfoSG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoSG
	// </summary>
	// <remarks>
	...
	public MutedInfoSG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoSG newObject = (schemaLib.MutedInfoSG)super.clone();

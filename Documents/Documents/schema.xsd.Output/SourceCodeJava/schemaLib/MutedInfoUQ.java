...
// </summary>
public class MutedInfoUQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoUQ
	// </summary>
	// <remarks>
	...
	public MutedInfoUQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoUQ newObject = (schemaLib.MutedInfoUQ)super.clone();

...
// </summary>
public class MutedInfoJS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoJS
	// </summary>
	// <remarks>
	...
	public MutedInfoJS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoJS newObject = (schemaLib.MutedInfoJS)super.clone();

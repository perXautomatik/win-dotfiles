...
// </summary>
public class MutedInfoDŠT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŠT
	// </summary>
	// <remarks>
	...
	public MutedInfoDŠT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŠT newObject = (schemaLib.MutedInfoDŠT)super.clone();

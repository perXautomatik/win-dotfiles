...
// </summary>
public class MutedInfoYG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoYG
	// </summary>
	// <remarks>
	...
	public MutedInfoYG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoYG newObject = (schemaLib.MutedInfoYG)super.clone();

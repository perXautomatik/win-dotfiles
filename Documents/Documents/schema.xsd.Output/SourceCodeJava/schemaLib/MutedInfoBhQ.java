...
// </summary>
public class MutedInfoBhQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBhQ
	// </summary>
	// <remarks>
	...
	public MutedInfoBhQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBhQ newObject = (schemaLib.MutedInfoBhQ)super.clone();

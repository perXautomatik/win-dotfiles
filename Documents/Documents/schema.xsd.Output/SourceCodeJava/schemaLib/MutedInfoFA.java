...
// </summary>
public class MutedInfoFA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoFA
	// </summary>
	// <remarks>
	...
	public MutedInfoFA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoFA newObject = (schemaLib.MutedInfoFA)super.clone();

...
// </summary>
public class MutedInfoCtK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCtK
	// </summary>
	// <remarks>
	...
	public MutedInfoCtK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCtK newObject = (schemaLib.MutedInfoCtK)super.clone();

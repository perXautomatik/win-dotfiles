...
// </summary>
public class MutedInfoBaC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBaC
	// </summary>
	// <remarks>
	...
	public MutedInfoBaC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBaC newObject = (schemaLib.MutedInfoBaC)super.clone();

...
// </summary>
public class MutedInfoB_IE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_IE
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_IE() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_IE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_IE newObject = (schemaLib.MutedInfoB_IE)super.clone();

...
// </summary>
public class MutedInfoClK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoClK
	// </summary>
	// <remarks>
	...
	public MutedInfoClK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoClK newObject = (schemaLib.MutedInfoClK)super.clone();

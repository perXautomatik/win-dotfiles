...
// </summary>
public class MutedInfoCqP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCqP
	// </summary>
	// <remarks>
	...
	public MutedInfoCqP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCqP newObject = (schemaLib.MutedInfoCqP)super.clone();

...
// </summary>
public class MutedInfoVC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoVC
	// </summary>
	// <remarks>
	...
	public MutedInfoVC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoVC newObject = (schemaLib.MutedInfoVC)super.clone();

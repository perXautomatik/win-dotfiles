...
// </summary>
public class MutedInfoGR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoGR
	// </summary>
	// <remarks>
	...
	public MutedInfoGR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoGR newObject = (schemaLib.MutedInfoGR)super.clone();

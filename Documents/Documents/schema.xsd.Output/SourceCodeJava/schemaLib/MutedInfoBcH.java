...
// </summary>
public class MutedInfoBcH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBcH
	// </summary>
	// <remarks>
	...
	public MutedInfoBcH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBcH newObject = (schemaLib.MutedInfoBcH)super.clone();

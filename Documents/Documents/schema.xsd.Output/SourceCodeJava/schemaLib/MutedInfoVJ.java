...
// </summary>
public class MutedInfoVJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoVJ
	// </summary>
	// <remarks>
	...
	public MutedInfoVJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoVJ newObject = (schemaLib.MutedInfoVJ)super.clone();

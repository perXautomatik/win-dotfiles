...
// </summary>
public class MutedInfoNO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoNO
	// </summary>
	// <remarks>
	...
	public MutedInfoNO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoNO newObject = (schemaLib.MutedInfoNO)super.clone();

...
// </summary>
public class MutedInfoQE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoQE
	// </summary>
	// <remarks>
	...
	public MutedInfoQE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoQE newObject = (schemaLib.MutedInfoQE)super.clone();

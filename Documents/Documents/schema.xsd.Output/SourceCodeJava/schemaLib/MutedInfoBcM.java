...
// </summary>
public class MutedInfoBcM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBcM
	// </summary>
	// <remarks>
	...
	public MutedInfoBcM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBcM newObject = (schemaLib.MutedInfoBcM)super.clone();

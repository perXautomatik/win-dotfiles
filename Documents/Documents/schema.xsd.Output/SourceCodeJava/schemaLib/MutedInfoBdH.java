...
// </summary>
public class MutedInfoBdH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBdH
	// </summary>
	// <remarks>
	...
	public MutedInfoBdH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBdH newObject = (schemaLib.MutedInfoBdH)super.clone();

...
// </summary>
public class MutedInfoJT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoJT
	// </summary>
	// <remarks>
	...
	public MutedInfoJT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoJT newObject = (schemaLib.MutedInfoJT)super.clone();

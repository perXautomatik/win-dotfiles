...
// </summary>
public class MutedInfoGJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoGJ
	// </summary>
	// <remarks>
	...
	public MutedInfoGJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoGJ newObject = (schemaLib.MutedInfoGJ)super.clone();

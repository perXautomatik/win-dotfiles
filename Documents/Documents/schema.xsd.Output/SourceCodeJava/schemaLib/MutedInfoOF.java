...
// </summary>
public class MutedInfoOF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoOF
	// </summary>
	// <remarks>
	...
	public MutedInfoOF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoOF newObject = (schemaLib.MutedInfoOF)super.clone();

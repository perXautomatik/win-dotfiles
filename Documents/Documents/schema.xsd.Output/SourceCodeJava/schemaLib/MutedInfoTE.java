...
// </summary>
public class MutedInfoTE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoTE
	// </summary>
	// <remarks>
	...
	public MutedInfoTE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoTE newObject = (schemaLib.MutedInfoTE)super.clone();

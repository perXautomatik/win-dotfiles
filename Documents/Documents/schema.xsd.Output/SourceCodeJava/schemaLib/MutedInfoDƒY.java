...
// </summary>
public class MutedInfoDƒY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDƒY
	// </summary>
	// <remarks>
	...
	public MutedInfoDƒY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDƒY newObject = (schemaLib.MutedInfoDƒY)super.clone();

...
// </summary>
public class MutedInfoDQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDQ
	// </summary>
	// <remarks>
	...
	public MutedInfoDQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDQ newObject = (schemaLib.MutedInfoDQ)super.clone();

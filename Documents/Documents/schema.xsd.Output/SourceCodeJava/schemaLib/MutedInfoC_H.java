...
// </summary>
public class MutedInfoC_H extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_H
	// </summary>
	// <remarks>
	...
	public MutedInfoC_H(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_H newObject = (schemaLib.MutedInfoC_H)super.clone();

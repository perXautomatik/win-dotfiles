...
// </summary>
public class MutedInfoCrI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCrI
	// </summary>
	// <remarks>
	...
	public MutedInfoCrI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCrI newObject = (schemaLib.MutedInfoCrI)super.clone();

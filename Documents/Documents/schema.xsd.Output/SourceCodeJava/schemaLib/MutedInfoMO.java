...
// </summary>
public class MutedInfoMO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoMO
	// </summary>
	// <remarks>
	...
	public MutedInfoMO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoMO newObject = (schemaLib.MutedInfoMO)super.clone();

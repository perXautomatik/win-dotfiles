...
// </summary>
public class MutedInfoCkU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCkU
	// </summary>
	// <remarks>
	...
	public MutedInfoCkU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCkU newObject = (schemaLib.MutedInfoCkU)super.clone();

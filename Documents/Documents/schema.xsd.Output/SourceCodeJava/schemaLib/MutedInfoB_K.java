...
// </summary>
public class MutedInfoB_K extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_K
	// </summary>
	// <remarks>
	...
	public MutedInfoB_K(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_K newObject = (schemaLib.MutedInfoB_K)super.clone();

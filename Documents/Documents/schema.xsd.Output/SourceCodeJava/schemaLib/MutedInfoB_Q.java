...
// </summary>
public class MutedInfoB_Q extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_Q
	// </summary>
	// <remarks>
	...
	public MutedInfoB_Q(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_Q newObject = (schemaLib.MutedInfoB_Q)super.clone();

...
// </summary>
public class MutedInfoYX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoYX
	// </summary>
	// <remarks>
	...
	public MutedInfoYX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoYX newObject = (schemaLib.MutedInfoYX)super.clone();

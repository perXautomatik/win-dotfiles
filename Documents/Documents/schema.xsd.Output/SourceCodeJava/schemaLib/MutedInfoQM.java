...
// </summary>
public class MutedInfoQM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoQM
	// </summary>
	// <remarks>
	...
	public MutedInfoQM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoQM newObject = (schemaLib.MutedInfoQM)super.clone();

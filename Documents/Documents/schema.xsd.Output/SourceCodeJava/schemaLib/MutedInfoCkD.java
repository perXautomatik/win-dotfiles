...
// </summary>
public class MutedInfoCkD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCkD
	// </summary>
	// <remarks>
	...
	public MutedInfoCkD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCkD newObject = (schemaLib.MutedInfoCkD)super.clone();

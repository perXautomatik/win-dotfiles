...
// </summary>
public class MutedInfoC_FB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_FB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_FB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_FB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_FB newObject = (schemaLib.MutedInfoC_FB)super.clone();

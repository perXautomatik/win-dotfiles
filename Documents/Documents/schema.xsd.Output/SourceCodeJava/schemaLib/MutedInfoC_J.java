...
// </summary>
public class MutedInfoC_J extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_J
	// </summary>
	// <remarks>
	...
	public MutedInfoC_J(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_J newObject = (schemaLib.MutedInfoC_J)super.clone();

...
// </summary>
public class MutedInfoC_JC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_JC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_JC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_JC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_JC newObject = (schemaLib.MutedInfoC_JC)super.clone();

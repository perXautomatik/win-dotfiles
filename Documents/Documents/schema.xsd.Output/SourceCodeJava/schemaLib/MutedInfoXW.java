...
// </summary>
public class MutedInfoXW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoXW
	// </summary>
	// <remarks>
	...
	public MutedInfoXW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoXW newObject = (schemaLib.MutedInfoXW)super.clone();

...
// </summary>
public class MutedInfoMG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoMG
	// </summary>
	// <remarks>
	...
	public MutedInfoMG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoMG newObject = (schemaLib.MutedInfoMG)super.clone();

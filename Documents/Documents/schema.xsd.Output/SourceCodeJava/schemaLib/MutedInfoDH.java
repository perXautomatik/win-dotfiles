...
// </summary>
public class MutedInfoDH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDH
	// </summary>
	// <remarks>
	...
	public MutedInfoDH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDH newObject = (schemaLib.MutedInfoDH)super.clone();

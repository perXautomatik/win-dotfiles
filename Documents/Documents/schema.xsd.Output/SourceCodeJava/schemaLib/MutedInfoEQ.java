...
// </summary>
public class MutedInfoEQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoEQ
	// </summary>
	// <remarks>
	...
	public MutedInfoEQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoEQ newObject = (schemaLib.MutedInfoEQ)super.clone();

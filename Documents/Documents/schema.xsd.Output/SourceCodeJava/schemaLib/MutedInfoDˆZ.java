...
// </summary>
public class MutedInfoDˆZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDˆZ
	// </summary>
	// <remarks>
	...
	public MutedInfoDˆZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDˆZ newObject = (schemaLib.MutedInfoDˆZ)super.clone();

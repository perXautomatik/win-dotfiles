...
// </summary>
public class MutedInfoCsH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCsH
	// </summary>
	// <remarks>
	...
	public MutedInfoCsH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCsH newObject = (schemaLib.MutedInfoCsH)super.clone();

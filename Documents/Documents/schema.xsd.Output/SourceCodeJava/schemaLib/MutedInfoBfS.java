...
// </summary>
public class MutedInfoBfS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBfS
	// </summary>
	// <remarks>
	...
	public MutedInfoBfS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBfS newObject = (schemaLib.MutedInfoBfS)super.clone();

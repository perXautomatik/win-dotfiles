...
// </summary>
public class MutedInfoClE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoClE
	// </summary>
	// <remarks>
	...
	public MutedInfoClE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoClE newObject = (schemaLib.MutedInfoClE)super.clone();

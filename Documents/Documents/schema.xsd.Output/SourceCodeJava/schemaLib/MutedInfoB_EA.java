...
// </summary>
public class MutedInfoB_EA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_EA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_EA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_EA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_EA newObject = (schemaLib.MutedInfoB_EA)super.clone();

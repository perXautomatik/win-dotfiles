...
// </summary>
public class MutedInfoCrP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCrP
	// </summary>
	// <remarks>
	...
	public MutedInfoCrP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCrP newObject = (schemaLib.MutedInfoCrP)super.clone();

...
// </summary>
public class MutedInfoUB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoUB
	// </summary>
	// <remarks>
	...
	public MutedInfoUB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoUB newObject = (schemaLib.MutedInfoUB)super.clone();

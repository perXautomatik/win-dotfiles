...
// </summary>
public class MutedInfoDŠC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŠC
	// </summary>
	// <remarks>
	...
	public MutedInfoDŠC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŠC newObject = (schemaLib.MutedInfoDŠC)super.clone();

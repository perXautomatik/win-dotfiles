...
// </summary>
public class MutedInfoCpO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCpO
	// </summary>
	// <remarks>
	...
	public MutedInfoCpO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCpO newObject = (schemaLib.MutedInfoCpO)super.clone();

...
// </summary>
public class MutedInfoCuW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCuW
	// </summary>
	// <remarks>
	...
	public MutedInfoCuW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCuW newObject = (schemaLib.MutedInfoCuW)super.clone();

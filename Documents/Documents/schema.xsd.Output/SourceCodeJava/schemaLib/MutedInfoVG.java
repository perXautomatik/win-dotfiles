...
// </summary>
public class MutedInfoVG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoVG
	// </summary>
	// <remarks>
	...
	public MutedInfoVG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoVG newObject = (schemaLib.MutedInfoVG)super.clone();

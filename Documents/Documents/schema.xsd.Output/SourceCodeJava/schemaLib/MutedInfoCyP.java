...
// </summary>
public class MutedInfoCyP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCyP
	// </summary>
	// <remarks>
	...
	public MutedInfoCyP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCyP newObject = (schemaLib.MutedInfoCyP)super.clone();

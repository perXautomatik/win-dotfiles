...
// </summary>
public class MutedInfoC_ZA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_ZA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_ZA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_ZA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_ZA newObject = (schemaLib.MutedInfoC_ZA)super.clone();

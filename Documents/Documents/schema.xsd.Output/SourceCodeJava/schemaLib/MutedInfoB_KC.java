...
// </summary>
public class MutedInfoB_KC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_KC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_KC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_KC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_KC newObject = (schemaLib.MutedInfoB_KC)super.clone();

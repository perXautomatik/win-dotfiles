...
// </summary>
public class MutedInfoBdX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBdX
	// </summary>
	// <remarks>
	...
	public MutedInfoBdX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBdX newObject = (schemaLib.MutedInfoBdX)super.clone();

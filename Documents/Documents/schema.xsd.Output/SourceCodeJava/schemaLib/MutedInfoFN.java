...
// </summary>
public class MutedInfoFN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoFN
	// </summary>
	// <remarks>
	...
	public MutedInfoFN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoFN newObject = (schemaLib.MutedInfoFN)super.clone();

...
// </summary>
public class MutedInfoCiT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCiT
	// </summary>
	// <remarks>
	...
	public MutedInfoCiT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCiT newObject = (schemaLib.MutedInfoCiT)super.clone();

...
// </summary>
public class MutedInfoC_VC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_VC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_VC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_VC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_VC newObject = (schemaLib.MutedInfoC_VC)super.clone();

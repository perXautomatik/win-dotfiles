...
// </summary>
public class MutedInfoBhP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBhP
	// </summary>
	// <remarks>
	...
	public MutedInfoBhP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBhP newObject = (schemaLib.MutedInfoBhP)super.clone();

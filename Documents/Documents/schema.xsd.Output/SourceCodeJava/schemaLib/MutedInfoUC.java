...
// </summary>
public class MutedInfoUC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoUC
	// </summary>
	// <remarks>
	...
	public MutedInfoUC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoUC newObject = (schemaLib.MutedInfoUC)super.clone();

...
// </summary>
public class MutedInfoCwS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCwS
	// </summary>
	// <remarks>
	...
	public MutedInfoCwS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCwS newObject = (schemaLib.MutedInfoCwS)super.clone();

...
// </summary>
public class MutedInfoCxV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCxV
	// </summary>
	// <remarks>
	...
	public MutedInfoCxV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCxV newObject = (schemaLib.MutedInfoCxV)super.clone();

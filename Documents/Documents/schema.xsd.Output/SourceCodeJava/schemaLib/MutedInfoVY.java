...
// </summary>
public class MutedInfoVY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoVY
	// </summary>
	// <remarks>
	...
	public MutedInfoVY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoVY newObject = (schemaLib.MutedInfoVY)super.clone();

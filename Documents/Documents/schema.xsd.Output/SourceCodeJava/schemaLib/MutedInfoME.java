...
// </summary>
public class MutedInfoME extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoME
	// </summary>
	// <remarks>
	...
	public MutedInfoME(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoME newObject = (schemaLib.MutedInfoME)super.clone();

...
// </summary>
public class MutedInfoNR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoNR
	// </summary>
	// <remarks>
	...
	public MutedInfoNR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoNR newObject = (schemaLib.MutedInfoNR)super.clone();

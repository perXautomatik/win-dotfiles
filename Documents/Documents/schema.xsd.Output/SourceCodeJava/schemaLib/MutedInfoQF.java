...
// </summary>
public class MutedInfoQF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoQF
	// </summary>
	// <remarks>
	...
	public MutedInfoQF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoQF newObject = (schemaLib.MutedInfoQF)super.clone();

...
// </summary>
public class MutedInfoCsZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCsZ
	// </summary>
	// <remarks>
	...
	public MutedInfoCsZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCsZ newObject = (schemaLib.MutedInfoCsZ)super.clone();

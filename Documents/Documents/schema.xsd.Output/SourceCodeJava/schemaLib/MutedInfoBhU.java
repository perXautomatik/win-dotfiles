...
// </summary>
public class MutedInfoBhU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBhU
	// </summary>
	// <remarks>
	...
	public MutedInfoBhU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBhU newObject = (schemaLib.MutedInfoBhU)super.clone();

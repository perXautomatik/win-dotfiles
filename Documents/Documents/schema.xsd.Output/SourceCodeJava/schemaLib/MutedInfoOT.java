...
// </summary>
public class MutedInfoOT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoOT
	// </summary>
	// <remarks>
	...
	public MutedInfoOT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoOT newObject = (schemaLib.MutedInfoOT)super.clone();

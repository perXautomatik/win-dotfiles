...
// </summary>
public class MutedInfoFU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoFU
	// </summary>
	// <remarks>
	...
	public MutedInfoFU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoFU newObject = (schemaLib.MutedInfoFU)super.clone();

...
// </summary>
public class MutedInfoCwP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCwP
	// </summary>
	// <remarks>
	...
	public MutedInfoCwP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCwP newObject = (schemaLib.MutedInfoCwP)super.clone();

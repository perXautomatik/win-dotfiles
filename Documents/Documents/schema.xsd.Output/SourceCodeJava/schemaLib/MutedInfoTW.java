...
// </summary>
public class MutedInfoTW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoTW
	// </summary>
	// <remarks>
	...
	public MutedInfoTW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoTW newObject = (schemaLib.MutedInfoTW)super.clone();

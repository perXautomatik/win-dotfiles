...
// </summary>
public class MutedInfoDƒP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDƒP
	// </summary>
	// <remarks>
	...
	public MutedInfoDƒP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDƒP newObject = (schemaLib.MutedInfoDƒP)super.clone();

...
// </summary>
public class MutedInfoC_OA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_OA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_OA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_OA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_OA newObject = (schemaLib.MutedInfoC_OA)super.clone();

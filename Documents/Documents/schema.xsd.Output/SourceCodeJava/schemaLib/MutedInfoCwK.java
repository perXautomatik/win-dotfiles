...
// </summary>
public class MutedInfoCwK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCwK
	// </summary>
	// <remarks>
	...
	public MutedInfoCwK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCwK newObject = (schemaLib.MutedInfoCwK)super.clone();

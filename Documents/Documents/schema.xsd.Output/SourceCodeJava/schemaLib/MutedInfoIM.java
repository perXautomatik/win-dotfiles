...
// </summary>
public class MutedInfoIM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoIM
	// </summary>
	// <remarks>
	...
	public MutedInfoIM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoIM newObject = (schemaLib.MutedInfoIM)super.clone();

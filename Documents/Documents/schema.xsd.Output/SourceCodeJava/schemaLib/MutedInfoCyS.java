...
// </summary>
public class MutedInfoCyS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCyS
	// </summary>
	// <remarks>
	...
	public MutedInfoCyS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCyS newObject = (schemaLib.MutedInfoCyS)super.clone();

...
// </summary>
public class MutedInfoNZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoNZ
	// </summary>
	// <remarks>
	...
	public MutedInfoNZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoNZ newObject = (schemaLib.MutedInfoNZ)super.clone();

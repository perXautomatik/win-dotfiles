...
// </summary>
public class MutedInfoClQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoClQ
	// </summary>
	// <remarks>
	...
	public MutedInfoClQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoClQ newObject = (schemaLib.MutedInfoClQ)super.clone();

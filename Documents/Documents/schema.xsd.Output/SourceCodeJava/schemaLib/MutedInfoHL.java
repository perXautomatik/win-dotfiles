...
// </summary>
public class MutedInfoHL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoHL
	// </summary>
	// <remarks>
	...
	public MutedInfoHL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoHL newObject = (schemaLib.MutedInfoHL)super.clone();

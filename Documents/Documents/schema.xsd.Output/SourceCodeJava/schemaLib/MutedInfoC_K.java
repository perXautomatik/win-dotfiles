...
// </summary>
public class MutedInfoC_K extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_K
	// </summary>
	// <remarks>
	...
	public MutedInfoC_K(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_K newObject = (schemaLib.MutedInfoC_K)super.clone();

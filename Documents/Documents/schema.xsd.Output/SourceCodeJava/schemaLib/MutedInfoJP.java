...
// </summary>
public class MutedInfoJP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoJP
	// </summary>
	// <remarks>
	...
	public MutedInfoJP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoJP newObject = (schemaLib.MutedInfoJP)super.clone();

...
// </summary>
public class MutedInfoDƒR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDƒR
	// </summary>
	// <remarks>
	...
	public MutedInfoDƒR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDƒR newObject = (schemaLib.MutedInfoDƒR)super.clone();

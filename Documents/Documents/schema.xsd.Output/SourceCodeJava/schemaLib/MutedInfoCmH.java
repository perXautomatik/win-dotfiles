...
// </summary>
public class MutedInfoCmH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCmH
	// </summary>
	// <remarks>
	...
	public MutedInfoCmH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCmH newObject = (schemaLib.MutedInfoCmH)super.clone();

...
// </summary>
public class MutedInfoBeS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBeS
	// </summary>
	// <remarks>
	...
	public MutedInfoBeS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBeS newObject = (schemaLib.MutedInfoBeS)super.clone();

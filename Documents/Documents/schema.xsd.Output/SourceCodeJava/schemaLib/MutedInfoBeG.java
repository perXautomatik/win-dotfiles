...
// </summary>
public class MutedInfoBeG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBeG
	// </summary>
	// <remarks>
	...
	public MutedInfoBeG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBeG newObject = (schemaLib.MutedInfoBeG)super.clone();

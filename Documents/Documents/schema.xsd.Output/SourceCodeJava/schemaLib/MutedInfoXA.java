...
// </summary>
public class MutedInfoXA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoXA
	// </summary>
	// <remarks>
	...
	public MutedInfoXA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoXA newObject = (schemaLib.MutedInfoXA)super.clone();

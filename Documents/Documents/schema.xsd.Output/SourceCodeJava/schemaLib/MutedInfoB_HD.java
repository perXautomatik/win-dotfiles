...
// </summary>
public class MutedInfoB_HD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_HD
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_HD() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_HD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_HD newObject = (schemaLib.MutedInfoB_HD)super.clone();

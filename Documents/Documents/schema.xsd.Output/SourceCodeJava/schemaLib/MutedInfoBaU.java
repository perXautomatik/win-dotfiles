...
// </summary>
public class MutedInfoBaU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBaU
	// </summary>
	// <remarks>
	...
	public MutedInfoBaU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBaU newObject = (schemaLib.MutedInfoBaU)super.clone();

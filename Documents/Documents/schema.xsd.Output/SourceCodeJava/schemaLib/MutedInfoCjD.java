...
// </summary>
public class MutedInfoCjD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCjD
	// </summary>
	// <remarks>
	...
	public MutedInfoCjD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCjD newObject = (schemaLib.MutedInfoCjD)super.clone();

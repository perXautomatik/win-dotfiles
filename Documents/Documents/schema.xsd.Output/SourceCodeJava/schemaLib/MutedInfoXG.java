...
// </summary>
public class MutedInfoXG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoXG
	// </summary>
	// <remarks>
	...
	public MutedInfoXG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoXG newObject = (schemaLib.MutedInfoXG)super.clone();

...
// </summary>
public class MutedInfoCoU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCoU
	// </summary>
	// <remarks>
	...
	public MutedInfoCoU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCoU newObject = (schemaLib.MutedInfoCoU)super.clone();

...
// </summary>
public class MutedInfoBbX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBbX
	// </summary>
	// <remarks>
	...
	public MutedInfoBbX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBbX newObject = (schemaLib.MutedInfoBbX)super.clone();

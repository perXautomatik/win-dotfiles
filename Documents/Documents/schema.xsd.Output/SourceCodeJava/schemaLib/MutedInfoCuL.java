...
// </summary>
public class MutedInfoCuL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCuL
	// </summary>
	// <remarks>
	...
	public MutedInfoCuL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCuL newObject = (schemaLib.MutedInfoCuL)super.clone();

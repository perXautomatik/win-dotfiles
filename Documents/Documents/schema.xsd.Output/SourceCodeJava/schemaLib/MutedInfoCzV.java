...
// </summary>
public class MutedInfoCzV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCzV
	// </summary>
	// <remarks>
	...
	public MutedInfoCzV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCzV newObject = (schemaLib.MutedInfoCzV)super.clone();

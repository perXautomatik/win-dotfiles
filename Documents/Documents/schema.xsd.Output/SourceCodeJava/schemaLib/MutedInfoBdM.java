...
// </summary>
public class MutedInfoBdM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBdM
	// </summary>
	// <remarks>
	...
	public MutedInfoBdM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBdM newObject = (schemaLib.MutedInfoBdM)super.clone();

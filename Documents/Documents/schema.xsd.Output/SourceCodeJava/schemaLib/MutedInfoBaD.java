...
// </summary>
public class MutedInfoBaD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBaD
	// </summary>
	// <remarks>
	...
	public MutedInfoBaD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBaD newObject = (schemaLib.MutedInfoBaD)super.clone();

...
// </summary>
public class MutedInfoH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoH
	// </summary>
	// <remarks>
	...
	public MutedInfoH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoH newObject = (schemaLib.MutedInfoH)super.clone();

...
// </summary>
public class MutedInfoEU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoEU
	// </summary>
	// <remarks>
	...
	public MutedInfoEU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoEU newObject = (schemaLib.MutedInfoEU)super.clone();

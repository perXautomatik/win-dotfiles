...
// </summary>
public class MutedInfoRQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoRQ
	// </summary>
	// <remarks>
	...
	public MutedInfoRQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoRQ newObject = (schemaLib.MutedInfoRQ)super.clone();

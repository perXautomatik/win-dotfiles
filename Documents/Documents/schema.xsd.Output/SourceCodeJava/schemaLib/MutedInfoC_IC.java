...
// </summary>
public class MutedInfoC_IC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_IC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_IC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_IC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_IC newObject = (schemaLib.MutedInfoC_IC)super.clone();

...
// </summary>
public class MutedInfoDƒX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDƒX
	// </summary>
	// <remarks>
	...
	public MutedInfoDƒX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDƒX newObject = (schemaLib.MutedInfoDƒX)super.clone();

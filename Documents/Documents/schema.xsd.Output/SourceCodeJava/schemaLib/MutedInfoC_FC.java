...
// </summary>
public class MutedInfoC_FC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_FC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_FC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_FC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_FC newObject = (schemaLib.MutedInfoC_FC)super.clone();

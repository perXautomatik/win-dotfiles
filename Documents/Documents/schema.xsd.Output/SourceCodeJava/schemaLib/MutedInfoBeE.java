...
// </summary>
public class MutedInfoBeE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBeE
	// </summary>
	// <remarks>
	...
	public MutedInfoBeE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBeE newObject = (schemaLib.MutedInfoBeE)super.clone();

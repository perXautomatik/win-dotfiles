...
// </summary>
public class MutedInfoC_EA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_EA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_EA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_EA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_EA newObject = (schemaLib.MutedInfoC_EA)super.clone();

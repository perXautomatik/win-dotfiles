...
// </summary>
public class MutedInfoCH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCH
	// </summary>
	// <remarks>
	...
	public MutedInfoCH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCH newObject = (schemaLib.MutedInfoCH)super.clone();

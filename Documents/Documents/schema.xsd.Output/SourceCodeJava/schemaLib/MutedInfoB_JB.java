...
// </summary>
public class MutedInfoB_JB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_JB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_JB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_JB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_JB newObject = (schemaLib.MutedInfoB_JB)super.clone();

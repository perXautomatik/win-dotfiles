...
// </summary>
public class MutedInfoYQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoYQ
	// </summary>
	// <remarks>
	...
	public MutedInfoYQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoYQ newObject = (schemaLib.MutedInfoYQ)super.clone();

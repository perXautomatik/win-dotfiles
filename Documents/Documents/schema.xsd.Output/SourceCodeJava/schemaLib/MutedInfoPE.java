...
// </summary>
public class MutedInfoPE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoPE
	// </summary>
	// <remarks>
	...
	public MutedInfoPE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoPE newObject = (schemaLib.MutedInfoPE)super.clone();

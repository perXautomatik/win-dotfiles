...
// </summary>
public class MutedInfoCxA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCxA
	// </summary>
	// <remarks>
	...
	public MutedInfoCxA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCxA newObject = (schemaLib.MutedInfoCxA)super.clone();

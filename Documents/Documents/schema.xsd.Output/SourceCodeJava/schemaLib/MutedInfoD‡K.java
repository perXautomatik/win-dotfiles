...
// </summary>
public class MutedInfoD‡K extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoD‡K
	// </summary>
	// <remarks>
	...
	public MutedInfoD‡K(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoD‡K newObject = (schemaLib.MutedInfoD‡K)super.clone();

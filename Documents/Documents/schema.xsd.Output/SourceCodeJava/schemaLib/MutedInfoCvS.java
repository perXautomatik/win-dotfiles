...
// </summary>
public class MutedInfoCvS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCvS
	// </summary>
	// <remarks>
	...
	public MutedInfoCvS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCvS newObject = (schemaLib.MutedInfoCvS)super.clone();

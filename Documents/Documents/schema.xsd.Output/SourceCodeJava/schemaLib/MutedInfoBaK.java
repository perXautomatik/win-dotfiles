...
// </summary>
public class MutedInfoBaK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBaK
	// </summary>
	// <remarks>
	...
	public MutedInfoBaK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBaK newObject = (schemaLib.MutedInfoBaK)super.clone();

...
// </summary>
public class MutedInfoCnQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCnQ
	// </summary>
	// <remarks>
	...
	public MutedInfoCnQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCnQ newObject = (schemaLib.MutedInfoCnQ)super.clone();

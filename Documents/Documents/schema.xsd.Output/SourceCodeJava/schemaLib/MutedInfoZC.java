...
// </summary>
public class MutedInfoZC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoZC
	// </summary>
	// <remarks>
	...
	public MutedInfoZC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoZC newObject = (schemaLib.MutedInfoZC)super.clone();

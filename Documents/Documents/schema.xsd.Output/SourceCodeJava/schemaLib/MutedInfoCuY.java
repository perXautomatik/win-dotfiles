...
// </summary>
public class MutedInfoCuY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCuY
	// </summary>
	// <remarks>
	...
	public MutedInfoCuY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCuY newObject = (schemaLib.MutedInfoCuY)super.clone();

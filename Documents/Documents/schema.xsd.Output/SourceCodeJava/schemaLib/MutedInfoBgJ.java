...
// </summary>
public class MutedInfoBgJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBgJ
	// </summary>
	// <remarks>
	...
	public MutedInfoBgJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBgJ newObject = (schemaLib.MutedInfoBgJ)super.clone();

...
// </summary>
public class MutedInfoBbE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBbE
	// </summary>
	// <remarks>
	...
	public MutedInfoBbE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBbE newObject = (schemaLib.MutedInfoBbE)super.clone();

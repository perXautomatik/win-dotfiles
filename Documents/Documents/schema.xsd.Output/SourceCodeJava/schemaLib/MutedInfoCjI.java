...
// </summary>
public class MutedInfoCjI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCjI
	// </summary>
	// <remarks>
	...
	public MutedInfoCjI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCjI newObject = (schemaLib.MutedInfoCjI)super.clone();

...
// </summary>
public class MutedInfoBhO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBhO
	// </summary>
	// <remarks>
	...
	public MutedInfoBhO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBhO newObject = (schemaLib.MutedInfoBhO)super.clone();

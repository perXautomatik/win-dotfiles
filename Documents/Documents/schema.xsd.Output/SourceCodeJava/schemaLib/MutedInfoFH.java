...
// </summary>
public class MutedInfoFH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoFH
	// </summary>
	// <remarks>
	...
	public MutedInfoFH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoFH newObject = (schemaLib.MutedInfoFH)super.clone();

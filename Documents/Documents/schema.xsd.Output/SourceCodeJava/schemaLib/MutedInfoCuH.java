...
// </summary>
public class MutedInfoCuH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCuH
	// </summary>
	// <remarks>
	...
	public MutedInfoCuH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCuH newObject = (schemaLib.MutedInfoCuH)super.clone();

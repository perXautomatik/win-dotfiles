...
// </summary>
public class MutedInfoBbO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBbO
	// </summary>
	// <remarks>
	...
	public MutedInfoBbO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBbO newObject = (schemaLib.MutedInfoBbO)super.clone();

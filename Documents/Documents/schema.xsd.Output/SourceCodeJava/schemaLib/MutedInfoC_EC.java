...
// </summary>
public class MutedInfoC_EC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_EC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_EC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_EC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_EC newObject = (schemaLib.MutedInfoC_EC)super.clone();

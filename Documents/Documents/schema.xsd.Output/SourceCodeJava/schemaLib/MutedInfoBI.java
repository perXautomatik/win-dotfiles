...
// </summary>
public class MutedInfoBI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBI
	// </summary>
	// <remarks>
	...
	public MutedInfoBI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBI newObject = (schemaLib.MutedInfoBI)super.clone();

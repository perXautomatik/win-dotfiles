...
// </summary>
public class MutedInfo_Q extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfo_Q
	// </summary>
	// <remarks>
	...
	public MutedInfo_Q(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfo_Q newObject = (schemaLib.MutedInfo_Q)super.clone();

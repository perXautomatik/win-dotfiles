...
// </summary>
public class MutedInfoC_MA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_MA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_MA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_MA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_MA newObject = (schemaLib.MutedInfoC_MA)super.clone();

...
// </summary>
public class MutedInfoUW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoUW
	// </summary>
	// <remarks>
	...
	public MutedInfoUW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoUW newObject = (schemaLib.MutedInfoUW)super.clone();

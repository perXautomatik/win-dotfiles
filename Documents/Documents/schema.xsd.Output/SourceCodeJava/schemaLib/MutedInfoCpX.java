...
// </summary>
public class MutedInfoCpX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCpX
	// </summary>
	// <remarks>
	...
	public MutedInfoCpX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCpX newObject = (schemaLib.MutedInfoCpX)super.clone();

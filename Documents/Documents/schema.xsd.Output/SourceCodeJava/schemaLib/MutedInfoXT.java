...
// </summary>
public class MutedInfoXT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoXT
	// </summary>
	// <remarks>
	...
	public MutedInfoXT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoXT newObject = (schemaLib.MutedInfoXT)super.clone();

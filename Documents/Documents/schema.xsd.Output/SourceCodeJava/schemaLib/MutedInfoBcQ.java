...
// </summary>
public class MutedInfoBcQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBcQ
	// </summary>
	// <remarks>
	...
	public MutedInfoBcQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBcQ newObject = (schemaLib.MutedInfoBcQ)super.clone();

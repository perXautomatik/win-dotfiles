...
// </summary>
public class MutedInfoDT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDT
	// </summary>
	// <remarks>
	...
	public MutedInfoDT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDT newObject = (schemaLib.MutedInfoDT)super.clone();

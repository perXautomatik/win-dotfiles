...
// </summary>
public class MutedInfoB_FA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_FA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_FA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_FA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_FA newObject = (schemaLib.MutedInfoB_FA)super.clone();

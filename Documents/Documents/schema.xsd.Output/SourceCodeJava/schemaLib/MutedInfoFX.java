...
// </summary>
public class MutedInfoFX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoFX
	// </summary>
	// <remarks>
	...
	public MutedInfoFX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoFX newObject = (schemaLib.MutedInfoFX)super.clone();

...
/// </remarks>
public class XmlEnumTypeCollection<T> extends com.liquid_technologies.ltxmllib19.XmlEnumCollection<T> {
	private static final long serialVersionUID = 13L;

	public XmlEnumTypeCollection(String elementName, String targetNamespace, int minOccurs, int maxOccurs, Class<?> enumClass, String fromStringMethod, String toStringMethod) {
		super(elementName, targetNamespace, minOccurs, maxOccurs, enumClass, fromStringMethod, toStringMethod);

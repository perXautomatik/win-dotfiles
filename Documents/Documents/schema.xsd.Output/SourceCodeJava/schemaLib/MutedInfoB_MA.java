...
// </summary>
public class MutedInfoB_MA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_MA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_MA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_MA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_MA newObject = (schemaLib.MutedInfoB_MA)super.clone();

...
// </summary>
public class MutedInfoCiY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCiY
	// </summary>
	// <remarks>
	...
	public MutedInfoCiY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCiY newObject = (schemaLib.MutedInfoCiY)super.clone();

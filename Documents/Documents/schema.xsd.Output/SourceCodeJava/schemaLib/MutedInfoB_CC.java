...
// </summary>
public class MutedInfoB_CC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_CC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_CC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_CC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_CC newObject = (schemaLib.MutedInfoB_CC)super.clone();

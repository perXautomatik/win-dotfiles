...
// </summary>
public class MutedInfoB_PA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_PA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_PA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_PA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_PA newObject = (schemaLib.MutedInfoB_PA)super.clone();

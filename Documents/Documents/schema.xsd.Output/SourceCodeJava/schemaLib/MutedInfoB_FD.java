...
// </summary>
public class MutedInfoB_FD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_FD
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_FD() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_FD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_FD newObject = (schemaLib.MutedInfoB_FD)super.clone();

...
// </summary>
public class MutedInfoHR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoHR
	// </summary>
	// <remarks>
	...
	public MutedInfoHR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoHR newObject = (schemaLib.MutedInfoHR)super.clone();

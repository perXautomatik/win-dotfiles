...
// </summary>
public class MutedInfoQR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoQR
	// </summary>
	// <remarks>
	...
	public MutedInfoQR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoQR newObject = (schemaLib.MutedInfoQR)super.clone();

...
// </summary>
public class MutedInfoB_GE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_GE
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_GE() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_GE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_GE newObject = (schemaLib.MutedInfoB_GE)super.clone();

...
// </summary>
public class MutedInfoGV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoGV
	// </summary>
	// <remarks>
	...
	public MutedInfoGV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoGV newObject = (schemaLib.MutedInfoGV)super.clone();

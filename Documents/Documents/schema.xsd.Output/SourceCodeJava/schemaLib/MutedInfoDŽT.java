...
// </summary>
public class MutedInfoDŽT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŽT
	// </summary>
	// <remarks>
	...
	public MutedInfoDŽT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŽT newObject = (schemaLib.MutedInfoDŽT)super.clone();

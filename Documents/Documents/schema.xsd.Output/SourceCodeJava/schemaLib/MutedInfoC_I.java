...
// </summary>
public class MutedInfoC_I extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_I
	// </summary>
	// <remarks>
	...
	public MutedInfoC_I(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_I newObject = (schemaLib.MutedInfoC_I)super.clone();

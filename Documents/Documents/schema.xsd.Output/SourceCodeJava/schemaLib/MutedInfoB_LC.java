...
// </summary>
public class MutedInfoB_LC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_LC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_LC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_LC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_LC newObject = (schemaLib.MutedInfoB_LC)super.clone();

...
// </summary>
public class MutedInfoBfX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBfX
	// </summary>
	// <remarks>
	...
	public MutedInfoBfX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBfX newObject = (schemaLib.MutedInfoBfX)super.clone();

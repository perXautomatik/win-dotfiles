...
// </summary>
public class MutedInfoDˆH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDˆH
	// </summary>
	// <remarks>
	...
	public MutedInfoDˆH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDˆH newObject = (schemaLib.MutedInfoDˆH)super.clone();

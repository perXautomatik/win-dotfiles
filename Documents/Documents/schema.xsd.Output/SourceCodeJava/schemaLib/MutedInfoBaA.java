...
// </summary>
public class MutedInfoBaA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBaA
	// </summary>
	// <remarks>
	...
	public MutedInfoBaA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBaA newObject = (schemaLib.MutedInfoBaA)super.clone();

...
// </summary>
public class MutedInfoCtJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCtJ
	// </summary>
	// <remarks>
	...
	public MutedInfoCtJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCtJ newObject = (schemaLib.MutedInfoCtJ)super.clone();

...
// </summary>
public class MutedInfoKZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoKZ
	// </summary>
	// <remarks>
	...
	public MutedInfoKZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoKZ newObject = (schemaLib.MutedInfoKZ)super.clone();

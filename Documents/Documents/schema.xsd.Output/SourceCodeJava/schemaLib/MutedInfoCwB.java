...
// </summary>
public class MutedInfoCwB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCwB
	// </summary>
	// <remarks>
	...
	public MutedInfoCwB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCwB newObject = (schemaLib.MutedInfoCwB)super.clone();

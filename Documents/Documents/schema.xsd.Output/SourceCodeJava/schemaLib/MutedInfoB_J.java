...
// </summary>
public class MutedInfoB_J extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_J
	// </summary>
	// <remarks>
	...
	public MutedInfoB_J(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_J newObject = (schemaLib.MutedInfoB_J)super.clone();

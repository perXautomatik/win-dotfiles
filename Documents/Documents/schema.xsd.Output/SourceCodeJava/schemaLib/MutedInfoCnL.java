...
// </summary>
public class MutedInfoCnL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCnL
	// </summary>
	// <remarks>
	...
	public MutedInfoCnL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCnL newObject = (schemaLib.MutedInfoCnL)super.clone();

...
// </summary>
public class MutedInfoCmU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCmU
	// </summary>
	// <remarks>
	...
	public MutedInfoCmU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCmU newObject = (schemaLib.MutedInfoCmU)super.clone();

...
// </summary>
public class MutedInfoB_JD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_JD
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_JD() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_JD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_JD newObject = (schemaLib.MutedInfoB_JD)super.clone();

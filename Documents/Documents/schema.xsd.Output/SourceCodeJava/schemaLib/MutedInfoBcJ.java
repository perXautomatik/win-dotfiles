...
// </summary>
public class MutedInfoBcJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBcJ
	// </summary>
	// <remarks>
	...
	public MutedInfoBcJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBcJ newObject = (schemaLib.MutedInfoBcJ)super.clone();

...
// </summary>
public class MutedInfoCyQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCyQ
	// </summary>
	// <remarks>
	...
	public MutedInfoCyQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCyQ newObject = (schemaLib.MutedInfoCyQ)super.clone();

...
// </summary>
public class MutedInfoCqT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCqT
	// </summary>
	// <remarks>
	...
	public MutedInfoCqT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCqT newObject = (schemaLib.MutedInfoCqT)super.clone();

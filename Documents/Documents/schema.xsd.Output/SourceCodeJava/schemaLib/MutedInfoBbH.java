...
// </summary>
public class MutedInfoBbH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBbH
	// </summary>
	// <remarks>
	...
	public MutedInfoBbH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBbH newObject = (schemaLib.MutedInfoBbH)super.clone();

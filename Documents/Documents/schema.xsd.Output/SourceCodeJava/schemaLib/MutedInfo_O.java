...
// </summary>
public class MutedInfo_O extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfo_O
	// </summary>
	// <remarks>
	...
	public MutedInfo_O(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfo_O newObject = (schemaLib.MutedInfo_O)super.clone();

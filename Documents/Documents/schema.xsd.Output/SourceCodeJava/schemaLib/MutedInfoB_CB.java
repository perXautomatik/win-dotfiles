...
// </summary>
public class MutedInfoB_CB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_CB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_CB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_CB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_CB newObject = (schemaLib.MutedInfoB_CB)super.clone();

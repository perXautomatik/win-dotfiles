...
// </summary>
public class MutedInfoCrD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCrD
	// </summary>
	// <remarks>
	...
	public MutedInfoCrD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCrD newObject = (schemaLib.MutedInfoCrD)super.clone();

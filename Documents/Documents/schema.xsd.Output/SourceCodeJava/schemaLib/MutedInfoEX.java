...
// </summary>
public class MutedInfoEX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoEX
	// </summary>
	// <remarks>
	...
	public MutedInfoEX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoEX newObject = (schemaLib.MutedInfoEX)super.clone();

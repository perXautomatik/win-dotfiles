...
// </summary>
public class MutedInfoBN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBN
	// </summary>
	// <remarks>
	...
	public MutedInfoBN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBN newObject = (schemaLib.MutedInfoBN)super.clone();

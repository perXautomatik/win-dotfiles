...
// </summary>
public class MutedInfoClP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoClP
	// </summary>
	// <remarks>
	...
	public MutedInfoClP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoClP newObject = (schemaLib.MutedInfoClP)super.clone();

...
// </summary>
public class MutedInfoBF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBF
	// </summary>
	// <remarks>
	...
	public MutedInfoBF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBF newObject = (schemaLib.MutedInfoBF)super.clone();

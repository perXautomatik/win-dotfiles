...
// </summary>
public class MutedInfoOS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoOS
	// </summary>
	// <remarks>
	...
	public MutedInfoOS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoOS newObject = (schemaLib.MutedInfoOS)super.clone();

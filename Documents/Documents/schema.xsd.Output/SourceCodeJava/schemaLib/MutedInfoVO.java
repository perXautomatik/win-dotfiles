...
// </summary>
public class MutedInfoVO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoVO
	// </summary>
	// <remarks>
	...
	public MutedInfoVO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoVO newObject = (schemaLib.MutedInfoVO)super.clone();

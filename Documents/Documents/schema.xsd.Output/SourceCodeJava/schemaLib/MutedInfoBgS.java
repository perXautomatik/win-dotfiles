...
// </summary>
public class MutedInfoBgS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBgS
	// </summary>
	// <remarks>
	...
	public MutedInfoBgS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBgS newObject = (schemaLib.MutedInfoBgS)super.clone();

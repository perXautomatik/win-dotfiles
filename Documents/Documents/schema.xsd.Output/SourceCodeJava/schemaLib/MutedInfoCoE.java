...
// </summary>
public class MutedInfoCoE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCoE
	// </summary>
	// <remarks>
	...
	public MutedInfoCoE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCoE newObject = (schemaLib.MutedInfoCoE)super.clone();

...
// </summary>
public class MutedInfoRU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoRU
	// </summary>
	// <remarks>
	...
	public MutedInfoRU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoRU newObject = (schemaLib.MutedInfoRU)super.clone();

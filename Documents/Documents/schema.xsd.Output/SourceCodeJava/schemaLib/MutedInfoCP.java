...
// </summary>
public class MutedInfoCP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCP
	// </summary>
	// <remarks>
	...
	public MutedInfoCP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCP newObject = (schemaLib.MutedInfoCP)super.clone();

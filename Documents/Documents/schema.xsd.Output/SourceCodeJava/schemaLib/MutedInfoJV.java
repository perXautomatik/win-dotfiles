...
// </summary>
public class MutedInfoJV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoJV
	// </summary>
	// <remarks>
	...
	public MutedInfoJV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoJV newObject = (schemaLib.MutedInfoJV)super.clone();

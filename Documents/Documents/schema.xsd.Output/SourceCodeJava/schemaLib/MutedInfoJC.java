...
// </summary>
public class MutedInfoJC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoJC
	// </summary>
	// <remarks>
	...
	public MutedInfoJC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoJC newObject = (schemaLib.MutedInfoJC)super.clone();

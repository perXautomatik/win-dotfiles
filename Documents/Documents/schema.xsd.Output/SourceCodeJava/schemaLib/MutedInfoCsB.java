...
// </summary>
public class MutedInfoCsB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCsB
	// </summary>
	// <remarks>
	...
	public MutedInfoCsB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCsB newObject = (schemaLib.MutedInfoCsB)super.clone();

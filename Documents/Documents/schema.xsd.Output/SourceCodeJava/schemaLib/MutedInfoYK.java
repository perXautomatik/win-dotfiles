...
// </summary>
public class MutedInfoYK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoYK
	// </summary>
	// <remarks>
	...
	public MutedInfoYK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoYK newObject = (schemaLib.MutedInfoYK)super.clone();

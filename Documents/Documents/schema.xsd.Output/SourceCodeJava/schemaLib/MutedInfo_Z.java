...
// </summary>
public class MutedInfo_Z extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfo_Z
	// </summary>
	// <remarks>
	...
	public MutedInfo_Z(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfo_Z newObject = (schemaLib.MutedInfo_Z)super.clone();

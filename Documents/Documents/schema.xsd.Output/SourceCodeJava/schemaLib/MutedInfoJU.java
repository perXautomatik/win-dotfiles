...
// </summary>
public class MutedInfoJU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoJU
	// </summary>
	// <remarks>
	...
	public MutedInfoJU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoJU newObject = (schemaLib.MutedInfoJU)super.clone();

...
// </summary>
public class MutedInfoRJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoRJ
	// </summary>
	// <remarks>
	...
	public MutedInfoRJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoRJ newObject = (schemaLib.MutedInfoRJ)super.clone();

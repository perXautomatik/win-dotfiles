...
// </summary>
public class MutedInfoHZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoHZ
	// </summary>
	// <remarks>
	...
	public MutedInfoHZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoHZ newObject = (schemaLib.MutedInfoHZ)super.clone();

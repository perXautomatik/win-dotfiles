...
// </summary>
public class MutedInfoCjU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCjU
	// </summary>
	// <remarks>
	...
	public MutedInfoCjU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCjU newObject = (schemaLib.MutedInfoCjU)super.clone();

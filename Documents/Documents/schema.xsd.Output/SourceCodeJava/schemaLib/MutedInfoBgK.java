...
// </summary>
public class MutedInfoBgK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBgK
	// </summary>
	// <remarks>
	...
	public MutedInfoBgK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBgK newObject = (schemaLib.MutedInfoBgK)super.clone();

...
// </summary>
public class MutedInfoNX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoNX
	// </summary>
	// <remarks>
	...
	public MutedInfoNX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoNX newObject = (schemaLib.MutedInfoNX)super.clone();

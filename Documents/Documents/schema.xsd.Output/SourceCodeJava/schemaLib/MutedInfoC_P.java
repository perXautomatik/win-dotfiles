...
// </summary>
public class MutedInfoC_P extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_P
	// </summary>
	// <remarks>
	...
	public MutedInfoC_P(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_P newObject = (schemaLib.MutedInfoC_P)super.clone();

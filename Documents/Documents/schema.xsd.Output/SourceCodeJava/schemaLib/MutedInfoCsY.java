...
// </summary>
public class MutedInfoCsY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCsY
	// </summary>
	// <remarks>
	...
	public MutedInfoCsY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCsY newObject = (schemaLib.MutedInfoCsY)super.clone();

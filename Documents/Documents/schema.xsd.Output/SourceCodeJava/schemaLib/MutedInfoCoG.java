...
// </summary>
public class MutedInfoCoG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCoG
	// </summary>
	// <remarks>
	...
	public MutedInfoCoG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCoG newObject = (schemaLib.MutedInfoCoG)super.clone();

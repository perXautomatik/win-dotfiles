...
// </summary>
public class MutedInfoCrA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCrA
	// </summary>
	// <remarks>
	...
	public MutedInfoCrA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCrA newObject = (schemaLib.MutedInfoCrA)super.clone();

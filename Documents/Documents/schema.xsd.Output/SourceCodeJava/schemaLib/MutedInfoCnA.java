...
// </summary>
public class MutedInfoCnA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCnA
	// </summary>
	// <remarks>
	...
	public MutedInfoCnA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCnA newObject = (schemaLib.MutedInfoCnA)super.clone();

...
// </summary>
public class MutedInfoYH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoYH
	// </summary>
	// <remarks>
	...
	public MutedInfoYH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoYH newObject = (schemaLib.MutedInfoYH)super.clone();

...
// </summary>
public class MutedInfoPO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoPO
	// </summary>
	// <remarks>
	...
	public MutedInfoPO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoPO newObject = (schemaLib.MutedInfoPO)super.clone();

...
// </summary>
public class MutedInfoBgA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBgA
	// </summary>
	// <remarks>
	...
	public MutedInfoBgA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBgA newObject = (schemaLib.MutedInfoBgA)super.clone();

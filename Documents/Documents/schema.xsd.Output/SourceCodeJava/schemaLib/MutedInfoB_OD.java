...
// </summary>
public class MutedInfoB_OD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_OD
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_OD() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_OD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_OD newObject = (schemaLib.MutedInfoB_OD)super.clone();

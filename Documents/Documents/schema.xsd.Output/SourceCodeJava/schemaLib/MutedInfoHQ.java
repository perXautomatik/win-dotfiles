...
// </summary>
public class MutedInfoHQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoHQ
	// </summary>
	// <remarks>
	...
	public MutedInfoHQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoHQ newObject = (schemaLib.MutedInfoHQ)super.clone();

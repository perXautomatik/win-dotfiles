...
// </summary>
public class MutedInfoCB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCB
	// </summary>
	// <remarks>
	...
	public MutedInfoCB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCB newObject = (schemaLib.MutedInfoCB)super.clone();

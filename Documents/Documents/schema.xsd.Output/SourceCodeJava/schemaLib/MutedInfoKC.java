...
// </summary>
public class MutedInfoKC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoKC
	// </summary>
	// <remarks>
	...
	public MutedInfoKC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoKC newObject = (schemaLib.MutedInfoKC)super.clone();

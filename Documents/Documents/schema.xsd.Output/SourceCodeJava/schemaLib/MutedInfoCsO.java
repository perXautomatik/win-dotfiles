...
// </summary>
public class MutedInfoCsO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCsO
	// </summary>
	// <remarks>
	...
	public MutedInfoCsO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCsO newObject = (schemaLib.MutedInfoCsO)super.clone();

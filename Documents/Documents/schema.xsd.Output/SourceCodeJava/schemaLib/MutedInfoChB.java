...
// </summary>
public class MutedInfoChB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoChB
	// </summary>
	// <remarks>
	...
	public MutedInfoChB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoChB newObject = (schemaLib.MutedInfoChB)super.clone();

...
// </summary>
public class MutedInfoIO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoIO
	// </summary>
	// <remarks>
	...
	public MutedInfoIO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoIO newObject = (schemaLib.MutedInfoIO)super.clone();

...
// </summary>
public class MutedInfoC_AB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_AB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_AB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_AB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_AB newObject = (schemaLib.MutedInfoC_AB)super.clone();

...
// </summary>
public class MutedInfoCwO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCwO
	// </summary>
	// <remarks>
	...
	public MutedInfoCwO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCwO newObject = (schemaLib.MutedInfoCwO)super.clone();

...
// </summary>
public class MutedInfo_P extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfo_P
	// </summary>
	// <remarks>
	...
	public MutedInfo_P(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfo_P newObject = (schemaLib.MutedInfo_P)super.clone();

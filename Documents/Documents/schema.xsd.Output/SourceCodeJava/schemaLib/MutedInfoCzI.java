...
// </summary>
public class MutedInfoCzI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCzI
	// </summary>
	// <remarks>
	...
	public MutedInfoCzI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCzI newObject = (schemaLib.MutedInfoCzI)super.clone();

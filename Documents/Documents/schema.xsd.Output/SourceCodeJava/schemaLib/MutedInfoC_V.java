...
// </summary>
public class MutedInfoC_V extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_V
	// </summary>
	// <remarks>
	...
	public MutedInfoC_V(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_V newObject = (schemaLib.MutedInfoC_V)super.clone();

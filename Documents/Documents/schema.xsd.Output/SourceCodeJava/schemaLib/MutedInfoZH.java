...
// </summary>
public class MutedInfoZH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoZH
	// </summary>
	// <remarks>
	...
	public MutedInfoZH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoZH newObject = (schemaLib.MutedInfoZH)super.clone();

...
// </summary>
public class MutedInfoCwY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCwY
	// </summary>
	// <remarks>
	...
	public MutedInfoCwY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCwY newObject = (schemaLib.MutedInfoCwY)super.clone();

...
// </summary>
public class MutedInfoC_KC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_KC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_KC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_KC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_KC newObject = (schemaLib.MutedInfoC_KC)super.clone();

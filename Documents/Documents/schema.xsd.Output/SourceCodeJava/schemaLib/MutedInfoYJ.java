...
// </summary>
public class MutedInfoYJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoYJ
	// </summary>
	// <remarks>
	...
	public MutedInfoYJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoYJ newObject = (schemaLib.MutedInfoYJ)super.clone();

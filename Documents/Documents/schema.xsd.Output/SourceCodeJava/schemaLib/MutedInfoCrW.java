...
// </summary>
public class MutedInfoCrW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCrW
	// </summary>
	// <remarks>
	...
	public MutedInfoCrW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCrW newObject = (schemaLib.MutedInfoCrW)super.clone();

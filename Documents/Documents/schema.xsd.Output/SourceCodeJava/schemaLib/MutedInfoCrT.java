...
// </summary>
public class MutedInfoCrT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCrT
	// </summary>
	// <remarks>
	...
	public MutedInfoCrT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCrT newObject = (schemaLib.MutedInfoCrT)super.clone();

...
// </summary>
public class MutedInfoCxO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCxO
	// </summary>
	// <remarks>
	...
	public MutedInfoCxO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCxO newObject = (schemaLib.MutedInfoCxO)super.clone();

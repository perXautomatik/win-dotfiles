...
// </summary>
public class MutedInfoKD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoKD
	// </summary>
	// <remarks>
	...
	public MutedInfoKD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoKD newObject = (schemaLib.MutedInfoKD)super.clone();

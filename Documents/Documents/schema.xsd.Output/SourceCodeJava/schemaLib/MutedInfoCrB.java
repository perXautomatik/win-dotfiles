...
// </summary>
public class MutedInfoCrB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCrB
	// </summary>
	// <remarks>
	...
	public MutedInfoCrB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCrB newObject = (schemaLib.MutedInfoCrB)super.clone();

...
// </summary>
public class MutedInfoCxN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCxN
	// </summary>
	// <remarks>
	...
	public MutedInfoCxN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCxN newObject = (schemaLib.MutedInfoCxN)super.clone();

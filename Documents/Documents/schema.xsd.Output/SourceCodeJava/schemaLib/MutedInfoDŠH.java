...
// </summary>
public class MutedInfoDŠH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŠH
	// </summary>
	// <remarks>
	...
	public MutedInfoDŠH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŠH newObject = (schemaLib.MutedInfoDŠH)super.clone();

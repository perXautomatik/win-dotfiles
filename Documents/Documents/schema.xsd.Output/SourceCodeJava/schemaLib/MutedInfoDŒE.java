...
// </summary>
public class MutedInfoDŒE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŒE
	// </summary>
	// <remarks>
	...
	public MutedInfoDŒE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŒE newObject = (schemaLib.MutedInfoDŒE)super.clone();
			...
			if (_isValidReason)
				newObject._reason = _reason;
			newObject._isValidReason = _isValidReason;
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
	...
	// It is optional, initially it is not valid.
	// </remarks>
	public java.lang.String getReason() throws com.liquid_technologies.ltxmllib19.exceptions.LtException { 
		if (_isValidReason == false)
			throw new com.liquid_technologies.ltxmllib19.exceptions.LtInvalidStateException("The Property reason is not valid. Set reasonValid = true");
		return _reason;  
	}
	public void setReason(java.lang.String value) throws com.liquid_technologies.ltxmllib19.exceptions.LtException { 
	...
	// <summary>
	// Indicates if reason contains a valid value.
	// </summary>
	// <remarks>
	// true if the value for reason is valid, false if not.
	// If this is set to true then the property is considered valid, and assigned its
	// default value ("").
	// If its set to false then its made invalid, and subsequent calls to get reason
	// will raise an exception.
	// </remarks>
	public boolean isValidReason() {
		return _isValidReason;
	}
	public void setValidReason(boolean value)  throws com.liquid_technologies.ltxmllib19.exceptions.LtException { 
		if (value != _isValidReason) {
			_reason = "";
			_isValidReason = value;
		}
	}
	protected boolean _isValidReason;

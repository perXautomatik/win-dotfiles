...
// </summary>
public class MutedInfoCJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCJ
	// </summary>
	// <remarks>
	...
	public MutedInfoCJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCJ newObject = (schemaLib.MutedInfoCJ)super.clone();

...
// </summary>
public class MutedInfoCiR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCiR
	// </summary>
	// <remarks>
	...
	public MutedInfoCiR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCiR newObject = (schemaLib.MutedInfoCiR)super.clone();

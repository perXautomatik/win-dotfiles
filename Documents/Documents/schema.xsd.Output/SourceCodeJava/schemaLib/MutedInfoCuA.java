...
// </summary>
public class MutedInfoCuA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCuA
	// </summary>
	// <remarks>
	...
	public MutedInfoCuA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCuA newObject = (schemaLib.MutedInfoCuA)super.clone();

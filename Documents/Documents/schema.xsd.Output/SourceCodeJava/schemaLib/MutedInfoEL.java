...
// </summary>
public class MutedInfoEL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoEL
	// </summary>
	// <remarks>
	...
	public MutedInfoEL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoEL newObject = (schemaLib.MutedInfoEL)super.clone();

...
// </summary>
public class MutedInfoDŒK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŒK
	// </summary>
	// <remarks>
	...
	public MutedInfoDŒK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŒK newObject = (schemaLib.MutedInfoDŒK)super.clone();

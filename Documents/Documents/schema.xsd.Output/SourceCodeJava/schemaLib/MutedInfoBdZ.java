...
// </summary>
public class MutedInfoBdZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBdZ
	// </summary>
	// <remarks>
	...
	public MutedInfoBdZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBdZ newObject = (schemaLib.MutedInfoBdZ)super.clone();

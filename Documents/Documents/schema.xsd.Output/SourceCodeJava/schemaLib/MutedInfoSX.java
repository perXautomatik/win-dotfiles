...
// </summary>
public class MutedInfoSX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoSX
	// </summary>
	// <remarks>
	...
	public MutedInfoSX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoSX newObject = (schemaLib.MutedInfoSX)super.clone();

...
// </summary>
public class MutedInfoBeD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBeD
	// </summary>
	// <remarks>
	...
	public MutedInfoBeD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBeD newObject = (schemaLib.MutedInfoBeD)super.clone();

...
// </summary>
public class MutedInfoCjF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCjF
	// </summary>
	// <remarks>
	...
	public MutedInfoCjF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCjF newObject = (schemaLib.MutedInfoCjF)super.clone();

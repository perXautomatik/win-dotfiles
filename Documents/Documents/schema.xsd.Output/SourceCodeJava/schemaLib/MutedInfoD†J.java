...
// </summary>
public class MutedInfoD†J extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoD†J
	// </summary>
	// <remarks>
	...
	public MutedInfoD†J(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoD†J newObject = (schemaLib.MutedInfoD†J)super.clone();

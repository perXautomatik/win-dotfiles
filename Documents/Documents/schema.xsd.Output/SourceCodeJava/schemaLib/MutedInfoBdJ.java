...
// </summary>
public class MutedInfoBdJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBdJ
	// </summary>
	// <remarks>
	...
	public MutedInfoBdJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBdJ newObject = (schemaLib.MutedInfoBdJ)super.clone();

...
// </summary>
public class MutedInfoClO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoClO
	// </summary>
	// <remarks>
	...
	public MutedInfoClO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoClO newObject = (schemaLib.MutedInfoClO)super.clone();

...
// </summary>
public class MutedInfoML extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoML
	// </summary>
	// <remarks>
	...
	public MutedInfoML(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoML newObject = (schemaLib.MutedInfoML)super.clone();

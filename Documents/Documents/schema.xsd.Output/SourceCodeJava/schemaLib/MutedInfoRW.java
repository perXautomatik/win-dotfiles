...
// </summary>
public class MutedInfoRW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoRW
	// </summary>
	// <remarks>
	...
	public MutedInfoRW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoRW newObject = (schemaLib.MutedInfoRW)super.clone();

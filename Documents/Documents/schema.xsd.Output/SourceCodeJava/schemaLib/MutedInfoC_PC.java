...
// </summary>
public class MutedInfoC_PC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_PC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_PC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_PC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_PC newObject = (schemaLib.MutedInfoC_PC)super.clone();

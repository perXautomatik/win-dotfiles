...
// </summary>
public class MutedInfoBhW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBhW
	// </summary>
	// <remarks>
	...
	public MutedInfoBhW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBhW newObject = (schemaLib.MutedInfoBhW)super.clone();

...
// </summary>
public class MutedInfoB_PB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_PB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_PB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_PB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_PB newObject = (schemaLib.MutedInfoB_PB)super.clone();

...
// </summary>
public class MutedInfoC_QC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_QC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_QC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_QC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_QC newObject = (schemaLib.MutedInfoC_QC)super.clone();

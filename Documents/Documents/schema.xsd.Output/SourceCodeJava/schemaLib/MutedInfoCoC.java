...
// </summary>
public class MutedInfoCoC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCoC
	// </summary>
	// <remarks>
	...
	public MutedInfoCoC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCoC newObject = (schemaLib.MutedInfoCoC)super.clone();

...
// </summary>
public class MutedInfoVB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoVB
	// </summary>
	// <remarks>
	...
	public MutedInfoVB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoVB newObject = (schemaLib.MutedInfoVB)super.clone();

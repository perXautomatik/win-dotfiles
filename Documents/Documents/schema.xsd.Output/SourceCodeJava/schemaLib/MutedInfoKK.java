...
// </summary>
public class MutedInfoKK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoKK
	// </summary>
	// <remarks>
	...
	public MutedInfoKK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoKK newObject = (schemaLib.MutedInfoKK)super.clone();

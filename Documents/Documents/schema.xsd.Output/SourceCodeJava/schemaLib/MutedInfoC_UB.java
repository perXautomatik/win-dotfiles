...
// </summary>
public class MutedInfoC_UB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_UB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_UB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_UB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_UB newObject = (schemaLib.MutedInfoC_UB)super.clone();

...
// </summary>
public class MutedInfoDˆC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDˆC
	// </summary>
	// <remarks>
	...
	public MutedInfoDˆC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDˆC newObject = (schemaLib.MutedInfoDˆC)super.clone();

...
// </summary>
public class MutedInfoDŠX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŠX
	// </summary>
	// <remarks>
	...
	public MutedInfoDŠX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŠX newObject = (schemaLib.MutedInfoDŠX)super.clone();

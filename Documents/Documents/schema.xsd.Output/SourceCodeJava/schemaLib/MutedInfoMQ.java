...
// </summary>
public class MutedInfoMQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoMQ
	// </summary>
	// <remarks>
	...
	public MutedInfoMQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoMQ newObject = (schemaLib.MutedInfoMQ)super.clone();

...
// </summary>
public class MutedInfoNP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoNP
	// </summary>
	// <remarks>
	...
	public MutedInfoNP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoNP newObject = (schemaLib.MutedInfoNP)super.clone();

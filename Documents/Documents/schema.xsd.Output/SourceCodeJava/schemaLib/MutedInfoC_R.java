...
// </summary>
public class MutedInfoC_R extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_R
	// </summary>
	// <remarks>
	...
	public MutedInfoC_R(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_R newObject = (schemaLib.MutedInfoC_R)super.clone();

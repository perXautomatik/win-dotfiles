...
// </summary>
public class MutedInfoLJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoLJ
	// </summary>
	// <remarks>
	...
	public MutedInfoLJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoLJ newObject = (schemaLib.MutedInfoLJ)super.clone();

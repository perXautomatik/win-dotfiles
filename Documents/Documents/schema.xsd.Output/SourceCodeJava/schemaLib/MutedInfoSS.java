...
// </summary>
public class MutedInfoSS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoSS
	// </summary>
	// <remarks>
	...
	public MutedInfoSS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoSS newObject = (schemaLib.MutedInfoSS)super.clone();

...
// </summary>
public class MutedInfoBhX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBhX
	// </summary>
	// <remarks>
	...
	public MutedInfoBhX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBhX newObject = (schemaLib.MutedInfoBhX)super.clone();

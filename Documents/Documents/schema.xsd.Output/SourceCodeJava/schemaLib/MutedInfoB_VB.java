...
// </summary>
public class MutedInfoB_VB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_VB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_VB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_VB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_VB newObject = (schemaLib.MutedInfoB_VB)super.clone();

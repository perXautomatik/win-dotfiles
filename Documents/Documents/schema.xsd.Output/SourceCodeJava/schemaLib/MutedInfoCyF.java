...
// </summary>
public class MutedInfoCyF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCyF
	// </summary>
	// <remarks>
	...
	public MutedInfoCyF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCyF newObject = (schemaLib.MutedInfoCyF)super.clone();

...
// </summary>
public class MutedInfoCmF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCmF
	// </summary>
	// <remarks>
	...
	public MutedInfoCmF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCmF newObject = (schemaLib.MutedInfoCmF)super.clone();

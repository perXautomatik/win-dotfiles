...
// </summary>
public class MutedInfoC_XA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_XA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_XA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_XA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_XA newObject = (schemaLib.MutedInfoC_XA)super.clone();

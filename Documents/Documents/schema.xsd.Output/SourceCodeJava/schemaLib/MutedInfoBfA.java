...
// </summary>
public class MutedInfoBfA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBfA
	// </summary>
	// <remarks>
	...
	public MutedInfoBfA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBfA newObject = (schemaLib.MutedInfoBfA)super.clone();

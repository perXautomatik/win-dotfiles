...
// </summary>
public class MutedInfoCzT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCzT
	// </summary>
	// <remarks>
	...
	public MutedInfoCzT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCzT newObject = (schemaLib.MutedInfoCzT)super.clone();

...
// </summary>
public class MutedInfoCQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCQ
	// </summary>
	// <remarks>
	...
	public MutedInfoCQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCQ newObject = (schemaLib.MutedInfoCQ)super.clone();

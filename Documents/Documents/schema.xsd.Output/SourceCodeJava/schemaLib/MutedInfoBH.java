...
// </summary>
public class MutedInfoBH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBH
	// </summary>
	// <remarks>
	...
	public MutedInfoBH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBH newObject = (schemaLib.MutedInfoBH)super.clone();

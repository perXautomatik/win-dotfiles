...
// </summary>
public class MutedInfoC_GC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_GC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_GC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_GC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_GC newObject = (schemaLib.MutedInfoC_GC)super.clone();

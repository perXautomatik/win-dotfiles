...
// </summary>
public class MutedInfoB_EE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_EE
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_EE() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_EE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_EE newObject = (schemaLib.MutedInfoB_EE)super.clone();

...
// </summary>
public class MutedInfoCkH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCkH
	// </summary>
	// <remarks>
	...
	public MutedInfoCkH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCkH newObject = (schemaLib.MutedInfoCkH)super.clone();

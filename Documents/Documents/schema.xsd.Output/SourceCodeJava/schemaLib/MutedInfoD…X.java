...
// </summary>
public class MutedInfoD…X extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoD…X
	// </summary>
	// <remarks>
	...
	public MutedInfoD…X(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoD…X newObject = (schemaLib.MutedInfoD…X)super.clone();

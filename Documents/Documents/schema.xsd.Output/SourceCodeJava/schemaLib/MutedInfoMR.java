...
// </summary>
public class MutedInfoMR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoMR
	// </summary>
	// <remarks>
	...
	public MutedInfoMR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoMR newObject = (schemaLib.MutedInfoMR)super.clone();

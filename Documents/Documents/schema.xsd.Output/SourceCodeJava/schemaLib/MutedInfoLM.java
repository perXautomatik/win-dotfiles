...
// </summary>
public class MutedInfoLM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoLM
	// </summary>
	// <remarks>
	...
	public MutedInfoLM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoLM newObject = (schemaLib.MutedInfoLM)super.clone();

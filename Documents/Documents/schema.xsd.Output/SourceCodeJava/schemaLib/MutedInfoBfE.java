...
// </summary>
public class MutedInfoBfE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBfE
	// </summary>
	// <remarks>
	...
	public MutedInfoBfE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBfE newObject = (schemaLib.MutedInfoBfE)super.clone();

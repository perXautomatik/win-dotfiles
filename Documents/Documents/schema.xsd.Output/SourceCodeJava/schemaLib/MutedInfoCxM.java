...
// </summary>
public class MutedInfoCxM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCxM
	// </summary>
	// <remarks>
	...
	public MutedInfoCxM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCxM newObject = (schemaLib.MutedInfoCxM)super.clone();

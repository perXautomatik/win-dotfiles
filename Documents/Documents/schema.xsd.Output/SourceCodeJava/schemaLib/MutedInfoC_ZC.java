...
// </summary>
public class MutedInfoC_ZC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_ZC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_ZC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_ZC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_ZC newObject = (schemaLib.MutedInfoC_ZC)super.clone();

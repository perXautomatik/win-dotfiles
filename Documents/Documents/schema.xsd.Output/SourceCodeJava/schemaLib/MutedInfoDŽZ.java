...
// </summary>
public class MutedInfoDŽZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŽZ
	// </summary>
	// <remarks>
	...
	public MutedInfoDŽZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŽZ newObject = (schemaLib.MutedInfoDŽZ)super.clone();

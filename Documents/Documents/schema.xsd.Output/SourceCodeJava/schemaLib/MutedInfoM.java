...
// </summary>
public class MutedInfoM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoM
	// </summary>
	// <remarks>
	...
	public MutedInfoM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoM newObject = (schemaLib.MutedInfoM)super.clone();

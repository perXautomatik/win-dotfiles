...
// </summary>
public class MutedInfoBgB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBgB
	// </summary>
	// <remarks>
	...
	public MutedInfoBgB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBgB newObject = (schemaLib.MutedInfoBgB)super.clone();

...
// </summary>
public class MutedInfoBgD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBgD
	// </summary>
	// <remarks>
	...
	public MutedInfoBgD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBgD newObject = (schemaLib.MutedInfoBgD)super.clone();

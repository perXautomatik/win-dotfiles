...
// </summary>
public class MutedInfoWY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoWY
	// </summary>
	// <remarks>
	...
	public MutedInfoWY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoWY newObject = (schemaLib.MutedInfoWY)super.clone();

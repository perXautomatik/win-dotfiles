...
// </summary>
public class MutedInfoER extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoER
	// </summary>
	// <remarks>
	...
	public MutedInfoER(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoER newObject = (schemaLib.MutedInfoER)super.clone();

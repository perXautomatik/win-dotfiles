...
// </summary>
public class MutedInfoDƒO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDƒO
	// </summary>
	// <remarks>
	...
	public MutedInfoDƒO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDƒO newObject = (schemaLib.MutedInfoDƒO)super.clone();

...
// </summary>
public class MutedInfoJM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoJM
	// </summary>
	// <remarks>
	...
	public MutedInfoJM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoJM newObject = (schemaLib.MutedInfoJM)super.clone();

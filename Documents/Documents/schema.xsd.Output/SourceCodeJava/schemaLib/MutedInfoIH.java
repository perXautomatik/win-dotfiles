...
// </summary>
public class MutedInfoIH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoIH
	// </summary>
	// <remarks>
	...
	public MutedInfoIH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoIH newObject = (schemaLib.MutedInfoIH)super.clone();

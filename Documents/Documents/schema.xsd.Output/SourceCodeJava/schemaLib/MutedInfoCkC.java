...
// </summary>
public class MutedInfoCkC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCkC
	// </summary>
	// <remarks>
	...
	public MutedInfoCkC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCkC newObject = (schemaLib.MutedInfoCkC)super.clone();

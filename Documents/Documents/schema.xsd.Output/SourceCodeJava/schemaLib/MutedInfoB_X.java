...
// </summary>
public class MutedInfoB_X extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_X
	// </summary>
	// <remarks>
	...
	public MutedInfoB_X(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_X newObject = (schemaLib.MutedInfoB_X)super.clone();

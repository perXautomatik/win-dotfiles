...
// </summary>
public class MutedInfoCxK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCxK
	// </summary>
	// <remarks>
	...
	public MutedInfoCxK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCxK newObject = (schemaLib.MutedInfoCxK)super.clone();

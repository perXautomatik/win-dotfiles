...
// </summary>
public class MutedInfoC_UC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_UC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_UC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_UC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_UC newObject = (schemaLib.MutedInfoC_UC)super.clone();

...
// </summary>
public class MutedInfoUM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoUM
	// </summary>
	// <remarks>
	...
	public MutedInfoUM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoUM newObject = (schemaLib.MutedInfoUM)super.clone();

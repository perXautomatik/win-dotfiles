...
// </summary>
public class MutedInfoCA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCA
	// </summary>
	// <remarks>
	...
	public MutedInfoCA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCA newObject = (schemaLib.MutedInfoCA)super.clone();

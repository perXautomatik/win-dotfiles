...
// </summary>
public class MutedInfoCkE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCkE
	// </summary>
	// <remarks>
	...
	public MutedInfoCkE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCkE newObject = (schemaLib.MutedInfoCkE)super.clone();

...
// </summary>
public class MutedInfoCkA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCkA
	// </summary>
	// <remarks>
	...
	public MutedInfoCkA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCkA newObject = (schemaLib.MutedInfoCkA)super.clone();

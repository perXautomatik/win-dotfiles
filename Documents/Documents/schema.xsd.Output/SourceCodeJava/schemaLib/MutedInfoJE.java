...
// </summary>
public class MutedInfoJE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoJE
	// </summary>
	// <remarks>
	...
	public MutedInfoJE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoJE newObject = (schemaLib.MutedInfoJE)super.clone();

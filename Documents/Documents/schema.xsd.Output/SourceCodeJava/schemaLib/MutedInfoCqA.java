...
// </summary>
public class MutedInfoCqA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCqA
	// </summary>
	// <remarks>
	...
	public MutedInfoCqA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCqA newObject = (schemaLib.MutedInfoCqA)super.clone();

...
// </summary>
public class MutedInfoB_HB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_HB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_HB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_HB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_HB newObject = (schemaLib.MutedInfoB_HB)super.clone();

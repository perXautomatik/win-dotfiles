...
// </summary>
public class MutedInfoClA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoClA
	// </summary>
	// <remarks>
	...
	public MutedInfoClA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoClA newObject = (schemaLib.MutedInfoClA)super.clone();

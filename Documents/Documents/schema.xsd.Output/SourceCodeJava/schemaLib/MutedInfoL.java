...
// </summary>
public class MutedInfoL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoL
	// </summary>
	// <remarks>
	...
	public MutedInfoL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoL newObject = (schemaLib.MutedInfoL)super.clone();

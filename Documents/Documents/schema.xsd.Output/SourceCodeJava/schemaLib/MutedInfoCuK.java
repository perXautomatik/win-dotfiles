...
// </summary>
public class MutedInfoCuK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCuK
	// </summary>
	// <remarks>
	...
	public MutedInfoCuK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCuK newObject = (schemaLib.MutedInfoCuK)super.clone();

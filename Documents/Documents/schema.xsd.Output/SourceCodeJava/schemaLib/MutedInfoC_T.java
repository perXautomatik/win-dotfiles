...
// </summary>
public class MutedInfoC_T extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_T
	// </summary>
	// <remarks>
	...
	public MutedInfoC_T(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_T newObject = (schemaLib.MutedInfoC_T)super.clone();

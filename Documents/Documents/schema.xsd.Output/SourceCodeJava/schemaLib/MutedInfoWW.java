...
// </summary>
public class MutedInfoWW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoWW
	// </summary>
	// <remarks>
	...
	public MutedInfoWW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoWW newObject = (schemaLib.MutedInfoWW)super.clone();

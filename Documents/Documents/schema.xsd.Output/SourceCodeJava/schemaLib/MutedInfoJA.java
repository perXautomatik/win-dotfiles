...
// </summary>
public class MutedInfoJA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoJA
	// </summary>
	// <remarks>
	...
	public MutedInfoJA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoJA newObject = (schemaLib.MutedInfoJA)super.clone();

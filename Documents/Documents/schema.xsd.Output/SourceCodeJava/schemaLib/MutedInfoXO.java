...
// </summary>
public class MutedInfoXO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoXO
	// </summary>
	// <remarks>
	...
	public MutedInfoXO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoXO newObject = (schemaLib.MutedInfoXO)super.clone();

...
// </summary>
public class MutedInfoCmQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCmQ
	// </summary>
	// <remarks>
	...
	public MutedInfoCmQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCmQ newObject = (schemaLib.MutedInfoCmQ)super.clone();

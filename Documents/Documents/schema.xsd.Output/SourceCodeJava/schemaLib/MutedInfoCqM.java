...
// </summary>
public class MutedInfoCqM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCqM
	// </summary>
	// <remarks>
	...
	public MutedInfoCqM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCqM newObject = (schemaLib.MutedInfoCqM)super.clone();

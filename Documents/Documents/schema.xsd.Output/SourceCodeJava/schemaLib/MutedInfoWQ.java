...
// </summary>
public class MutedInfoWQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoWQ
	// </summary>
	// <remarks>
	...
	public MutedInfoWQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoWQ newObject = (schemaLib.MutedInfoWQ)super.clone();

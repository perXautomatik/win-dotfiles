...
// </summary>
public class MutedInfoZW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoZW
	// </summary>
	// <remarks>
	...
	public MutedInfoZW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoZW newObject = (schemaLib.MutedInfoZW)super.clone();

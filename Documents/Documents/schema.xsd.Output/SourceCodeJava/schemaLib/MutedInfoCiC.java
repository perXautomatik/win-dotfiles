...
// </summary>
public class MutedInfoCiC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCiC
	// </summary>
	// <remarks>
	...
	public MutedInfoCiC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCiC newObject = (schemaLib.MutedInfoCiC)super.clone();

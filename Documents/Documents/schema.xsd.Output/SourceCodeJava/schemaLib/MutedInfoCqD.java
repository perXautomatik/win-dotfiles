...
// </summary>
public class MutedInfoCqD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCqD
	// </summary>
	// <remarks>
	...
	public MutedInfoCqD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCqD newObject = (schemaLib.MutedInfoCqD)super.clone();

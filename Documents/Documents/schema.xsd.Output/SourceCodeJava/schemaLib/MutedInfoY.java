...
// </summary>
public class MutedInfoY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoY
	// </summary>
	// <remarks>
	...
	public MutedInfoY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoY newObject = (schemaLib.MutedInfoY)super.clone();

...
// </summary>
public class MutedInfoDˆP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDˆP
	// </summary>
	// <remarks>
	...
	public MutedInfoDˆP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDˆP newObject = (schemaLib.MutedInfoDˆP)super.clone();

...
// </summary>
public class MutedInfoCzC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCzC
	// </summary>
	// <remarks>
	...
	public MutedInfoCzC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCzC newObject = (schemaLib.MutedInfoCzC)super.clone();

...
// </summary>
public class MutedInfoHV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoHV
	// </summary>
	// <remarks>
	...
	public MutedInfoHV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoHV newObject = (schemaLib.MutedInfoHV)super.clone();

...
// </summary>
public class MutedInfoGH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoGH
	// </summary>
	// <remarks>
	...
	public MutedInfoGH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoGH newObject = (schemaLib.MutedInfoGH)super.clone();

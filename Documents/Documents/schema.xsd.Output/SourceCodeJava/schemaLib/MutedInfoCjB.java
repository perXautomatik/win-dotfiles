...
// </summary>
public class MutedInfoCjB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCjB
	// </summary>
	// <remarks>
	...
	public MutedInfoCjB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCjB newObject = (schemaLib.MutedInfoCjB)super.clone();

...
// </summary>
public class MutedInfoB_R extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_R
	// </summary>
	// <remarks>
	...
	public MutedInfoB_R(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_R newObject = (schemaLib.MutedInfoB_R)super.clone();

...
// </summary>
public class MutedInfoNQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoNQ
	// </summary>
	// <remarks>
	...
	public MutedInfoNQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoNQ newObject = (schemaLib.MutedInfoNQ)super.clone();

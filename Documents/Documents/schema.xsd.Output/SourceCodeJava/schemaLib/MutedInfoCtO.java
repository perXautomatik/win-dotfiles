...
// </summary>
public class MutedInfoCtO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCtO
	// </summary>
	// <remarks>
	...
	public MutedInfoCtO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCtO newObject = (schemaLib.MutedInfoCtO)super.clone();

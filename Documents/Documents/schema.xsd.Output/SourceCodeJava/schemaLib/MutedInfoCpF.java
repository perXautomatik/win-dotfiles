...
// </summary>
public class MutedInfoCpF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCpF
	// </summary>
	// <remarks>
	...
	public MutedInfoCpF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCpF newObject = (schemaLib.MutedInfoCpF)super.clone();

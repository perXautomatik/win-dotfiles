...
// </summary>
public class MutedInfoBaE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBaE
	// </summary>
	// <remarks>
	...
	public MutedInfoBaE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBaE newObject = (schemaLib.MutedInfoBaE)super.clone();

...
// </summary>
public class MutedInfoBcT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBcT
	// </summary>
	// <remarks>
	...
	public MutedInfoBcT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBcT newObject = (schemaLib.MutedInfoBcT)super.clone();

...
// </summary>
public class MutedInfoKM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoKM
	// </summary>
	// <remarks>
	...
	public MutedInfoKM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoKM newObject = (schemaLib.MutedInfoKM)super.clone();

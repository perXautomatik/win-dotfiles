...
// </summary>
public class MutedInfoCoD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCoD
	// </summary>
	// <remarks>
	...
	public MutedInfoCoD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCoD newObject = (schemaLib.MutedInfoCoD)super.clone();

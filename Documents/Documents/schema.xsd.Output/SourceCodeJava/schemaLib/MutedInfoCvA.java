...
// </summary>
public class MutedInfoCvA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCvA
	// </summary>
	// <remarks>
	...
	public MutedInfoCvA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCvA newObject = (schemaLib.MutedInfoCvA)super.clone();

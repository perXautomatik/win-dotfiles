...
// </summary>
public class MutedInfoB_BD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_BD
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_BD() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_BD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_BD newObject = (schemaLib.MutedInfoB_BD)super.clone();

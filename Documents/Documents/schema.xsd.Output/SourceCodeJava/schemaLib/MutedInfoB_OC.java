...
// </summary>
public class MutedInfoB_OC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_OC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_OC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_OC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_OC newObject = (schemaLib.MutedInfoB_OC)super.clone();

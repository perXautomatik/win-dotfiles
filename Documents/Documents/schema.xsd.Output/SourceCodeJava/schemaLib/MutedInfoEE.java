...
// </summary>
public class MutedInfoEE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoEE
	// </summary>
	// <remarks>
	...
	public MutedInfoEE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoEE newObject = (schemaLib.MutedInfoEE)super.clone();

...
// </summary>
public class MutedInfoO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoO
	// </summary>
	// <remarks>
	...
	public MutedInfoO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoO newObject = (schemaLib.MutedInfoO)super.clone();

...
// </summary>
public class MutedInfoBfG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBfG
	// </summary>
	// <remarks>
	...
	public MutedInfoBfG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBfG newObject = (schemaLib.MutedInfoBfG)super.clone();

...
// </summary>
public class MutedInfoCtI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCtI
	// </summary>
	// <remarks>
	...
	public MutedInfoCtI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCtI newObject = (schemaLib.MutedInfoCtI)super.clone();

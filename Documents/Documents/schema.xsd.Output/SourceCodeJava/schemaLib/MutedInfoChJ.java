...
// </summary>
public class MutedInfoChJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoChJ
	// </summary>
	// <remarks>
	...
	public MutedInfoChJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoChJ newObject = (schemaLib.MutedInfoChJ)super.clone();

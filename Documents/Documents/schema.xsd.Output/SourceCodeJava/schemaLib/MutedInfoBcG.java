...
// </summary>
public class MutedInfoBcG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBcG
	// </summary>
	// <remarks>
	...
	public MutedInfoBcG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBcG newObject = (schemaLib.MutedInfoBcG)super.clone();

...
// </summary>
public class MutedInfoCxB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCxB
	// </summary>
	// <remarks>
	...
	public MutedInfoCxB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCxB newObject = (schemaLib.MutedInfoCxB)super.clone();

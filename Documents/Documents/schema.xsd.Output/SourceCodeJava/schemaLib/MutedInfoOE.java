...
// </summary>
public class MutedInfoOE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoOE
	// </summary>
	// <remarks>
	...
	public MutedInfoOE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoOE newObject = (schemaLib.MutedInfoOE)super.clone();

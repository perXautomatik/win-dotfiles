...
// </summary>
public class MutedInfoDŠB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŠB
	// </summary>
	// <remarks>
	...
	public MutedInfoDŠB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŠB newObject = (schemaLib.MutedInfoDŠB)super.clone();

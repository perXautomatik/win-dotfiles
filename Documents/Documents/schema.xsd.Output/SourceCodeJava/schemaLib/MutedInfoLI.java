...
// </summary>
public class MutedInfoLI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoLI
	// </summary>
	// <remarks>
	...
	public MutedInfoLI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoLI newObject = (schemaLib.MutedInfoLI)super.clone();

...
// </summary>
public class MutedInfoCpA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCpA
	// </summary>
	// <remarks>
	...
	public MutedInfoCpA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCpA newObject = (schemaLib.MutedInfoCpA)super.clone();

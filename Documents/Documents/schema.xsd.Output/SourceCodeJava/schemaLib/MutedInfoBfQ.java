...
// </summary>
public class MutedInfoBfQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBfQ
	// </summary>
	// <remarks>
	...
	public MutedInfoBfQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBfQ newObject = (schemaLib.MutedInfoBfQ)super.clone();

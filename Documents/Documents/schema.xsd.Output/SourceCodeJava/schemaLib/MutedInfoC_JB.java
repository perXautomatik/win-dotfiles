...
// </summary>
public class MutedInfoC_JB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_JB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_JB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_JB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_JB newObject = (schemaLib.MutedInfoC_JB)super.clone();

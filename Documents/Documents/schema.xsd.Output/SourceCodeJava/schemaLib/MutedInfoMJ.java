...
// </summary>
public class MutedInfoMJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoMJ
	// </summary>
	// <remarks>
	...
	public MutedInfoMJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoMJ newObject = (schemaLib.MutedInfoMJ)super.clone();

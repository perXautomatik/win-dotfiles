...
// </summary>
public class MutedInfoZP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoZP
	// </summary>
	// <remarks>
	...
	public MutedInfoZP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoZP newObject = (schemaLib.MutedInfoZP)super.clone();

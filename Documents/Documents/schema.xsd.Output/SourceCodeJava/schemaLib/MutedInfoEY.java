...
// </summary>
public class MutedInfoEY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoEY
	// </summary>
	// <remarks>
	...
	public MutedInfoEY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoEY newObject = (schemaLib.MutedInfoEY)super.clone();

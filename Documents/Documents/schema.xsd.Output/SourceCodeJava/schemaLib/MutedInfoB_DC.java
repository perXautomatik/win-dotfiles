...
// </summary>
public class MutedInfoB_DC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_DC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_DC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_DC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_DC newObject = (schemaLib.MutedInfoB_DC)super.clone();

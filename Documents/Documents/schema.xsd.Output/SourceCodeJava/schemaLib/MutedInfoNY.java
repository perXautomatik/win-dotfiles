...
// </summary>
public class MutedInfoNY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoNY
	// </summary>
	// <remarks>
	...
	public MutedInfoNY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoNY newObject = (schemaLib.MutedInfoNY)super.clone();

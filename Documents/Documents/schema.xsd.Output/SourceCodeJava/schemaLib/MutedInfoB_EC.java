...
// </summary>
public class MutedInfoB_EC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_EC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_EC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_EC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_EC newObject = (schemaLib.MutedInfoB_EC)super.clone();

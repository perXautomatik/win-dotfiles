...
// </summary>
public class MutedInfoC_HC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_HC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_HC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_HC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_HC newObject = (schemaLib.MutedInfoC_HC)super.clone();

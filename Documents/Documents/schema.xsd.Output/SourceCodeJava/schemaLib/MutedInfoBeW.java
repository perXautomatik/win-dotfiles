...
// </summary>
public class MutedInfoBeW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBeW
	// </summary>
	// <remarks>
	...
	public MutedInfoBeW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBeW newObject = (schemaLib.MutedInfoBeW)super.clone();

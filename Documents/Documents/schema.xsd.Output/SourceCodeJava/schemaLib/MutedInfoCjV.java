...
// </summary>
public class MutedInfoCjV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCjV
	// </summary>
	// <remarks>
	...
	public MutedInfoCjV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCjV newObject = (schemaLib.MutedInfoCjV)super.clone();

...
// </summary>
public class MutedInfoC_YB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_YB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_YB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_YB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_YB newObject = (schemaLib.MutedInfoC_YB)super.clone();

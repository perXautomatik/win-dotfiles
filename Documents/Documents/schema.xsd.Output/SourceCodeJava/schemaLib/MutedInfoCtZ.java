...
// </summary>
public class MutedInfoCtZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCtZ
	// </summary>
	// <remarks>
	...
	public MutedInfoCtZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCtZ newObject = (schemaLib.MutedInfoCtZ)super.clone();

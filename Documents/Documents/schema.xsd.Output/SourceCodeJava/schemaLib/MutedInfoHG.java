...
// </summary>
public class MutedInfoHG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoHG
	// </summary>
	// <remarks>
	...
	public MutedInfoHG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoHG newObject = (schemaLib.MutedInfoHG)super.clone();

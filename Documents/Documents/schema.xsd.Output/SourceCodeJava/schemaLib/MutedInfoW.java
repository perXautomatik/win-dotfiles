...
// </summary>
public class MutedInfoW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoW
	// </summary>
	// <remarks>
	...
	public MutedInfoW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoW newObject = (schemaLib.MutedInfoW)super.clone();

...
// </summary>
public class MutedInfoCsF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCsF
	// </summary>
	// <remarks>
	...
	public MutedInfoCsF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCsF newObject = (schemaLib.MutedInfoCsF)super.clone();

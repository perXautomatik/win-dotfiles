...
// </summary>
public class MutedInfoCuF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCuF
	// </summary>
	// <remarks>
	...
	public MutedInfoCuF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCuF newObject = (schemaLib.MutedInfoCuF)super.clone();

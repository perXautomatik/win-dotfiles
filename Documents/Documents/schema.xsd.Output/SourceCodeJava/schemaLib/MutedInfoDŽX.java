...
// </summary>
public class MutedInfoDŽX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŽX
	// </summary>
	// <remarks>
	...
	public MutedInfoDŽX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŽX newObject = (schemaLib.MutedInfoDŽX)super.clone();

...
// </summary>
public class MutedInfoBgH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBgH
	// </summary>
	// <remarks>
	...
	public MutedInfoBgH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBgH newObject = (schemaLib.MutedInfoBgH)super.clone();

...
// </summary>
public class MutedInfoBhY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBhY
	// </summary>
	// <remarks>
	...
	public MutedInfoBhY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBhY newObject = (schemaLib.MutedInfoBhY)super.clone();

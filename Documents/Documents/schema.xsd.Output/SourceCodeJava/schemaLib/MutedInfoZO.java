...
// </summary>
public class MutedInfoZO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoZO
	// </summary>
	// <remarks>
	...
	public MutedInfoZO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoZO newObject = (schemaLib.MutedInfoZO)super.clone();

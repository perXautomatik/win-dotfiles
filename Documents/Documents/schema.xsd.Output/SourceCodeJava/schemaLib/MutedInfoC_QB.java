...
// </summary>
public class MutedInfoC_QB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_QB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_QB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_QB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_QB newObject = (schemaLib.MutedInfoC_QB)super.clone();

...
// </summary>
public class MutedInfoCqJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCqJ
	// </summary>
	// <remarks>
	...
	public MutedInfoCqJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCqJ newObject = (schemaLib.MutedInfoCqJ)super.clone();

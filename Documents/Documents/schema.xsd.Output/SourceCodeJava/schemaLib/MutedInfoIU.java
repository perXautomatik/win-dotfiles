...
// </summary>
public class MutedInfoIU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoIU
	// </summary>
	// <remarks>
	...
	public MutedInfoIU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoIU newObject = (schemaLib.MutedInfoIU)super.clone();

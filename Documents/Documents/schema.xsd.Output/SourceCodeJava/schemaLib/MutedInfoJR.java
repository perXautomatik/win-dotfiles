...
// </summary>
public class MutedInfoJR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoJR
	// </summary>
	// <remarks>
	...
	public MutedInfoJR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoJR newObject = (schemaLib.MutedInfoJR)super.clone();

...
// </summary>
public class MutedInfoCoV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCoV
	// </summary>
	// <remarks>
	...
	public MutedInfoCoV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCoV newObject = (schemaLib.MutedInfoCoV)super.clone();

...
// </summary>
public class MutedInfoCxH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCxH
	// </summary>
	// <remarks>
	...
	public MutedInfoCxH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCxH newObject = (schemaLib.MutedInfoCxH)super.clone();

...
// </summary>
public class MutedInfoCtC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCtC
	// </summary>
	// <remarks>
	...
	public MutedInfoCtC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCtC newObject = (schemaLib.MutedInfoCtC)super.clone();

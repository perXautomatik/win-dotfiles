...
// </summary>
public class MutedInfoYC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoYC
	// </summary>
	// <remarks>
	...
	public MutedInfoYC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoYC newObject = (schemaLib.MutedInfoYC)super.clone();

...
// </summary>
public class MutedInfoCoR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCoR
	// </summary>
	// <remarks>
	...
	public MutedInfoCoR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCoR newObject = (schemaLib.MutedInfoCoR)super.clone();

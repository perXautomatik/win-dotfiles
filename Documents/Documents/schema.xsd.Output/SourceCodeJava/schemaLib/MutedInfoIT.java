...
// </summary>
public class MutedInfoIT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoIT
	// </summary>
	// <remarks>
	...
	public MutedInfoIT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoIT newObject = (schemaLib.MutedInfoIT)super.clone();

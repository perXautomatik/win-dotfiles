...
// </summary>
public class MutedInfoCrU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCrU
	// </summary>
	// <remarks>
	...
	public MutedInfoCrU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCrU newObject = (schemaLib.MutedInfoCrU)super.clone();

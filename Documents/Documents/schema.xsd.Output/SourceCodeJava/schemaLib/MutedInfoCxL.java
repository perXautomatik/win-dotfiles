...
// </summary>
public class MutedInfoCxL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCxL
	// </summary>
	// <remarks>
	...
	public MutedInfoCxL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCxL newObject = (schemaLib.MutedInfoCxL)super.clone();

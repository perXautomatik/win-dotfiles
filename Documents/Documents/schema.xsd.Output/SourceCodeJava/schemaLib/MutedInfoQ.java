...
// </summary>
public class MutedInfoQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoQ
	// </summary>
	// <remarks>
	...
	public MutedInfoQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoQ newObject = (schemaLib.MutedInfoQ)super.clone();

...
// </summary>
public class MutedInfoCrM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCrM
	// </summary>
	// <remarks>
	...
	public MutedInfoCrM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCrM newObject = (schemaLib.MutedInfoCrM)super.clone();

...
// </summary>
public class MutedInfoC_BC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_BC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_BC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_BC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_BC newObject = (schemaLib.MutedInfoC_BC)super.clone();

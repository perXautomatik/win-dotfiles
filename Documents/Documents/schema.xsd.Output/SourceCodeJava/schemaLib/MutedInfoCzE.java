...
// </summary>
public class MutedInfoCzE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCzE
	// </summary>
	// <remarks>
	...
	public MutedInfoCzE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCzE newObject = (schemaLib.MutedInfoCzE)super.clone();

...
// </summary>
public class MutedInfoCnV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCnV
	// </summary>
	// <remarks>
	...
	public MutedInfoCnV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCnV newObject = (schemaLib.MutedInfoCnV)super.clone();

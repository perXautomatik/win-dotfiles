...
// </summary>
public class MutedInfoCvT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCvT
	// </summary>
	// <remarks>
	...
	public MutedInfoCvT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCvT newObject = (schemaLib.MutedInfoCvT)super.clone();

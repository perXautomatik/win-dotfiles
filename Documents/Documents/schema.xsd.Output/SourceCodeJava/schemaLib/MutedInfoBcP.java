...
// </summary>
public class MutedInfoBcP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBcP
	// </summary>
	// <remarks>
	...
	public MutedInfoBcP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBcP newObject = (schemaLib.MutedInfoBcP)super.clone();

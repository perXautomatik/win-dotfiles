...
// </summary>
public class MutedInfoCzY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCzY
	// </summary>
	// <remarks>
	...
	public MutedInfoCzY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCzY newObject = (schemaLib.MutedInfoCzY)super.clone();

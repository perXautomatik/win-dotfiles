...
// </summary>
public class MutedInfoBgT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBgT
	// </summary>
	// <remarks>
	...
	public MutedInfoBgT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBgT newObject = (schemaLib.MutedInfoBgT)super.clone();

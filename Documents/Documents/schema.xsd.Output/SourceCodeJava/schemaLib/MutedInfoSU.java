...
// </summary>
public class MutedInfoSU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoSU
	// </summary>
	// <remarks>
	...
	public MutedInfoSU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoSU newObject = (schemaLib.MutedInfoSU)super.clone();

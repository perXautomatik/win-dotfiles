...
// </summary>
public class MutedInfoCzL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCzL
	// </summary>
	// <remarks>
	...
	public MutedInfoCzL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCzL newObject = (schemaLib.MutedInfoCzL)super.clone();

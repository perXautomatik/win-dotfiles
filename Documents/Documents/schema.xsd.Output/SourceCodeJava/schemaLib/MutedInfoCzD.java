...
// </summary>
public class MutedInfoCzD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCzD
	// </summary>
	// <remarks>
	...
	public MutedInfoCzD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCzD newObject = (schemaLib.MutedInfoCzD)super.clone();

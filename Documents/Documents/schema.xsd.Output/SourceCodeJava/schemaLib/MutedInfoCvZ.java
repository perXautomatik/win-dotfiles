...
// </summary>
public class MutedInfoCvZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCvZ
	// </summary>
	// <remarks>
	...
	public MutedInfoCvZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCvZ newObject = (schemaLib.MutedInfoCvZ)super.clone();

...
// </summary>
public class MutedInfoCwM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCwM
	// </summary>
	// <remarks>
	...
	public MutedInfoCwM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCwM newObject = (schemaLib.MutedInfoCwM)super.clone();

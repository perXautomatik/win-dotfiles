...
// </summary>
public class MutedInfoNH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoNH
	// </summary>
	// <remarks>
	...
	public MutedInfoNH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoNH newObject = (schemaLib.MutedInfoNH)super.clone();

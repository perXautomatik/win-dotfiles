...
// </summary>
public class MutedInfoB_Y extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_Y
	// </summary>
	// <remarks>
	...
	public MutedInfoB_Y(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_Y newObject = (schemaLib.MutedInfoB_Y)super.clone();

...
// </summary>
public class MutedInfoC_EB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_EB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_EB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_EB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_EB newObject = (schemaLib.MutedInfoC_EB)super.clone();

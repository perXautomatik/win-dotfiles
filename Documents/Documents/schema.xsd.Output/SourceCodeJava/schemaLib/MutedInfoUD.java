...
// </summary>
public class MutedInfoUD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoUD
	// </summary>
	// <remarks>
	...
	public MutedInfoUD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoUD newObject = (schemaLib.MutedInfoUD)super.clone();

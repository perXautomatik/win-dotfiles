...
// </summary>
public class MutedInfoOX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoOX
	// </summary>
	// <remarks>
	...
	public MutedInfoOX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoOX newObject = (schemaLib.MutedInfoOX)super.clone();

...
// </summary>
public class MutedInfoBbZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBbZ
	// </summary>
	// <remarks>
	...
	public MutedInfoBbZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBbZ newObject = (schemaLib.MutedInfoBbZ)super.clone();

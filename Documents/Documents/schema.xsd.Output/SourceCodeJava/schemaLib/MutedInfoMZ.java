...
// </summary>
public class MutedInfoMZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoMZ
	// </summary>
	// <remarks>
	...
	public MutedInfoMZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoMZ newObject = (schemaLib.MutedInfoMZ)super.clone();

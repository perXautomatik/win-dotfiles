...
// </summary>
public class MutedInfoXK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoXK
	// </summary>
	// <remarks>
	...
	public MutedInfoXK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoXK newObject = (schemaLib.MutedInfoXK)super.clone();

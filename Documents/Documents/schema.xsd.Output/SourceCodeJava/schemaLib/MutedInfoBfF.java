...
// </summary>
public class MutedInfoBfF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBfF
	// </summary>
	// <remarks>
	...
	public MutedInfoBfF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBfF newObject = (schemaLib.MutedInfoBfF)super.clone();

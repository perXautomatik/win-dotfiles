...
// </summary>
public class MutedInfoIZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoIZ
	// </summary>
	// <remarks>
	...
	public MutedInfoIZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoIZ newObject = (schemaLib.MutedInfoIZ)super.clone();

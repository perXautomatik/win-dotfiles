...
// </summary>
public class MutedInfoB_E extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_E
	// </summary>
	// <remarks>
	...
	public MutedInfoB_E(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_E newObject = (schemaLib.MutedInfoB_E)super.clone();

...
// </summary>
public class MutedInfoB_S extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_S
	// </summary>
	// <remarks>
	...
	public MutedInfoB_S(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_S newObject = (schemaLib.MutedInfoB_S)super.clone();

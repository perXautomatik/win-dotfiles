...
// </summary>
public class MutedInfoCuR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCuR
	// </summary>
	// <remarks>
	...
	public MutedInfoCuR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCuR newObject = (schemaLib.MutedInfoCuR)super.clone();

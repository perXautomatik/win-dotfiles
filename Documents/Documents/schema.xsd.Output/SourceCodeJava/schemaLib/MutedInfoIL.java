...
// </summary>
public class MutedInfoIL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoIL
	// </summary>
	// <remarks>
	...
	public MutedInfoIL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoIL newObject = (schemaLib.MutedInfoIL)super.clone();

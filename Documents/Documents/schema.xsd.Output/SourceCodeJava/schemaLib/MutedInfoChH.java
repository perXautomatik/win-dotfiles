...
// </summary>
public class MutedInfoChH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoChH
	// </summary>
	// <remarks>
	...
	public MutedInfoChH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoChH newObject = (schemaLib.MutedInfoChH)super.clone();

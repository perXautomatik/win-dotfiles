...
// </summary>
public class MutedInfoPW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoPW
	// </summary>
	// <remarks>
	...
	public MutedInfoPW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoPW newObject = (schemaLib.MutedInfoPW)super.clone();

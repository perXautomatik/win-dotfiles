...
// </summary>
public class MutedInfoC_S extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_S
	// </summary>
	// <remarks>
	...
	public MutedInfoC_S(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_S newObject = (schemaLib.MutedInfoC_S)super.clone();

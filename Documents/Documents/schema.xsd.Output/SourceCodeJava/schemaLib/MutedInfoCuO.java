...
// </summary>
public class MutedInfoCuO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCuO
	// </summary>
	// <remarks>
	...
	public MutedInfoCuO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCuO newObject = (schemaLib.MutedInfoCuO)super.clone();

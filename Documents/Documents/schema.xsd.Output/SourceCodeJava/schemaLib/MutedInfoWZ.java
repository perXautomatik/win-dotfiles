...
// </summary>
public class MutedInfoWZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoWZ
	// </summary>
	// <remarks>
	...
	public MutedInfoWZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoWZ newObject = (schemaLib.MutedInfoWZ)super.clone();

...
// </summary>
public class MutedInfoBfW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBfW
	// </summary>
	// <remarks>
	...
	public MutedInfoBfW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBfW newObject = (schemaLib.MutedInfoBfW)super.clone();

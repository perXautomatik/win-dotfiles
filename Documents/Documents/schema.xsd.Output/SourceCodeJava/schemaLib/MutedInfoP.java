...
// </summary>
public class MutedInfoP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoP
	// </summary>
	// <remarks>
	...
	public MutedInfoP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoP newObject = (schemaLib.MutedInfoP)super.clone();

...
// </summary>
public class MutedInfoCsQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCsQ
	// </summary>
	// <remarks>
	...
	public MutedInfoCsQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCsQ newObject = (schemaLib.MutedInfoCsQ)super.clone();

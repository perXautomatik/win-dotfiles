...
// </summary>
public class MutedInfoCiW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCiW
	// </summary>
	// <remarks>
	...
	public MutedInfoCiW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCiW newObject = (schemaLib.MutedInfoCiW)super.clone();

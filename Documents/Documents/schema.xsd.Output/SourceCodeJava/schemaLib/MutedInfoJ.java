...
// </summary>
public class MutedInfoJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoJ
	// </summary>
	// <remarks>
	...
	public MutedInfoJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoJ newObject = (schemaLib.MutedInfoJ)super.clone();

...
// </summary>
public class MutedInfoBeR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBeR
	// </summary>
	// <remarks>
	...
	public MutedInfoBeR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBeR newObject = (schemaLib.MutedInfoBeR)super.clone();

...
// </summary>
public class MutedInfoCW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCW
	// </summary>
	// <remarks>
	...
	public MutedInfoCW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCW newObject = (schemaLib.MutedInfoCW)super.clone();

...
// </summary>
public class MutedInfoMV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoMV
	// </summary>
	// <remarks>
	...
	public MutedInfoMV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoMV newObject = (schemaLib.MutedInfoMV)super.clone();

...
// </summary>
public class MutedInfoFY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoFY
	// </summary>
	// <remarks>
	...
	public MutedInfoFY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoFY newObject = (schemaLib.MutedInfoFY)super.clone();

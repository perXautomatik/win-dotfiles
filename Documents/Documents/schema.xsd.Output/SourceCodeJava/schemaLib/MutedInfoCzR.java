...
// </summary>
public class MutedInfoCzR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCzR
	// </summary>
	// <remarks>
	...
	public MutedInfoCzR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCzR newObject = (schemaLib.MutedInfoCzR)super.clone();

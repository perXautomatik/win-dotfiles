...
// </summary>
public class MutedInfoBL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBL
	// </summary>
	// <remarks>
	...
	public MutedInfoBL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBL newObject = (schemaLib.MutedInfoBL)super.clone();

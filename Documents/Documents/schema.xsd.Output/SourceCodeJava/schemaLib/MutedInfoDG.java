...
// </summary>
public class MutedInfoDG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDG
	// </summary>
	// <remarks>
	...
	public MutedInfoDG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDG newObject = (schemaLib.MutedInfoDG)super.clone();

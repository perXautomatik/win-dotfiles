...
// </summary>
public class MutedInfoUS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoUS
	// </summary>
	// <remarks>
	...
	public MutedInfoUS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoUS newObject = (schemaLib.MutedInfoUS)super.clone();

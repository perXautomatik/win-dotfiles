...
// </summary>
public class MutedInfoDƒZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDƒZ
	// </summary>
	// <remarks>
	...
	public MutedInfoDƒZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDƒZ newObject = (schemaLib.MutedInfoDƒZ)super.clone();

...
// </summary>
public class MutedInfoQJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoQJ
	// </summary>
	// <remarks>
	...
	public MutedInfoQJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoQJ newObject = (schemaLib.MutedInfoQJ)super.clone();

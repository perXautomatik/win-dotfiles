...
// </summary>
public class MutedInfoIK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoIK
	// </summary>
	// <remarks>
	...
	public MutedInfoIK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoIK newObject = (schemaLib.MutedInfoIK)super.clone();

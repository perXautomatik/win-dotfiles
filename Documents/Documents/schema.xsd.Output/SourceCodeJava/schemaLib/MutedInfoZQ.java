...
// </summary>
public class MutedInfoZQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoZQ
	// </summary>
	// <remarks>
	...
	public MutedInfoZQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoZQ newObject = (schemaLib.MutedInfoZQ)super.clone();

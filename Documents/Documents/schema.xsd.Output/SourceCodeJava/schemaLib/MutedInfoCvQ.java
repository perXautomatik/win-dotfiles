...
// </summary>
public class MutedInfoCvQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCvQ
	// </summary>
	// <remarks>
	...
	public MutedInfoCvQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCvQ newObject = (schemaLib.MutedInfoCvQ)super.clone();

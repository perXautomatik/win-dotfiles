...
// </summary>
public class MutedInfoCB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCB
	// </summary>
	// <remarks>
	...
	public MutedInfoCB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCB newObject = (schemaLib.MutedInfoCB)super.clone();

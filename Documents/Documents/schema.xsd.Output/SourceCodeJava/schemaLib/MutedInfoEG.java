...
// </summary>
public class MutedInfoEG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoEG
	// </summary>
	// <remarks>
	...
	public MutedInfoEG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoEG newObject = (schemaLib.MutedInfoEG)super.clone();

...
// </summary>
public class MutedInfoIF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoIF
	// </summary>
	// <remarks>
	...
	public MutedInfoIF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoIF newObject = (schemaLib.MutedInfoIF)super.clone();

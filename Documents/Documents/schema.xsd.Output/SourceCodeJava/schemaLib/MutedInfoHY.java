...
// </summary>
public class MutedInfoHY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoHY
	// </summary>
	// <remarks>
	...
	public MutedInfoHY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoHY newObject = (schemaLib.MutedInfoHY)super.clone();

...
// </summary>
public class MutedInfoZJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoZJ
	// </summary>
	// <remarks>
	...
	public MutedInfoZJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoZJ newObject = (schemaLib.MutedInfoZJ)super.clone();

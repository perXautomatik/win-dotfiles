...
// </summary>
public class MutedInfoC_N extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_N
	// </summary>
	// <remarks>
	...
	public MutedInfoC_N(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_N newObject = (schemaLib.MutedInfoC_N)super.clone();

...
// </summary>
public class MutedInfoCwG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCwG
	// </summary>
	// <remarks>
	...
	public MutedInfoCwG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCwG newObject = (schemaLib.MutedInfoCwG)super.clone();

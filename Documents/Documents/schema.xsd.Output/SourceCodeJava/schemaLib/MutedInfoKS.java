...
// </summary>
public class MutedInfoKS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoKS
	// </summary>
	// <remarks>
	...
	public MutedInfoKS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoKS newObject = (schemaLib.MutedInfoKS)super.clone();

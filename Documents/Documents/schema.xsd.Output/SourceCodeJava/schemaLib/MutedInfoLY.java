...
// </summary>
public class MutedInfoLY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoLY
	// </summary>
	// <remarks>
	...
	public MutedInfoLY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoLY newObject = (schemaLib.MutedInfoLY)super.clone();

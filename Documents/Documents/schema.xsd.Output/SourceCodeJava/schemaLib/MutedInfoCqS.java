...
// </summary>
public class MutedInfoCqS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCqS
	// </summary>
	// <remarks>
	...
	public MutedInfoCqS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCqS newObject = (schemaLib.MutedInfoCqS)super.clone();

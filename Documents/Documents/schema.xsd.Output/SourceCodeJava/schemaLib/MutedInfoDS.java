...
// </summary>
public class MutedInfoDS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDS
	// </summary>
	// <remarks>
	...
	public MutedInfoDS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDS newObject = (schemaLib.MutedInfoDS)super.clone();

...
// </summary>
public class MutedInfoWL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoWL
	// </summary>
	// <remarks>
	...
	public MutedInfoWL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoWL newObject = (schemaLib.MutedInfoWL)super.clone();

...
// </summary>
public class MutedInfoCsV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCsV
	// </summary>
	// <remarks>
	...
	public MutedInfoCsV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCsV newObject = (schemaLib.MutedInfoCsV)super.clone();

...
// </summary>
public class MutedInfoCtB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCtB
	// </summary>
	// <remarks>
	...
	public MutedInfoCtB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCtB newObject = (schemaLib.MutedInfoCtB)super.clone();

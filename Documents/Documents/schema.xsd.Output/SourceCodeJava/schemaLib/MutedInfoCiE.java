...
// </summary>
public class MutedInfoCiE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCiE
	// </summary>
	// <remarks>
	...
	public MutedInfoCiE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCiE newObject = (schemaLib.MutedInfoCiE)super.clone();

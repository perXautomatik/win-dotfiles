...
// </summary>
public class MutedInfoDŒV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŒV
	// </summary>
	// <remarks>
	...
	public MutedInfoDŒV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŒV newObject = (schemaLib.MutedInfoDŒV)super.clone();

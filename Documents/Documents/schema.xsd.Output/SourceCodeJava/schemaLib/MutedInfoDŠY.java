...
// </summary>
public class MutedInfoDŠY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŠY
	// </summary>
	// <remarks>
	...
	public MutedInfoDŠY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŠY newObject = (schemaLib.MutedInfoDŠY)super.clone();

...
// </summary>
public class MutedInfoClI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoClI
	// </summary>
	// <remarks>
	...
	public MutedInfoClI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoClI newObject = (schemaLib.MutedInfoClI)super.clone();

...
// </summary>
public class MutedInfoCvR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCvR
	// </summary>
	// <remarks>
	...
	public MutedInfoCvR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCvR newObject = (schemaLib.MutedInfoCvR)super.clone();

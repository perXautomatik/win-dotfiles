...
// </summary>
public class MutedInfoBdP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBdP
	// </summary>
	// <remarks>
	...
	public MutedInfoBdP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBdP newObject = (schemaLib.MutedInfoBdP)super.clone();

...
// </summary>
public class MutedInfoB_UC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_UC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_UC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_UC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_UC newObject = (schemaLib.MutedInfoB_UC)super.clone();

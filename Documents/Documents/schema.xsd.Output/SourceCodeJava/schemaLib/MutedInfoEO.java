...
// </summary>
public class MutedInfoEO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoEO
	// </summary>
	// <remarks>
	...
	public MutedInfoEO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoEO newObject = (schemaLib.MutedInfoEO)super.clone();

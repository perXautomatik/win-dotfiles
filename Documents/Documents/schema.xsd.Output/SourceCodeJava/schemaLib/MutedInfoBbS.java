...
// </summary>
public class MutedInfoBbS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBbS
	// </summary>
	// <remarks>
	...
	public MutedInfoBbS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBbS newObject = (schemaLib.MutedInfoBbS)super.clone();

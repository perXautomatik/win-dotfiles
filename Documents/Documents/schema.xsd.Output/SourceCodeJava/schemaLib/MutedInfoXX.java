...
// </summary>
public class MutedInfoXX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoXX
	// </summary>
	// <remarks>
	...
	public MutedInfoXX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoXX newObject = (schemaLib.MutedInfoXX)super.clone();

...
// </summary>
public class MutedInfoCwT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCwT
	// </summary>
	// <remarks>
	...
	public MutedInfoCwT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCwT newObject = (schemaLib.MutedInfoCwT)super.clone();

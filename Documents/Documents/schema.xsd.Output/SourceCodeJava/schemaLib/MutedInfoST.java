...
// </summary>
public class MutedInfoST extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoST
	// </summary>
	// <remarks>
	...
	public MutedInfoST(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoST newObject = (schemaLib.MutedInfoST)super.clone();

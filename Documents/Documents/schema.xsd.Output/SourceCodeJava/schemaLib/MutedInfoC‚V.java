...
// </summary>
public class MutedInfoC‚V extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC‚V
	// </summary>
	// <remarks>
	...
	public MutedInfoC‚V(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC‚V newObject = (schemaLib.MutedInfoC‚V)super.clone();

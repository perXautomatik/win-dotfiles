...
// </summary>
public class MutedInfoC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC
	// </summary>
	// <remarks>
	...
	public MutedInfoC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC newObject = (schemaLib.MutedInfoC)super.clone();

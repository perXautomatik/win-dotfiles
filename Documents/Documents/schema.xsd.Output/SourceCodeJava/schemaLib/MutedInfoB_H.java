...
// </summary>
public class MutedInfoB_H extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_H
	// </summary>
	// <remarks>
	...
	public MutedInfoB_H(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_H newObject = (schemaLib.MutedInfoB_H)super.clone();

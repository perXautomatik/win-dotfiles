...
// </summary>
public class MutedInfoCuM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCuM
	// </summary>
	// <remarks>
	...
	public MutedInfoCuM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCuM newObject = (schemaLib.MutedInfoCuM)super.clone();

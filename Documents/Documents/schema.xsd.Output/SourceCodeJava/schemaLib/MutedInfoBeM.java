...
// </summary>
public class MutedInfoBeM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBeM
	// </summary>
	// <remarks>
	...
	public MutedInfoBeM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBeM newObject = (schemaLib.MutedInfoBeM)super.clone();

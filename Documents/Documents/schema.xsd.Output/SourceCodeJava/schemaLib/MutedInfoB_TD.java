...
// </summary>
public class MutedInfoB_TD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_TD
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_TD() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_TD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_TD newObject = (schemaLib.MutedInfoB_TD)super.clone();

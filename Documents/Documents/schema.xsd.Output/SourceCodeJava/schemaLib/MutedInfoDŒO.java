...
// </summary>
public class MutedInfoDŒO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŒO
	// </summary>
	// <remarks>
	...
	public MutedInfoDŒO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŒO newObject = (schemaLib.MutedInfoDŒO)super.clone();

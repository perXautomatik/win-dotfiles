...
// </summary>
public class MutedInfoCnD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCnD
	// </summary>
	// <remarks>
	...
	public MutedInfoCnD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCnD newObject = (schemaLib.MutedInfoCnD)super.clone();

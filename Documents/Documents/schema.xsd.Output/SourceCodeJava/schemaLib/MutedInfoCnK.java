...
// </summary>
public class MutedInfoCnK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCnK
	// </summary>
	// <remarks>
	...
	public MutedInfoCnK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCnK newObject = (schemaLib.MutedInfoCnK)super.clone();

...
// </summary>
public class MutedInfoCrR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCrR
	// </summary>
	// <remarks>
	...
	public MutedInfoCrR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCrR newObject = (schemaLib.MutedInfoCrR)super.clone();

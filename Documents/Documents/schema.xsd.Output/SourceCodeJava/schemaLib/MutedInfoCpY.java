...
// </summary>
public class MutedInfoCpY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCpY
	// </summary>
	// <remarks>
	...
	public MutedInfoCpY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCpY newObject = (schemaLib.MutedInfoCpY)super.clone();

...
// </summary>
public class MutedInfoBfL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBfL
	// </summary>
	// <remarks>
	...
	public MutedInfoBfL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBfL newObject = (schemaLib.MutedInfoBfL)super.clone();

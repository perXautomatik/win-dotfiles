...
// </summary>
public class MutedInfoCwD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCwD
	// </summary>
	// <remarks>
	...
	public MutedInfoCwD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCwD newObject = (schemaLib.MutedInfoCwD)super.clone();

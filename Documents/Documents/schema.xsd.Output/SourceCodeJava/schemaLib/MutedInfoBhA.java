...
// </summary>
public class MutedInfoBhA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBhA
	// </summary>
	// <remarks>
	...
	public MutedInfoBhA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBhA newObject = (schemaLib.MutedInfoBhA)super.clone();

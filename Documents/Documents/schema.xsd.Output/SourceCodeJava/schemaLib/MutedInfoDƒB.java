...
// </summary>
public class MutedInfoDƒB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDƒB
	// </summary>
	// <remarks>
	...
	public MutedInfoDƒB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDƒB newObject = (schemaLib.MutedInfoDƒB)super.clone();

...
// </summary>
public class MutedInfo_Y extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfo_Y
	// </summary>
	// <remarks>
	...
	public MutedInfo_Y(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfo_Y newObject = (schemaLib.MutedInfo_Y)super.clone();

...
// </summary>
public class MutedInfoC_DB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_DB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_DB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_DB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_DB newObject = (schemaLib.MutedInfoC_DB)super.clone();

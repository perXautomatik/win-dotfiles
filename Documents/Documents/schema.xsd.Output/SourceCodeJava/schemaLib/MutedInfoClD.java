...
// </summary>
public class MutedInfoClD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoClD
	// </summary>
	// <remarks>
	...
	public MutedInfoClD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoClD newObject = (schemaLib.MutedInfoClD)super.clone();

...
// </summary>
public class MutedInfoPC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoPC
	// </summary>
	// <remarks>
	...
	public MutedInfoPC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoPC newObject = (schemaLib.MutedInfoPC)super.clone();

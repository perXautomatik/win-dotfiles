...
// </summary>
public class MutedInfoBaY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBaY
	// </summary>
	// <remarks>
	...
	public MutedInfoBaY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBaY newObject = (schemaLib.MutedInfoBaY)super.clone();

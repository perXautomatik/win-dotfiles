...
// </summary>
public class MutedInfoIA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoIA
	// </summary>
	// <remarks>
	...
	public MutedInfoIA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoIA newObject = (schemaLib.MutedInfoIA)super.clone();

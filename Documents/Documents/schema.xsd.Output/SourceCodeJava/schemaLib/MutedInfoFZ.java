...
// </summary>
public class MutedInfoFZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoFZ
	// </summary>
	// <remarks>
	...
	public MutedInfoFZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoFZ newObject = (schemaLib.MutedInfoFZ)super.clone();

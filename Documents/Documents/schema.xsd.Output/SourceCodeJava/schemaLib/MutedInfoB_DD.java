...
// </summary>
public class MutedInfoB_DD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_DD
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_DD() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_DD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_DD newObject = (schemaLib.MutedInfoB_DD)super.clone();

...
// </summary>
public class MutedInfoTF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoTF
	// </summary>
	// <remarks>
	...
	public MutedInfoTF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoTF newObject = (schemaLib.MutedInfoTF)super.clone();

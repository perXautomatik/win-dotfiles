...
// </summary>
public class MutedInfoCxY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCxY
	// </summary>
	// <remarks>
	...
	public MutedInfoCxY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCxY newObject = (schemaLib.MutedInfoCxY)super.clone();

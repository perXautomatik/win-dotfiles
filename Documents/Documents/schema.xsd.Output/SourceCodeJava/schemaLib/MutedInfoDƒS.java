...
// </summary>
public class MutedInfoDƒS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDƒS
	// </summary>
	// <remarks>
	...
	public MutedInfoDƒS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDƒS newObject = (schemaLib.MutedInfoDƒS)super.clone();

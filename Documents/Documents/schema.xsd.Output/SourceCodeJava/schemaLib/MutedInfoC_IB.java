...
// </summary>
public class MutedInfoC_IB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_IB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_IB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_IB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_IB newObject = (schemaLib.MutedInfoC_IB)super.clone();

...
// </summary>
public class MutedInfoCvH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCvH
	// </summary>
	// <remarks>
	...
	public MutedInfoCvH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCvH newObject = (schemaLib.MutedInfoCvH)super.clone();

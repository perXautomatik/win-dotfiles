...
// </summary>
public class MutedInfoCpS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCpS
	// </summary>
	// <remarks>
	...
	public MutedInfoCpS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCpS newObject = (schemaLib.MutedInfoCpS)super.clone();

...
// </summary>
public class MutedInfoIE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoIE
	// </summary>
	// <remarks>
	...
	public MutedInfoIE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoIE newObject = (schemaLib.MutedInfoIE)super.clone();

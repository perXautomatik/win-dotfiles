...
// </summary>
public class MutedInfoBgI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBgI
	// </summary>
	// <remarks>
	...
	public MutedInfoBgI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBgI newObject = (schemaLib.MutedInfoBgI)super.clone();

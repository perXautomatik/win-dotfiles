...
// </summary>
public class MutedInfoLH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoLH
	// </summary>
	// <remarks>
	...
	public MutedInfoLH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoLH newObject = (schemaLib.MutedInfoLH)super.clone();

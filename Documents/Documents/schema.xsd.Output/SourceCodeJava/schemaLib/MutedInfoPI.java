...
// </summary>
public class MutedInfoPI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoPI
	// </summary>
	// <remarks>
	...
	public MutedInfoPI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoPI newObject = (schemaLib.MutedInfoPI)super.clone();

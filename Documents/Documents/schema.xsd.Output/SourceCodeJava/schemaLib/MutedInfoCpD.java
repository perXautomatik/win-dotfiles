...
// </summary>
public class MutedInfoCpD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCpD
	// </summary>
	// <remarks>
	...
	public MutedInfoCpD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCpD newObject = (schemaLib.MutedInfoCpD)super.clone();

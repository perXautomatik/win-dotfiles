...
// </summary>
public class MutedInfoCvD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCvD
	// </summary>
	// <remarks>
	...
	public MutedInfoCvD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCvD newObject = (schemaLib.MutedInfoCvD)super.clone();

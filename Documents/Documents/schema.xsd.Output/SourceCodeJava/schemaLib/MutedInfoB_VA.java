...
// </summary>
public class MutedInfoB_VA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_VA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_VA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_VA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_VA newObject = (schemaLib.MutedInfoB_VA)super.clone();

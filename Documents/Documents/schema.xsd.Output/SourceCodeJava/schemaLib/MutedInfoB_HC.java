...
// </summary>
public class MutedInfoB_HC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_HC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_HC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_HC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_HC newObject = (schemaLib.MutedInfoB_HC)super.clone();

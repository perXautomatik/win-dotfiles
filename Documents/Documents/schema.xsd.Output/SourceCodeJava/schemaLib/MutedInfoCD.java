...
// </summary>
public class MutedInfoCD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCD
	// </summary>
	// <remarks>
	...
	public MutedInfoCD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCD newObject = (schemaLib.MutedInfoCD)super.clone();

...
// </summary>
public class MutedInfoYS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoYS
	// </summary>
	// <remarks>
	...
	public MutedInfoYS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoYS newObject = (schemaLib.MutedInfoYS)super.clone();

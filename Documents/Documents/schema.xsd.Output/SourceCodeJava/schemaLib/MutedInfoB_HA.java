...
// </summary>
public class MutedInfoB_HA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_HA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_HA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_HA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_HA newObject = (schemaLib.MutedInfoB_HA)super.clone();

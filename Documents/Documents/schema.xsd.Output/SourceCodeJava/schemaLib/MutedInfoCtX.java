...
// </summary>
public class MutedInfoCtX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCtX
	// </summary>
	// <remarks>
	...
	public MutedInfoCtX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCtX newObject = (schemaLib.MutedInfoCtX)super.clone();

...
// </summary>
public class MutedInfoTX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoTX
	// </summary>
	// <remarks>
	...
	public MutedInfoTX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoTX newObject = (schemaLib.MutedInfoTX)super.clone();

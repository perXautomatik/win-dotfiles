...
// </summary>
public class MutedInfoYM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoYM
	// </summary>
	// <remarks>
	...
	public MutedInfoYM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoYM newObject = (schemaLib.MutedInfoYM)super.clone();

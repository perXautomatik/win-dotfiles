...
// </summary>
public class MutedInfoCxX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCxX
	// </summary>
	// <remarks>
	...
	public MutedInfoCxX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCxX newObject = (schemaLib.MutedInfoCxX)super.clone();

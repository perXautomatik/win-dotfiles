...
// </summary>
public class MutedInfoC_E extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_E
	// </summary>
	// <remarks>
	...
	public MutedInfoC_E(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_E newObject = (schemaLib.MutedInfoC_E)super.clone();

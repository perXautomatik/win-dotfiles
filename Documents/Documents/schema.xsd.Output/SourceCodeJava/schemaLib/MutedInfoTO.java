...
// </summary>
public class MutedInfoTO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoTO
	// </summary>
	// <remarks>
	...
	public MutedInfoTO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoTO newObject = (schemaLib.MutedInfoTO)super.clone();

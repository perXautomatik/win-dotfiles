...
// </summary>
public class MutedInfoC_AA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_AA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_AA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_AA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_AA newObject = (schemaLib.MutedInfoC_AA)super.clone();

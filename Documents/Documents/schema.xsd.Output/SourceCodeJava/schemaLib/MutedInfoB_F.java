...
// </summary>
public class MutedInfoB_F extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_F
	// </summary>
	// <remarks>
	...
	public MutedInfoB_F(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_F newObject = (schemaLib.MutedInfoB_F)super.clone();

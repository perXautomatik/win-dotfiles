...
// </summary>
public class MutedInfoCmA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCmA
	// </summary>
	// <remarks>
	...
	public MutedInfoCmA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCmA newObject = (schemaLib.MutedInfoCmA)super.clone();

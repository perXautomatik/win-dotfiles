...
// </summary>
public class MutedInfoBhS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBhS
	// </summary>
	// <remarks>
	...
	public MutedInfoBhS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBhS newObject = (schemaLib.MutedInfoBhS)super.clone();

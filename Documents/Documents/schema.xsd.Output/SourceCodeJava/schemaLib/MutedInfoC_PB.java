...
// </summary>
public class MutedInfoC_PB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_PB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_PB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_PB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_PB newObject = (schemaLib.MutedInfoC_PB)super.clone();

...
// </summary>
public class MutedInfoNM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoNM
	// </summary>
	// <remarks>
	...
	public MutedInfoNM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoNM newObject = (schemaLib.MutedInfoNM)super.clone();

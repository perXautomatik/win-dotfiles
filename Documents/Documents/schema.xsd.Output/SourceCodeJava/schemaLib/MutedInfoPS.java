...
// </summary>
public class MutedInfoPS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoPS
	// </summary>
	// <remarks>
	...
	public MutedInfoPS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoPS newObject = (schemaLib.MutedInfoPS)super.clone();

...
// </summary>
public class MutedInfoCvB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCvB
	// </summary>
	// <remarks>
	...
	public MutedInfoCvB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCvB newObject = (schemaLib.MutedInfoCvB)super.clone();

...
// </summary>
public class MutedInfoHW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoHW
	// </summary>
	// <remarks>
	...
	public MutedInfoHW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoHW newObject = (schemaLib.MutedInfoHW)super.clone();

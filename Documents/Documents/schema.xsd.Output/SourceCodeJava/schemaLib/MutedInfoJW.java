...
// </summary>
public class MutedInfoJW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoJW
	// </summary>
	// <remarks>
	...
	public MutedInfoJW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoJW newObject = (schemaLib.MutedInfoJW)super.clone();

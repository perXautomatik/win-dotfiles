...
// </summary>
public class MutedInfoCU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCU
	// </summary>
	// <remarks>
	...
	public MutedInfoCU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCU newObject = (schemaLib.MutedInfoCU)super.clone();

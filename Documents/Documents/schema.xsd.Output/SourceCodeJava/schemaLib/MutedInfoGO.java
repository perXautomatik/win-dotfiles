...
// </summary>
public class MutedInfoGO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoGO
	// </summary>
	// <remarks>
	...
	public MutedInfoGO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoGO newObject = (schemaLib.MutedInfoGO)super.clone();

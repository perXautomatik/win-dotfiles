...
// </summary>
public class MutedInfoCiG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCiG
	// </summary>
	// <remarks>
	...
	public MutedInfoCiG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCiG newObject = (schemaLib.MutedInfoCiG)super.clone();

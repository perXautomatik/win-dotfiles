...
// </summary>
public class MutedInfoSD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoSD
	// </summary>
	// <remarks>
	...
	public MutedInfoSD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoSD newObject = (schemaLib.MutedInfoSD)super.clone();

...
// </summary>
public class MutedInfoCjL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCjL
	// </summary>
	// <remarks>
	...
	public MutedInfoCjL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCjL newObject = (schemaLib.MutedInfoCjL)super.clone();

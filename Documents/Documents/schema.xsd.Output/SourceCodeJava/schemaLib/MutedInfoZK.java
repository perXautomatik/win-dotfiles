...
// </summary>
public class MutedInfoZK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoZK
	// </summary>
	// <remarks>
	...
	public MutedInfoZK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoZK newObject = (schemaLib.MutedInfoZK)super.clone();

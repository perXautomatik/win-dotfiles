...
// </summary>
public class MutedInfoMD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoMD
	// </summary>
	// <remarks>
	...
	public MutedInfoMD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoMD newObject = (schemaLib.MutedInfoMD)super.clone();

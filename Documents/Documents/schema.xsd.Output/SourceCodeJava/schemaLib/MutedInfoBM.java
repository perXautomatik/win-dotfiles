...
// </summary>
public class MutedInfoBM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBM
	// </summary>
	// <remarks>
	...
	public MutedInfoBM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBM newObject = (schemaLib.MutedInfoBM)super.clone();

...
// </summary>
public class MutedInfoCsR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCsR
	// </summary>
	// <remarks>
	...
	public MutedInfoCsR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCsR newObject = (schemaLib.MutedInfoCsR)super.clone();

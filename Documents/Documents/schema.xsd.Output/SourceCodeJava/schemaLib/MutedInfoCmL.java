...
// </summary>
public class MutedInfoCmL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCmL
	// </summary>
	// <remarks>
	...
	public MutedInfoCmL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCmL newObject = (schemaLib.MutedInfoCmL)super.clone();

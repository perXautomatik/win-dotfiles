...
// </summary>
public class MutedInfoB_XC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_XC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_XC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_XC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_XC newObject = (schemaLib.MutedInfoB_XC)super.clone();

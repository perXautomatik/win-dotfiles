...
// </summary>
public class MutedInfoGB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoGB
	// </summary>
	// <remarks>
	...
	public MutedInfoGB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoGB newObject = (schemaLib.MutedInfoGB)super.clone();

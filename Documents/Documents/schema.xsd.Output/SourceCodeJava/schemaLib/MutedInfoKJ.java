...
// </summary>
public class MutedInfoKJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoKJ
	// </summary>
	// <remarks>
	...
	public MutedInfoKJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoKJ newObject = (schemaLib.MutedInfoKJ)super.clone();

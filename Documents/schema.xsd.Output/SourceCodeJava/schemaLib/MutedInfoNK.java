...
// </summary>
public class MutedInfoNK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoNK
	// </summary>
	// <remarks>
	...
	public MutedInfoNK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoNK newObject = (schemaLib.MutedInfoNK)super.clone();

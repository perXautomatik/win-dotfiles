...
// </summary>
public class MutedInfoB_OB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_OB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_OB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_OB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_OB newObject = (schemaLib.MutedInfoB_OB)super.clone();

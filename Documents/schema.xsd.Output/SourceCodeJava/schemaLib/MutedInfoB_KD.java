...
// </summary>
public class MutedInfoB_KD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_KD
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_KD() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_KD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_KD newObject = (schemaLib.MutedInfoB_KD)super.clone();

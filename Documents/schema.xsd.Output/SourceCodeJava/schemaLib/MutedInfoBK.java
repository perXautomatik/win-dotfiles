...
// </summary>
public class MutedInfoBK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBK
	// </summary>
	// <remarks>
	...
	public MutedInfoBK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBK newObject = (schemaLib.MutedInfoBK)super.clone();

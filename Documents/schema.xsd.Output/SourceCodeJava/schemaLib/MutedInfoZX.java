...
// </summary>
public class MutedInfoZX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoZX
	// </summary>
	// <remarks>
	...
	public MutedInfoZX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoZX newObject = (schemaLib.MutedInfoZX)super.clone();

...
// </summary>
public class MutedInfoCmV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCmV
	// </summary>
	// <remarks>
	...
	public MutedInfoCmV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCmV newObject = (schemaLib.MutedInfoCmV)super.clone();

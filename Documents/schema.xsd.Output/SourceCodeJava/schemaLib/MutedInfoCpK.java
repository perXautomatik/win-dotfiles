...
// </summary>
public class MutedInfoCpK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCpK
	// </summary>
	// <remarks>
	...
	public MutedInfoCpK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCpK newObject = (schemaLib.MutedInfoCpK)super.clone();

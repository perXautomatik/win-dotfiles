...
// </summary>
public class MutedInfoYZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoYZ
	// </summary>
	// <remarks>
	...
	public MutedInfoYZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoYZ newObject = (schemaLib.MutedInfoYZ)super.clone();

...
// </summary>
public class MutedInfoCyD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCyD
	// </summary>
	// <remarks>
	...
	public MutedInfoCyD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCyD newObject = (schemaLib.MutedInfoCyD)super.clone();

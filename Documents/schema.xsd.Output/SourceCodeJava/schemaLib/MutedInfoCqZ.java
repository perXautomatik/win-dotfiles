...
// </summary>
public class MutedInfoCqZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCqZ
	// </summary>
	// <remarks>
	...
	public MutedInfoCqZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCqZ newObject = (schemaLib.MutedInfoCqZ)super.clone();

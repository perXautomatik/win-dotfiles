...
// </summary>
public class MutedInfoBcV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBcV
	// </summary>
	// <remarks>
	...
	public MutedInfoBcV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBcV newObject = (schemaLib.MutedInfoBcV)super.clone();

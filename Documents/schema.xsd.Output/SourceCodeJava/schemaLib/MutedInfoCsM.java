...
// </summary>
public class MutedInfoCsM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCsM
	// </summary>
	// <remarks>
	...
	public MutedInfoCsM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCsM newObject = (schemaLib.MutedInfoCsM)super.clone();

...
// </summary>
public class MutedInfoJJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoJJ
	// </summary>
	// <remarks>
	...
	public MutedInfoJJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoJJ newObject = (schemaLib.MutedInfoJJ)super.clone();

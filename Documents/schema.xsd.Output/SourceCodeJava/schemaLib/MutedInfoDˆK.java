...
// </summary>
public class MutedInfoDˆK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDˆK
	// </summary>
	// <remarks>
	...
	public MutedInfoDˆK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDˆK newObject = (schemaLib.MutedInfoDˆK)super.clone();

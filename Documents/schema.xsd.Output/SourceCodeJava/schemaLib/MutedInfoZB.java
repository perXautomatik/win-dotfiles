...
// </summary>
public class MutedInfoZB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoZB
	// </summary>
	// <remarks>
	...
	public MutedInfoZB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoZB newObject = (schemaLib.MutedInfoZB)super.clone();

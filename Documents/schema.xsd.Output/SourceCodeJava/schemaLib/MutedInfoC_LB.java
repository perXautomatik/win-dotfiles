...
// </summary>
public class MutedInfoC_LB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_LB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_LB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_LB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_LB newObject = (schemaLib.MutedInfoC_LB)super.clone();

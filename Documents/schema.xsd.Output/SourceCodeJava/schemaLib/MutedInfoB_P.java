...
// </summary>
public class MutedInfoB_P extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_P
	// </summary>
	// <remarks>
	...
	public MutedInfoB_P(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_P newObject = (schemaLib.MutedInfoB_P)super.clone();

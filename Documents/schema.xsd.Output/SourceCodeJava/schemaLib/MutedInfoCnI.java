...
// </summary>
public class MutedInfoCnI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCnI
	// </summary>
	// <remarks>
	...
	public MutedInfoCnI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCnI newObject = (schemaLib.MutedInfoCnI)super.clone();

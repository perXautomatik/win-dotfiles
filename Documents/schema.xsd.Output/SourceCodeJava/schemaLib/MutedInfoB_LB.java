...
// </summary>
public class MutedInfoB_LB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_LB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_LB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_LB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_LB newObject = (schemaLib.MutedInfoB_LB)super.clone();

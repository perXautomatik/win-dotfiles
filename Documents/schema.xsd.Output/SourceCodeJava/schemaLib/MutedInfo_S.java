...
// </summary>
public class MutedInfo_S extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfo_S
	// </summary>
	// <remarks>
	...
	public MutedInfo_S(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfo_S newObject = (schemaLib.MutedInfo_S)super.clone();

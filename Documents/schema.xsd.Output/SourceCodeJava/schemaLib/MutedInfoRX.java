...
// </summary>
public class MutedInfoRX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoRX
	// </summary>
	// <remarks>
	...
	public MutedInfoRX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoRX newObject = (schemaLib.MutedInfoRX)super.clone();

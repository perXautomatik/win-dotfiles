...
// </summary>
public class MutedInfoCxD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCxD
	// </summary>
	// <remarks>
	...
	public MutedInfoCxD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCxD newObject = (schemaLib.MutedInfoCxD)super.clone();

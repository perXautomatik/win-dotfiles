...
// </summary>
public class MutedInfoB_M extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_M
	// </summary>
	// <remarks>
	...
	public MutedInfoB_M(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_M newObject = (schemaLib.MutedInfoB_M)super.clone();

...
// </summary>
public class MutedInfoVV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoVV
	// </summary>
	// <remarks>
	...
	public MutedInfoVV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoVV newObject = (schemaLib.MutedInfoVV)super.clone();

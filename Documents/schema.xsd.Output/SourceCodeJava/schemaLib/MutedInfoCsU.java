...
// </summary>
public class MutedInfoCsU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCsU
	// </summary>
	// <remarks>
	...
	public MutedInfoCsU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCsU newObject = (schemaLib.MutedInfoCsU)super.clone();

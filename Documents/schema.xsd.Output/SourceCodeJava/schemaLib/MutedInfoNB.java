...
// </summary>
public class MutedInfoNB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoNB
	// </summary>
	// <remarks>
	...
	public MutedInfoNB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoNB newObject = (schemaLib.MutedInfoNB)super.clone();

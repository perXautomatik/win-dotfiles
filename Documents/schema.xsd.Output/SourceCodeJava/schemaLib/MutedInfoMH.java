...
// </summary>
public class MutedInfoMH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoMH
	// </summary>
	// <remarks>
	...
	public MutedInfoMH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoMH newObject = (schemaLib.MutedInfoMH)super.clone();

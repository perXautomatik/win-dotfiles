...
// </summary>
public class MutedInfoB_ZA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_ZA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_ZA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_ZA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_ZA newObject = (schemaLib.MutedInfoB_ZA)super.clone();

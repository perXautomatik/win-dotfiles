...
// </summary>
public class MutedInfoDR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDR
	// </summary>
	// <remarks>
	...
	public MutedInfoDR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDR newObject = (schemaLib.MutedInfoDR)super.clone();

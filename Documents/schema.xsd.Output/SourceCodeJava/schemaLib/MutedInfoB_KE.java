...
// </summary>
public class MutedInfoB_KE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_KE
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_KE() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_KE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_KE newObject = (schemaLib.MutedInfoB_KE)super.clone();

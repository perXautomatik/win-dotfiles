...
// </summary>
public class MutedInfoEJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoEJ
	// </summary>
	// <remarks>
	...
	public MutedInfoEJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoEJ newObject = (schemaLib.MutedInfoEJ)super.clone();

...
// </summary>
public class MutedInfoBhT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBhT
	// </summary>
	// <remarks>
	...
	public MutedInfoBhT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBhT newObject = (schemaLib.MutedInfoBhT)super.clone();

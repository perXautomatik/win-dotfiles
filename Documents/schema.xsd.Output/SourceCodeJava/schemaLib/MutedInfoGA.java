...
// </summary>
public class MutedInfoGA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoGA
	// </summary>
	// <remarks>
	...
	public MutedInfoGA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoGA newObject = (schemaLib.MutedInfoGA)super.clone();

...
// </summary>
public class MutedInfoRK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoRK
	// </summary>
	// <remarks>
	...
	public MutedInfoRK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoRK newObject = (schemaLib.MutedInfoRK)super.clone();

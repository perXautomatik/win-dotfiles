...
// </summary>
public class MutedInfoBeY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBeY
	// </summary>
	// <remarks>
	...
	public MutedInfoBeY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBeY newObject = (schemaLib.MutedInfoBeY)super.clone();

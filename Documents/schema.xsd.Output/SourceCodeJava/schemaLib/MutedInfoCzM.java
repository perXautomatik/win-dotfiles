...
// </summary>
public class MutedInfoCzM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCzM
	// </summary>
	// <remarks>
	...
	public MutedInfoCzM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCzM newObject = (schemaLib.MutedInfoCzM)super.clone();

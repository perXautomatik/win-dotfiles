...
// </summary>
public class MutedInfoC_HA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_HA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_HA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_HA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_HA newObject = (schemaLib.MutedInfoC_HA)super.clone();

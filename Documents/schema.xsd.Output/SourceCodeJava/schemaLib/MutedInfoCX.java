...
// </summary>
public class MutedInfoCX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCX
	// </summary>
	// <remarks>
	...
	public MutedInfoCX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCX newObject = (schemaLib.MutedInfoCX)super.clone();

...
// </summary>
public class MutedInfoWA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoWA
	// </summary>
	// <remarks>
	...
	public MutedInfoWA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoWA newObject = (schemaLib.MutedInfoWA)super.clone();

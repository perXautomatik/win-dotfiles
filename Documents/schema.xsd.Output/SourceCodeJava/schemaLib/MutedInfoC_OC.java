...
// </summary>
public class MutedInfoC_OC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_OC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_OC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_OC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_OC newObject = (schemaLib.MutedInfoC_OC)super.clone();

...
// </summary>
public class MutedInfoCzA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCzA
	// </summary>
	// <remarks>
	...
	public MutedInfoCzA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCzA newObject = (schemaLib.MutedInfoCzA)super.clone();

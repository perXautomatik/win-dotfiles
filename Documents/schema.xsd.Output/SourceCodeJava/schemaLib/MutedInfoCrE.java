...
// </summary>
public class MutedInfoCrE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCrE
	// </summary>
	// <remarks>
	...
	public MutedInfoCrE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCrE newObject = (schemaLib.MutedInfoCrE)super.clone();

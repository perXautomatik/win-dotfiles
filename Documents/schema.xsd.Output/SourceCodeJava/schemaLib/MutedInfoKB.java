...
// </summary>
public class MutedInfoKB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoKB
	// </summary>
	// <remarks>
	...
	public MutedInfoKB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoKB newObject = (schemaLib.MutedInfoKB)super.clone();

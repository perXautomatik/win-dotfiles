...
// </summary>
public class MutedInfoCnH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCnH
	// </summary>
	// <remarks>
	...
	public MutedInfoCnH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCnH newObject = (schemaLib.MutedInfoCnH)super.clone();

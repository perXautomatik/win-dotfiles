...
// </summary>
public class MutedInfoHK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoHK
	// </summary>
	// <remarks>
	...
	public MutedInfoHK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoHK newObject = (schemaLib.MutedInfoHK)super.clone();

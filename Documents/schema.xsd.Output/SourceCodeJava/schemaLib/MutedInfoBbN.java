...
// </summary>
public class MutedInfoBbN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBbN
	// </summary>
	// <remarks>
	...
	public MutedInfoBbN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBbN newObject = (schemaLib.MutedInfoBbN)super.clone();

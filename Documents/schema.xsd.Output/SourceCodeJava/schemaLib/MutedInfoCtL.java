...
// </summary>
public class MutedInfoCtL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCtL
	// </summary>
	// <remarks>
	...
	public MutedInfoCtL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCtL newObject = (schemaLib.MutedInfoCtL)super.clone();

...
// </summary>
public class MutedInfoChN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoChN
	// </summary>
	// <remarks>
	...
	public MutedInfoChN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoChN newObject = (schemaLib.MutedInfoChN)super.clone();

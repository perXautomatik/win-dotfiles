...
// </summary>
public class MutedInfoB_CE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_CE
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_CE() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_CE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_CE newObject = (schemaLib.MutedInfoB_CE)super.clone();

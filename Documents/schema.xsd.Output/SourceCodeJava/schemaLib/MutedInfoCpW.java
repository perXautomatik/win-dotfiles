...
// </summary>
public class MutedInfoCpW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCpW
	// </summary>
	// <remarks>
	...
	public MutedInfoCpW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCpW newObject = (schemaLib.MutedInfoCpW)super.clone();

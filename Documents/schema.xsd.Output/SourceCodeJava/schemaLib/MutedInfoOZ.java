...
// </summary>
public class MutedInfoOZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoOZ
	// </summary>
	// <remarks>
	...
	public MutedInfoOZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoOZ newObject = (schemaLib.MutedInfoOZ)super.clone();

...
// </summary>
public class MutedInfoCrX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCrX
	// </summary>
	// <remarks>
	...
	public MutedInfoCrX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCrX newObject = (schemaLib.MutedInfoCrX)super.clone();

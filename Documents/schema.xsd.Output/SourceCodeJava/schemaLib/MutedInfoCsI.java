...
// </summary>
public class MutedInfoCsI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCsI
	// </summary>
	// <remarks>
	...
	public MutedInfoCsI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCsI newObject = (schemaLib.MutedInfoCsI)super.clone();

...
// </summary>
public class MutedInfoC_MC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_MC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_MC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_MC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_MC newObject = (schemaLib.MutedInfoC_MC)super.clone();

...
// </summary>
public class MutedInfoCvL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCvL
	// </summary>
	// <remarks>
	...
	public MutedInfoCvL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCvL newObject = (schemaLib.MutedInfoCvL)super.clone();

...
// </summary>
public class MutedInfoB_YC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_YC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_YC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_YC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_YC newObject = (schemaLib.MutedInfoB_YC)super.clone();

...
// </summary>
public class MutedInfoCV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCV
	// </summary>
	// <remarks>
	...
	public MutedInfoCV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCV newObject = (schemaLib.MutedInfoCV)super.clone();

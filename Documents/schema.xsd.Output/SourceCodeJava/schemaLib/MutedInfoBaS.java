...
// </summary>
public class MutedInfoBaS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBaS
	// </summary>
	// <remarks>
	...
	public MutedInfoBaS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBaS newObject = (schemaLib.MutedInfoBaS)super.clone();

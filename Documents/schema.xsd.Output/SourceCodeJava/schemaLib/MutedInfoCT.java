...
// </summary>
public class MutedInfoCT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCT
	// </summary>
	// <remarks>
	...
	public MutedInfoCT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCT newObject = (schemaLib.MutedInfoCT)super.clone();

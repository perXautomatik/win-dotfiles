...
// </summary>
public class MutedInfoD‰Z extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoD‰Z
	// </summary>
	// <remarks>
	...
	public MutedInfoD‰Z(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoD‰Z newObject = (schemaLib.MutedInfoD‰Z)super.clone();

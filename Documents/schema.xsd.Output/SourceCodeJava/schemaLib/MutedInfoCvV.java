...
// </summary>
public class MutedInfoCvV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCvV
	// </summary>
	// <remarks>
	...
	public MutedInfoCvV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCvV newObject = (schemaLib.MutedInfoCvV)super.clone();

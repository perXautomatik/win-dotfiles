...
// </summary>
public class MutedInfoCjA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCjA
	// </summary>
	// <remarks>
	...
	public MutedInfoCjA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCjA newObject = (schemaLib.MutedInfoCjA)super.clone();

...
// </summary>
public class MutedInfoWD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoWD
	// </summary>
	// <remarks>
	...
	public MutedInfoWD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoWD newObject = (schemaLib.MutedInfoWD)super.clone();

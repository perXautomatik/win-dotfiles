...
// </summary>
public class MutedInfoCmZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCmZ
	// </summary>
	// <remarks>
	...
	public MutedInfoCmZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCmZ newObject = (schemaLib.MutedInfoCmZ)super.clone();

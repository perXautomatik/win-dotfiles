...
// </summary>
public class MutedInfoCjK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCjK
	// </summary>
	// <remarks>
	...
	public MutedInfoCjK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCjK newObject = (schemaLib.MutedInfoCjK)super.clone();

...
// </summary>
public class MutedInfoPT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoPT
	// </summary>
	// <remarks>
	...
	public MutedInfoPT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoPT newObject = (schemaLib.MutedInfoPT)super.clone();

...
// </summary>
public class MutedInfoHD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoHD
	// </summary>
	// <remarks>
	...
	public MutedInfoHD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoHD newObject = (schemaLib.MutedInfoHD)super.clone();

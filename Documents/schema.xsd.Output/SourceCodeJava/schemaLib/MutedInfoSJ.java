...
// </summary>
public class MutedInfoSJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoSJ
	// </summary>
	// <remarks>
	...
	public MutedInfoSJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoSJ newObject = (schemaLib.MutedInfoSJ)super.clone();

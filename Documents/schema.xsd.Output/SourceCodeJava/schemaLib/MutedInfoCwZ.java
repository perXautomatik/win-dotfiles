...
// </summary>
public class MutedInfoCwZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCwZ
	// </summary>
	// <remarks>
	...
	public MutedInfoCwZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCwZ newObject = (schemaLib.MutedInfoCwZ)super.clone();

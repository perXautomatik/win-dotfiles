...
// </summary>
public class MutedInfoCzS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCzS
	// </summary>
	// <remarks>
	...
	public MutedInfoCzS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCzS newObject = (schemaLib.MutedInfoCzS)super.clone();

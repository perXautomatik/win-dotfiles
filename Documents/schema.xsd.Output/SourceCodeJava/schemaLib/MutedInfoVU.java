...
// </summary>
public class MutedInfoVU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoVU
	// </summary>
	// <remarks>
	...
	public MutedInfoVU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoVU newObject = (schemaLib.MutedInfoVU)super.clone();

...
// </summary>
public class MutedInfoClF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoClF
	// </summary>
	// <remarks>
	...
	public MutedInfoClF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoClF newObject = (schemaLib.MutedInfoClF)super.clone();

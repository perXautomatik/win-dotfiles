...
// </summary>
public class MutedInfoCxS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCxS
	// </summary>
	// <remarks>
	...
	public MutedInfoCxS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCxS newObject = (schemaLib.MutedInfoCxS)super.clone();

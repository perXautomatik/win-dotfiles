...
// </summary>
public class MutedInfoCvC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCvC
	// </summary>
	// <remarks>
	...
	public MutedInfoCvC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCvC newObject = (schemaLib.MutedInfoCvC)super.clone();

...
// </summary>
public class MutedInfoCkR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCkR
	// </summary>
	// <remarks>
	...
	public MutedInfoCkR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCkR newObject = (schemaLib.MutedInfoCkR)super.clone();

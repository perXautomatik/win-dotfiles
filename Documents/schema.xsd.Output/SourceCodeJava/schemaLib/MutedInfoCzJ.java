...
// </summary>
public class MutedInfoCzJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCzJ
	// </summary>
	// <remarks>
	...
	public MutedInfoCzJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCzJ newObject = (schemaLib.MutedInfoCzJ)super.clone();

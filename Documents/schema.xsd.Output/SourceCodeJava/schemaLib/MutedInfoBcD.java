...
// </summary>
public class MutedInfoBcD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBcD
	// </summary>
	// <remarks>
	...
	public MutedInfoBcD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBcD newObject = (schemaLib.MutedInfoBcD)super.clone();

...
// </summary>
public class MutedInfo_ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfo_
	// </summary>
	// <remarks>
	...
	public MutedInfo_(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfo_ newObject = (schemaLib.MutedInfo_)super.clone();

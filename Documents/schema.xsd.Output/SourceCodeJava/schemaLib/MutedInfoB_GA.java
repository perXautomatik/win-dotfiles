...
// </summary>
public class MutedInfoB_GA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_GA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_GA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_GA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_GA newObject = (schemaLib.MutedInfoB_GA)super.clone();

...
// </summary>
public class MutedInfoCkM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCkM
	// </summary>
	// <remarks>
	...
	public MutedInfoCkM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCkM newObject = (schemaLib.MutedInfoCkM)super.clone();

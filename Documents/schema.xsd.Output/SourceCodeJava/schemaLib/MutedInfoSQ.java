...
// </summary>
public class MutedInfoSQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoSQ
	// </summary>
	// <remarks>
	...
	public MutedInfoSQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoSQ newObject = (schemaLib.MutedInfoSQ)super.clone();

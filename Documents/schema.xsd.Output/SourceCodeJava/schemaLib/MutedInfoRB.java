...
// </summary>
public class MutedInfoRB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoRB
	// </summary>
	// <remarks>
	...
	public MutedInfoRB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoRB newObject = (schemaLib.MutedInfoRB)super.clone();

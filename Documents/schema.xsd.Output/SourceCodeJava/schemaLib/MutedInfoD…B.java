...
// </summary>
public class MutedInfoD…B extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoD…B
	// </summary>
	// <remarks>
	...
	public MutedInfoD…B(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoD…B newObject = (schemaLib.MutedInfoD…B)super.clone();

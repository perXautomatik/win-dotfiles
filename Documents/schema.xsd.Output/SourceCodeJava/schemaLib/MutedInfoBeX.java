...
// </summary>
public class MutedInfoBeX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBeX
	// </summary>
	// <remarks>
	...
	public MutedInfoBeX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBeX newObject = (schemaLib.MutedInfoBeX)super.clone();

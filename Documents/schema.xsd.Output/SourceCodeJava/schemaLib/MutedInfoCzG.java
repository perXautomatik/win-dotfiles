...
// </summary>
public class MutedInfoCzG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCzG
	// </summary>
	// <remarks>
	...
	public MutedInfoCzG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCzG newObject = (schemaLib.MutedInfoCzG)super.clone();

...
// </summary>
public class MutedInfoBeJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBeJ
	// </summary>
	// <remarks>
	...
	public MutedInfoBeJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBeJ newObject = (schemaLib.MutedInfoBeJ)super.clone();

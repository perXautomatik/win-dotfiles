...
// </summary>
public class MutedInfoSI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoSI
	// </summary>
	// <remarks>
	...
	public MutedInfoSI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoSI newObject = (schemaLib.MutedInfoSI)super.clone();

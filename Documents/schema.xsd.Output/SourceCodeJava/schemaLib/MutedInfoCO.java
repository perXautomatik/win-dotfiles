...
// </summary>
public class MutedInfoCO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCO
	// </summary>
	// <remarks>
	...
	public MutedInfoCO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCO newObject = (schemaLib.MutedInfoCO)super.clone();

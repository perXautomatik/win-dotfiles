...
// </summary>
public class MutedInfoBdD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBdD
	// </summary>
	// <remarks>
	...
	public MutedInfoBdD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBdD newObject = (schemaLib.MutedInfoBdD)super.clone();

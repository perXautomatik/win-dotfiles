...
// </summary>
public class MutedInfoBdC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBdC
	// </summary>
	// <remarks>
	...
	public MutedInfoBdC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBdC newObject = (schemaLib.MutedInfoBdC)super.clone();

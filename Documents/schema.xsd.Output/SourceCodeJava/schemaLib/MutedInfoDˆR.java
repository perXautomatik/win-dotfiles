...
// </summary>
public class MutedInfoDˆR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDˆR
	// </summary>
	// <remarks>
	...
	public MutedInfoDˆR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDˆR newObject = (schemaLib.MutedInfoDˆR)super.clone();

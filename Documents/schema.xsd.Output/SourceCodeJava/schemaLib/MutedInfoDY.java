...
// </summary>
public class MutedInfoDY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDY
	// </summary>
	// <remarks>
	...
	public MutedInfoDY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDY newObject = (schemaLib.MutedInfoDY)super.clone();

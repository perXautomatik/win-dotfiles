...
// </summary>
public class MutedInfoVN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoVN
	// </summary>
	// <remarks>
	...
	public MutedInfoVN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoVN newObject = (schemaLib.MutedInfoVN)super.clone();

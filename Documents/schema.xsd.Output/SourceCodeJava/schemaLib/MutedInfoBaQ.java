...
// </summary>
public class MutedInfoBaQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBaQ
	// </summary>
	// <remarks>
	...
	public MutedInfoBaQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBaQ newObject = (schemaLib.MutedInfoBaQ)super.clone();

...
// </summary>
public class MutedInfoRF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoRF
	// </summary>
	// <remarks>
	...
	public MutedInfoRF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoRF newObject = (schemaLib.MutedInfoRF)super.clone();

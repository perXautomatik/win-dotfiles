...
// </summary>
public class MutedInfoClW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoClW
	// </summary>
	// <remarks>
	...
	public MutedInfoClW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoClW newObject = (schemaLib.MutedInfoClW)super.clone();

...
// </summary>
public class MutedInfoB_QB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_QB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_QB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_QB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_QB newObject = (schemaLib.MutedInfoB_QB)super.clone();

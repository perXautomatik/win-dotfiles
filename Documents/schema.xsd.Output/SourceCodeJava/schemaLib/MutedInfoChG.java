...
// </summary>
public class MutedInfoChG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoChG
	// </summary>
	// <remarks>
	...
	public MutedInfoChG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoChG newObject = (schemaLib.MutedInfoChG)super.clone();

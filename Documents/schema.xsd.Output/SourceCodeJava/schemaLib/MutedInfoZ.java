...
// </summary>
public class MutedInfoZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoZ
	// </summary>
	// <remarks>
	...
	public MutedInfoZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoZ newObject = (schemaLib.MutedInfoZ)super.clone();

...
// </summary>
public class MutedInfoZI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoZI
	// </summary>
	// <remarks>
	...
	public MutedInfoZI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoZI newObject = (schemaLib.MutedInfoZI)super.clone();

...
// </summary>
public class MutedInfoYT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoYT
	// </summary>
	// <remarks>
	...
	public MutedInfoYT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoYT newObject = (schemaLib.MutedInfoYT)super.clone();

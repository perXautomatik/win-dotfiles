...
// </summary>
public class MutedInfoDˆX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDˆX
	// </summary>
	// <remarks>
	...
	public MutedInfoDˆX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDˆX newObject = (schemaLib.MutedInfoDˆX)super.clone();

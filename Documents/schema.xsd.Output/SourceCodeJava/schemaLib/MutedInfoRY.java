...
// </summary>
public class MutedInfoRY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoRY
	// </summary>
	// <remarks>
	...
	public MutedInfoRY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoRY newObject = (schemaLib.MutedInfoRY)super.clone();

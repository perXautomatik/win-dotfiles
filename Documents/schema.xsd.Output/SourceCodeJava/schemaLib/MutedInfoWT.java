...
// </summary>
public class MutedInfoWT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoWT
	// </summary>
	// <remarks>
	...
	public MutedInfoWT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoWT newObject = (schemaLib.MutedInfoWT)super.clone();

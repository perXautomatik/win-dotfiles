...
// </summary>
public class MutedInfoBeT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBeT
	// </summary>
	// <remarks>
	...
	public MutedInfoBeT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBeT newObject = (schemaLib.MutedInfoBeT)super.clone();

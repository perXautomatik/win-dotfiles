...
// </summary>
public class MutedInfoC‚X extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC‚X
	// </summary>
	// <remarks>
	...
	public MutedInfoC‚X(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC‚X newObject = (schemaLib.MutedInfoC‚X)super.clone();

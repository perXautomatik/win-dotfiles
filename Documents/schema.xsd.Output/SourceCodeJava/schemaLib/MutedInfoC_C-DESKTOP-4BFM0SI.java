...
// </summary>
public class MutedInfoCC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCC
	// </summary>
	// <remarks>
	...
	public MutedInfoCC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCC newObject = (schemaLib.MutedInfoCC)super.clone();

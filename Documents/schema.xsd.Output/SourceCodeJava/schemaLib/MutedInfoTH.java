...
// </summary>
public class MutedInfoTH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoTH
	// </summary>
	// <remarks>
	...
	public MutedInfoTH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoTH newObject = (schemaLib.MutedInfoTH)super.clone();

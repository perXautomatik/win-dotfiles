...
// </summary>
public class MutedInfoLU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoLU
	// </summary>
	// <remarks>
	...
	public MutedInfoLU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoLU newObject = (schemaLib.MutedInfoLU)super.clone();

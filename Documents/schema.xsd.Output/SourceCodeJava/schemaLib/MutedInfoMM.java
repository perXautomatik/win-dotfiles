...
// </summary>
public class MutedInfoMM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoMM
	// </summary>
	// <remarks>
	...
	public MutedInfoMM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoMM newObject = (schemaLib.MutedInfoMM)super.clone();

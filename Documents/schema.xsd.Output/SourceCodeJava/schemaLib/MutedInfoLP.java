...
// </summary>
public class MutedInfoLP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoLP
	// </summary>
	// <remarks>
	...
	public MutedInfoLP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoLP newObject = (schemaLib.MutedInfoLP)super.clone();

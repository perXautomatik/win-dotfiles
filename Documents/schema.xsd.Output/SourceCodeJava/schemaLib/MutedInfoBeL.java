...
// </summary>
public class MutedInfoBeL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBeL
	// </summary>
	// <remarks>
	...
	public MutedInfoBeL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBeL newObject = (schemaLib.MutedInfoBeL)super.clone();

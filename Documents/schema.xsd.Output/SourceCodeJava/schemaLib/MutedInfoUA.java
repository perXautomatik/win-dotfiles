...
// </summary>
public class MutedInfoUA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoUA
	// </summary>
	// <remarks>
	...
	public MutedInfoUA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoUA newObject = (schemaLib.MutedInfoUA)super.clone();

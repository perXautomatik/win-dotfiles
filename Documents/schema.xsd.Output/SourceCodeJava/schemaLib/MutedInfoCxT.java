...
// </summary>
public class MutedInfoCxT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCxT
	// </summary>
	// <remarks>
	...
	public MutedInfoCxT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCxT newObject = (schemaLib.MutedInfoCxT)super.clone();

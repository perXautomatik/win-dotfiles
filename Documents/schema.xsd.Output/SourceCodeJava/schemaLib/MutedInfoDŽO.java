...
// </summary>
public class MutedInfoDŽO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŽO
	// </summary>
	// <remarks>
	...
	public MutedInfoDŽO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŽO newObject = (schemaLib.MutedInfoDŽO)super.clone();

...
// </summary>
public class MutedInfoFG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoFG
	// </summary>
	// <remarks>
	...
	public MutedInfoFG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoFG newObject = (schemaLib.MutedInfoFG)super.clone();

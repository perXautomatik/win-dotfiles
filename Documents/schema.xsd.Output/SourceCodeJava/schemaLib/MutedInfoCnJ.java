...
// </summary>
public class MutedInfoCnJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCnJ
	// </summary>
	// <remarks>
	...
	public MutedInfoCnJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCnJ newObject = (schemaLib.MutedInfoCnJ)super.clone();

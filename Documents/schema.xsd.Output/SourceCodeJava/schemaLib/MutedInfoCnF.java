...
// </summary>
public class MutedInfoCnF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCnF
	// </summary>
	// <remarks>
	...
	public MutedInfoCnF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCnF newObject = (schemaLib.MutedInfoCnF)super.clone();

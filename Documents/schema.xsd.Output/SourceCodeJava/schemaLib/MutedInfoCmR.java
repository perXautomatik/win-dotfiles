...
// </summary>
public class MutedInfoCmR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCmR
	// </summary>
	// <remarks>
	...
	public MutedInfoCmR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCmR newObject = (schemaLib.MutedInfoCmR)super.clone();

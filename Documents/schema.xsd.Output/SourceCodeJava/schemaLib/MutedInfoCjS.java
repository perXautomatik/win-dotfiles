...
// </summary>
public class MutedInfoCjS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCjS
	// </summary>
	// <remarks>
	...
	public MutedInfoCjS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCjS newObject = (schemaLib.MutedInfoCjS)super.clone();

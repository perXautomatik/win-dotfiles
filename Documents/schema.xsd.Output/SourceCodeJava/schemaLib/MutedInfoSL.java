...
// </summary>
public class MutedInfoSL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoSL
	// </summary>
	// <remarks>
	...
	public MutedInfoSL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoSL newObject = (schemaLib.MutedInfoSL)super.clone();

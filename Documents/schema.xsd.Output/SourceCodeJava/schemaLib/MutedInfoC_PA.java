...
// </summary>
public class MutedInfoC_PA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_PA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_PA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_PA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_PA newObject = (schemaLib.MutedInfoC_PA)super.clone();

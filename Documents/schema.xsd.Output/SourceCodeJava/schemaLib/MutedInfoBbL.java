...
// </summary>
public class MutedInfoBbL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBbL
	// </summary>
	// <remarks>
	...
	public MutedInfoBbL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBbL newObject = (schemaLib.MutedInfoBbL)super.clone();

...
// </summary>
public class MutedInfoCwQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCwQ
	// </summary>
	// <remarks>
	...
	public MutedInfoCwQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCwQ newObject = (schemaLib.MutedInfoCwQ)super.clone();

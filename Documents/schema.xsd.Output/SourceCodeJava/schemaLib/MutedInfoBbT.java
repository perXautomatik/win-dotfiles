...
// </summary>
public class MutedInfoBbT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBbT
	// </summary>
	// <remarks>
	...
	public MutedInfoBbT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBbT newObject = (schemaLib.MutedInfoBbT)super.clone();

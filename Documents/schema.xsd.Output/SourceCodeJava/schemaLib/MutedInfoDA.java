...
// </summary>
public class MutedInfoDA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDA
	// </summary>
	// <remarks>
	...
	public MutedInfoDA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDA newObject = (schemaLib.MutedInfoDA)super.clone();

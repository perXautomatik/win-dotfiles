...
// </summary>
public class MutedInfoBdO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBdO
	// </summary>
	// <remarks>
	...
	public MutedInfoBdO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBdO newObject = (schemaLib.MutedInfoBdO)super.clone();

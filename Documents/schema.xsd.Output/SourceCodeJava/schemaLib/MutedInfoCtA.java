...
// </summary>
public class MutedInfoCtA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCtA
	// </summary>
	// <remarks>
	...
	public MutedInfoCtA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCtA newObject = (schemaLib.MutedInfoCtA)super.clone();

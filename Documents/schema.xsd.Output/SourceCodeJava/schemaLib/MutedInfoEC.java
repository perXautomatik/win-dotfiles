...
// </summary>
public class MutedInfoEC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoEC
	// </summary>
	// <remarks>
	...
	public MutedInfoEC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoEC newObject = (schemaLib.MutedInfoEC)super.clone();

...
// </summary>
public class MutedInfoU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoU
	// </summary>
	// <remarks>
	...
	public MutedInfoU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoU newObject = (schemaLib.MutedInfoU)super.clone();

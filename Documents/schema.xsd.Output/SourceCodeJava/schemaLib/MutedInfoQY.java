...
// </summary>
public class MutedInfoQY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoQY
	// </summary>
	// <remarks>
	...
	public MutedInfoQY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoQY newObject = (schemaLib.MutedInfoQY)super.clone();

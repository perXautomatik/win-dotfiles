...
// </summary>
public class MutedInfoB_PC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_PC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_PC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_PC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_PC newObject = (schemaLib.MutedInfoB_PC)super.clone();

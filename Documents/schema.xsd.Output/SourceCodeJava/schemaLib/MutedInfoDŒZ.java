...
// </summary>
public class MutedInfoDŒZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŒZ
	// </summary>
	// <remarks>
	...
	public MutedInfoDŒZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŒZ newObject = (schemaLib.MutedInfoDŒZ)super.clone();

...
// </summary>
public class MutedInfoCjH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCjH
	// </summary>
	// <remarks>
	...
	public MutedInfoCjH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCjH newObject = (schemaLib.MutedInfoCjH)super.clone();

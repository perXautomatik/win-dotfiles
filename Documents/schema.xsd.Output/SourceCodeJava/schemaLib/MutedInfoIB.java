...
// </summary>
public class MutedInfoIB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoIB
	// </summary>
	// <remarks>
	...
	public MutedInfoIB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoIB newObject = (schemaLib.MutedInfoIB)super.clone();

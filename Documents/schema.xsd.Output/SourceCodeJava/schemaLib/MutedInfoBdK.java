...
// </summary>
public class MutedInfoBdK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBdK
	// </summary>
	// <remarks>
	...
	public MutedInfoBdK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBdK newObject = (schemaLib.MutedInfoBdK)super.clone();

...
// </summary>
public class MutedInfoQI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoQI
	// </summary>
	// <remarks>
	...
	public MutedInfoQI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoQI newObject = (schemaLib.MutedInfoQI)super.clone();

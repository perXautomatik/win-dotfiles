...
// </summary>
public class MutedInfoOL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoOL
	// </summary>
	// <remarks>
	...
	public MutedInfoOL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoOL newObject = (schemaLib.MutedInfoOL)super.clone();

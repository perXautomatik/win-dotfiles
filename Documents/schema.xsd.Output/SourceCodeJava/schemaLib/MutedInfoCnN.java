...
// </summary>
public class MutedInfoCnN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCnN
	// </summary>
	// <remarks>
	...
	public MutedInfoCnN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCnN newObject = (schemaLib.MutedInfoCnN)super.clone();

...
// </summary>
public class MutedInfoB_JC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_JC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_JC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_JC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_JC newObject = (schemaLib.MutedInfoB_JC)super.clone();

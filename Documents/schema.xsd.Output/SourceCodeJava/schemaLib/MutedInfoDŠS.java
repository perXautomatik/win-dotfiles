...
// </summary>
public class MutedInfoDŠS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŠS
	// </summary>
	// <remarks>
	...
	public MutedInfoDŠS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŠS newObject = (schemaLib.MutedInfoDŠS)super.clone();

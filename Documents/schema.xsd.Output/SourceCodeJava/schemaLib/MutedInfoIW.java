...
// </summary>
public class MutedInfoIW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoIW
	// </summary>
	// <remarks>
	...
	public MutedInfoIW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoIW newObject = (schemaLib.MutedInfoIW)super.clone();

...
// </summary>
public class MutedInfoC_MB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_MB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_MB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_MB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_MB newObject = (schemaLib.MutedInfoC_MB)super.clone();

...
// </summary>
public class MutedInfoMW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoMW
	// </summary>
	// <remarks>
	...
	public MutedInfoMW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoMW newObject = (schemaLib.MutedInfoMW)super.clone();

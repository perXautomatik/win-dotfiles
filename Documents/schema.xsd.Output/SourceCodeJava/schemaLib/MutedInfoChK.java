...
// </summary>
public class MutedInfoChK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoChK
	// </summary>
	// <remarks>
	...
	public MutedInfoChK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoChK newObject = (schemaLib.MutedInfoChK)super.clone();

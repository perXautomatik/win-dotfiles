...
// </summary>
public class MutedInfoBfM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBfM
	// </summary>
	// <remarks>
	...
	public MutedInfoBfM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBfM newObject = (schemaLib.MutedInfoBfM)super.clone();

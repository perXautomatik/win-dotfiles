...
// </summary>
public class MutedInfoC_L extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_L
	// </summary>
	// <remarks>
	...
	public MutedInfoC_L(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_L newObject = (schemaLib.MutedInfoC_L)super.clone();

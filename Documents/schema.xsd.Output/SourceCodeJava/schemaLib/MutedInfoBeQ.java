...
// </summary>
public class MutedInfoBeQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBeQ
	// </summary>
	// <remarks>
	...
	public MutedInfoBeQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBeQ newObject = (schemaLib.MutedInfoBeQ)super.clone();

...
// </summary>
public class MutedInfoBB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBB
	// </summary>
	// <remarks>
	...
	public MutedInfoBB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBB newObject = (schemaLib.MutedInfoBB)super.clone();

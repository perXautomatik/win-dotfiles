...
// </summary>
public class MutedInfoCkV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCkV
	// </summary>
	// <remarks>
	...
	public MutedInfoCkV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCkV newObject = (schemaLib.MutedInfoCkV)super.clone();

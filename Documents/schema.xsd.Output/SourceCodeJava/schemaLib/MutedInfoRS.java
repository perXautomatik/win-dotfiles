...
// </summary>
public class MutedInfoRS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoRS
	// </summary>
	// <remarks>
	...
	public MutedInfoRS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoRS newObject = (schemaLib.MutedInfoRS)super.clone();

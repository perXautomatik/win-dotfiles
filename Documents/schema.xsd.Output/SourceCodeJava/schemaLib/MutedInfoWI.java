...
// </summary>
public class MutedInfoWI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoWI
	// </summary>
	// <remarks>
	...
	public MutedInfoWI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoWI newObject = (schemaLib.MutedInfoWI)super.clone();

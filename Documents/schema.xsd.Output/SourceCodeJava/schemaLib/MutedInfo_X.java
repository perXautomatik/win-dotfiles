...
// </summary>
public class MutedInfo_X extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfo_X
	// </summary>
	// <remarks>
	...
	public MutedInfo_X(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfo_X newObject = (schemaLib.MutedInfo_X)super.clone();

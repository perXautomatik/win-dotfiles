...
// </summary>
public class MutedInfoQC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoQC
	// </summary>
	// <remarks>
	...
	public MutedInfoQC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoQC newObject = (schemaLib.MutedInfoQC)super.clone();

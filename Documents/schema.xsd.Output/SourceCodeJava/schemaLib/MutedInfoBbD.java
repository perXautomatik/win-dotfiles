...
// </summary>
public class MutedInfoBbD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBbD
	// </summary>
	// <remarks>
	...
	public MutedInfoBbD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBbD newObject = (schemaLib.MutedInfoBbD)super.clone();

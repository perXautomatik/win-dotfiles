...
// </summary>
public class MutedInfoCvJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCvJ
	// </summary>
	// <remarks>
	...
	public MutedInfoCvJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCvJ newObject = (schemaLib.MutedInfoCvJ)super.clone();

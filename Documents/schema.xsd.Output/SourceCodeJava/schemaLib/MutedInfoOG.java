...
// </summary>
public class MutedInfoOG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoOG
	// </summary>
	// <remarks>
	...
	public MutedInfoOG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoOG newObject = (schemaLib.MutedInfoOG)super.clone();

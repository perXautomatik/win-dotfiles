...
// </summary>
public class MutedInfoMB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoMB
	// </summary>
	// <remarks>
	...
	public MutedInfoMB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoMB newObject = (schemaLib.MutedInfoMB)super.clone();

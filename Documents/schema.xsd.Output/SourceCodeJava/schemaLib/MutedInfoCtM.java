...
// </summary>
public class MutedInfoCtM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCtM
	// </summary>
	// <remarks>
	...
	public MutedInfoCtM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCtM newObject = (schemaLib.MutedInfoCtM)super.clone();

...
// </summary>
public class MutedInfoMU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoMU
	// </summary>
	// <remarks>
	...
	public MutedInfoMU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoMU newObject = (schemaLib.MutedInfoMU)super.clone();

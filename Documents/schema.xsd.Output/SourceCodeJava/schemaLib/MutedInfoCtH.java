...
// </summary>
public class MutedInfoCtH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCtH
	// </summary>
	// <remarks>
	...
	public MutedInfoCtH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCtH newObject = (schemaLib.MutedInfoCtH)super.clone();

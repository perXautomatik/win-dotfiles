...
// </summary>
public class MutedInfoDŽP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŽP
	// </summary>
	// <remarks>
	...
	public MutedInfoDŽP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŽP newObject = (schemaLib.MutedInfoDŽP)super.clone();

...
// </summary>
public class MutedInfoX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoX
	// </summary>
	// <remarks>
	...
	public MutedInfoX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoX newObject = (schemaLib.MutedInfoX)super.clone();

...
// </summary>
public class MutedInfoCwL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCwL
	// </summary>
	// <remarks>
	...
	public MutedInfoCwL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCwL newObject = (schemaLib.MutedInfoCwL)super.clone();

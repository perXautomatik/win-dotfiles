...
// </summary>
public class MutedInfoCkQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCkQ
	// </summary>
	// <remarks>
	...
	public MutedInfoCkQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCkQ newObject = (schemaLib.MutedInfoCkQ)super.clone();

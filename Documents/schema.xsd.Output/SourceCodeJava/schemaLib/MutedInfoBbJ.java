...
// </summary>
public class MutedInfoBbJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBbJ
	// </summary>
	// <remarks>
	...
	public MutedInfoBbJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBbJ newObject = (schemaLib.MutedInfoBbJ)super.clone();

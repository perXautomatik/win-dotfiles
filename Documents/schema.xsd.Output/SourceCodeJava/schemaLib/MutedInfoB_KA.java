...
// </summary>
public class MutedInfoB_KA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_KA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_KA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_KA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_KA newObject = (schemaLib.MutedInfoB_KA)super.clone();

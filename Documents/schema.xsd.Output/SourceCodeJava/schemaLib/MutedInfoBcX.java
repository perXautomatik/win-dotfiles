...
// </summary>
public class MutedInfoBcX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBcX
	// </summary>
	// <remarks>
	...
	public MutedInfoBcX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBcX newObject = (schemaLib.MutedInfoBcX)super.clone();

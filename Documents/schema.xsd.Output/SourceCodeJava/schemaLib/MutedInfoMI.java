...
// </summary>
public class MutedInfoMI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoMI
	// </summary>
	// <remarks>
	...
	public MutedInfoMI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoMI newObject = (schemaLib.MutedInfoMI)super.clone();

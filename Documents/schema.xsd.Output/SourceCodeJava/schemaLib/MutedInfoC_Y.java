...
// </summary>
public class MutedInfoC_Y extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_Y
	// </summary>
	// <remarks>
	...
	public MutedInfoC_Y(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_Y newObject = (schemaLib.MutedInfoC_Y)super.clone();

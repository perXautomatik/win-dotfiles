...
// </summary>
public class MutedInfoTP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoTP
	// </summary>
	// <remarks>
	...
	public MutedInfoTP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoTP newObject = (schemaLib.MutedInfoTP)super.clone();

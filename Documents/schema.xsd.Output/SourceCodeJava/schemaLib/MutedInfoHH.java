...
// </summary>
public class MutedInfoHH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoHH
	// </summary>
	// <remarks>
	...
	public MutedInfoHH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoHH newObject = (schemaLib.MutedInfoHH)super.clone();

...
// </summary>
public class MutedInfoZM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoZM
	// </summary>
	// <remarks>
	...
	public MutedInfoZM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoZM newObject = (schemaLib.MutedInfoZM)super.clone();

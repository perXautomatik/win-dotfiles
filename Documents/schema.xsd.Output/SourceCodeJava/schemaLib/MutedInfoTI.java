...
// </summary>
public class MutedInfoTI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoTI
	// </summary>
	// <remarks>
	...
	public MutedInfoTI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoTI newObject = (schemaLib.MutedInfoTI)super.clone();

...
// </summary>
public class MutedInfoGF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoGF
	// </summary>
	// <remarks>
	...
	public MutedInfoGF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoGF newObject = (schemaLib.MutedInfoGF)super.clone();

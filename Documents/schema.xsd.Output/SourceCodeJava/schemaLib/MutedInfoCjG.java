...
// </summary>
public class MutedInfoCjG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCjG
	// </summary>
	// <remarks>
	...
	public MutedInfoCjG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCjG newObject = (schemaLib.MutedInfoCjG)super.clone();

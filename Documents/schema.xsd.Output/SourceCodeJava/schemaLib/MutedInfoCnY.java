...
// </summary>
public class MutedInfoCnY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCnY
	// </summary>
	// <remarks>
	...
	public MutedInfoCnY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCnY newObject = (schemaLib.MutedInfoCnY)super.clone();

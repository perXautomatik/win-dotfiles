...
// </summary>
public class MutedInfoHP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoHP
	// </summary>
	// <remarks>
	...
	public MutedInfoHP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoHP newObject = (schemaLib.MutedInfoHP)super.clone();

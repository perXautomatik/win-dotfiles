...
// </summary>
public class MutedInfoB_NA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_NA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_NA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_NA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_NA newObject = (schemaLib.MutedInfoB_NA)super.clone();

...
// </summary>
public class MutedInfoKT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoKT
	// </summary>
	// <remarks>
	...
	public MutedInfoKT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoKT newObject = (schemaLib.MutedInfoKT)super.clone();

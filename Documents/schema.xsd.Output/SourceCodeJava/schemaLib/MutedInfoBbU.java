...
// </summary>
public class MutedInfoBbU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBbU
	// </summary>
	// <remarks>
	...
	public MutedInfoBbU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBbU newObject = (schemaLib.MutedInfoBbU)super.clone();

...
// </summary>
public class MutedInfoTA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoTA
	// </summary>
	// <remarks>
	...
	public MutedInfoTA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoTA newObject = (schemaLib.MutedInfoTA)super.clone();

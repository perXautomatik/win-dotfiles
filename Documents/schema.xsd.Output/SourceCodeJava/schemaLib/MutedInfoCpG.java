...
// </summary>
public class MutedInfoCpG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCpG
	// </summary>
	// <remarks>
	...
	public MutedInfoCpG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCpG newObject = (schemaLib.MutedInfoCpG)super.clone();

...
// </summary>
public class MutedInfoBgW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBgW
	// </summary>
	// <remarks>
	...
	public MutedInfoBgW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBgW newObject = (schemaLib.MutedInfoBgW)super.clone();

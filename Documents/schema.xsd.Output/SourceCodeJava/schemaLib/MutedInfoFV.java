...
// </summary>
public class MutedInfoFV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoFV
	// </summary>
	// <remarks>
	...
	public MutedInfoFV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoFV newObject = (schemaLib.MutedInfoFV)super.clone();

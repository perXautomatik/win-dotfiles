...
// </summary>
public class MutedInfoBaB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBaB
	// </summary>
	// <remarks>
	...
	public MutedInfoBaB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBaB newObject = (schemaLib.MutedInfoBaB)super.clone();

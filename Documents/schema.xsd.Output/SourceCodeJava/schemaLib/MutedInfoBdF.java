...
// </summary>
public class MutedInfoBdF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBdF
	// </summary>
	// <remarks>
	...
	public MutedInfoBdF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBdF newObject = (schemaLib.MutedInfoBdF)super.clone();

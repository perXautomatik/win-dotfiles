...
// </summary>
public class MutedInfoCqG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCqG
	// </summary>
	// <remarks>
	...
	public MutedInfoCqG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCqG newObject = (schemaLib.MutedInfoCqG)super.clone();

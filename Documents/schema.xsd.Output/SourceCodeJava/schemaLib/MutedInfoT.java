...
// </summary>
public class MutedInfoT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoT
	// </summary>
	// <remarks>
	...
	public MutedInfoT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoT newObject = (schemaLib.MutedInfoT)super.clone();

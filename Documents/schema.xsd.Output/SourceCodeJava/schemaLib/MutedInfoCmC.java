...
// </summary>
public class MutedInfoCmC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCmC
	// </summary>
	// <remarks>
	...
	public MutedInfoCmC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCmC newObject = (schemaLib.MutedInfoCmC)super.clone();

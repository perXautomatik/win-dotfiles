...
// </summary>
public class MutedInfoF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoF
	// </summary>
	// <remarks>
	...
	public MutedInfoF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoF newObject = (schemaLib.MutedInfoF)super.clone();

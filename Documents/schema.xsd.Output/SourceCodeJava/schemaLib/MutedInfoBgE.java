...
// </summary>
public class MutedInfoBgE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBgE
	// </summary>
	// <remarks>
	...
	public MutedInfoBgE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBgE newObject = (schemaLib.MutedInfoBgE)super.clone();

...
// </summary>
public class MutedInfoRD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoRD
	// </summary>
	// <remarks>
	...
	public MutedInfoRD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoRD newObject = (schemaLib.MutedInfoRD)super.clone();

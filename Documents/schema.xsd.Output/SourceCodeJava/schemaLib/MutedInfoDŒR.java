...
// </summary>
public class MutedInfoDŒR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŒR
	// </summary>
	// <remarks>
	...
	public MutedInfoDŒR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŒR newObject = (schemaLib.MutedInfoDŒR)super.clone();

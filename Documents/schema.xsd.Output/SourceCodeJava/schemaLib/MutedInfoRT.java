...
// </summary>
public class MutedInfoRT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoRT
	// </summary>
	// <remarks>
	...
	public MutedInfoRT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoRT newObject = (schemaLib.MutedInfoRT)super.clone();

...
// </summary>
public class MutedInfoCC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCC
	// </summary>
	// <remarks>
	...
	public MutedInfoCC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCC newObject = (schemaLib.MutedInfoCC)super.clone();

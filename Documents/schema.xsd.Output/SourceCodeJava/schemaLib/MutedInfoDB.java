...
// </summary>
public class MutedInfoDB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDB
	// </summary>
	// <remarks>
	...
	public MutedInfoDB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDB newObject = (schemaLib.MutedInfoDB)super.clone();

...
// </summary>
public class MutedInfoBfJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBfJ
	// </summary>
	// <remarks>
	...
	public MutedInfoBfJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBfJ newObject = (schemaLib.MutedInfoBfJ)super.clone();

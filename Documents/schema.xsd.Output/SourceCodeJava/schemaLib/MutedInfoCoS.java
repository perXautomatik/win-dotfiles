...
// </summary>
public class MutedInfoCoS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCoS
	// </summary>
	// <remarks>
	...
	public MutedInfoCoS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCoS newObject = (schemaLib.MutedInfoCoS)super.clone();

...
// </summary>
public class MutedInfoNF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoNF
	// </summary>
	// <remarks>
	...
	public MutedInfoNF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoNF newObject = (schemaLib.MutedInfoNF)super.clone();

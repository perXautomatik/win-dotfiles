...
// </summary>
public class MutedInfoCyZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCyZ
	// </summary>
	// <remarks>
	...
	public MutedInfoCyZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCyZ newObject = (schemaLib.MutedInfoCyZ)super.clone();

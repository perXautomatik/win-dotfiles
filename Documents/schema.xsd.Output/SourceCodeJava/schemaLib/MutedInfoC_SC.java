...
// </summary>
public class MutedInfoC_SC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_SC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_SC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_SC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_SC newObject = (schemaLib.MutedInfoC_SC)super.clone();

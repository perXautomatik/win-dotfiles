...
// </summary>
public class MutedInfoCrK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCrK
	// </summary>
	// <remarks>
	...
	public MutedInfoCrK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCrK newObject = (schemaLib.MutedInfoCrK)super.clone();

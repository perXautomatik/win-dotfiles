...
// </summary>
public class MutedInfoNL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoNL
	// </summary>
	// <remarks>
	...
	public MutedInfoNL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoNL newObject = (schemaLib.MutedInfoNL)super.clone();

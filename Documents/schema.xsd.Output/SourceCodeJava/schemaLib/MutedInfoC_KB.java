...
// </summary>
public class MutedInfoC_KB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_KB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_KB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_KB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_KB newObject = (schemaLib.MutedInfoC_KB)super.clone();

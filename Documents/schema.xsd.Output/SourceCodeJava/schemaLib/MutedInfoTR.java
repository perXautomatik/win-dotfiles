...
// </summary>
public class MutedInfoTR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoTR
	// </summary>
	// <remarks>
	...
	public MutedInfoTR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoTR newObject = (schemaLib.MutedInfoTR)super.clone();

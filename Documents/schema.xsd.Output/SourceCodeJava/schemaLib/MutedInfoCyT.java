...
// </summary>
public class MutedInfoCyT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCyT
	// </summary>
	// <remarks>
	...
	public MutedInfoCyT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCyT newObject = (schemaLib.MutedInfoCyT)super.clone();

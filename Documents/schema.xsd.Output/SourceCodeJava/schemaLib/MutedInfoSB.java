...
// </summary>
public class MutedInfoSB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoSB
	// </summary>
	// <remarks>
	...
	public MutedInfoSB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoSB newObject = (schemaLib.MutedInfoSB)super.clone();

...
// </summary>
public class MutedInfoLB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoLB
	// </summary>
	// <remarks>
	...
	public MutedInfoLB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoLB newObject = (schemaLib.MutedInfoLB)super.clone();

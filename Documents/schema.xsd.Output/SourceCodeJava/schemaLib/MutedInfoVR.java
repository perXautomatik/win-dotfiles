...
// </summary>
public class MutedInfoVR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoVR
	// </summary>
	// <remarks>
	...
	public MutedInfoVR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoVR newObject = (schemaLib.MutedInfoVR)super.clone();

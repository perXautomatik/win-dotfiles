...
// </summary>
public class MutedInfoPD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoPD
	// </summary>
	// <remarks>
	...
	public MutedInfoPD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoPD newObject = (schemaLib.MutedInfoPD)super.clone();

...
// </summary>
public class MutedInfoTD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoTD
	// </summary>
	// <remarks>
	...
	public MutedInfoTD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoTD newObject = (schemaLib.MutedInfoTD)super.clone();

...
// </summary>
public class MutedInfoNW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoNW
	// </summary>
	// <remarks>
	...
	public MutedInfoNW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoNW newObject = (schemaLib.MutedInfoNW)super.clone();

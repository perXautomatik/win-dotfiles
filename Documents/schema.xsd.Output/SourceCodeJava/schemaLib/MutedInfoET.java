...
// </summary>
public class MutedInfoET extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoET
	// </summary>
	// <remarks>
	...
	public MutedInfoET(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoET newObject = (schemaLib.MutedInfoET)super.clone();

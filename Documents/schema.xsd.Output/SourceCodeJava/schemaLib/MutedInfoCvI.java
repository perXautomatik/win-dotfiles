...
// </summary>
public class MutedInfoCvI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCvI
	// </summary>
	// <remarks>
	...
	public MutedInfoCvI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCvI newObject = (schemaLib.MutedInfoCvI)super.clone();

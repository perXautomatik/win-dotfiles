...
// </summary>
public class MutedInfoYF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoYF
	// </summary>
	// <remarks>
	...
	public MutedInfoYF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoYF newObject = (schemaLib.MutedInfoYF)super.clone();

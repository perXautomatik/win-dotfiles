...
// </summary>
public class MutedInfoCvO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCvO
	// </summary>
	// <remarks>
	...
	public MutedInfoCvO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCvO newObject = (schemaLib.MutedInfoCvO)super.clone();

...
// </summary>
public class MutedInfoBgY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBgY
	// </summary>
	// <remarks>
	...
	public MutedInfoBgY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBgY newObject = (schemaLib.MutedInfoBgY)super.clone();

...
// </summary>
public class MutedInfoB_WD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_WD
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_WD() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_WD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_WD newObject = (schemaLib.MutedInfoB_WD)super.clone();

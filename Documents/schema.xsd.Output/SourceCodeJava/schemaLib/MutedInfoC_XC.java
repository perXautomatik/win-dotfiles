...
// </summary>
public class MutedInfoC_XC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_XC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_XC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_XC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_XC newObject = (schemaLib.MutedInfoC_XC)super.clone();

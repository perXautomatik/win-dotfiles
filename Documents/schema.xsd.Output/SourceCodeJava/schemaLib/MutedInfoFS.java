...
// </summary>
public class MutedInfoFS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoFS
	// </summary>
	// <remarks>
	...
	public MutedInfoFS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoFS newObject = (schemaLib.MutedInfoFS)super.clone();

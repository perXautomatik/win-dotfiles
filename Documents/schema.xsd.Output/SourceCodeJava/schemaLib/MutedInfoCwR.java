...
// </summary>
public class MutedInfoCwR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCwR
	// </summary>
	// <remarks>
	...
	public MutedInfoCwR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCwR newObject = (schemaLib.MutedInfoCwR)super.clone();

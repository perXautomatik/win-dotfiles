...
// </summary>
public class MutedInfoCvN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCvN
	// </summary>
	// <remarks>
	...
	public MutedInfoCvN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCvN newObject = (schemaLib.MutedInfoCvN)super.clone();

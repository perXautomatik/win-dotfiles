...
// </summary>
public class MutedInfoB_SA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_SA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_SA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_SA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_SA newObject = (schemaLib.MutedInfoB_SA)super.clone();

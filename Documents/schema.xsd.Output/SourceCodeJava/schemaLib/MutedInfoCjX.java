...
// </summary>
public class MutedInfoCjX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCjX
	// </summary>
	// <remarks>
	...
	public MutedInfoCjX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCjX newObject = (schemaLib.MutedInfoCjX)super.clone();

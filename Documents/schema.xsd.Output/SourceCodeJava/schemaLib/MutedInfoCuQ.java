...
// </summary>
public class MutedInfoCuQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCuQ
	// </summary>
	// <remarks>
	...
	public MutedInfoCuQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCuQ newObject = (schemaLib.MutedInfoCuQ)super.clone();

...
// </summary>
public class MutedInfoC_AC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_AC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_AC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_AC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_AC newObject = (schemaLib.MutedInfoC_AC)super.clone();

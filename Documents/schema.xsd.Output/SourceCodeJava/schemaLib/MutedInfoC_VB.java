...
// </summary>
public class MutedInfoC_VB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_VB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_VB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_VB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_VB newObject = (schemaLib.MutedInfoC_VB)super.clone();

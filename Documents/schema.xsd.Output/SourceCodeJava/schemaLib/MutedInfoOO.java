...
// </summary>
public class MutedInfoOO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoOO
	// </summary>
	// <remarks>
	...
	public MutedInfoOO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoOO newObject = (schemaLib.MutedInfoOO)super.clone();

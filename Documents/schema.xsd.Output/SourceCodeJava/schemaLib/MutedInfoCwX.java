...
// </summary>
public class MutedInfoCwX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCwX
	// </summary>
	// <remarks>
	...
	public MutedInfoCwX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCwX newObject = (schemaLib.MutedInfoCwX)super.clone();

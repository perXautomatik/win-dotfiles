...
// </summary>
public class MutedInfoCkF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCkF
	// </summary>
	// <remarks>
	...
	public MutedInfoCkF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCkF newObject = (schemaLib.MutedInfoCkF)super.clone();

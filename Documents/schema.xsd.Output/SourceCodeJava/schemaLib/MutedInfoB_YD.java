...
// </summary>
public class MutedInfoB_YD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_YD
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_YD() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_YD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_YD newObject = (schemaLib.MutedInfoB_YD)super.clone();

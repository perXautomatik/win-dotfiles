...
// </summary>
public class MutedInfoBaW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBaW
	// </summary>
	// <remarks>
	...
	public MutedInfoBaW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBaW newObject = (schemaLib.MutedInfoBaW)super.clone();

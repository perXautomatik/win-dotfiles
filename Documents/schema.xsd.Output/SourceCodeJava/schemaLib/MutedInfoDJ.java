...
// </summary>
public class MutedInfoDJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDJ
	// </summary>
	// <remarks>
	...
	public MutedInfoDJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDJ newObject = (schemaLib.MutedInfoDJ)super.clone();

...
// </summary>
public class MutedInfoB_B extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_B
	// </summary>
	// <remarks>
	...
	public MutedInfoB_B(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_B newObject = (schemaLib.MutedInfoB_B)super.clone();

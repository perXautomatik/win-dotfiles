...
// </summary>
public class MutedInfoB_VC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_VC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_VC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_VC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_VC newObject = (schemaLib.MutedInfoB_VC)super.clone();

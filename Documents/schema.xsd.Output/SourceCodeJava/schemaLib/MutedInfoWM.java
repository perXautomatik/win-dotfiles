...
// </summary>
public class MutedInfoWM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoWM
	// </summary>
	// <remarks>
	...
	public MutedInfoWM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoWM newObject = (schemaLib.MutedInfoWM)super.clone();

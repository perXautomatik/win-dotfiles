...
// </summary>
public class MutedInfoCnZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCnZ
	// </summary>
	// <remarks>
	...
	public MutedInfoCnZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCnZ newObject = (schemaLib.MutedInfoCnZ)super.clone();

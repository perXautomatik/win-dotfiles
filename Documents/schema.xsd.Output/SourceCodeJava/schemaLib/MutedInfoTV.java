...
// </summary>
public class MutedInfoTV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoTV
	// </summary>
	// <remarks>
	...
	public MutedInfoTV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoTV newObject = (schemaLib.MutedInfoTV)super.clone();

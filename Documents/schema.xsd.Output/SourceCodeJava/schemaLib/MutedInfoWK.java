...
// </summary>
public class MutedInfoWK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoWK
	// </summary>
	// <remarks>
	...
	public MutedInfoWK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoWK newObject = (schemaLib.MutedInfoWK)super.clone();

...
// </summary>
public class MutedInfoBcO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBcO
	// </summary>
	// <remarks>
	...
	public MutedInfoBcO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBcO newObject = (schemaLib.MutedInfoBcO)super.clone();

...
// </summary>
public class MutedInfoFT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoFT
	// </summary>
	// <remarks>
	...
	public MutedInfoFT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoFT newObject = (schemaLib.MutedInfoFT)super.clone();

...
// </summary>
public class MutedInfoTZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoTZ
	// </summary>
	// <remarks>
	...
	public MutedInfoTZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoTZ newObject = (schemaLib.MutedInfoTZ)super.clone();

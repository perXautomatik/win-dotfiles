...
// </summary>
public class MutedInfoCyI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCyI
	// </summary>
	// <remarks>
	...
	public MutedInfoCyI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCyI newObject = (schemaLib.MutedInfoCyI)super.clone();

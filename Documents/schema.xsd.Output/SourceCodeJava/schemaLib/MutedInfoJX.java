...
// </summary>
public class MutedInfoJX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoJX
	// </summary>
	// <remarks>
	...
	public MutedInfoJX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoJX newObject = (schemaLib.MutedInfoJX)super.clone();

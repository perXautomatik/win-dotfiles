...
// </summary>
public class MutedInfoB_IB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_IB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_IB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_IB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_IB newObject = (schemaLib.MutedInfoB_IB)super.clone();

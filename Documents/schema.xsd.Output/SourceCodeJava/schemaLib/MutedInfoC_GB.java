...
// </summary>
public class MutedInfoC_GB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_GB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_GB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_GB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_GB newObject = (schemaLib.MutedInfoC_GB)super.clone();

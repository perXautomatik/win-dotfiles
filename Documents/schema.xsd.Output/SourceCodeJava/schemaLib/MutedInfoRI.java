...
// </summary>
public class MutedInfoRI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoRI
	// </summary>
	// <remarks>
	...
	public MutedInfoRI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoRI newObject = (schemaLib.MutedInfoRI)super.clone();

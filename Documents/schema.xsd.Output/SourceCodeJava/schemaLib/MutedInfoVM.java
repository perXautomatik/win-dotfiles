...
// </summary>
public class MutedInfoVM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoVM
	// </summary>
	// <remarks>
	...
	public MutedInfoVM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoVM newObject = (schemaLib.MutedInfoVM)super.clone();

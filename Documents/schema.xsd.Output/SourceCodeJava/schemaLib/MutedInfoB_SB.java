...
// </summary>
public class MutedInfoB_SB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_SB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_SB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_SB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_SB newObject = (schemaLib.MutedInfoB_SB)super.clone();

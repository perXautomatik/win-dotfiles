...
// </summary>
public class MutedInfoB_HE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_HE
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_HE() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_HE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_HE newObject = (schemaLib.MutedInfoB_HE)super.clone();

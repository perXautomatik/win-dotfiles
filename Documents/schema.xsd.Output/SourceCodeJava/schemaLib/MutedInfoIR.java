...
// </summary>
public class MutedInfoIR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoIR
	// </summary>
	// <remarks>
	...
	public MutedInfoIR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoIR newObject = (schemaLib.MutedInfoIR)super.clone();

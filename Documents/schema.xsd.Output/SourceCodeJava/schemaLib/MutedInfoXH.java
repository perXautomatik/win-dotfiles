...
// </summary>
public class MutedInfoXH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoXH
	// </summary>
	// <remarks>
	...
	public MutedInfoXH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoXH newObject = (schemaLib.MutedInfoXH)super.clone();

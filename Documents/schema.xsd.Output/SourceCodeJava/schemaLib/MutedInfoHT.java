...
// </summary>
public class MutedInfoHT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoHT
	// </summary>
	// <remarks>
	...
	public MutedInfoHT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoHT newObject = (schemaLib.MutedInfoHT)super.clone();

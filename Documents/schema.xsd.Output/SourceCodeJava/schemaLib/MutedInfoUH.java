...
// </summary>
public class MutedInfoUH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoUH
	// </summary>
	// <remarks>
	...
	public MutedInfoUH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoUH newObject = (schemaLib.MutedInfoUH)super.clone();

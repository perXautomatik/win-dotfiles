...
// </summary>
public class MutedInfoCvG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCvG
	// </summary>
	// <remarks>
	...
	public MutedInfoCvG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCvG newObject = (schemaLib.MutedInfoCvG)super.clone();

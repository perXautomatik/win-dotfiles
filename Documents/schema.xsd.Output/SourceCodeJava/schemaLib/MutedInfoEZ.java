...
// </summary>
public class MutedInfoEZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoEZ
	// </summary>
	// <remarks>
	...
	public MutedInfoEZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoEZ newObject = (schemaLib.MutedInfoEZ)super.clone();

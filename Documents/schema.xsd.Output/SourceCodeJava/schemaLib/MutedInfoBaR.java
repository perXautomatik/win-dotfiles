...
// </summary>
public class MutedInfoBaR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBaR
	// </summary>
	// <remarks>
	...
	public MutedInfoBaR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBaR newObject = (schemaLib.MutedInfoBaR)super.clone();

...
// </summary>
public class MutedInfoGY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoGY
	// </summary>
	// <remarks>
	...
	public MutedInfoGY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoGY newObject = (schemaLib.MutedInfoGY)super.clone();

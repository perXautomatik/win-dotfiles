...
// </summary>
public class MutedInfoOU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoOU
	// </summary>
	// <remarks>
	...
	public MutedInfoOU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoOU newObject = (schemaLib.MutedInfoOU)super.clone();

...
// </summary>
public class MutedInfoNA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoNA
	// </summary>
	// <remarks>
	...
	public MutedInfoNA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoNA newObject = (schemaLib.MutedInfoNA)super.clone();

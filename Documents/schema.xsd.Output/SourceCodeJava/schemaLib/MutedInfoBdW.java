...
// </summary>
public class MutedInfoBdW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBdW
	// </summary>
	// <remarks>
	...
	public MutedInfoBdW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBdW newObject = (schemaLib.MutedInfoBdW)super.clone();

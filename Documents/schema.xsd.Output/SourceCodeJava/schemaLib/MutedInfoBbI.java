...
// </summary>
public class MutedInfoBbI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBbI
	// </summary>
	// <remarks>
	...
	public MutedInfoBbI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBbI newObject = (schemaLib.MutedInfoBbI)super.clone();

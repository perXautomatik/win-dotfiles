...
// </summary>
public class MutedInfoXJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoXJ
	// </summary>
	// <remarks>
	...
	public MutedInfoXJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoXJ newObject = (schemaLib.MutedInfoXJ)super.clone();

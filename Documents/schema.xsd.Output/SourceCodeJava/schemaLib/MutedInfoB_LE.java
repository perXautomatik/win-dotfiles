...
// </summary>
public class MutedInfoB_LE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_LE
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_LE() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_LE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_LE newObject = (schemaLib.MutedInfoB_LE)super.clone();

...
// </summary>
public class MutedInfoOP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoOP
	// </summary>
	// <remarks>
	...
	public MutedInfoOP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoOP newObject = (schemaLib.MutedInfoOP)super.clone();

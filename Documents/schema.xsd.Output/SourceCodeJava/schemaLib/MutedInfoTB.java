...
// </summary>
public class MutedInfoTB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoTB
	// </summary>
	// <remarks>
	...
	public MutedInfoTB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoTB newObject = (schemaLib.MutedInfoTB)super.clone();

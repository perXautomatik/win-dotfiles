...
// </summary>
public class MutedInfoBfK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBfK
	// </summary>
	// <remarks>
	...
	public MutedInfoBfK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBfK newObject = (schemaLib.MutedInfoBfK)super.clone();

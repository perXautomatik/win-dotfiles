...
// </summary>
public class MutedInfoB_ED extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_ED
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_ED() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_ED(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_ED newObject = (schemaLib.MutedInfoB_ED)super.clone();

...
// </summary>
public class MutedInfoBgF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBgF
	// </summary>
	// <remarks>
	...
	public MutedInfoBgF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBgF newObject = (schemaLib.MutedInfoBgF)super.clone();

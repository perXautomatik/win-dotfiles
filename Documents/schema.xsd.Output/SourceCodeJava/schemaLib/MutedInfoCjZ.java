...
// </summary>
public class MutedInfoCjZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCjZ
	// </summary>
	// <remarks>
	...
	public MutedInfoCjZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCjZ newObject = (schemaLib.MutedInfoCjZ)super.clone();

...
// </summary>
public class MutedInfoC_DA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_DA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_DA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_DA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_DA newObject = (schemaLib.MutedInfoC_DA)super.clone();

...
// </summary>
public class MutedInfoJF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoJF
	// </summary>
	// <remarks>
	...
	public MutedInfoJF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoJF newObject = (schemaLib.MutedInfoJF)super.clone();

...
// </summary>
public class MutedInfoDŠP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŠP
	// </summary>
	// <remarks>
	...
	public MutedInfoDŠP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŠP newObject = (schemaLib.MutedInfoDŠP)super.clone();

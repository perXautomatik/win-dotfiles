...
// </summary>
public class MutedInfoCyY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCyY
	// </summary>
	// <remarks>
	...
	public MutedInfoCyY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCyY newObject = (schemaLib.MutedInfoCyY)super.clone();

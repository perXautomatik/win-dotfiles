...
// </summary>
public class MutedInfoC_U extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_U
	// </summary>
	// <remarks>
	...
	public MutedInfoC_U(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_U newObject = (schemaLib.MutedInfoC_U)super.clone();

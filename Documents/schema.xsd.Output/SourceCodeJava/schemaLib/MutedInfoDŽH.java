...
// </summary>
public class MutedInfoDŽH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŽH
	// </summary>
	// <remarks>
	...
	public MutedInfoDŽH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŽH newObject = (schemaLib.MutedInfoDŽH)super.clone();

...
// </summary>
public class MutedInfoBdG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBdG
	// </summary>
	// <remarks>
	...
	public MutedInfoBdG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBdG newObject = (schemaLib.MutedInfoBdG)super.clone();

...
// </summary>
public class MutedInfoDU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDU
	// </summary>
	// <remarks>
	...
	public MutedInfoDU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDU newObject = (schemaLib.MutedInfoDU)super.clone();

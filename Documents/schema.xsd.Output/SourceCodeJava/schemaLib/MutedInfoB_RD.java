...
// </summary>
public class MutedInfoB_RD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_RD
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_RD() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_RD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_RD newObject = (schemaLib.MutedInfoB_RD)super.clone();

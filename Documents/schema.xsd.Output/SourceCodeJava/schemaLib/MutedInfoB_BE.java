...
// </summary>
public class MutedInfoB_BE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_BE
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_BE() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_BE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_BE newObject = (schemaLib.MutedInfoB_BE)super.clone();

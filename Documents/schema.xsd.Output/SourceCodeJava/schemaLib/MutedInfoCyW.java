...
// </summary>
public class MutedInfoCyW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCyW
	// </summary>
	// <remarks>
	...
	public MutedInfoCyW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCyW newObject = (schemaLib.MutedInfoCyW)super.clone();

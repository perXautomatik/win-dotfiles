...
// </summary>
public class MutedInfoVD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoVD
	// </summary>
	// <remarks>
	...
	public MutedInfoVD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoVD newObject = (schemaLib.MutedInfoVD)super.clone();

...
// </summary>
public class MutedInfoCpI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCpI
	// </summary>
	// <remarks>
	...
	public MutedInfoCpI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCpI newObject = (schemaLib.MutedInfoCpI)super.clone();

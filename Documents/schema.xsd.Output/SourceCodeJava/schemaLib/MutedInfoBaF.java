...
// </summary>
public class MutedInfoBaF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBaF
	// </summary>
	// <remarks>
	...
	public MutedInfoBaF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBaF newObject = (schemaLib.MutedInfoBaF)super.clone();

...
// </summary>
public class MutedInfoXQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoXQ
	// </summary>
	// <remarks>
	...
	public MutedInfoXQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoXQ newObject = (schemaLib.MutedInfoXQ)super.clone();

...
// </summary>
public class MutedInfoCyR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCyR
	// </summary>
	// <remarks>
	...
	public MutedInfoCyR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCyR newObject = (schemaLib.MutedInfoCyR)super.clone();

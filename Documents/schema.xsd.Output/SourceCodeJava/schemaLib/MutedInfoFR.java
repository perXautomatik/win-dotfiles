...
// </summary>
public class MutedInfoFR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoFR
	// </summary>
	// <remarks>
	...
	public MutedInfoFR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoFR newObject = (schemaLib.MutedInfoFR)super.clone();

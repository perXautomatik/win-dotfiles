...
// </summary>
public class MutedInfoB_XA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_XA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_XA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_XA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_XA newObject = (schemaLib.MutedInfoB_XA)super.clone();

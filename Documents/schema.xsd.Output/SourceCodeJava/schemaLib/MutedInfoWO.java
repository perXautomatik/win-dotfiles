...
// </summary>
public class MutedInfoWO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoWO
	// </summary>
	// <remarks>
	...
	public MutedInfoWO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoWO newObject = (schemaLib.MutedInfoWO)super.clone();

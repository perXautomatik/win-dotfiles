...
// </summary>
public class MutedInfoPQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoPQ
	// </summary>
	// <remarks>
	...
	public MutedInfoPQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoPQ newObject = (schemaLib.MutedInfoPQ)super.clone();

...
// </summary>
public class MutedInfoCnG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCnG
	// </summary>
	// <remarks>
	...
	public MutedInfoCnG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCnG newObject = (schemaLib.MutedInfoCnG)super.clone();

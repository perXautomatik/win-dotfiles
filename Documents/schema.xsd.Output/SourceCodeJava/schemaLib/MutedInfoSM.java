...
// </summary>
public class MutedInfoSM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoSM
	// </summary>
	// <remarks>
	...
	public MutedInfoSM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoSM newObject = (schemaLib.MutedInfoSM)super.clone();

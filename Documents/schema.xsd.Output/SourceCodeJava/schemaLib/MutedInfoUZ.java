...
// </summary>
public class MutedInfoUZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoUZ
	// </summary>
	// <remarks>
	...
	public MutedInfoUZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoUZ newObject = (schemaLib.MutedInfoUZ)super.clone();

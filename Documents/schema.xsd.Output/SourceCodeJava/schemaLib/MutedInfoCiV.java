...
// </summary>
public class MutedInfoCiV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCiV
	// </summary>
	// <remarks>
	...
	public MutedInfoCiV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCiV newObject = (schemaLib.MutedInfoCiV)super.clone();

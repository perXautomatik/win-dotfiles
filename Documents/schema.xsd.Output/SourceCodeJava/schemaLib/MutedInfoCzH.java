...
// </summary>
public class MutedInfoCzH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCzH
	// </summary>
	// <remarks>
	...
	public MutedInfoCzH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCzH newObject = (schemaLib.MutedInfoCzH)super.clone();

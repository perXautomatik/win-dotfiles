...
// </summary>
public class MutedInfoCmY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCmY
	// </summary>
	// <remarks>
	...
	public MutedInfoCmY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCmY newObject = (schemaLib.MutedInfoCmY)super.clone();

...
// </summary>
public class MutedInfoCxC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCxC
	// </summary>
	// <remarks>
	...
	public MutedInfoCxC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCxC newObject = (schemaLib.MutedInfoCxC)super.clone();

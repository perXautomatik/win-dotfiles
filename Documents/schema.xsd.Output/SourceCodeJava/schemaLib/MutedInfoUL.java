...
// </summary>
public class MutedInfoUL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoUL
	// </summary>
	// <remarks>
	...
	public MutedInfoUL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoUL newObject = (schemaLib.MutedInfoUL)super.clone();

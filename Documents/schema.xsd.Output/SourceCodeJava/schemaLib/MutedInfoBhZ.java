...
// </summary>
public class MutedInfoBhZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBhZ
	// </summary>
	// <remarks>
	...
	public MutedInfoBhZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBhZ newObject = (schemaLib.MutedInfoBhZ)super.clone();

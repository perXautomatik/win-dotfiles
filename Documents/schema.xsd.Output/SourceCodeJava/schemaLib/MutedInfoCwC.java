...
// </summary>
public class MutedInfoCwC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCwC
	// </summary>
	// <remarks>
	...
	public MutedInfoCwC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCwC newObject = (schemaLib.MutedInfoCwC)super.clone();

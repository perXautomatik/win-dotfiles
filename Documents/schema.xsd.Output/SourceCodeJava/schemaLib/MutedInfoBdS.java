...
// </summary>
public class MutedInfoBdS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBdS
	// </summary>
	// <remarks>
	...
	public MutedInfoBdS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBdS newObject = (schemaLib.MutedInfoBdS)super.clone();

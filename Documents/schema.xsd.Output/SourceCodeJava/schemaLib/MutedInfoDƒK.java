...
// </summary>
public class MutedInfoDƒK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDƒK
	// </summary>
	// <remarks>
	...
	public MutedInfoDƒK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDƒK newObject = (schemaLib.MutedInfoDƒK)super.clone();

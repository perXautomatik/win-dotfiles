...
// </summary>
public class MutedInfoCiD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCiD
	// </summary>
	// <remarks>
	...
	public MutedInfoCiD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCiD newObject = (schemaLib.MutedInfoCiD)super.clone();

...
// </summary>
public class MutedInfoCtN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCtN
	// </summary>
	// <remarks>
	...
	public MutedInfoCtN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCtN newObject = (schemaLib.MutedInfoCtN)super.clone();

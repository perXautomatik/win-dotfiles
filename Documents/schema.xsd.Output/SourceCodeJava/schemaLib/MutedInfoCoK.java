...
// </summary>
public class MutedInfoCoK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCoK
	// </summary>
	// <remarks>
	...
	public MutedInfoCoK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCoK newObject = (schemaLib.MutedInfoCoK)super.clone();

...
// </summary>
public class MutedInfoRM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoRM
	// </summary>
	// <remarks>
	...
	public MutedInfoRM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoRM newObject = (schemaLib.MutedInfoRM)super.clone();

...
// </summary>
public class MutedInfoCyV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCyV
	// </summary>
	// <remarks>
	...
	public MutedInfoCyV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCyV newObject = (schemaLib.MutedInfoCyV)super.clone();

...
// </summary>
public class MutedInfoCyG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCyG
	// </summary>
	// <remarks>
	...
	public MutedInfoCyG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCyG newObject = (schemaLib.MutedInfoCyG)super.clone();

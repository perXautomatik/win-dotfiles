...
// </summary>
public class MutedInfoB_FC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_FC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_FC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_FC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_FC newObject = (schemaLib.MutedInfoB_FC)super.clone();

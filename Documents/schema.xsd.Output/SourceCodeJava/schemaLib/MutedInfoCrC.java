...
// </summary>
public class MutedInfoCrC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCrC
	// </summary>
	// <remarks>
	...
	public MutedInfoCrC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCrC newObject = (schemaLib.MutedInfoCrC)super.clone();

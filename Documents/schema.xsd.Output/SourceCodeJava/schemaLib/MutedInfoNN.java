...
// </summary>
public class MutedInfoNN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoNN
	// </summary>
	// <remarks>
	...
	public MutedInfoNN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoNN newObject = (schemaLib.MutedInfoNN)super.clone();

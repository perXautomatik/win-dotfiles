...
// </summary>
public class MutedInfoLW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoLW
	// </summary>
	// <remarks>
	...
	public MutedInfoLW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoLW newObject = (schemaLib.MutedInfoLW)super.clone();

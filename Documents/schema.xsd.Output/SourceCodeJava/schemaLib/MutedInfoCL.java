...
// </summary>
public class MutedInfoCL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCL
	// </summary>
	// <remarks>
	...
	public MutedInfoCL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCL newObject = (schemaLib.MutedInfoCL)super.clone();

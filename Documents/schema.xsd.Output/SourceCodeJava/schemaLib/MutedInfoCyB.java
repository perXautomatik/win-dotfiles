...
// </summary>
public class MutedInfoCyB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCyB
	// </summary>
	// <remarks>
	...
	public MutedInfoCyB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCyB newObject = (schemaLib.MutedInfoCyB)super.clone();

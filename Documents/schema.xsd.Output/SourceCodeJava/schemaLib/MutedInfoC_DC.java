...
// </summary>
public class MutedInfoC_DC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_DC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_DC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_DC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_DC newObject = (schemaLib.MutedInfoC_DC)super.clone();

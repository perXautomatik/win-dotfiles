...
// </summary>
public class MutedInfoCiM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCiM
	// </summary>
	// <remarks>
	...
	public MutedInfoCiM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCiM newObject = (schemaLib.MutedInfoCiM)super.clone();

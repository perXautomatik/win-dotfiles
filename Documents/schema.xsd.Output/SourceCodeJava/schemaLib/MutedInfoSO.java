...
// </summary>
public class MutedInfoSO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoSO
	// </summary>
	// <remarks>
	...
	public MutedInfoSO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoSO newObject = (schemaLib.MutedInfoSO)super.clone();

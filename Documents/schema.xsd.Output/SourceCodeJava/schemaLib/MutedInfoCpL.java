...
// </summary>
public class MutedInfoCpL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCpL
	// </summary>
	// <remarks>
	...
	public MutedInfoCpL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCpL newObject = (schemaLib.MutedInfoCpL)super.clone();

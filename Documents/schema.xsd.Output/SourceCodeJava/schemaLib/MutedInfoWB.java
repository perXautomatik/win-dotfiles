...
// </summary>
public class MutedInfoWB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoWB
	// </summary>
	// <remarks>
	...
	public MutedInfoWB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoWB newObject = (schemaLib.MutedInfoWB)super.clone();

...
// </summary>
public class MutedInfoRH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoRH
	// </summary>
	// <remarks>
	...
	public MutedInfoRH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoRH newObject = (schemaLib.MutedInfoRH)super.clone();

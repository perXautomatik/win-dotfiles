...
// </summary>
public class MutedInfoCmI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCmI
	// </summary>
	// <remarks>
	...
	public MutedInfoCmI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCmI newObject = (schemaLib.MutedInfoCmI)super.clone();

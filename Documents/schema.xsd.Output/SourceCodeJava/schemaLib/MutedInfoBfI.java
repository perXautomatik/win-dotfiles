...
// </summary>
public class MutedInfoBfI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBfI
	// </summary>
	// <remarks>
	...
	public MutedInfoBfI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBfI newObject = (schemaLib.MutedInfoBfI)super.clone();

...
// </summary>
public class MutedInfoB_CD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_CD
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_CD() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_CD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_CD newObject = (schemaLib.MutedInfoB_CD)super.clone();

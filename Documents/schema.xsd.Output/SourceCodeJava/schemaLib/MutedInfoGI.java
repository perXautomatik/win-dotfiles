...
// </summary>
public class MutedInfoGI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoGI
	// </summary>
	// <remarks>
	...
	public MutedInfoGI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoGI newObject = (schemaLib.MutedInfoGI)super.clone();

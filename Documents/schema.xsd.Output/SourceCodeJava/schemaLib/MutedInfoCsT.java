...
// </summary>
public class MutedInfoCsT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCsT
	// </summary>
	// <remarks>
	...
	public MutedInfoCsT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCsT newObject = (schemaLib.MutedInfoCsT)super.clone();

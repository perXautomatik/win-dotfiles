...
// </summary>
public class MutedInfoHJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoHJ
	// </summary>
	// <remarks>
	...
	public MutedInfoHJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoHJ newObject = (schemaLib.MutedInfoHJ)super.clone();

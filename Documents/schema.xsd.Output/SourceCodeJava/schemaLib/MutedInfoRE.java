...
// </summary>
public class MutedInfoRE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoRE
	// </summary>
	// <remarks>
	...
	public MutedInfoRE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoRE newObject = (schemaLib.MutedInfoRE)super.clone();

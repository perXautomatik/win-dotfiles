...
// </summary>
public class MutedInfoUI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoUI
	// </summary>
	// <remarks>
	...
	public MutedInfoUI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoUI newObject = (schemaLib.MutedInfoUI)super.clone();

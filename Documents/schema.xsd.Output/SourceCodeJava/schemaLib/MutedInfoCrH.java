...
// </summary>
public class MutedInfoCrH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCrH
	// </summary>
	// <remarks>
	...
	public MutedInfoCrH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCrH newObject = (schemaLib.MutedInfoCrH)super.clone();

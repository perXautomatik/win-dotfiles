...
// </summary>
public class MutedInfoEB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoEB
	// </summary>
	// <remarks>
	...
	public MutedInfoEB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoEB newObject = (schemaLib.MutedInfoEB)super.clone();

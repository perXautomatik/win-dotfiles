...
// </summary>
public class MutedInfoDŠK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŠK
	// </summary>
	// <remarks>
	...
	public MutedInfoDŠK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŠK newObject = (schemaLib.MutedInfoDŠK)super.clone();

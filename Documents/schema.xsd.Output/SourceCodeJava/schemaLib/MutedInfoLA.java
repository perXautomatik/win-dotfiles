...
// </summary>
public class MutedInfoLA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoLA
	// </summary>
	// <remarks>
	...
	public MutedInfoLA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoLA newObject = (schemaLib.MutedInfoLA)super.clone();

...
// </summary>
public class MutedInfoClB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoClB
	// </summary>
	// <remarks>
	...
	public MutedInfoClB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoClB newObject = (schemaLib.MutedInfoClB)super.clone();

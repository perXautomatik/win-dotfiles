...
// </summary>
public class MutedInfoCrL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCrL
	// </summary>
	// <remarks>
	...
	public MutedInfoCrL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCrL newObject = (schemaLib.MutedInfoCrL)super.clone();

...
// </summary>
public class MutedInfoTC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoTC
	// </summary>
	// <remarks>
	...
	public MutedInfoTC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoTC newObject = (schemaLib.MutedInfoTC)super.clone();

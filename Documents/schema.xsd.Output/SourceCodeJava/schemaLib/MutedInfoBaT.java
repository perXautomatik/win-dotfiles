...
// </summary>
public class MutedInfoBaT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBaT
	// </summary>
	// <remarks>
	...
	public MutedInfoBaT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBaT newObject = (schemaLib.MutedInfoBaT)super.clone();

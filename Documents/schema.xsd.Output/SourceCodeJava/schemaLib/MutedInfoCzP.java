...
// </summary>
public class MutedInfoCzP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCzP
	// </summary>
	// <remarks>
	...
	public MutedInfoCzP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCzP newObject = (schemaLib.MutedInfoCzP)super.clone();

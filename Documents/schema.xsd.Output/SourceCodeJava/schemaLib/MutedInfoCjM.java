...
// </summary>
public class MutedInfoCjM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCjM
	// </summary>
	// <remarks>
	...
	public MutedInfoCjM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCjM newObject = (schemaLib.MutedInfoCjM)super.clone();

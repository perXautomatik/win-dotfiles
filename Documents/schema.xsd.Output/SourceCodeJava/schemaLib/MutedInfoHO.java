...
// </summary>
public class MutedInfoHO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoHO
	// </summary>
	// <remarks>
	...
	public MutedInfoHO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoHO newObject = (schemaLib.MutedInfoHO)super.clone();

...
// </summary>
public class MutedInfoGL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoGL
	// </summary>
	// <remarks>
	...
	public MutedInfoGL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoGL newObject = (schemaLib.MutedInfoGL)super.clone();

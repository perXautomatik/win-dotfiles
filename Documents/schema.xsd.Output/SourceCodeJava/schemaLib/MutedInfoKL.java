...
// </summary>
public class MutedInfoKL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoKL
	// </summary>
	// <remarks>
	...
	public MutedInfoKL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoKL newObject = (schemaLib.MutedInfoKL)super.clone();

...
// </summary>
public class MutedInfoDƒJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDƒJ
	// </summary>
	// <remarks>
	...
	public MutedInfoDƒJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDƒJ newObject = (schemaLib.MutedInfoDƒJ)super.clone();

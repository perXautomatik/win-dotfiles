...
// </summary>
public class MutedInfoDC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDC
	// </summary>
	// <remarks>
	...
	public MutedInfoDC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDC newObject = (schemaLib.MutedInfoDC)super.clone();

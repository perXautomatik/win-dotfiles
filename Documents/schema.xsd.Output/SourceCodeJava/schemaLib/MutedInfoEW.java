...
// </summary>
public class MutedInfoEW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoEW
	// </summary>
	// <remarks>
	...
	public MutedInfoEW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoEW newObject = (schemaLib.MutedInfoEW)super.clone();

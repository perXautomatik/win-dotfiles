...
// </summary>
public class MutedInfoB_UD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_UD
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_UD() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_UD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_UD newObject = (schemaLib.MutedInfoB_UD)super.clone();

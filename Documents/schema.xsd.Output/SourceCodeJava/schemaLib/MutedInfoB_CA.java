...
// </summary>
public class MutedInfoB_CA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_CA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_CA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_CA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_CA newObject = (schemaLib.MutedInfoB_CA)super.clone();

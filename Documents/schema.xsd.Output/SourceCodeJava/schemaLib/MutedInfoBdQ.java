...
// </summary>
public class MutedInfoBdQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBdQ
	// </summary>
	// <remarks>
	...
	public MutedInfoBdQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBdQ newObject = (schemaLib.MutedInfoBdQ)super.clone();

...
// </summary>
public class MutedInfoCzB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCzB
	// </summary>
	// <remarks>
	...
	public MutedInfoCzB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCzB newObject = (schemaLib.MutedInfoCzB)super.clone();

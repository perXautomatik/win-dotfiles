...
// </summary>
public class MutedInfoUU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoUU
	// </summary>
	// <remarks>
	...
	public MutedInfoUU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoUU newObject = (schemaLib.MutedInfoUU)super.clone();

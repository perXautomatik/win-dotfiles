...
// </summary>
public class MutedInfoB_YB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_YB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_YB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_YB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_YB newObject = (schemaLib.MutedInfoB_YB)super.clone();

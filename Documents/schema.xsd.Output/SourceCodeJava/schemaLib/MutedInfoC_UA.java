...
// </summary>
public class MutedInfoC_UA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_UA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_UA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_UA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_UA newObject = (schemaLib.MutedInfoC_UA)super.clone();

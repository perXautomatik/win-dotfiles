...
// </summary>
public class MutedInfoC_ZB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_ZB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_ZB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_ZB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_ZB newObject = (schemaLib.MutedInfoC_ZB)super.clone();

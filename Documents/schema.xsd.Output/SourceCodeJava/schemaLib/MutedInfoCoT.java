...
// </summary>
public class MutedInfoCoT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCoT
	// </summary>
	// <remarks>
	...
	public MutedInfoCoT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCoT newObject = (schemaLib.MutedInfoCoT)super.clone();

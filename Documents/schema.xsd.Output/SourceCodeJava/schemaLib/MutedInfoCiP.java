...
// </summary>
public class MutedInfoCiP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCiP
	// </summary>
	// <remarks>
	...
	public MutedInfoCiP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCiP newObject = (schemaLib.MutedInfoCiP)super.clone();

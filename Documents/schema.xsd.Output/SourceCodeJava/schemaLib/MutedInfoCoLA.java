...
// </summary>
public class MutedInfoCoLA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCoLA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoCoLA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoCoLA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCoLA newObject = (schemaLib.MutedInfoCoLA)super.clone();

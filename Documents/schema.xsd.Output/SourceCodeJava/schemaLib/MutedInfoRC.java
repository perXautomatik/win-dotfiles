...
// </summary>
public class MutedInfoRC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoRC
	// </summary>
	// <remarks>
	...
	public MutedInfoRC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoRC newObject = (schemaLib.MutedInfoRC)super.clone();

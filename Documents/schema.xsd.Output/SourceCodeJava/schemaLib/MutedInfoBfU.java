...
// </summary>
public class MutedInfoBfU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBfU
	// </summary>
	// <remarks>
	...
	public MutedInfoBfU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBfU newObject = (schemaLib.MutedInfoBfU)super.clone();

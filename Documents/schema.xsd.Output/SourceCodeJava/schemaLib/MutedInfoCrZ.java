...
// </summary>
public class MutedInfoCrZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCrZ
	// </summary>
	// <remarks>
	...
	public MutedInfoCrZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCrZ newObject = (schemaLib.MutedInfoCrZ)super.clone();

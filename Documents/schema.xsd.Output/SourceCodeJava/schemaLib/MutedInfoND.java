...
// </summary>
public class MutedInfoND extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoND
	// </summary>
	// <remarks>
	...
	public MutedInfoND(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoND newObject = (schemaLib.MutedInfoND)super.clone();

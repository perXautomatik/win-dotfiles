...
// </summary>
public class MutedInfoKO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoKO
	// </summary>
	// <remarks>
	...
	public MutedInfoKO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoKO newObject = (schemaLib.MutedInfoKO)super.clone();

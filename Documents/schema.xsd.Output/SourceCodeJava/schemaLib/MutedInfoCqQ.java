...
// </summary>
public class MutedInfoCqQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCqQ
	// </summary>
	// <remarks>
	...
	public MutedInfoCqQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCqQ newObject = (schemaLib.MutedInfoCqQ)super.clone();

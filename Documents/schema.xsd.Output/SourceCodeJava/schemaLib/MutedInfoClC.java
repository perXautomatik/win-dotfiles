...
// </summary>
public class MutedInfoClC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoClC
	// </summary>
	// <remarks>
	...
	public MutedInfoClC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoClC newObject = (schemaLib.MutedInfoClC)super.clone();

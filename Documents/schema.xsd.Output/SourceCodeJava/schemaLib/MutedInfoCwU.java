...
// </summary>
public class MutedInfoCwU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCwU
	// </summary>
	// <remarks>
	...
	public MutedInfoCwU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCwU newObject = (schemaLib.MutedInfoCwU)super.clone();

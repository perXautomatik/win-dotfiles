...
// </summary>
public class MutedInfoCtP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCtP
	// </summary>
	// <remarks>
	...
	public MutedInfoCtP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCtP newObject = (schemaLib.MutedInfoCtP)super.clone();

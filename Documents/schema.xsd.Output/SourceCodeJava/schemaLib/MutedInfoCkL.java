...
// </summary>
public class MutedInfoCkL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCkL
	// </summary>
	// <remarks>
	...
	public MutedInfoCkL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCkL newObject = (schemaLib.MutedInfoCkL)super.clone();

...
// </summary>
public class MutedInfoIG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoIG
	// </summary>
	// <remarks>
	...
	public MutedInfoIG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoIG newObject = (schemaLib.MutedInfoIG)super.clone();

...
// </summary>
public class MutedInfoCmB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCmB
	// </summary>
	// <remarks>
	...
	public MutedInfoCmB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCmB newObject = (schemaLib.MutedInfoCmB)super.clone();

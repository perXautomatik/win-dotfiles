...
// </summary>
public class MutedInfoDˆO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDˆO
	// </summary>
	// <remarks>
	...
	public MutedInfoDˆO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDˆO newObject = (schemaLib.MutedInfoDˆO)super.clone();

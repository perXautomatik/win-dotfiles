...
// </summary>
public class MutedInfoC_GA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_GA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_GA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_GA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_GA newObject = (schemaLib.MutedInfoC_GA)super.clone();

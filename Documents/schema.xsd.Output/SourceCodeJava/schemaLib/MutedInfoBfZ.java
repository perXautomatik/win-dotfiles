...
// </summary>
public class MutedInfoBfZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBfZ
	// </summary>
	// <remarks>
	...
	public MutedInfoBfZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBfZ newObject = (schemaLib.MutedInfoBfZ)super.clone();

...
// </summary>
public class MutedInfoHU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoHU
	// </summary>
	// <remarks>
	...
	public MutedInfoHU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoHU newObject = (schemaLib.MutedInfoHU)super.clone();

...
// </summary>
public class MutedInfoRN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoRN
	// </summary>
	// <remarks>
	...
	public MutedInfoRN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoRN newObject = (schemaLib.MutedInfoRN)super.clone();

...
// </summary>
public class MutedInfoQX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoQX
	// </summary>
	// <remarks>
	...
	public MutedInfoQX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoQX newObject = (schemaLib.MutedInfoQX)super.clone();

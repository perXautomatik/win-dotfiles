...
// </summary>
public class MutedInfoWV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoWV
	// </summary>
	// <remarks>
	...
	public MutedInfoWV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoWV newObject = (schemaLib.MutedInfoWV)super.clone();

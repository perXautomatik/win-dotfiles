...
// </summary>
public class MutedInfoEI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoEI
	// </summary>
	// <remarks>
	...
	public MutedInfoEI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoEI newObject = (schemaLib.MutedInfoEI)super.clone();

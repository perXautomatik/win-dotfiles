...
// </summary>
public class MutedInfoB_RA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_RA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_RA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_RA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_RA newObject = (schemaLib.MutedInfoB_RA)super.clone();

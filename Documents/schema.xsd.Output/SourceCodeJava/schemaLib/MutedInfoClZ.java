...
// </summary>
public class MutedInfoClZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoClZ
	// </summary>
	// <remarks>
	...
	public MutedInfoClZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoClZ newObject = (schemaLib.MutedInfoClZ)super.clone();

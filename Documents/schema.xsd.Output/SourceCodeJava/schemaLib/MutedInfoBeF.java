...
// </summary>
public class MutedInfoBeF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBeF
	// </summary>
	// <remarks>
	...
	public MutedInfoBeF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBeF newObject = (schemaLib.MutedInfoBeF)super.clone();

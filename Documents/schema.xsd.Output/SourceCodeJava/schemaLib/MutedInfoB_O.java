...
// </summary>
public class MutedInfoB_O extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_O
	// </summary>
	// <remarks>
	...
	public MutedInfoB_O(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_O newObject = (schemaLib.MutedInfoB_O)super.clone();

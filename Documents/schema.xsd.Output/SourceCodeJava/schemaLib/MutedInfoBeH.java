...
// </summary>
public class MutedInfoBeH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBeH
	// </summary>
	// <remarks>
	...
	public MutedInfoBeH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBeH newObject = (schemaLib.MutedInfoBeH)super.clone();

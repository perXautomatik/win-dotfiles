...
// </summary>
public class MutedInfoCmP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCmP
	// </summary>
	// <remarks>
	...
	public MutedInfoCmP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCmP newObject = (schemaLib.MutedInfoCmP)super.clone();

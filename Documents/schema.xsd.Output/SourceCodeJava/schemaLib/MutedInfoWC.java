...
// </summary>
public class MutedInfoWC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoWC
	// </summary>
	// <remarks>
	...
	public MutedInfoWC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoWC newObject = (schemaLib.MutedInfoWC)super.clone();

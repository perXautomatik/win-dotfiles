...
// </summary>
public class MutedInfoCvP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCvP
	// </summary>
	// <remarks>
	...
	public MutedInfoCvP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCvP newObject = (schemaLib.MutedInfoCvP)super.clone();

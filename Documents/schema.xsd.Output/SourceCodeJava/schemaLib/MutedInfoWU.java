...
// </summary>
public class MutedInfoWU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoWU
	// </summary>
	// <remarks>
	...
	public MutedInfoWU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoWU newObject = (schemaLib.MutedInfoWU)super.clone();

...
// </summary>
public class MutedInfoGT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoGT
	// </summary>
	// <remarks>
	...
	public MutedInfoGT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoGT newObject = (schemaLib.MutedInfoGT)super.clone();

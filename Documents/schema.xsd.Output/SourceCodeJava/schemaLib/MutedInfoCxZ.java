...
// </summary>
public class MutedInfoCxZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCxZ
	// </summary>
	// <remarks>
	...
	public MutedInfoCxZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCxZ newObject = (schemaLib.MutedInfoCxZ)super.clone();

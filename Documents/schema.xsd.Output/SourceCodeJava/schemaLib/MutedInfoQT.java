...
// </summary>
public class MutedInfoQT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoQT
	// </summary>
	// <remarks>
	...
	public MutedInfoQT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoQT newObject = (schemaLib.MutedInfoQT)super.clone();

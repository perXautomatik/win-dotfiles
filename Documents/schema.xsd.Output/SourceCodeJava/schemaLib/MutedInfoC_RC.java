...
// </summary>
public class MutedInfoC_RC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_RC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_RC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_RC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_RC newObject = (schemaLib.MutedInfoC_RC)super.clone();

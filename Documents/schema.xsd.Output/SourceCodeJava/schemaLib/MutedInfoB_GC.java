...
// </summary>
public class MutedInfoB_GC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_GC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_GC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_GC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_GC newObject = (schemaLib.MutedInfoB_GC)super.clone();

...
// </summary>
public class MutedInfoWF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoWF
	// </summary>
	// <remarks>
	...
	public MutedInfoWF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoWF newObject = (schemaLib.MutedInfoWF)super.clone();

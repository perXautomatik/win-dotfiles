...
// </summary>
public class MutedInfoRP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoRP
	// </summary>
	// <remarks>
	...
	public MutedInfoRP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoRP newObject = (schemaLib.MutedInfoRP)super.clone();

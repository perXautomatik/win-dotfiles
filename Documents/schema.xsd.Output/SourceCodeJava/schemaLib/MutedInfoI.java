...
// </summary>
public class MutedInfoI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoI
	// </summary>
	// <remarks>
	...
	public MutedInfoI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoI newObject = (schemaLib.MutedInfoI)super.clone();

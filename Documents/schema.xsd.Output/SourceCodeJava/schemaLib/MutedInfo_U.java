...
// </summary>
public class MutedInfo_U extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfo_U
	// </summary>
	// <remarks>
	...
	public MutedInfo_U(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfo_U newObject = (schemaLib.MutedInfo_U)super.clone();

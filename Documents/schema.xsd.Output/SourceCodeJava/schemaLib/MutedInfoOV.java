...
// </summary>
public class MutedInfoOV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoOV
	// </summary>
	// <remarks>
	...
	public MutedInfoOV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoOV newObject = (schemaLib.MutedInfoOV)super.clone();

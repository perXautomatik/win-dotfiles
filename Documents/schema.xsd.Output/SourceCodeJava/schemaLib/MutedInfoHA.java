...
// </summary>
public class MutedInfoHA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoHA
	// </summary>
	// <remarks>
	...
	public MutedInfoHA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoHA newObject = (schemaLib.MutedInfoHA)super.clone();

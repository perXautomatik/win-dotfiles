...
// </summary>
public class MutedInfoChM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoChM
	// </summary>
	// <remarks>
	...
	public MutedInfoChM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoChM newObject = (schemaLib.MutedInfoChM)super.clone();

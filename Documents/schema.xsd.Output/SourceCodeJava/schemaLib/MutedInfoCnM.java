...
// </summary>
public class MutedInfoCnM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCnM
	// </summary>
	// <remarks>
	...
	public MutedInfoCnM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCnM newObject = (schemaLib.MutedInfoCnM)super.clone();

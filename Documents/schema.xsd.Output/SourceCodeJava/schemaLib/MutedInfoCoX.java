...
// </summary>
public class MutedInfoCoX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCoX
	// </summary>
	// <remarks>
	...
	public MutedInfoCoX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCoX newObject = (schemaLib.MutedInfoCoX)super.clone();

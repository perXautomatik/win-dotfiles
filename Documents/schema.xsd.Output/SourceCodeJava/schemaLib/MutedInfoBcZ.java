...
// </summary>
public class MutedInfoBcZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBcZ
	// </summary>
	// <remarks>
	...
	public MutedInfoBcZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBcZ newObject = (schemaLib.MutedInfoBcZ)super.clone();

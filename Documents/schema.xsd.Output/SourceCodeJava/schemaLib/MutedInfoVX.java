...
// </summary>
public class MutedInfoVX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoVX
	// </summary>
	// <remarks>
	...
	public MutedInfoVX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoVX newObject = (schemaLib.MutedInfoVX)super.clone();

...
// </summary>
public class MutedInfoCuV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCuV
	// </summary>
	// <remarks>
	...
	public MutedInfoCuV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCuV newObject = (schemaLib.MutedInfoCuV)super.clone();

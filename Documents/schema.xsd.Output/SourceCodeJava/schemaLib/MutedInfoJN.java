...
// </summary>
public class MutedInfoJN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoJN
	// </summary>
	// <remarks>
	...
	public MutedInfoJN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoJN newObject = (schemaLib.MutedInfoJN)super.clone();

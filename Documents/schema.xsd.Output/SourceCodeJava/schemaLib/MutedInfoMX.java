...
// </summary>
public class MutedInfoMX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoMX
	// </summary>
	// <remarks>
	...
	public MutedInfoMX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoMX newObject = (schemaLib.MutedInfoMX)super.clone();

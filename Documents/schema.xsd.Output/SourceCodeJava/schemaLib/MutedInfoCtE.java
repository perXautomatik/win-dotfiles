...
// </summary>
public class MutedInfoCtE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCtE
	// </summary>
	// <remarks>
	...
	public MutedInfoCtE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCtE newObject = (schemaLib.MutedInfoCtE)super.clone();

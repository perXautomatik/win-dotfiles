...
// </summary>
public class MutedInfoXN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoXN
	// </summary>
	// <remarks>
	...
	public MutedInfoXN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoXN newObject = (schemaLib.MutedInfoXN)super.clone();

...
// </summary>
public class MutedInfoCiJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCiJ
	// </summary>
	// <remarks>
	...
	public MutedInfoCiJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCiJ newObject = (schemaLib.MutedInfoCiJ)super.clone();

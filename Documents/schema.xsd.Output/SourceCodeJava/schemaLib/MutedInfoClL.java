...
// </summary>
public class MutedInfoClL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoClL
	// </summary>
	// <remarks>
	...
	public MutedInfoClL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoClL newObject = (schemaLib.MutedInfoClL)super.clone();

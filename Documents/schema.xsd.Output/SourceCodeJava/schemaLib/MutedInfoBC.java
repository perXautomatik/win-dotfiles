...
// </summary>
public class MutedInfoBC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBC
	// </summary>
	// <remarks>
	...
	public MutedInfoBC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBC newObject = (schemaLib.MutedInfoBC)super.clone();

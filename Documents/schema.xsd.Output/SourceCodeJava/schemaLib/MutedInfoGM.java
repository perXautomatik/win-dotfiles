...
// </summary>
public class MutedInfoGM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoGM
	// </summary>
	// <remarks>
	...
	public MutedInfoGM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoGM newObject = (schemaLib.MutedInfoGM)super.clone();

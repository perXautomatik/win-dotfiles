...
// </summary>
public class MutedInfoBgO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBgO
	// </summary>
	// <remarks>
	...
	public MutedInfoBgO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBgO newObject = (schemaLib.MutedInfoBgO)super.clone();

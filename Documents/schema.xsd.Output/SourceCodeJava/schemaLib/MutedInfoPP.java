...
// </summary>
public class MutedInfoPP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoPP
	// </summary>
	// <remarks>
	...
	public MutedInfoPP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoPP newObject = (schemaLib.MutedInfoPP)super.clone();

...
// </summary>
public class MutedInfoLD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoLD
	// </summary>
	// <remarks>
	...
	public MutedInfoLD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoLD newObject = (schemaLib.MutedInfoLD)super.clone();

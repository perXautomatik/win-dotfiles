...
// </summary>
public class MutedInfoDŽC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŽC
	// </summary>
	// <remarks>
	...
	public MutedInfoDŽC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŽC newObject = (schemaLib.MutedInfoDŽC)super.clone();

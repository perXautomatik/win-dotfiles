...
// </summary>
public class MutedInfoCpV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCpV
	// </summary>
	// <remarks>
	...
	public MutedInfoCpV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCpV newObject = (schemaLib.MutedInfoCpV)super.clone();

...
// </summary>
public class MutedInfoCqY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCqY
	// </summary>
	// <remarks>
	...
	public MutedInfoCqY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCqY newObject = (schemaLib.MutedInfoCqY)super.clone();

...
// </summary>
public class MutedInfoKH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoKH
	// </summary>
	// <remarks>
	...
	public MutedInfoKH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoKH newObject = (schemaLib.MutedInfoKH)super.clone();

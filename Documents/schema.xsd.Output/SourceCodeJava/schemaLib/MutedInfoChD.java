...
// </summary>
public class MutedInfoChD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoChD
	// </summary>
	// <remarks>
	...
	public MutedInfoChD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoChD newObject = (schemaLib.MutedInfoChD)super.clone();

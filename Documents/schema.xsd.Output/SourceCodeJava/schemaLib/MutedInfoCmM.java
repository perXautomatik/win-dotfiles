...
// </summary>
public class MutedInfoCmM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCmM
	// </summary>
	// <remarks>
	...
	public MutedInfoCmM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCmM newObject = (schemaLib.MutedInfoCmM)super.clone();

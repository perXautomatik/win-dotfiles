...
// </summary>
public class MutedInfoYA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoYA
	// </summary>
	// <remarks>
	...
	public MutedInfoYA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoYA newObject = (schemaLib.MutedInfoYA)super.clone();

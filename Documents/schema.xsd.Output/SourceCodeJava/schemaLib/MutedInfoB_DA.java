...
// </summary>
public class MutedInfoB_DA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_DA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_DA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_DA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_DA newObject = (schemaLib.MutedInfoB_DA)super.clone();

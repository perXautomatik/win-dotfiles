...
// </summary>
public class MutedInfoPF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoPF
	// </summary>
	// <remarks>
	...
	public MutedInfoPF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoPF newObject = (schemaLib.MutedInfoPF)super.clone();

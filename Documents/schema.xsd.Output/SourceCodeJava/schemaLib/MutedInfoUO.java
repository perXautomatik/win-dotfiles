...
// </summary>
public class MutedInfoUO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoUO
	// </summary>
	// <remarks>
	...
	public MutedInfoUO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoUO newObject = (schemaLib.MutedInfoUO)super.clone();

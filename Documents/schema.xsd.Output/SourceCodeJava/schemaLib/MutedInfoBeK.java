...
// </summary>
public class MutedInfoBeK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBeK
	// </summary>
	// <remarks>
	...
	public MutedInfoBeK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBeK newObject = (schemaLib.MutedInfoBeK)super.clone();

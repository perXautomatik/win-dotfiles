...
// </summary>
public class MutedInfoCuE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCuE
	// </summary>
	// <remarks>
	...
	public MutedInfoCuE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCuE newObject = (schemaLib.MutedInfoCuE)super.clone();

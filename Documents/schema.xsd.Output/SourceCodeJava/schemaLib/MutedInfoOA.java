...
// </summary>
public class MutedInfoOA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoOA
	// </summary>
	// <remarks>
	...
	public MutedInfoOA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoOA newObject = (schemaLib.MutedInfoOA)super.clone();

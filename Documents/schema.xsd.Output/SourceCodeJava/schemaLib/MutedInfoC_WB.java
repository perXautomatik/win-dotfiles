...
// </summary>
public class MutedInfoC_WB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_WB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_WB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_WB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_WB newObject = (schemaLib.MutedInfoC_WB)super.clone();

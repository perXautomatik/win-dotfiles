...
// </summary>
public class MutedInfoBcI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBcI
	// </summary>
	// <remarks>
	...
	public MutedInfoBcI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBcI newObject = (schemaLib.MutedInfoBcI)super.clone();

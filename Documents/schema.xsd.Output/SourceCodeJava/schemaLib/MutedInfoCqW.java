...
// </summary>
public class MutedInfoCqW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCqW
	// </summary>
	// <remarks>
	...
	public MutedInfoCqW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCqW newObject = (schemaLib.MutedInfoCqW)super.clone();

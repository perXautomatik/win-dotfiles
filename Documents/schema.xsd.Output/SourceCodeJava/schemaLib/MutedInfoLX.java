...
// </summary>
public class MutedInfoLX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoLX
	// </summary>
	// <remarks>
	...
	public MutedInfoLX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoLX newObject = (schemaLib.MutedInfoLX)super.clone();

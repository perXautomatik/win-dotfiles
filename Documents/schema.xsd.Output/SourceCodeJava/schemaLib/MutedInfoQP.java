...
// </summary>
public class MutedInfoQP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoQP
	// </summary>
	// <remarks>
	...
	public MutedInfoQP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoQP newObject = (schemaLib.MutedInfoQP)super.clone();

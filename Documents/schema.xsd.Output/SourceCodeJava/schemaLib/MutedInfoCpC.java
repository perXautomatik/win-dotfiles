...
// </summary>
public class MutedInfoCpC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCpC
	// </summary>
	// <remarks>
	...
	public MutedInfoCpC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCpC newObject = (schemaLib.MutedInfoCpC)super.clone();

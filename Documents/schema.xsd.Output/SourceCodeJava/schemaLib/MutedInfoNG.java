...
// </summary>
public class MutedInfoNG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoNG
	// </summary>
	// <remarks>
	...
	public MutedInfoNG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoNG newObject = (schemaLib.MutedInfoNG)super.clone();

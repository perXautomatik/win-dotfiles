...
// </summary>
public class MutedInfoSA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoSA
	// </summary>
	// <remarks>
	...
	public MutedInfoSA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoSA newObject = (schemaLib.MutedInfoSA)super.clone();

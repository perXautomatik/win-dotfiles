...
// </summary>
public class MutedInfoQU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoQU
	// </summary>
	// <remarks>
	...
	public MutedInfoQU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoQU newObject = (schemaLib.MutedInfoQU)super.clone();

...
// </summary>
public class MutedInfoB_DB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_DB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_DB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_DB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_DB newObject = (schemaLib.MutedInfoB_DB)super.clone();

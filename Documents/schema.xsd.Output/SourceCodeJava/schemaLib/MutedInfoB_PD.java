...
// </summary>
public class MutedInfoB_PD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_PD
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_PD() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_PD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_PD newObject = (schemaLib.MutedInfoB_PD)super.clone();

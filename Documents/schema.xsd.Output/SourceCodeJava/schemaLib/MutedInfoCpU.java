...
// </summary>
public class MutedInfoCpU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCpU
	// </summary>
	// <remarks>
	...
	public MutedInfoCpU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCpU newObject = (schemaLib.MutedInfoCpU)super.clone();

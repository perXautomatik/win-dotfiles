...
// </summary>
public class MutedInfoB_I extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_I
	// </summary>
	// <remarks>
	...
	public MutedInfoB_I(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_I newObject = (schemaLib.MutedInfoB_I)super.clone();

...
// </summary>
public class MutedInfoC_Z extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_Z
	// </summary>
	// <remarks>
	...
	public MutedInfoC_Z(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_Z newObject = (schemaLib.MutedInfoC_Z)super.clone();

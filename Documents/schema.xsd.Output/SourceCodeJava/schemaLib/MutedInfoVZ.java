...
// </summary>
public class MutedInfoVZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoVZ
	// </summary>
	// <remarks>
	...
	public MutedInfoVZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoVZ newObject = (schemaLib.MutedInfoVZ)super.clone();

...
// </summary>
public class MutedInfoCvX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCvX
	// </summary>
	// <remarks>
	...
	public MutedInfoCvX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCvX newObject = (schemaLib.MutedInfoCvX)super.clone();

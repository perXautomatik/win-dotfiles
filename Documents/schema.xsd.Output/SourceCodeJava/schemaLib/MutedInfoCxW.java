...
// </summary>
public class MutedInfoCxW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCxW
	// </summary>
	// <remarks>
	...
	public MutedInfoCxW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCxW newObject = (schemaLib.MutedInfoCxW)super.clone();

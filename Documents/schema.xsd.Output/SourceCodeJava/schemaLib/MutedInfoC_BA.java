...
// </summary>
public class MutedInfoC_BA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_BA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_BA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_BA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_BA newObject = (schemaLib.MutedInfoC_BA)super.clone();

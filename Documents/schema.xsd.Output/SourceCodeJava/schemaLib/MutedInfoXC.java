...
// </summary>
public class MutedInfoXC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoXC
	// </summary>
	// <remarks>
	...
	public MutedInfoXC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoXC newObject = (schemaLib.MutedInfoXC)super.clone();

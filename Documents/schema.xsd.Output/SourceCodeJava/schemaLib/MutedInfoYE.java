...
// </summary>
public class MutedInfoYE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoYE
	// </summary>
	// <remarks>
	...
	public MutedInfoYE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoYE newObject = (schemaLib.MutedInfoYE)super.clone();

...
// </summary>
public class MutedInfoCxJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCxJ
	// </summary>
	// <remarks>
	...
	public MutedInfoCxJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCxJ newObject = (schemaLib.MutedInfoCxJ)super.clone();

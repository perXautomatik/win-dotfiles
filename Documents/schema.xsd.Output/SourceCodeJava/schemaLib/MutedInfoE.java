...
// </summary>
public class MutedInfoE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoE
	// </summary>
	// <remarks>
	...
	public MutedInfoE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoE newObject = (schemaLib.MutedInfoE)super.clone();

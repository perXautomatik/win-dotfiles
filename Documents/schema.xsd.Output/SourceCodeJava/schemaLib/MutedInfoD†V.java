...
// </summary>
public class MutedInfoD†V extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoD†V
	// </summary>
	// <remarks>
	...
	public MutedInfoD†V(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoD†V newObject = (schemaLib.MutedInfoD†V)super.clone();

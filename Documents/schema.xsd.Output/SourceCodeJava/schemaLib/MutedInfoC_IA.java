...
// </summary>
public class MutedInfoC_IA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_IA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_IA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_IA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_IA newObject = (schemaLib.MutedInfoC_IA)super.clone();

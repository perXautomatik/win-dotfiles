...
// </summary>
public class MutedInfoBfP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBfP
	// </summary>
	// <remarks>
	...
	public MutedInfoBfP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBfP newObject = (schemaLib.MutedInfoBfP)super.clone();

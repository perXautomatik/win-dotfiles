...
// </summary>
public class MutedInfoCpJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCpJ
	// </summary>
	// <remarks>
	...
	public MutedInfoCpJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCpJ newObject = (schemaLib.MutedInfoCpJ)super.clone();

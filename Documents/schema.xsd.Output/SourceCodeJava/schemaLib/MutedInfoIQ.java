...
// </summary>
public class MutedInfoIQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoIQ
	// </summary>
	// <remarks>
	...
	public MutedInfoIQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoIQ newObject = (schemaLib.MutedInfoIQ)super.clone();

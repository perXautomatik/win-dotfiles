...
// </summary>
public class MutedInfoRR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoRR
	// </summary>
	// <remarks>
	...
	public MutedInfoRR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoRR newObject = (schemaLib.MutedInfoRR)super.clone();

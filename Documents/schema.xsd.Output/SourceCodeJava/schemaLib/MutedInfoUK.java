...
// </summary>
public class MutedInfoUK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoUK
	// </summary>
	// <remarks>
	...
	public MutedInfoUK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoUK newObject = (schemaLib.MutedInfoUK)super.clone();

...
// </summary>
public class MutedInfoTN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoTN
	// </summary>
	// <remarks>
	...
	public MutedInfoTN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoTN newObject = (schemaLib.MutedInfoTN)super.clone();

...
// </summary>
public class MutedInfoPU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoPU
	// </summary>
	// <remarks>
	...
	public MutedInfoPU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoPU newObject = (schemaLib.MutedInfoPU)super.clone();

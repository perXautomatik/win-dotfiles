...
// </summary>
public class MutedInfoLC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoLC
	// </summary>
	// <remarks>
	...
	public MutedInfoLC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoLC newObject = (schemaLib.MutedInfoLC)super.clone();

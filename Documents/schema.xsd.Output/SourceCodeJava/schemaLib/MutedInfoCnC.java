...
// </summary>
public class MutedInfoCnC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCnC
	// </summary>
	// <remarks>
	...
	public MutedInfoCnC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCnC newObject = (schemaLib.MutedInfoCnC)super.clone();

...
// </summary>
public class MutedInfoZS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoZS
	// </summary>
	// <remarks>
	...
	public MutedInfoZS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoZS newObject = (schemaLib.MutedInfoZS)super.clone();

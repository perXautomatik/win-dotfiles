...
// </summary>
public class MutedInfoDŒX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŒX
	// </summary>
	// <remarks>
	...
	public MutedInfoDŒX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŒX newObject = (schemaLib.MutedInfoDŒX)super.clone();

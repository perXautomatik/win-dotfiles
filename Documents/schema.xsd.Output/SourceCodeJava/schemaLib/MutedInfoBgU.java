...
// </summary>
public class MutedInfoBgU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBgU
	// </summary>
	// <remarks>
	...
	public MutedInfoBgU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBgU newObject = (schemaLib.MutedInfoBgU)super.clone();

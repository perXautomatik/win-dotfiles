...
// </summary>
public class MutedInfoCmT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCmT
	// </summary>
	// <remarks>
	...
	public MutedInfoCmT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCmT newObject = (schemaLib.MutedInfoCmT)super.clone();

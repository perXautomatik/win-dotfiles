...
// </summary>
public class MutedInfoSZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoSZ
	// </summary>
	// <remarks>
	...
	public MutedInfoSZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoSZ newObject = (schemaLib.MutedInfoSZ)super.clone();

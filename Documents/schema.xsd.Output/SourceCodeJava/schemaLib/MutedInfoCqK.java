...
// </summary>
public class MutedInfoCqK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCqK
	// </summary>
	// <remarks>
	...
	public MutedInfoCqK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCqK newObject = (schemaLib.MutedInfoCqK)super.clone();

...
// </summary>
public class MutedInfoBgP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBgP
	// </summary>
	// <remarks>
	...
	public MutedInfoBgP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBgP newObject = (schemaLib.MutedInfoBgP)super.clone();

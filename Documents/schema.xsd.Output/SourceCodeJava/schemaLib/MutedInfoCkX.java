...
// </summary>
public class MutedInfoCkX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCkX
	// </summary>
	// <remarks>
	...
	public MutedInfoCkX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCkX newObject = (schemaLib.MutedInfoCkX)super.clone();

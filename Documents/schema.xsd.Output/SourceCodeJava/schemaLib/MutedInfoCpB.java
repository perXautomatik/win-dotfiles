...
// </summary>
public class MutedInfoCpB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCpB
	// </summary>
	// <remarks>
	...
	public MutedInfoCpB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCpB newObject = (schemaLib.MutedInfoCpB)super.clone();

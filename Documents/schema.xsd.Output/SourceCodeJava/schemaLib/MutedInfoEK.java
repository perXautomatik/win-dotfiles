...
// </summary>
public class MutedInfoEK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoEK
	// </summary>
	// <remarks>
	...
	public MutedInfoEK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoEK newObject = (schemaLib.MutedInfoEK)super.clone();

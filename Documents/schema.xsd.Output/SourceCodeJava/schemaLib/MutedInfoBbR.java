...
// </summary>
public class MutedInfoBbR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBbR
	// </summary>
	// <remarks>
	...
	public MutedInfoBbR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBbR newObject = (schemaLib.MutedInfoBbR)super.clone();

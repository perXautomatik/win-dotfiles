...
// </summary>
public class MutedInfoBbK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBbK
	// </summary>
	// <remarks>
	...
	public MutedInfoBbK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBbK newObject = (schemaLib.MutedInfoBbK)super.clone();

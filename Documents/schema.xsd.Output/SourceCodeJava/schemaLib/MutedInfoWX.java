...
// </summary>
public class MutedInfoWX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoWX
	// </summary>
	// <remarks>
	...
	public MutedInfoWX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoWX newObject = (schemaLib.MutedInfoWX)super.clone();

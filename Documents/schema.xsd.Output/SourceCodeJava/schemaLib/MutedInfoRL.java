...
// </summary>
public class MutedInfoRL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoRL
	// </summary>
	// <remarks>
	...
	public MutedInfoRL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoRL newObject = (schemaLib.MutedInfoRL)super.clone();

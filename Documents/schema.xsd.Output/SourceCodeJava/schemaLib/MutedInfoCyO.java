...
// </summary>
public class MutedInfoCyO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCyO
	// </summary>
	// <remarks>
	...
	public MutedInfoCyO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCyO newObject = (schemaLib.MutedInfoCyO)super.clone();

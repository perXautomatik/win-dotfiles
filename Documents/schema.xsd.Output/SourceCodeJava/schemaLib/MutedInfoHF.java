...
// </summary>
public class MutedInfoHF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoHF
	// </summary>
	// <remarks>
	...
	public MutedInfoHF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoHF newObject = (schemaLib.MutedInfoHF)super.clone();

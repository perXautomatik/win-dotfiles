...
// </summary>
public class MutedInfoMT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoMT
	// </summary>
	// <remarks>
	...
	public MutedInfoMT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoMT newObject = (schemaLib.MutedInfoMT)super.clone();

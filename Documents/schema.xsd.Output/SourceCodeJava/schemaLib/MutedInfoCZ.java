...
// </summary>
public class MutedInfoCZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCZ
	// </summary>
	// <remarks>
	...
	public MutedInfoCZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCZ newObject = (schemaLib.MutedInfoCZ)super.clone();

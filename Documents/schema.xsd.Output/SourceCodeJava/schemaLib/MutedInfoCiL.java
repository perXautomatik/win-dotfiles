...
// </summary>
public class MutedInfoCiL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCiL
	// </summary>
	// <remarks>
	...
	public MutedInfoCiL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCiL newObject = (schemaLib.MutedInfoCiL)super.clone();

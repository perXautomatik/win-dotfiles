...
// </summary>
public class MutedInfoBfT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBfT
	// </summary>
	// <remarks>
	...
	public MutedInfoBfT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBfT newObject = (schemaLib.MutedInfoBfT)super.clone();

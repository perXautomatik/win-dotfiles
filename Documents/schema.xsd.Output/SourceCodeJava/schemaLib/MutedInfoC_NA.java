...
// </summary>
public class MutedInfoC_NA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_NA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_NA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_NA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_NA newObject = (schemaLib.MutedInfoC_NA)super.clone();

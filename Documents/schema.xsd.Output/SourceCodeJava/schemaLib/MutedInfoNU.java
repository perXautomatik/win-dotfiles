...
// </summary>
public class MutedInfoNU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoNU
	// </summary>
	// <remarks>
	...
	public MutedInfoNU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoNU newObject = (schemaLib.MutedInfoNU)super.clone();

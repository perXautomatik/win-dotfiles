...
// </summary>
public class MutedInfoOY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoOY
	// </summary>
	// <remarks>
	...
	public MutedInfoOY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoOY newObject = (schemaLib.MutedInfoOY)super.clone();

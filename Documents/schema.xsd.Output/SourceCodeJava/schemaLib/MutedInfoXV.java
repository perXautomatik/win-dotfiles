...
// </summary>
public class MutedInfoXV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoXV
	// </summary>
	// <remarks>
	...
	public MutedInfoXV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoXV newObject = (schemaLib.MutedInfoXV)super.clone();

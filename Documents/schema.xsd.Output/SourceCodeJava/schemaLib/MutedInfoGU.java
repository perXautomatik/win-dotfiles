...
// </summary>
public class MutedInfoGU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoGU
	// </summary>
	// <remarks>
	...
	public MutedInfoGU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoGU newObject = (schemaLib.MutedInfoGU)super.clone();

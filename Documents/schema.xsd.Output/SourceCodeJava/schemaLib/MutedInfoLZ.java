...
// </summary>
public class MutedInfoLZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoLZ
	// </summary>
	// <remarks>
	...
	public MutedInfoLZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoLZ newObject = (schemaLib.MutedInfoLZ)super.clone();

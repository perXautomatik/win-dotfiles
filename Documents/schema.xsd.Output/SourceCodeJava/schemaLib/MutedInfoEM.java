...
// </summary>
public class MutedInfoEM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoEM
	// </summary>
	// <remarks>
	...
	public MutedInfoEM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoEM newObject = (schemaLib.MutedInfoEM)super.clone();

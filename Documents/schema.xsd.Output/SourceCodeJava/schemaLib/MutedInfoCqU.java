...
// </summary>
public class MutedInfoCqU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCqU
	// </summary>
	// <remarks>
	...
	public MutedInfoCqU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCqU newObject = (schemaLib.MutedInfoCqU)super.clone();

...
// </summary>
public class MutedInfoCpP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCpP
	// </summary>
	// <remarks>
	...
	public MutedInfoCpP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCpP newObject = (schemaLib.MutedInfoCpP)super.clone();

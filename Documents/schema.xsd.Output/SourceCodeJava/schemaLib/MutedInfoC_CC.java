...
// </summary>
public class MutedInfoC_CC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_CC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_CC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_CC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_CC newObject = (schemaLib.MutedInfoC_CC)super.clone();

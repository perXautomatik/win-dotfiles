...
// </summary>
public class MutedInfoDL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDL
	// </summary>
	// <remarks>
	...
	public MutedInfoDL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDL newObject = (schemaLib.MutedInfoDL)super.clone();

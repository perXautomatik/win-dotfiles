...
// </summary>
public class MutedInfoBbY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBbY
	// </summary>
	// <remarks>
	...
	public MutedInfoBbY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBbY newObject = (schemaLib.MutedInfoBbY)super.clone();

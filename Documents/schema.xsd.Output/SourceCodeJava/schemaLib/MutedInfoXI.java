...
// </summary>
public class MutedInfoXI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoXI
	// </summary>
	// <remarks>
	...
	public MutedInfoXI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoXI newObject = (schemaLib.MutedInfoXI)super.clone();

...
// </summary>
public class MutedInfoCzX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCzX
	// </summary>
	// <remarks>
	...
	public MutedInfoCzX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCzX newObject = (schemaLib.MutedInfoCzX)super.clone();

...
// </summary>
public class MutedInfoCpT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCpT
	// </summary>
	// <remarks>
	...
	public MutedInfoCpT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCpT newObject = (schemaLib.MutedInfoCpT)super.clone();

...
// </summary>
public class MutedInfoTG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoTG
	// </summary>
	// <remarks>
	...
	public MutedInfoTG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoTG newObject = (schemaLib.MutedInfoTG)super.clone();

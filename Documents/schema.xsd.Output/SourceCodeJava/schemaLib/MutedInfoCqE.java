...
// </summary>
public class MutedInfoCqE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCqE
	// </summary>
	// <remarks>
	...
	public MutedInfoCqE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCqE newObject = (schemaLib.MutedInfoCqE)super.clone();

...
// </summary>
public class MutedInfoZN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoZN
	// </summary>
	// <remarks>
	...
	public MutedInfoZN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoZN newObject = (schemaLib.MutedInfoZN)super.clone();

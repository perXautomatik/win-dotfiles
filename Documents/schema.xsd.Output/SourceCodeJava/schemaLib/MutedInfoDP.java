...
// </summary>
public class MutedInfoDP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDP
	// </summary>
	// <remarks>
	...
	public MutedInfoDP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDP newObject = (schemaLib.MutedInfoDP)super.clone();

...
// </summary>
public class MutedInfoJK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoJK
	// </summary>
	// <remarks>
	...
	public MutedInfoJK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoJK newObject = (schemaLib.MutedInfoJK)super.clone();

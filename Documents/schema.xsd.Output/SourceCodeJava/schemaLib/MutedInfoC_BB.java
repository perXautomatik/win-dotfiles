...
// </summary>
public class MutedInfoC_BB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_BB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_BB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_BB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_BB newObject = (schemaLib.MutedInfoC_BB)super.clone();

...
// </summary>
public class MutedInfoC_TB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_TB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_TB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_TB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_TB newObject = (schemaLib.MutedInfoC_TB)super.clone();

...
// </summary>
public class MutedInfoBdI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBdI
	// </summary>
	// <remarks>
	...
	public MutedInfoBdI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBdI newObject = (schemaLib.MutedInfoBdI)super.clone();

...
// </summary>
public class MutedInfoBfB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBfB
	// </summary>
	// <remarks>
	...
	public MutedInfoBfB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBfB newObject = (schemaLib.MutedInfoBfB)super.clone();

...
// </summary>
public class MutedInfoCjP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCjP
	// </summary>
	// <remarks>
	...
	public MutedInfoCjP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCjP newObject = (schemaLib.MutedInfoCjP)super.clone();

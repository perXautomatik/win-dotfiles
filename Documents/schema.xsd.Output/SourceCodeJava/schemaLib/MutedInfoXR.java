...
// </summary>
public class MutedInfoXR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoXR
	// </summary>
	// <remarks>
	...
	public MutedInfoXR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoXR newObject = (schemaLib.MutedInfoXR)super.clone();

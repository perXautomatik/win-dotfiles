...
// </summary>
public class MutedInfoCoY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCoY
	// </summary>
	// <remarks>
	...
	public MutedInfoCoY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCoY newObject = (schemaLib.MutedInfoCoY)super.clone();

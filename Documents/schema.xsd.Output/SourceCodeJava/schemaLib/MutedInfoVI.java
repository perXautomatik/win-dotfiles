...
// </summary>
public class MutedInfoVI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoVI
	// </summary>
	// <remarks>
	...
	public MutedInfoVI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoVI newObject = (schemaLib.MutedInfoVI)super.clone();

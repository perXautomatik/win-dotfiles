...
// </summary>
public class MutedInfoB_QC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_QC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_QC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_QC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_QC newObject = (schemaLib.MutedInfoB_QC)super.clone();

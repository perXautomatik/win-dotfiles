...
// </summary>
public class MutedInfoBdT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBdT
	// </summary>
	// <remarks>
	...
	public MutedInfoBdT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBdT newObject = (schemaLib.MutedInfoBdT)super.clone();

...
// </summary>
public class MutedInfoTS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoTS
	// </summary>
	// <remarks>
	...
	public MutedInfoTS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoTS newObject = (schemaLib.MutedInfoTS)super.clone();

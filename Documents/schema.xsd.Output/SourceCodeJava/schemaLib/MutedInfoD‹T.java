...
// </summary>
public class MutedInfoD‹T extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoD‹T
	// </summary>
	// <remarks>
	...
	public MutedInfoD‹T(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoD‹T newObject = (schemaLib.MutedInfoD‹T)super.clone();

...
// </summary>
public class MutedInfoVA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoVA
	// </summary>
	// <remarks>
	...
	public MutedInfoVA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoVA newObject = (schemaLib.MutedInfoVA)super.clone();

...
// </summary>
public class MutedInfoB_OA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_OA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_OA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_OA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_OA newObject = (schemaLib.MutedInfoB_OA)super.clone();

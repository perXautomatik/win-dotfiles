...
// </summary>
public class MutedInfoBgM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBgM
	// </summary>
	// <remarks>
	...
	public MutedInfoBgM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBgM newObject = (schemaLib.MutedInfoBgM)super.clone();

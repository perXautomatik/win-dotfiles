...
// </summary>
public class MutedInfoKR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoKR
	// </summary>
	// <remarks>
	...
	public MutedInfoKR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoKR newObject = (schemaLib.MutedInfoKR)super.clone();

...
// </summary>
public class MutedInfoRO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoRO
	// </summary>
	// <remarks>
	...
	public MutedInfoRO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoRO newObject = (schemaLib.MutedInfoRO)super.clone();

...
// </summary>
public class MutedInfoG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoG
	// </summary>
	// <remarks>
	...
	public MutedInfoG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoG newObject = (schemaLib.MutedInfoG)super.clone();

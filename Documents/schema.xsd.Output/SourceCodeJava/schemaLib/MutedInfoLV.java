...
// </summary>
public class MutedInfoLV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoLV
	// </summary>
	// <remarks>
	...
	public MutedInfoLV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoLV newObject = (schemaLib.MutedInfoLV)super.clone();

...
// </summary>
public class MutedInfoBgV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBgV
	// </summary>
	// <remarks>
	...
	public MutedInfoBgV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBgV newObject = (schemaLib.MutedInfoBgV)super.clone();

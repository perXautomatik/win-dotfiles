...
// </summary>
public class MutedInfoHI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoHI
	// </summary>
	// <remarks>
	...
	public MutedInfoHI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoHI newObject = (schemaLib.MutedInfoHI)super.clone();

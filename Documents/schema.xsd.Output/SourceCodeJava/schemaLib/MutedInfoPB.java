...
// </summary>
public class MutedInfoPB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoPB
	// </summary>
	// <remarks>
	...
	public MutedInfoPB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoPB newObject = (schemaLib.MutedInfoPB)super.clone();

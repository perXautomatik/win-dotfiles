...
// </summary>
public class MutedInfoGZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoGZ
	// </summary>
	// <remarks>
	...
	public MutedInfoGZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoGZ newObject = (schemaLib.MutedInfoGZ)super.clone();

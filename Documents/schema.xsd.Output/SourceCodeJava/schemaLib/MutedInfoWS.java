...
// </summary>
public class MutedInfoWS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoWS
	// </summary>
	// <remarks>
	...
	public MutedInfoWS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoWS newObject = (schemaLib.MutedInfoWS)super.clone();

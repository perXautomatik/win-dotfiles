...
// </summary>
public class MutedInfoCxF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCxF
	// </summary>
	// <remarks>
	...
	public MutedInfoCxF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCxF newObject = (schemaLib.MutedInfoCxF)super.clone();

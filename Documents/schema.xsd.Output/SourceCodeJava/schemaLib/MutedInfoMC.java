...
// </summary>
public class MutedInfoMC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoMC
	// </summary>
	// <remarks>
	...
	public MutedInfoMC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoMC newObject = (schemaLib.MutedInfoMC)super.clone();

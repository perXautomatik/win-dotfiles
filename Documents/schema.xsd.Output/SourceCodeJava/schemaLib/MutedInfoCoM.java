...
// </summary>
public class MutedInfoCoM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCoM
	// </summary>
	// <remarks>
	...
	public MutedInfoCoM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCoM newObject = (schemaLib.MutedInfoCoM)super.clone();

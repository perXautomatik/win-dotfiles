...
// </summary>
public class MutedInfoC_RA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_RA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_RA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_RA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_RA newObject = (schemaLib.MutedInfoC_RA)super.clone();

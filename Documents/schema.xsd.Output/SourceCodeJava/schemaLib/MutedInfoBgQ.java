...
// </summary>
public class MutedInfoBgQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBgQ
	// </summary>
	// <remarks>
	...
	public MutedInfoBgQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBgQ newObject = (schemaLib.MutedInfoBgQ)super.clone();

...
// </summary>
public class MutedInfoCuU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCuU
	// </summary>
	// <remarks>
	...
	public MutedInfoCuU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCuU newObject = (schemaLib.MutedInfoCuU)super.clone();

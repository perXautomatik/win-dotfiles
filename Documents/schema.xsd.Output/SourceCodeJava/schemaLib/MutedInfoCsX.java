...
// </summary>
public class MutedInfoCsX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCsX
	// </summary>
	// <remarks>
	...
	public MutedInfoCsX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCsX newObject = (schemaLib.MutedInfoCsX)super.clone();

...
// </summary>
public class MutedInfoCtD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCtD
	// </summary>
	// <remarks>
	...
	public MutedInfoCtD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCtD newObject = (schemaLib.MutedInfoCtD)super.clone();

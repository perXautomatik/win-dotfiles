...
// </summary>
public class MutedInfoSY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoSY
	// </summary>
	// <remarks>
	...
	public MutedInfoSY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoSY newObject = (schemaLib.MutedInfoSY)super.clone();

...
// </summary>
public class MutedInfoSH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoSH
	// </summary>
	// <remarks>
	...
	public MutedInfoSH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoSH newObject = (schemaLib.MutedInfoSH)super.clone();

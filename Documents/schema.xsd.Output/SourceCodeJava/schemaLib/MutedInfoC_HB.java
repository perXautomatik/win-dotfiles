...
// </summary>
public class MutedInfoC_HB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_HB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_HB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_HB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_HB newObject = (schemaLib.MutedInfoC_HB)super.clone();

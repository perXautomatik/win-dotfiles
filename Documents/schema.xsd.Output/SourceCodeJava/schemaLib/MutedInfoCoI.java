...
// </summary>
public class MutedInfoCoI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCoI
	// </summary>
	// <remarks>
	...
	public MutedInfoCoI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCoI newObject = (schemaLib.MutedInfoCoI)super.clone();

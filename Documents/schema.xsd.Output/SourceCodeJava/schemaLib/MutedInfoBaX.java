...
// </summary>
public class MutedInfoBaX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBaX
	// </summary>
	// <remarks>
	...
	public MutedInfoBaX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBaX newObject = (schemaLib.MutedInfoBaX)super.clone();

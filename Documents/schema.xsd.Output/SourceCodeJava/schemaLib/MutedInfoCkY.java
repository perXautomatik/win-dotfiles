...
// </summary>
public class MutedInfoCkY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCkY
	// </summary>
	// <remarks>
	...
	public MutedInfoCkY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCkY newObject = (schemaLib.MutedInfoCkY)super.clone();

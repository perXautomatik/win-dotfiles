...
// </summary>
public class MutedInfoZG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoZG
	// </summary>
	// <remarks>
	...
	public MutedInfoZG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoZG newObject = (schemaLib.MutedInfoZG)super.clone();

...
// </summary>
public class MutedInfoBgG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBgG
	// </summary>
	// <remarks>
	...
	public MutedInfoBgG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBgG newObject = (schemaLib.MutedInfoBgG)super.clone();

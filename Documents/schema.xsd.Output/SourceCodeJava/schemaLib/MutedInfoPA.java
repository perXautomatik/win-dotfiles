...
// </summary>
public class MutedInfoPA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoPA
	// </summary>
	// <remarks>
	...
	public MutedInfoPA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoPA newObject = (schemaLib.MutedInfoPA)super.clone();

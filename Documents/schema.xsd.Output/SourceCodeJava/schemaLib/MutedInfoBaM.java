...
// </summary>
public class MutedInfoBaM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBaM
	// </summary>
	// <remarks>
	...
	public MutedInfoBaM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBaM newObject = (schemaLib.MutedInfoBaM)super.clone();

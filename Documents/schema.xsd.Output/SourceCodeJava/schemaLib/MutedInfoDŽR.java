...
// </summary>
public class MutedInfoDŽR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŽR
	// </summary>
	// <remarks>
	...
	public MutedInfoDŽR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŽR newObject = (schemaLib.MutedInfoDŽR)super.clone();

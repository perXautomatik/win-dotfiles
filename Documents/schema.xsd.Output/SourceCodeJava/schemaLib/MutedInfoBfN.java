...
// </summary>
public class MutedInfoBfN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBfN
	// </summary>
	// <remarks>
	...
	public MutedInfoBfN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBfN newObject = (schemaLib.MutedInfoBfN)super.clone();

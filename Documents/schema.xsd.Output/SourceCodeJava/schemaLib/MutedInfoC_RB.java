...
// </summary>
public class MutedInfoC_RB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_RB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_RB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_RB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_RB newObject = (schemaLib.MutedInfoC_RB)super.clone();

...
// </summary>
public class MutedInfoB_U extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_U
	// </summary>
	// <remarks>
	...
	public MutedInfoB_U(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_U newObject = (schemaLib.MutedInfoB_U)super.clone();

...
// </summary>
public class MutedInfoMY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoMY
	// </summary>
	// <remarks>
	...
	public MutedInfoMY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoMY newObject = (schemaLib.MutedInfoMY)super.clone();

...
// </summary>
public class MutedInfoCjR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCjR
	// </summary>
	// <remarks>
	...
	public MutedInfoCjR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCjR newObject = (schemaLib.MutedInfoCjR)super.clone();

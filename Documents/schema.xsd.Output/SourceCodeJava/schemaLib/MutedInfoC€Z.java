...
// </summary>
public class MutedInfoC€Z extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC€Z
	// </summary>
	// <remarks>
	...
	public MutedInfoC€Z(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC€Z newObject = (schemaLib.MutedInfoC€Z)super.clone();

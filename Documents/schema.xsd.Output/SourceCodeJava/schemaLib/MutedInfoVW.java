...
// </summary>
public class MutedInfoVW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoVW
	// </summary>
	// <remarks>
	...
	public MutedInfoVW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoVW newObject = (schemaLib.MutedInfoVW)super.clone();

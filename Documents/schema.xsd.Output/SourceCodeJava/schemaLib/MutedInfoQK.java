...
// </summary>
public class MutedInfoQK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoQK
	// </summary>
	// <remarks>
	...
	public MutedInfoQK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoQK newObject = (schemaLib.MutedInfoQK)super.clone();

...
// </summary>
public class MutedInfoDŠO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŠO
	// </summary>
	// <remarks>
	...
	public MutedInfoDŠO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŠO newObject = (schemaLib.MutedInfoDŠO)super.clone();

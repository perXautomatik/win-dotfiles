...
// </summary>
public class MutedInfoBgX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBgX
	// </summary>
	// <remarks>
	...
	public MutedInfoBgX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBgX newObject = (schemaLib.MutedInfoBgX)super.clone();

...
// </summary>
public class MutedInfoTL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoTL
	// </summary>
	// <remarks>
	...
	public MutedInfoTL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoTL newObject = (schemaLib.MutedInfoTL)super.clone();

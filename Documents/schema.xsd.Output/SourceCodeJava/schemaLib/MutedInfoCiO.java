...
// </summary>
public class MutedInfoCiO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCiO
	// </summary>
	// <remarks>
	...
	public MutedInfoCiO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCiO newObject = (schemaLib.MutedInfoCiO)super.clone();

...
// </summary>
public class MutedInfoCnR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCnR
	// </summary>
	// <remarks>
	...
	public MutedInfoCnR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCnR newObject = (schemaLib.MutedInfoCnR)super.clone();

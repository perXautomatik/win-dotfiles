...
// </summary>
public class MutedInfoB_L extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_L
	// </summary>
	// <remarks>
	...
	public MutedInfoB_L(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_L newObject = (schemaLib.MutedInfoB_L)super.clone();

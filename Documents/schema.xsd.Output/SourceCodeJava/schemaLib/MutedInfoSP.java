...
// </summary>
public class MutedInfoSP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoSP
	// </summary>
	// <remarks>
	...
	public MutedInfoSP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoSP newObject = (schemaLib.MutedInfoSP)super.clone();

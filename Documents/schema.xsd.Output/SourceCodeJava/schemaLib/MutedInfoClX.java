...
// </summary>
public class MutedInfoClX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoClX
	// </summary>
	// <remarks>
	...
	public MutedInfoClX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoClX newObject = (schemaLib.MutedInfoClX)super.clone();

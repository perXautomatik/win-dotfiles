...
// </summary>
public class MutedInfoB_ZC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_ZC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_ZC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_ZC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_ZC newObject = (schemaLib.MutedInfoB_ZC)super.clone();

...
// </summary>
public class MutedInfoMA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoMA
	// </summary>
	// <remarks>
	...
	public MutedInfoMA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoMA newObject = (schemaLib.MutedInfoMA)super.clone();

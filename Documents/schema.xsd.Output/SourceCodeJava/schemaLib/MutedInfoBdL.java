...
// </summary>
public class MutedInfoBdL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBdL
	// </summary>
	// <remarks>
	...
	public MutedInfoBdL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBdL newObject = (schemaLib.MutedInfoBdL)super.clone();

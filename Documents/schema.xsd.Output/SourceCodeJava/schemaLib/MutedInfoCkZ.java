...
// </summary>
public class MutedInfoCkZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCkZ
	// </summary>
	// <remarks>
	...
	public MutedInfoCkZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCkZ newObject = (schemaLib.MutedInfoCkZ)super.clone();

...
// </summary>
public class MutedInfoPL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoPL
	// </summary>
	// <remarks>
	...
	public MutedInfoPL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoPL newObject = (schemaLib.MutedInfoPL)super.clone();

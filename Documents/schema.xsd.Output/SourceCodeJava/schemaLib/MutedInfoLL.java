...
// </summary>
public class MutedInfoLL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoLL
	// </summary>
	// <remarks>
	...
	public MutedInfoLL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoLL newObject = (schemaLib.MutedInfoLL)super.clone();

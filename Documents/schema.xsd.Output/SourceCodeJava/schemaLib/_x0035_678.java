...
// <summary>
// This class represents the ComplexType _x0035_678
// </summary>
public class _x0035_678 extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for _x0035_678
	// </summary>
	// <remarks>
	...
	// </remarks>
	public _x0035_678() {
		setElementName("_x0035_678");
		init();
	}
	public _x0035_678(String elementName) {
	...
	protected void init() {
		try {
			...
			_mutedInfo = null;
			_openerTabId = 0;
			_isValidOpenerTabId = false;
			_pendingUrl = "";
			_isValidPendingUrl = false;
			_pinned = false;
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib._x0035_678 newObject = (schemaLib._x0035_678)super.clone();
			...
			if (_mutedInfo != null)
				newObject._mutedInfo = (schemaLib.MutedInfoBfG)_mutedInfo.clone();
			if (_isValidOpenerTabId)
				newObject._openerTabId = _openerTabId;
			newObject._isValidOpenerTabId = _isValidOpenerTabId;
			if (_isValidPendingUrl)
				newObject._pendingUrl = _pendingUrl;
			newObject._isValidPendingUrl = _isValidPendingUrl;
			if (_isValidPinned)
			...
			if (_title != null)
				newObject._title = (com.liquid_technologies.ltxmllib19.Element)_title.clone();
			newObject._url = null;
			if (_url != null)
				newObject._url = (com.liquid_technologies.ltxmllib19.Element)_url.clone();
			if (_isValidWidth)
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
	...
	// </remarks>
	public schemaLib.MutedInfoBfG getMutedInfo() {
		return _mutedInfo;  
	}
	public void setMutedInfo(schemaLib.MutedInfoBfG value) throws com.liquid_technologies.ltxmllib19.exceptions.LtException { 
		if (value == null)
			_mutedInfo = null;
		else {
	...
	protected schemaLib.MutedInfoBfG _mutedInfo;
	...
	// It is optional, initially it is not valid.
	// </remarks>
	public int getOpenerTabId() throws com.liquid_technologies.ltxmllib19.exceptions.LtException { 
		if (_isValidOpenerTabId == false)
			throw new com.liquid_technologies.ltxmllib19.exceptions.LtInvalidStateException("The Property openerTabId is not valid. Set openerTabIdValid = true");
		return _openerTabId;  
	}
	public void setOpenerTabId(int value) throws com.liquid_technologies.ltxmllib19.exceptions.LtException { 
		_isValidOpenerTabId = true;
		_openerTabId = value;
	}

	// <summary>
	// Indicates if openerTabId contains a valid value.
	// </summary>
	// <remarks>
	// true if the value for openerTabId is valid, false if not.
	// If this is set to true then the property is considered valid, and assigned its
	// default value (0).
	// If its set to false then its made invalid, and subsequent calls to get openerTabId
	// will raise an exception.
	// </remarks>
	public boolean isValidOpenerTabId() {
		return _isValidOpenerTabId;
	}
	public void setValidOpenerTabId(boolean value)  throws com.liquid_technologies.ltxmllib19.exceptions.LtException { 
		if (value != _isValidOpenerTabId) {
			_openerTabId = 0;
			_isValidOpenerTabId = value;
		}
	}
	protected boolean _isValidOpenerTabId;
	protected int _openerTabId;
	...
	// It is optional, initially it is not valid.
	// </remarks>
	public java.lang.String getPendingUrl() throws com.liquid_technologies.ltxmllib19.exceptions.LtException { 
		if (_isValidPendingUrl == false)
			throw new com.liquid_technologies.ltxmllib19.exceptions.LtInvalidStateException("The Property pendingUrl is not valid. Set pendingUrlValid = true");
		return _pendingUrl;  
	}
	public void setPendingUrl(java.lang.String value) throws com.liquid_technologies.ltxmllib19.exceptions.LtException { 
		// Apply whitespace rules appropriately
		value = com.liquid_technologies.ltxmllib19.WhitespaceUtils.preserve(value); 
		_isValidPendingUrl = true;
		_pendingUrl = value;
	}

	// <summary>
	// Indicates if pendingUrl contains a valid value.
	// </summary>
	// <remarks>
	// true if the value for pendingUrl is valid, false if not.
	// If this is set to true then the property is considered valid, and assigned its
	// default value ("").
	// If its set to false then its made invalid, and subsequent calls to get pendingUrl
	// will raise an exception.
	// </remarks>
	public boolean isValidPendingUrl() {
		return _isValidPendingUrl;
	}
	public void setValidPendingUrl(boolean value)  throws com.liquid_technologies.ltxmllib19.exceptions.LtException { 
		if (value != _isValidPendingUrl) {
			_pendingUrl = "";
			_isValidPendingUrl = value;
		}
	}
	protected boolean _isValidPendingUrl;
	protected java.lang.String _pendingUrl;
	...
	// </remarks>
	public com.liquid_technologies.ltxmllib19.Element getTitle() {
		return _title;  
	}
	public void setTitle(com.liquid_technologies.ltxmllib19.Element value)  throws com.liquid_technologies.ltxmllib19.exceptions.LtException { 
		if (value != null)
			testNamespace(value.getNamespace(), "##any", "");
		_title = value; 
	}
	protected com.liquid_technologies.ltxmllib19.Element _title;
	...
	// </remarks>
	public com.liquid_technologies.ltxmllib19.Element getUrl() {
		return _url;  
	}
	public void setUrl(com.liquid_technologies.ltxmllib19.Element value)  throws com.liquid_technologies.ltxmllib19.exceptions.LtException { 
		if (value != null)
			testNamespace(value.getNamespace(), "##any", "");
		_url = value; 
	}
	protected com.liquid_technologies.ltxmllib19.Element _url;
	...
	protected com.liquid_technologies.ltxmllib19.ParentElementInfo getClassInfo() throws Exception {
		if (__parentElementInfo == null) {
			__parentElementInfo = new com.liquid_technologies.ltxmllib19.ParentElementInfo(	
																	...
																	com.liquid_technologies.ltxmllib19.XmlObjectBase.XmlElementType.ELEMENT, "_x0035_678", "", true, false,
	...
	protected com.liquid_technologies.ltxmllib19.ElementInfo[] getClassElementInfo() throws Exception {
		if (__elementInfo == null) {
			__elementInfo = new com.liquid_technologies.ltxmllib19.ElementInfo[] {
				 new com.liquid_technologies.ltxmllib19.data.ElementInfoSeqPrimOpt("active", "", findGetterMethod("schemaLib._x0035_678", "getActive"), findSetterMethod("schemaLib._x0035_678", "setActive", "boolean"), findGetterMethod("schemaLib._x0035_678", "isValidActive"), null, null, com.liquid_technologies.ltxmllib19.Conversions.ConversionType.TYPE_BOOLEAN, null, com.liquid_technologies.ltxmllib19.WhitespaceRule.COLLAPSE, new com.liquid_technologies.ltxmllib19.PrimitiveRestrictions("", -1, -1, "", "", "", "", -1, -1, -1), null)
				,new com.liquid_technologies.ltxmllib19.data.ElementInfoSeqPrimOpt("audible", "", findGetterMethod("schemaLib._x0035_678", "getAudible"), findSetterMethod("schemaLib._x0035_678", "setAudible", "boolean"), findGetterMethod("schemaLib._x0035_678", "isValidAudible"), null, null, com.liquid_technologies.ltxmllib19.Conversions.ConversionType.TYPE_BOOLEAN, null, com.liquid_technologies.ltxmllib19.WhitespaceRule.COLLAPSE, new com.liquid_technologies.ltxmllib19.PrimitiveRestrictions("", -1, -1, "", "", "", "", -1, -1, -1), null)
				,new com.liquid_technologies.ltxmllib19.data.ElementInfoSeqPrimOpt("autoDiscardable", "", findGetterMethod("schemaLib._x0035_678", "getAutoDiscardable"), findSetterMethod("schemaLib._x0035_678", "setAutoDiscardable", "boolean"), findGetterMethod("schemaLib._x0035_678", "isValidAutoDiscardable"), null, null, com.liquid_technologies.ltxmllib19.Conversions.ConversionType.TYPE_BOOLEAN, null, com.liquid_technologies.ltxmllib19.WhitespaceRule.COLLAPSE, new com.liquid_technologies.ltxmllib19.PrimitiveRestrictions("", -1, -1, "", "", "", "", -1, -1, -1), null)
				,new com.liquid_technologies.ltxmllib19.data.ElementInfoSeqPrimOpt("discarded", "", findGetterMethod("schemaLib._x0035_678", "getDiscarded"), findSetterMethod("schemaLib._x0035_678", "setDiscarded", "boolean"), findGetterMethod("schemaLib._x0035_678", "isValidDiscarded"), null, null, com.liquid_technologies.ltxmllib19.Conversions.ConversionType.TYPE_BOOLEAN, null, com.liquid_technologies.ltxmllib19.WhitespaceRule.COLLAPSE, new com.liquid_technologies.ltxmllib19.PrimitiveRestrictions("", -1, -1, "", "", "", "", -1, -1, -1), null)
				,new com.liquid_technologies.ltxmllib19.data.ElementInfoSeqPrimOpt("height", "", findGetterMethod("schemaLib._x0035_678", "getHeight"), findSetterMethod("schemaLib._x0035_678", "setHeight", "int"), findGetterMethod("schemaLib._x0035_678", "isValidHeight"), null, null, com.liquid_technologies.ltxmllib19.Conversions.ConversionType.TYPE_UI2, null, com.liquid_technologies.ltxmllib19.WhitespaceRule.COLLAPSE, new com.liquid_technologies.ltxmllib19.PrimitiveRestrictions("", -1, -1, "", "", "", "", -1, -1, -1), null)
				,new com.liquid_technologies.ltxmllib19.data.ElementInfoSeqPrimOpt("highlighted", "", findGetterMethod("schemaLib._x0035_678", "getHighlighted"), findSetterMethod("schemaLib._x0035_678", "setHighlighted", "boolean"), findGetterMethod("schemaLib._x0035_678", "isValidHighlighted"), null, null, com.liquid_technologies.ltxmllib19.Conversions.ConversionType.TYPE_BOOLEAN, null, com.liquid_technologies.ltxmllib19.WhitespaceRule.COLLAPSE, new com.liquid_technologies.ltxmllib19.PrimitiveRestrictions("", -1, -1, "", "", "", "", -1, -1, -1), null)
				,new com.liquid_technologies.ltxmllib19.data.ElementInfoSeqPrimOpt("id", "", findGetterMethod("schemaLib._x0035_678", "getId"), findSetterMethod("schemaLib._x0035_678", "setId", "int"), findGetterMethod("schemaLib._x0035_678", "isValidId"), null, null, com.liquid_technologies.ltxmllib19.Conversions.ConversionType.TYPE_UI2, null, com.liquid_technologies.ltxmllib19.WhitespaceRule.COLLAPSE, new com.liquid_technologies.ltxmllib19.PrimitiveRestrictions("", -1, -1, "", "", "", "", -1, -1, -1), null)
				,new com.liquid_technologies.ltxmllib19.data.ElementInfoSeqPrimOpt("incognito", "", findGetterMethod("schemaLib._x0035_678", "getIncognito"), findSetterMethod("schemaLib._x0035_678", "setIncognito", "boolean"), findGetterMethod("schemaLib._x0035_678", "isValidIncognito"), null, null, com.liquid_technologies.ltxmllib19.Conversions.ConversionType.TYPE_BOOLEAN, null, com.liquid_technologies.ltxmllib19.WhitespaceRule.COLLAPSE, new com.liquid_technologies.ltxmllib19.PrimitiveRestrictions("", -1, -1, "", "", "", "", -1, -1, -1), null)
				,new com.liquid_technologies.ltxmllib19.data.ElementInfoSeqPrimOpt("index", "", findGetterMethod("schemaLib._x0035_678", "getIndex"), findSetterMethod("schemaLib._x0035_678", "setIndex", "short"), findGetterMethod("schemaLib._x0035_678", "isValidIndex"), null, null, com.liquid_technologies.ltxmllib19.Conversions.ConversionType.TYPE_UI1, null, com.liquid_technologies.ltxmllib19.WhitespaceRule.COLLAPSE, new com.liquid_technologies.ltxmllib19.PrimitiveRestrictions("", -1, -1, "", "", "", "", -1, -1, -1), null)
				,new com.liquid_technologies.ltxmllib19.data.ElementInfoSeqClsOpt("mutedInfo", "", findGetterMethod("schemaLib._x0035_678", "getMutedInfo"), findSetterMethod("schemaLib._x0035_678", "setMutedInfo", "schemaLib.MutedInfoBfG"), com.liquid_technologies.ltxmllib19.XmlObjectBase.XmlElementType.ELEMENT, schemaLib.MutedInfoBfG.class)
				,new com.liquid_technologies.ltxmllib19.data.ElementInfoSeqPrimOpt("openerTabId", "", findGetterMethod("schemaLib._x0035_678", "getOpenerTabId"), findSetterMethod("schemaLib._x0035_678", "setOpenerTabId", "int"), findGetterMethod("schemaLib._x0035_678", "isValidOpenerTabId"), null, null, com.liquid_technologies.ltxmllib19.Conversions.ConversionType.TYPE_UI2, null, com.liquid_technologies.ltxmllib19.WhitespaceRule.COLLAPSE, new com.liquid_technologies.ltxmllib19.PrimitiveRestrictions("", -1, -1, "", "", "", "", -1, -1, -1), null)
				,new com.liquid_technologies.ltxmllib19.data.ElementInfoSeqPrimOpt("pendingUrl", "", findGetterMethod("schemaLib._x0035_678", "getPendingUrl"), findSetterMethod("schemaLib._x0035_678", "setPendingUrl", "java.lang.String"), findGetterMethod("schemaLib._x0035_678", "isValidPendingUrl"), null, null, com.liquid_technologies.ltxmllib19.Conversions.ConversionType.TYPE_STRING, null, com.liquid_technologies.ltxmllib19.WhitespaceRule.PRESERVE, new com.liquid_technologies.ltxmllib19.PrimitiveRestrictions("", -1, -1, "", "", "", "", -1, -1, -1), null)
				,new com.liquid_technologies.ltxmllib19.data.ElementInfoSeqPrimOpt("pinned", "", findGetterMethod("schemaLib._x0035_678", "getPinned"), findSetterMethod("schemaLib._x0035_678", "setPinned", "boolean"), findGetterMethod("schemaLib._x0035_678", "isValidPinned"), null, null, com.liquid_technologies.ltxmllib19.Conversions.ConversionType.TYPE_BOOLEAN, null, com.liquid_technologies.ltxmllib19.WhitespaceRule.COLLAPSE, new com.liquid_technologies.ltxmllib19.PrimitiveRestrictions("", -1, -1, "", "", "", "", -1, -1, -1), null)
				,new com.liquid_technologies.ltxmllib19.data.ElementInfoSeqPrimOpt("selected", "", findGetterMethod("schemaLib._x0035_678", "getSelected"), findSetterMethod("schemaLib._x0035_678", "setSelected", "boolean"), findGetterMethod("schemaLib._x0035_678", "isValidSelected"), null, null, com.liquid_technologies.ltxmllib19.Conversions.ConversionType.TYPE_BOOLEAN, null, com.liquid_technologies.ltxmllib19.WhitespaceRule.COLLAPSE, new com.liquid_technologies.ltxmllib19.PrimitiveRestrictions("", -1, -1, "", "", "", "", -1, -1, -1), null)
				,new com.liquid_technologies.ltxmllib19.data.ElementInfoSeqPrimOpt("status", "", findGetterMethod("schemaLib._x0035_678", "getStatus"), findSetterMethod("schemaLib._x0035_678", "setStatus", "java.lang.String"), findGetterMethod("schemaLib._x0035_678", "isValidStatus"), null, null, com.liquid_technologies.ltxmllib19.Conversions.ConversionType.TYPE_STRING, null, com.liquid_technologies.ltxmllib19.WhitespaceRule.PRESERVE, new com.liquid_technologies.ltxmllib19.PrimitiveRestrictions("", -1, -1, "", "", "", "", -1, -1, -1), null)
				,new com.liquid_technologies.ltxmllib19.data.ElementInfoSeqUntpdOpt("title", "", findGetterMethod("schemaLib._x0035_678", "getTitle"), findSetterMethod("schemaLib._x0035_678", "setTitle", "com.liquid_technologies.ltxmllib19.Element"), "##any", "")
				,new com.liquid_technologies.ltxmllib19.data.ElementInfoSeqUntpdOpt("url", "", findGetterMethod("schemaLib._x0035_678", "getUrl"), findSetterMethod("schemaLib._x0035_678", "setUrl", "com.liquid_technologies.ltxmllib19.Element"), "##any", "")
				,new com.liquid_technologies.ltxmllib19.data.ElementInfoSeqPrimOpt("width", "", findGetterMethod("schemaLib._x0035_678", "getWidth"), findSetterMethod("schemaLib._x0035_678", "setWidth", "int"), findGetterMethod("schemaLib._x0035_678", "isValidWidth"), null, null, com.liquid_technologies.ltxmllib19.Conversions.ConversionType.TYPE_UI2, null, com.liquid_technologies.ltxmllib19.WhitespaceRule.COLLAPSE, new com.liquid_technologies.ltxmllib19.PrimitiveRestrictions("", -1, -1, "", "", "", "", -1, -1, -1), null)
				,new com.liquid_technologies.ltxmllib19.data.ElementInfoSeqPrimOpt("windowId", "", findGetterMethod("schemaLib._x0035_678", "getWindowId"), findSetterMethod("schemaLib._x0035_678", "setWindowId", "int"), findGetterMethod("schemaLib._x0035_678", "isValidWindowId"), null, null, com.liquid_technologies.ltxmllib19.Conversions.ConversionType.TYPE_UI2, null, com.liquid_technologies.ltxmllib19.WhitespaceRule.COLLAPSE, new com.liquid_technologies.ltxmllib19.PrimitiveRestrictions("", -1, -1, "", "", "", "", -1, -1, -1), null)
			};
		}

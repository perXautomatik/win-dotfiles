...
// </summary>
public class MutedInfoDƒH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDƒH
	// </summary>
	// <remarks>
	...
	public MutedInfoDƒH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDƒH newObject = (schemaLib.MutedInfoDƒH)super.clone();

...
// </summary>
public class MutedInfoOC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoOC
	// </summary>
	// <remarks>
	...
	public MutedInfoOC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoOC newObject = (schemaLib.MutedInfoOC)super.clone();

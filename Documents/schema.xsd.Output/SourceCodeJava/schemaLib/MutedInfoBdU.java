...
// </summary>
public class MutedInfoBdU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBdU
	// </summary>
	// <remarks>
	...
	public MutedInfoBdU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBdU newObject = (schemaLib.MutedInfoBdU)super.clone();

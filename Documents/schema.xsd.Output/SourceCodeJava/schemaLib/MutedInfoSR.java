...
// </summary>
public class MutedInfoSR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoSR
	// </summary>
	// <remarks>
	...
	public MutedInfoSR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoSR newObject = (schemaLib.MutedInfoSR)super.clone();

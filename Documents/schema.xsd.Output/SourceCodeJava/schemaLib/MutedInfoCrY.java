...
// </summary>
public class MutedInfoCrY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCrY
	// </summary>
	// <remarks>
	...
	public MutedInfoCrY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCrY newObject = (schemaLib.MutedInfoCrY)super.clone();

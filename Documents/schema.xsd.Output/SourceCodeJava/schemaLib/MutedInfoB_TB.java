...
// </summary>
public class MutedInfoB_TB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_TB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_TB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_TB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_TB newObject = (schemaLib.MutedInfoB_TB)super.clone();

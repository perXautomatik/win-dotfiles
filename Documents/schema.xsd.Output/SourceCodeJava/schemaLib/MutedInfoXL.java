...
// </summary>
public class MutedInfoXL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoXL
	// </summary>
	// <remarks>
	...
	public MutedInfoXL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoXL newObject = (schemaLib.MutedInfoXL)super.clone();

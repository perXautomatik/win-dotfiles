...
// </summary>
public class MutedInfoBD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBD
	// </summary>
	// <remarks>
	...
	public MutedInfoBD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBD newObject = (schemaLib.MutedInfoBD)super.clone();

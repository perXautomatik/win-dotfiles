...
// </summary>
public class MutedInfoGE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoGE
	// </summary>
	// <remarks>
	...
	public MutedInfoGE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoGE newObject = (schemaLib.MutedInfoGE)super.clone();

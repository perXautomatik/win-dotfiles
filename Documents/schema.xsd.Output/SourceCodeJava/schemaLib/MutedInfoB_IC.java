...
// </summary>
public class MutedInfoB_IC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_IC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_IC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_IC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_IC newObject = (schemaLib.MutedInfoB_IC)super.clone();

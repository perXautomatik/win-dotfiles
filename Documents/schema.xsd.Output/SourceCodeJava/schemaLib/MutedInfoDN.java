...
// </summary>
public class MutedInfoDN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDN
	// </summary>
	// <remarks>
	...
	public MutedInfoDN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDN newObject = (schemaLib.MutedInfoDN)super.clone();

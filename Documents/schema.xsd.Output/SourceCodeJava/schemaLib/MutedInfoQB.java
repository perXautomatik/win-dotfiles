...
// </summary>
public class MutedInfoQB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoQB
	// </summary>
	// <remarks>
	...
	public MutedInfoQB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoQB newObject = (schemaLib.MutedInfoQB)super.clone();

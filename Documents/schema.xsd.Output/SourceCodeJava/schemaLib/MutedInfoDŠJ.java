...
// </summary>
public class MutedInfoDŠJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŠJ
	// </summary>
	// <remarks>
	...
	public MutedInfoDŠJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŠJ newObject = (schemaLib.MutedInfoDŠJ)super.clone();

...
// </summary>
public class MutedInfoBeI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBeI
	// </summary>
	// <remarks>
	...
	public MutedInfoBeI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBeI newObject = (schemaLib.MutedInfoBeI)super.clone();

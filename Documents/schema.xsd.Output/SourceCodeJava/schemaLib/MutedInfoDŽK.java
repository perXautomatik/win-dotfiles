...
// </summary>
public class MutedInfoDŽK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŽK
	// </summary>
	// <remarks>
	...
	public MutedInfoDŽK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŽK newObject = (schemaLib.MutedInfoDŽK)super.clone();

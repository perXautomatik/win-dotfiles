...
// </summary>
public class MutedInfoIC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoIC
	// </summary>
	// <remarks>
	...
	public MutedInfoIC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoIC newObject = (schemaLib.MutedInfoIC)super.clone();

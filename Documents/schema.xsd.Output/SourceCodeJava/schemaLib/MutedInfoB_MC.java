...
// </summary>
public class MutedInfoB_MC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_MC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_MC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_MC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_MC newObject = (schemaLib.MutedInfoB_MC)super.clone();

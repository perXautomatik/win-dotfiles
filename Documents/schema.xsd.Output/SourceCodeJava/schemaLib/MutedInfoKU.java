...
// </summary>
public class MutedInfoKU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoKU
	// </summary>
	// <remarks>
	...
	public MutedInfoKU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoKU newObject = (schemaLib.MutedInfoKU)super.clone();

...
// </summary>
public class MutedInfoVF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoVF
	// </summary>
	// <remarks>
	...
	public MutedInfoVF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoVF newObject = (schemaLib.MutedInfoVF)super.clone();

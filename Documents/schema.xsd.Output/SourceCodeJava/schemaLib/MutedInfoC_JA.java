...
// </summary>
public class MutedInfoC_JA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_JA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_JA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_JA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_JA newObject = (schemaLib.MutedInfoC_JA)super.clone();

...
// </summary>
public class MutedInfoCoP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCoP
	// </summary>
	// <remarks>
	...
	public MutedInfoCoP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCoP newObject = (schemaLib.MutedInfoCoP)super.clone();

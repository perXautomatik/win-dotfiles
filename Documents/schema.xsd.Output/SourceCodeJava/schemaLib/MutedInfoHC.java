...
// </summary>
public class MutedInfoHC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoHC
	// </summary>
	// <remarks>
	...
	public MutedInfoHC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoHC newObject = (schemaLib.MutedInfoHC)super.clone();

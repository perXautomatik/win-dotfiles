...
// </summary>
public class MutedInfoB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB
	// </summary>
	// <remarks>
	...
	public MutedInfoB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB newObject = (schemaLib.MutedInfoB)super.clone();

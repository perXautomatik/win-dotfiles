...
// </summary>
public class MutedInfoBfO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBfO
	// </summary>
	// <remarks>
	...
	public MutedInfoBfO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBfO newObject = (schemaLib.MutedInfoBfO)super.clone();

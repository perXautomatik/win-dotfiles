...
// </summary>
public class MutedInfoDƒT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDƒT
	// </summary>
	// <remarks>
	...
	public MutedInfoDƒT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDƒT newObject = (schemaLib.MutedInfoDƒT)super.clone();

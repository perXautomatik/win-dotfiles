...
// </summary>
public class MutedInfoCnU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCnU
	// </summary>
	// <remarks>
	...
	public MutedInfoCnU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCnU newObject = (schemaLib.MutedInfoCnU)super.clone();

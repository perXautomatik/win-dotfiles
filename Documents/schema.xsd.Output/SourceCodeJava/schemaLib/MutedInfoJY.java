...
// </summary>
public class MutedInfoJY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoJY
	// </summary>
	// <remarks>
	...
	public MutedInfoJY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoJY newObject = (schemaLib.MutedInfoJY)super.clone();

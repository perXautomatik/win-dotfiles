...
// </summary>
public class MutedInfoC_YA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_YA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_YA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_YA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_YA newObject = (schemaLib.MutedInfoC_YA)super.clone();

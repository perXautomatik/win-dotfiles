...
// </summary>
public class MutedInfoNS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoNS
	// </summary>
	// <remarks>
	...
	public MutedInfoNS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoNS newObject = (schemaLib.MutedInfoNS)super.clone();

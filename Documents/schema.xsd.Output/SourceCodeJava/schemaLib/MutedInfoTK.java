...
// </summary>
public class MutedInfoTK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoTK
	// </summary>
	// <remarks>
	...
	public MutedInfoTK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoTK newObject = (schemaLib.MutedInfoTK)super.clone();

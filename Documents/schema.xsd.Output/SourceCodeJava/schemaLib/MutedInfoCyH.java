...
// </summary>
public class MutedInfoCyH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCyH
	// </summary>
	// <remarks>
	...
	public MutedInfoCyH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCyH newObject = (schemaLib.MutedInfoCyH)super.clone();

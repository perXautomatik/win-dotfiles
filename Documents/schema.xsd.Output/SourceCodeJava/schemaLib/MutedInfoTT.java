...
// </summary>
public class MutedInfoTT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoTT
	// </summary>
	// <remarks>
	...
	public MutedInfoTT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoTT newObject = (schemaLib.MutedInfoTT)super.clone();

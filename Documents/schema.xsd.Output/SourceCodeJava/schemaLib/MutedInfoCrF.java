...
// </summary>
public class MutedInfoCrF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCrF
	// </summary>
	// <remarks>
	...
	public MutedInfoCrF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCrF newObject = (schemaLib.MutedInfoCrF)super.clone();

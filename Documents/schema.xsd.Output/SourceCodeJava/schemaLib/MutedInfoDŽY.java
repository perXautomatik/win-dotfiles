...
// </summary>
public class MutedInfoDŽY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŽY
	// </summary>
	// <remarks>
	...
	public MutedInfoDŽY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŽY newObject = (schemaLib.MutedInfoDŽY)super.clone();

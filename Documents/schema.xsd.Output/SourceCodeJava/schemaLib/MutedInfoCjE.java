...
// </summary>
public class MutedInfoCjE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCjE
	// </summary>
	// <remarks>
	...
	public MutedInfoCjE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCjE newObject = (schemaLib.MutedInfoCjE)super.clone();

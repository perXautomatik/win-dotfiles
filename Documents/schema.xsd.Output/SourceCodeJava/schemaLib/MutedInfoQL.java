...
// </summary>
public class MutedInfoQL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoQL
	// </summary>
	// <remarks>
	...
	public MutedInfoQL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoQL newObject = (schemaLib.MutedInfoQL)super.clone();

...
// </summary>
public class MutedInfoCjO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCjO
	// </summary>
	// <remarks>
	...
	public MutedInfoCjO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCjO newObject = (schemaLib.MutedInfoCjO)super.clone();

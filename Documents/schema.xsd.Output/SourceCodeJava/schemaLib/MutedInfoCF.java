...
// </summary>
public class MutedInfoCF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCF
	// </summary>
	// <remarks>
	...
	public MutedInfoCF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCF newObject = (schemaLib.MutedInfoCF)super.clone();

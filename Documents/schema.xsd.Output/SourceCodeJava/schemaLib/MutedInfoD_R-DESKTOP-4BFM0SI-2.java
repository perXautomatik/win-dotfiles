...
// </summary>
public class MutedInfoDR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDR
	// </summary>
	// <remarks>
	...
	public MutedInfoDR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDR newObject = (schemaLib.MutedInfoDR)super.clone();

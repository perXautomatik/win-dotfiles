...
// </summary>
public class MutedInfoCsG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCsG
	// </summary>
	// <remarks>
	...
	public MutedInfoCsG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCsG newObject = (schemaLib.MutedInfoCsG)super.clone();

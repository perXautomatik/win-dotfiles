...
// </summary>
public class MutedInfoSV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoSV
	// </summary>
	// <remarks>
	...
	public MutedInfoSV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoSV newObject = (schemaLib.MutedInfoSV)super.clone();

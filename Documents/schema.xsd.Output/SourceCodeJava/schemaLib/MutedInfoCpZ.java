...
// </summary>
public class MutedInfoCpZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCpZ
	// </summary>
	// <remarks>
	...
	public MutedInfoCpZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCpZ newObject = (schemaLib.MutedInfoCpZ)super.clone();

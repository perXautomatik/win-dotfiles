...
// </summary>
public class MutedInfoBgC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBgC
	// </summary>
	// <remarks>
	...
	public MutedInfoBgC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBgC newObject = (schemaLib.MutedInfoBgC)super.clone();

...
// </summary>
public class MutedInfoEA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoEA
	// </summary>
	// <remarks>
	...
	public MutedInfoEA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoEA newObject = (schemaLib.MutedInfoEA)super.clone();

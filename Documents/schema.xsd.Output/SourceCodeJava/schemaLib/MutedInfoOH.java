...
// </summary>
public class MutedInfoOH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoOH
	// </summary>
	// <remarks>
	...
	public MutedInfoOH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoOH newObject = (schemaLib.MutedInfoOH)super.clone();

...
// </summary>
public class MutedInfoFQ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoFQ
	// </summary>
	// <remarks>
	...
	public MutedInfoFQ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoFQ newObject = (schemaLib.MutedInfoFQ)super.clone();

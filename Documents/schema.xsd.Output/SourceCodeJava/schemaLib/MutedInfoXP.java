...
// </summary>
public class MutedInfoXP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoXP
	// </summary>
	// <remarks>
	...
	public MutedInfoXP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoXP newObject = (schemaLib.MutedInfoXP)super.clone();

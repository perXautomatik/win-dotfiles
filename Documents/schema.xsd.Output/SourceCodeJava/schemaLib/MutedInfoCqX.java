...
// </summary>
public class MutedInfoCqX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCqX
	// </summary>
	// <remarks>
	...
	public MutedInfoCqX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCqX newObject = (schemaLib.MutedInfoCqX)super.clone();

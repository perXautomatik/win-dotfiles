...
// </summary>
public class MutedInfoD‘H extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoD‘H
	// </summary>
	// <remarks>
	...
	public MutedInfoD‘H(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoD‘H newObject = (schemaLib.MutedInfoD‘H)super.clone();

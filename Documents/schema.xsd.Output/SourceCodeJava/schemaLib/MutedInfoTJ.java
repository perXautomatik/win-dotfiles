...
// </summary>
public class MutedInfoTJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoTJ
	// </summary>
	// <remarks>
	...
	public MutedInfoTJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoTJ newObject = (schemaLib.MutedInfoTJ)super.clone();

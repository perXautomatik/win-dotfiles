...
// </summary>
public class MutedInfoCiF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCiF
	// </summary>
	// <remarks>
	...
	public MutedInfoCiF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCiF newObject = (schemaLib.MutedInfoCiF)super.clone();

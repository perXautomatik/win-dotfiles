...
// </summary>
public class MutedInfoB_ME extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_ME
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_ME() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_ME(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_ME newObject = (schemaLib.MutedInfoB_ME)super.clone();

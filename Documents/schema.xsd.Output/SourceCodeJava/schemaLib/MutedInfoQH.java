...
// </summary>
public class MutedInfoQH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoQH
	// </summary>
	// <remarks>
	...
	public MutedInfoQH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoQH newObject = (schemaLib.MutedInfoQH)super.clone();

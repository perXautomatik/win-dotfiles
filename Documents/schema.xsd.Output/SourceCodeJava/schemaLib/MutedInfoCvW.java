...
// </summary>
public class MutedInfoCvW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCvW
	// </summary>
	// <remarks>
	...
	public MutedInfoCvW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCvW newObject = (schemaLib.MutedInfoCvW)super.clone();

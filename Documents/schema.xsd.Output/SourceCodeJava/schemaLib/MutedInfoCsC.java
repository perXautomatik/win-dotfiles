...
// </summary>
public class MutedInfoCsC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCsC
	// </summary>
	// <remarks>
	...
	public MutedInfoCsC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCsC newObject = (schemaLib.MutedInfoCsC)super.clone();

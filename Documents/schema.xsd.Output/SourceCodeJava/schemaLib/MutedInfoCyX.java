...
// </summary>
public class MutedInfoCyX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCyX
	// </summary>
	// <remarks>
	...
	public MutedInfoCyX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCyX newObject = (schemaLib.MutedInfoCyX)super.clone();

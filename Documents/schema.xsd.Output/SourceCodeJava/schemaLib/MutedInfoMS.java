...
// </summary>
public class MutedInfoMS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoMS
	// </summary>
	// <remarks>
	...
	public MutedInfoMS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoMS newObject = (schemaLib.MutedInfoMS)super.clone();

...
// </summary>
public class MutedInfoCoW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCoW
	// </summary>
	// <remarks>
	...
	public MutedInfoCoW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCoW newObject = (schemaLib.MutedInfoCoW)super.clone();

...
// </summary>
public class MutedInfoDK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDK
	// </summary>
	// <remarks>
	...
	public MutedInfoDK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDK newObject = (schemaLib.MutedInfoDK)super.clone();

...
// </summary>
public class MutedInfoCxR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCxR
	// </summary>
	// <remarks>
	...
	public MutedInfoCxR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCxR newObject = (schemaLib.MutedInfoCxR)super.clone();

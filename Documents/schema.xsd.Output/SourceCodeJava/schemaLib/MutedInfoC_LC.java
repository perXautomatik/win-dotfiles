...
// </summary>
public class MutedInfoC_LC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_LC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_LC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_LC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_LC newObject = (schemaLib.MutedInfoC_LC)super.clone();

...
// </summary>
public class MutedInfoWE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoWE
	// </summary>
	// <remarks>
	...
	public MutedInfoWE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoWE newObject = (schemaLib.MutedInfoWE)super.clone();

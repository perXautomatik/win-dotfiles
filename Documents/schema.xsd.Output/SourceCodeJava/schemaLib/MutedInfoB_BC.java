...
// </summary>
public class MutedInfoB_BC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_BC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_BC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_BC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_BC newObject = (schemaLib.MutedInfoB_BC)super.clone();

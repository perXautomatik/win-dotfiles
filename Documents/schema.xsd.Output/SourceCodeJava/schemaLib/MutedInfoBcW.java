...
// </summary>
public class MutedInfoBcW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBcW
	// </summary>
	// <remarks>
	...
	public MutedInfoBcW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBcW newObject = (schemaLib.MutedInfoBcW)super.clone();

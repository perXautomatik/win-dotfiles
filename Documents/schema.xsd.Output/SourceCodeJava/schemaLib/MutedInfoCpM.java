...
// </summary>
public class MutedInfoCpM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCpM
	// </summary>
	// <remarks>
	...
	public MutedInfoCpM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCpM newObject = (schemaLib.MutedInfoCpM)super.clone();

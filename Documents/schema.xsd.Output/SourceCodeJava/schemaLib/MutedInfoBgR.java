...
// </summary>
public class MutedInfoBgR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBgR
	// </summary>
	// <remarks>
	...
	public MutedInfoBgR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBgR newObject = (schemaLib.MutedInfoBgR)super.clone();

...
// </summary>
public class MutedInfoB_DE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_DE
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_DE() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_DE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_DE newObject = (schemaLib.MutedInfoB_DE)super.clone();

...
// </summary>
public class MutedInfoKI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoKI
	// </summary>
	// <remarks>
	...
	public MutedInfoKI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoKI newObject = (schemaLib.MutedInfoKI)super.clone();

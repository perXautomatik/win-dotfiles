...
// </summary>
public class MutedInfoCwI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCwI
	// </summary>
	// <remarks>
	...
	public MutedInfoCwI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCwI newObject = (schemaLib.MutedInfoCwI)super.clone();

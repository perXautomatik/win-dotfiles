...
// </summary>
public class MutedInfoBbF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBbF
	// </summary>
	// <remarks>
	...
	public MutedInfoBbF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBbF newObject = (schemaLib.MutedInfoBbF)super.clone();

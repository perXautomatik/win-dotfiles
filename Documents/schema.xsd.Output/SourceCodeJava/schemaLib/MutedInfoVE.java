...
// </summary>
public class MutedInfoVE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoVE
	// </summary>
	// <remarks>
	...
	public MutedInfoVE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoVE newObject = (schemaLib.MutedInfoVE)super.clone();

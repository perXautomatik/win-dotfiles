...
// </summary>
public class MutedInfoCyC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCyC
	// </summary>
	// <remarks>
	...
	public MutedInfoCyC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCyC newObject = (schemaLib.MutedInfoCyC)super.clone();

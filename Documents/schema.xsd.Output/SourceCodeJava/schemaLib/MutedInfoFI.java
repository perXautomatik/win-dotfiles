...
// </summary>
public class MutedInfoFI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoFI
	// </summary>
	// <remarks>
	...
	public MutedInfoFI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoFI newObject = (schemaLib.MutedInfoFI)super.clone();

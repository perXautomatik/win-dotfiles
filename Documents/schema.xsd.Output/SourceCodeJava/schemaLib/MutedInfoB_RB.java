...
// </summary>
public class MutedInfoB_RB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_RB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_RB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_RB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_RB newObject = (schemaLib.MutedInfoB_RB)super.clone();

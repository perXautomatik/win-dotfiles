...
// </summary>
public class MutedInfoB_AB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_AB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_AB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_AB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_AB newObject = (schemaLib.MutedInfoB_AB)super.clone();

...
// </summary>
public class MutedInfoCuJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCuJ
	// </summary>
	// <remarks>
	...
	public MutedInfoCuJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCuJ newObject = (schemaLib.MutedInfoCuJ)super.clone();

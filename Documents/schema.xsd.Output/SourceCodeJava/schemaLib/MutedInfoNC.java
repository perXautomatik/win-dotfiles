...
// </summary>
public class MutedInfoNC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoNC
	// </summary>
	// <remarks>
	...
	public MutedInfoNC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoNC newObject = (schemaLib.MutedInfoNC)super.clone();

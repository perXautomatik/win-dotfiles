...
// </summary>
public class MutedInfoPN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoPN
	// </summary>
	// <remarks>
	...
	public MutedInfoPN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoPN newObject = (schemaLib.MutedInfoPN)super.clone();

...
// </summary>
public class MutedInfoCsP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCsP
	// </summary>
	// <remarks>
	...
	public MutedInfoCsP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCsP newObject = (schemaLib.MutedInfoCsP)super.clone();

...
// </summary>
public class MutedInfoDŠR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŠR
	// </summary>
	// <remarks>
	...
	public MutedInfoDŠR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŠR newObject = (schemaLib.MutedInfoDŠR)super.clone();

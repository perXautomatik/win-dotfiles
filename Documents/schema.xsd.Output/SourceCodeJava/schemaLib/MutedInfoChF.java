...
// </summary>
public class MutedInfoChF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoChF
	// </summary>
	// <remarks>
	...
	public MutedInfoChF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoChF newObject = (schemaLib.MutedInfoChF)super.clone();

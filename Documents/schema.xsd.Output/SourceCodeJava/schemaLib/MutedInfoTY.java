...
// </summary>
public class MutedInfoTY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoTY
	// </summary>
	// <remarks>
	...
	public MutedInfoTY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoTY newObject = (schemaLib.MutedInfoTY)super.clone();

...
// </summary>
public class MutedInfoB_AD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_AD
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_AD() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_AD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_AD newObject = (schemaLib.MutedInfoB_AD)super.clone();

...
// </summary>
public class MutedInfoCjY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCjY
	// </summary>
	// <remarks>
	...
	public MutedInfoCjY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCjY newObject = (schemaLib.MutedInfoCjY)super.clone();

...
// </summary>
public class MutedInfoBgZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBgZ
	// </summary>
	// <remarks>
	...
	public MutedInfoBgZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBgZ newObject = (schemaLib.MutedInfoBgZ)super.clone();

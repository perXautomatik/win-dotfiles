...
// </summary>
public class MutedInfoCiB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCiB
	// </summary>
	// <remarks>
	...
	public MutedInfoCiB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCiB newObject = (schemaLib.MutedInfoCiB)super.clone();

...
// </summary>
public class MutedInfoC‚Y extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC‚Y
	// </summary>
	// <remarks>
	...
	public MutedInfoC‚Y(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC‚Y newObject = (schemaLib.MutedInfoC‚Y)super.clone();

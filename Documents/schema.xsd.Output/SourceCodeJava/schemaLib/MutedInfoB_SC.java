...
// </summary>
public class MutedInfoB_SC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_SC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_SC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_SC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_SC newObject = (schemaLib.MutedInfoB_SC)super.clone();

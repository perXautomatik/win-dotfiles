...
// </summary>
public class MutedInfoBcE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBcE
	// </summary>
	// <remarks>
	...
	public MutedInfoBcE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBcE newObject = (schemaLib.MutedInfoBcE)super.clone();

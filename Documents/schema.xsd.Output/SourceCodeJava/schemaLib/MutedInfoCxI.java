...
// </summary>
public class MutedInfoCxI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCxI
	// </summary>
	// <remarks>
	...
	public MutedInfoCxI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCxI newObject = (schemaLib.MutedInfoCxI)super.clone();

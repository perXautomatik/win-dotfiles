...
// </summary>
public class MutedInfoEH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoEH
	// </summary>
	// <remarks>
	...
	public MutedInfoEH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoEH newObject = (schemaLib.MutedInfoEH)super.clone();

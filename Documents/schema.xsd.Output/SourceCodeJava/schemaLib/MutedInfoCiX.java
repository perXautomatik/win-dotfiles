...
// </summary>
public class MutedInfoCiX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCiX
	// </summary>
	// <remarks>
	...
	public MutedInfoCiX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCiX newObject = (schemaLib.MutedInfoCiX)super.clone();

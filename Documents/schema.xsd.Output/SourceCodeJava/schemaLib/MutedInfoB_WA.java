...
// </summary>
public class MutedInfoB_WA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_WA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_WA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_WA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_WA newObject = (schemaLib.MutedInfoB_WA)super.clone();

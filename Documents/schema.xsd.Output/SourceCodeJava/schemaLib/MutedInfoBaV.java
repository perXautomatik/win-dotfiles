...
// </summary>
public class MutedInfoBaV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBaV
	// </summary>
	// <remarks>
	...
	public MutedInfoBaV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBaV newObject = (schemaLib.MutedInfoBaV)super.clone();

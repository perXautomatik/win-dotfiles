...
// </summary>
public class MutedInfoB_JA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_JA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_JA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_JA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_JA newObject = (schemaLib.MutedInfoB_JA)super.clone();

...
// </summary>
public class MutedInfoC_WC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_WC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_WC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_WC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_WC newObject = (schemaLib.MutedInfoC_WC)super.clone();

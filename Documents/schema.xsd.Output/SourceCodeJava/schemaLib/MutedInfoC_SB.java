...
// </summary>
public class MutedInfoC_SB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_SB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_SB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_SB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_SB newObject = (schemaLib.MutedInfoC_SB)super.clone();

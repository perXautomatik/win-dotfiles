...
// </summary>
public class MutedInfoCuD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCuD
	// </summary>
	// <remarks>
	...
	public MutedInfoCuD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCuD newObject = (schemaLib.MutedInfoCuD)super.clone();

...
// </summary>
public class MutedInfoB_GB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_GB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_GB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_GB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_GB newObject = (schemaLib.MutedInfoB_GB)super.clone();

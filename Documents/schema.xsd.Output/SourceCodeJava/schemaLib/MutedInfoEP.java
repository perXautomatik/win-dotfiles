...
// </summary>
public class MutedInfoEP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoEP
	// </summary>
	// <remarks>
	...
	public MutedInfoEP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoEP newObject = (schemaLib.MutedInfoEP)super.clone();

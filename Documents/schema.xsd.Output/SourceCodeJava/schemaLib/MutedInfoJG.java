...
// </summary>
public class MutedInfoJG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoJG
	// </summary>
	// <remarks>
	...
	public MutedInfoJG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoJG newObject = (schemaLib.MutedInfoJG)super.clone();

...
// </summary>
public class MutedInfoB_QA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_QA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_QA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_QA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_QA newObject = (schemaLib.MutedInfoB_QA)super.clone();

...
// </summary>
public class MutedInfoBeO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBeO
	// </summary>
	// <remarks>
	...
	public MutedInfoBeO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBeO newObject = (schemaLib.MutedInfoBeO)super.clone();

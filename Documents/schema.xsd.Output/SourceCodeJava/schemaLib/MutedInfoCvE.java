...
// </summary>
public class MutedInfoCvE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCvE
	// </summary>
	// <remarks>
	...
	public MutedInfoCvE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCvE newObject = (schemaLib.MutedInfoCvE)super.clone();

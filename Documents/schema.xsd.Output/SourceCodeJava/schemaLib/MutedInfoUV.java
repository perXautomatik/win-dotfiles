...
// </summary>
public class MutedInfoUV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoUV
	// </summary>
	// <remarks>
	...
	public MutedInfoUV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoUV newObject = (schemaLib.MutedInfoUV)super.clone();

...
// </summary>
public class MutedInfoDI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDI
	// </summary>
	// <remarks>
	...
	public MutedInfoDI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDI newObject = (schemaLib.MutedInfoDI)super.clone();

...
// </summary>
public class MutedInfoClS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoClS
	// </summary>
	// <remarks>
	...
	public MutedInfoClS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoClS newObject = (schemaLib.MutedInfoClS)super.clone();

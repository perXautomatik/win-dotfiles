...
// </summary>
public class MutedInfoLR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoLR
	// </summary>
	// <remarks>
	...
	public MutedInfoLR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoLR newObject = (schemaLib.MutedInfoLR)super.clone();

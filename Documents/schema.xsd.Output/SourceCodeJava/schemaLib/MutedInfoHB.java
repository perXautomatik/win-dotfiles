...
// </summary>
public class MutedInfoHB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoHB
	// </summary>
	// <remarks>
	...
	public MutedInfoHB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoHB newObject = (schemaLib.MutedInfoHB)super.clone();

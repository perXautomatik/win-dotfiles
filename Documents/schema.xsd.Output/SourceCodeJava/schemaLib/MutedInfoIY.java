...
// </summary>
public class MutedInfoIY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoIY
	// </summary>
	// <remarks>
	...
	public MutedInfoIY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoIY newObject = (schemaLib.MutedInfoIY)super.clone();

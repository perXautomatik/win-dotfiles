...
// </summary>
public class MutedInfoCpH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCpH
	// </summary>
	// <remarks>
	...
	public MutedInfoCpH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCpH newObject = (schemaLib.MutedInfoCpH)super.clone();

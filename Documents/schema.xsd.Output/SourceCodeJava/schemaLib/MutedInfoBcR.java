...
// </summary>
public class MutedInfoBcR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBcR
	// </summary>
	// <remarks>
	...
	public MutedInfoBcR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBcR newObject = (schemaLib.MutedInfoBcR)super.clone();

...
// </summary>
public class MutedInfoYD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoYD
	// </summary>
	// <remarks>
	...
	public MutedInfoYD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoYD newObject = (schemaLib.MutedInfoYD)super.clone();

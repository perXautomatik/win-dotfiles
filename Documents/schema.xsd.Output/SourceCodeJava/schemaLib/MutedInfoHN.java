...
// </summary>
public class MutedInfoHN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoHN
	// </summary>
	// <remarks>
	...
	public MutedInfoHN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoHN newObject = (schemaLib.MutedInfoHN)super.clone();

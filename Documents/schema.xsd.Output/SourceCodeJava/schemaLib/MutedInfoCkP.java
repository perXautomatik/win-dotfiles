...
// </summary>
public class MutedInfoCkP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCkP
	// </summary>
	// <remarks>
	...
	public MutedInfoCkP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCkP newObject = (schemaLib.MutedInfoCkP)super.clone();

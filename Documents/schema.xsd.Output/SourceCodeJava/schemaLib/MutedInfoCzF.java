...
// </summary>
public class MutedInfoCzF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCzF
	// </summary>
	// <remarks>
	...
	public MutedInfoCzF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCzF newObject = (schemaLib.MutedInfoCzF)super.clone();

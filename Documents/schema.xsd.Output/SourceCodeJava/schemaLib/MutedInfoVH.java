...
// </summary>
public class MutedInfoVH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoVH
	// </summary>
	// <remarks>
	...
	public MutedInfoVH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoVH newObject = (schemaLib.MutedInfoVH)super.clone();

...
// </summary>
public class MutedInfoBG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBG
	// </summary>
	// <remarks>
	...
	public MutedInfoBG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBG newObject = (schemaLib.MutedInfoBG)super.clone();

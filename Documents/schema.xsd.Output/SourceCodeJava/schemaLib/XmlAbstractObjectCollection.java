...
/// </remarks>
public class XmlAbstractObjectCollection<T extends com.liquid_technologies.ltxmllib19.XmlObjectInterface> extends com.liquid_technologies.ltxmllib19.XmlAbstractCollection<T> {
	private static final long serialVersionUID = 13L;

	public XmlAbstractObjectCollection(String elementName, String targetNamespace, int minOccurs, int maxOccurs, Class<?> classFactoryType, String createObjectMethod) {
		super(elementName, targetNamespace, minOccurs, maxOccurs, classFactoryType, createObjectMethod);

...
// </summary>
public class MutedInfoC_QA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_QA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_QA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_QA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_QA newObject = (schemaLib.MutedInfoC_QA)super.clone();

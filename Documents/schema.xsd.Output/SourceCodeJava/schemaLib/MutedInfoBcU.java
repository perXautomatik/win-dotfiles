...
// </summary>
public class MutedInfoBcU extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBcU
	// </summary>
	// <remarks>
	...
	public MutedInfoBcU(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBcU newObject = (schemaLib.MutedInfoBcU)super.clone();

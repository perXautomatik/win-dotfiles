...
// </summary>
public class MutedInfoBbP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBbP
	// </summary>
	// <remarks>
	...
	public MutedInfoBbP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBbP newObject = (schemaLib.MutedInfoBbP)super.clone();

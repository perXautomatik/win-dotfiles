...
// </summary>
public class MutedInfoChI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoChI
	// </summary>
	// <remarks>
	...
	public MutedInfoChI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoChI newObject = (schemaLib.MutedInfoChI)super.clone();

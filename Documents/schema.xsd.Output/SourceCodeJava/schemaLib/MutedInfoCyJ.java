...
// </summary>
public class MutedInfoCyJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCyJ
	// </summary>
	// <remarks>
	...
	public MutedInfoCyJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCyJ newObject = (schemaLib.MutedInfoCyJ)super.clone();

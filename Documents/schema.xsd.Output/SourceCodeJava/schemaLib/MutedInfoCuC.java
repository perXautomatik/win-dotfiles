...
// </summary>
public class MutedInfoCuC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCuC
	// </summary>
	// <remarks>
	...
	public MutedInfoCuC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCuC newObject = (schemaLib.MutedInfoCuC)super.clone();

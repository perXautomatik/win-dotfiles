...
// </summary>
public class MutedInfoCmJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCmJ
	// </summary>
	// <remarks>
	...
	public MutedInfoCmJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCmJ newObject = (schemaLib.MutedInfoCmJ)super.clone();

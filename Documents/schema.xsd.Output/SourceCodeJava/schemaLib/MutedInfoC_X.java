...
// </summary>
public class MutedInfoC_X extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_X
	// </summary>
	// <remarks>
	...
	public MutedInfoC_X(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_X newObject = (schemaLib.MutedInfoC_X)super.clone();

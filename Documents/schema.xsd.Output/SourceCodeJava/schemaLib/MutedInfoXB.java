...
// </summary>
public class MutedInfoXB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoXB
	// </summary>
	// <remarks>
	...
	public MutedInfoXB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoXB newObject = (schemaLib.MutedInfoXB)super.clone();

...
// </summary>
public class MutedInfoB_T extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_T
	// </summary>
	// <remarks>
	...
	public MutedInfoB_T(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_T newObject = (schemaLib.MutedInfoB_T)super.clone();

...
// </summary>
public class MutedInfoYP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoYP
	// </summary>
	// <remarks>
	...
	public MutedInfoYP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoYP newObject = (schemaLib.MutedInfoYP)super.clone();

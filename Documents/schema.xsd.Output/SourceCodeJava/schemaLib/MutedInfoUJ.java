...
// </summary>
public class MutedInfoUJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoUJ
	// </summary>
	// <remarks>
	...
	public MutedInfoUJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoUJ newObject = (schemaLib.MutedInfoUJ)super.clone();

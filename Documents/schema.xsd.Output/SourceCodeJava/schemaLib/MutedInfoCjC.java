...
// </summary>
public class MutedInfoCjC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCjC
	// </summary>
	// <remarks>
	...
	public MutedInfoCjC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCjC newObject = (schemaLib.MutedInfoCjC)super.clone();

...
// </summary>
public class MutedInfoDŽS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŽS
	// </summary>
	// <remarks>
	...
	public MutedInfoDŽS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŽS newObject = (schemaLib.MutedInfoDŽS)super.clone();

...
// </summary>
public class MutedInfoB_IA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_IA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_IA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_IA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_IA newObject = (schemaLib.MutedInfoB_IA)super.clone();

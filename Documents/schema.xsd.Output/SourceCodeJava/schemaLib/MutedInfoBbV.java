...
// </summary>
public class MutedInfoBbV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBbV
	// </summary>
	// <remarks>
	...
	public MutedInfoBbV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBbV newObject = (schemaLib.MutedInfoBbV)super.clone();

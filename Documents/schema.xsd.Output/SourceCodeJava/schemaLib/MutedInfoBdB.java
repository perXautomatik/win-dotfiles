...
// </summary>
public class MutedInfoBdB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBdB
	// </summary>
	// <remarks>
	...
	public MutedInfoBdB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBdB newObject = (schemaLib.MutedInfoBdB)super.clone();

...
// </summary>
public class MutedInfoC‚P extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC‚P
	// </summary>
	// <remarks>
	...
	public MutedInfoC‚P(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC‚P newObject = (schemaLib.MutedInfoC‚P)super.clone();

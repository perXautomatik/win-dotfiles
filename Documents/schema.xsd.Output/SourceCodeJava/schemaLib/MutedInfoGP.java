...
// </summary>
public class MutedInfoGP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoGP
	// </summary>
	// <remarks>
	...
	public MutedInfoGP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoGP newObject = (schemaLib.MutedInfoGP)super.clone();

...
// </summary>
public class MutedInfoClM extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoClM
	// </summary>
	// <remarks>
	...
	public MutedInfoClM(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoClM newObject = (schemaLib.MutedInfoClM)super.clone();

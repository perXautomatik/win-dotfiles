...
// </summary>
public class MutedInfoBfY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBfY
	// </summary>
	// <remarks>
	...
	public MutedInfoBfY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBfY newObject = (schemaLib.MutedInfoBfY)super.clone();

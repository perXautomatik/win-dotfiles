...
// </summary>
public class MutedInfoK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoK
	// </summary>
	// <remarks>
	...
	public MutedInfoK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoK newObject = (schemaLib.MutedInfoK)super.clone();

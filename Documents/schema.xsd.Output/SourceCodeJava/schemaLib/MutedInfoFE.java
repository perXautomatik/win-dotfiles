...
// </summary>
public class MutedInfoFE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoFE
	// </summary>
	// <remarks>
	...
	public MutedInfoFE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoFE newObject = (schemaLib.MutedInfoFE)super.clone();

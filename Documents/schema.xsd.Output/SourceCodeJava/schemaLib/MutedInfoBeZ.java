...
// </summary>
public class MutedInfoBeZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBeZ
	// </summary>
	// <remarks>
	...
	public MutedInfoBeZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBeZ newObject = (schemaLib.MutedInfoBeZ)super.clone();

...
// </summary>
public class MutedInfoBcB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBcB
	// </summary>
	// <remarks>
	...
	public MutedInfoBcB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBcB newObject = (schemaLib.MutedInfoBcB)super.clone();

...
// </summary>
public class MutedInfoB_XD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_XD
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_XD() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_XD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_XD newObject = (schemaLib.MutedInfoB_XD)super.clone();

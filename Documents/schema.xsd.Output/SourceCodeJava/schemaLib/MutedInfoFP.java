...
// </summary>
public class MutedInfoFP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoFP
	// </summary>
	// <remarks>
	...
	public MutedInfoFP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoFP newObject = (schemaLib.MutedInfoFP)super.clone();

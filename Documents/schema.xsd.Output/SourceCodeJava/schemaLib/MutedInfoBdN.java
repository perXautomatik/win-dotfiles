...
// </summary>
public class MutedInfoBdN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBdN
	// </summary>
	// <remarks>
	...
	public MutedInfoBdN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBdN newObject = (schemaLib.MutedInfoBdN)super.clone();

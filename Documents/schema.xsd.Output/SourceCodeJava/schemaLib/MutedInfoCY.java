...
// </summary>
public class MutedInfoCY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCY
	// </summary>
	// <remarks>
	...
	public MutedInfoCY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCY newObject = (schemaLib.MutedInfoCY)super.clone();

...
// </summary>
public class MutedInfoBE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBE
	// </summary>
	// <remarks>
	...
	public MutedInfoBE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBE newObject = (schemaLib.MutedInfoBE)super.clone();

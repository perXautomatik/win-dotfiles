...
// </summary>
public class MutedInfoYL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoYL
	// </summary>
	// <remarks>
	...
	public MutedInfoYL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoYL newObject = (schemaLib.MutedInfoYL)super.clone();

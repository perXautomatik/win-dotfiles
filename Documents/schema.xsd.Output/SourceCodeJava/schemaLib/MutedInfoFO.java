...
// </summary>
public class MutedInfoFO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoFO
	// </summary>
	// <remarks>
	...
	public MutedInfoFO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoFO newObject = (schemaLib.MutedInfoFO)super.clone();

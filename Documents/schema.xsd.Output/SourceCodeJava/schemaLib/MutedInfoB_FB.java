...
// </summary>
public class MutedInfoB_FB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_FB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_FB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_FB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_FB newObject = (schemaLib.MutedInfoB_FB)super.clone();

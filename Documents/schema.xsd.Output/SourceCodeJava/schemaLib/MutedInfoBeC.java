...
// </summary>
public class MutedInfoBeC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBeC
	// </summary>
	// <remarks>
	...
	public MutedInfoBeC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBeC newObject = (schemaLib.MutedInfoBeC)super.clone();

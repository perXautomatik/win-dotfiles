...
// </summary>
public class MutedInfoVK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoVK
	// </summary>
	// <remarks>
	...
	public MutedInfoVK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoVK newObject = (schemaLib.MutedInfoVK)super.clone();

...
// </summary>
public class MutedInfoC_B extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_B
	// </summary>
	// <remarks>
	...
	public MutedInfoC_B(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_B newObject = (schemaLib.MutedInfoC_B)super.clone();

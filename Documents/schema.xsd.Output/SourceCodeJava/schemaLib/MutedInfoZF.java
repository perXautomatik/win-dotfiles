...
// </summary>
public class MutedInfoZF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoZF
	// </summary>
	// <remarks>
	...
	public MutedInfoZF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoZF newObject = (schemaLib.MutedInfoZF)super.clone();

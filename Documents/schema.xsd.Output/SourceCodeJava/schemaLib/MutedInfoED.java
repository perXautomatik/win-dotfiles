...
// </summary>
public class MutedInfoED extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoED
	// </summary>
	// <remarks>
	...
	public MutedInfoED(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoED newObject = (schemaLib.MutedInfoED)super.clone();

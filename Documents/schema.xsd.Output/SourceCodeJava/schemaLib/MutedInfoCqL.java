...
// </summary>
public class MutedInfoCqL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCqL
	// </summary>
	// <remarks>
	...
	public MutedInfoCqL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCqL newObject = (schemaLib.MutedInfoCqL)super.clone();

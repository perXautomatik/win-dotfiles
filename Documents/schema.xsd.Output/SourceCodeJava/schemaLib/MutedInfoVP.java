...
// </summary>
public class MutedInfoVP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoVP
	// </summary>
	// <remarks>
	...
	public MutedInfoVP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoVP newObject = (schemaLib.MutedInfoVP)super.clone();

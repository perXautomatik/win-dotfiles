...
// </summary>
public class MutedInfoOD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoOD
	// </summary>
	// <remarks>
	...
	public MutedInfoOD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoOD newObject = (schemaLib.MutedInfoOD)super.clone();

...
// </summary>
public class MutedInfoBcY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBcY
	// </summary>
	// <remarks>
	...
	public MutedInfoBcY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBcY newObject = (schemaLib.MutedInfoBcY)super.clone();

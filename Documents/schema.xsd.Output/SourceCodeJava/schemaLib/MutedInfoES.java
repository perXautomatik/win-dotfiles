...
// </summary>
public class MutedInfoES extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoES
	// </summary>
	// <remarks>
	...
	public MutedInfoES(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoES newObject = (schemaLib.MutedInfoES)super.clone();

...
// </summary>
public class MutedInfoB_QD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_QD
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_QD() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_QD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_QD newObject = (schemaLib.MutedInfoB_QD)super.clone();

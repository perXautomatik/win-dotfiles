...
// </summary>
public class MutedInfoClT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoClT
	// </summary>
	// <remarks>
	...
	public MutedInfoClT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoClT newObject = (schemaLib.MutedInfoClT)super.clone();

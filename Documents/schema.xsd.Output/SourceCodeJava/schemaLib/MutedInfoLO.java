...
// </summary>
public class MutedInfoLO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoLO
	// </summary>
	// <remarks>
	...
	public MutedInfoLO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoLO newObject = (schemaLib.MutedInfoLO)super.clone();

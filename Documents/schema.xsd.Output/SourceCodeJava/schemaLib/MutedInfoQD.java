...
// </summary>
public class MutedInfoQD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoQD
	// </summary>
	// <remarks>
	...
	public MutedInfoQD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoQD newObject = (schemaLib.MutedInfoQD)super.clone();

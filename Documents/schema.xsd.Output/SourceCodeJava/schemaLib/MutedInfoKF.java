...
// </summary>
public class MutedInfoKF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoKF
	// </summary>
	// <remarks>
	...
	public MutedInfoKF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoKF newObject = (schemaLib.MutedInfoKF)super.clone();

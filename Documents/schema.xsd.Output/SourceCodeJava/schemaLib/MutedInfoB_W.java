...
// </summary>
public class MutedInfoB_W extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_W
	// </summary>
	// <remarks>
	...
	public MutedInfoB_W(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_W newObject = (schemaLib.MutedInfoB_W)super.clone();

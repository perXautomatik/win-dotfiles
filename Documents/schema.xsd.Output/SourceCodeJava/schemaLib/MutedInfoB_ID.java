...
// </summary>
public class MutedInfoB_ID extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_ID
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_ID() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_ID(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_ID newObject = (schemaLib.MutedInfoB_ID)super.clone();

...
// </summary>
public class MutedInfoCiA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCiA
	// </summary>
	// <remarks>
	...
	public MutedInfoCiA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCiA newObject = (schemaLib.MutedInfoCiA)super.clone();

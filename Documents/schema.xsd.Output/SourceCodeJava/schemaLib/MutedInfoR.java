...
// </summary>
public class MutedInfoR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoR
	// </summary>
	// <remarks>
	...
	public MutedInfoR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoR newObject = (schemaLib.MutedInfoR)super.clone();

...
// </summary>
public class MutedInfoChC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoChC
	// </summary>
	// <remarks>
	...
	public MutedInfoChC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoChC newObject = (schemaLib.MutedInfoChC)super.clone();

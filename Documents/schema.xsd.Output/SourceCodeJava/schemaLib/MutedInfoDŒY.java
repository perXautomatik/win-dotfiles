...
// </summary>
public class MutedInfoDŒY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŒY
	// </summary>
	// <remarks>
	...
	public MutedInfoDŒY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŒY newObject = (schemaLib.MutedInfoDŒY)super.clone();

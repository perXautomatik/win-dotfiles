...
// </summary>
public class MutedInfoCuS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCuS
	// </summary>
	// <remarks>
	...
	public MutedInfoCuS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCuS newObject = (schemaLib.MutedInfoCuS)super.clone();

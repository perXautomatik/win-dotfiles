...
// </summary>
public class MutedInfoGW extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoGW
	// </summary>
	// <remarks>
	...
	public MutedInfoGW(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoGW newObject = (schemaLib.MutedInfoGW)super.clone();

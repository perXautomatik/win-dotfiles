...
// </summary>
public class MutedInfoDX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDX
	// </summary>
	// <remarks>
	...
	public MutedInfoDX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDX newObject = (schemaLib.MutedInfoDX)super.clone();

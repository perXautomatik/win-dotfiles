...
// </summary>
public class MutedInfoJI extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoJI
	// </summary>
	// <remarks>
	...
	public MutedInfoJI(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoJI newObject = (schemaLib.MutedInfoJI)super.clone();

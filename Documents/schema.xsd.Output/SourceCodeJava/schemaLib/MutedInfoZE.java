...
// </summary>
public class MutedInfoZE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoZE
	// </summary>
	// <remarks>
	...
	public MutedInfoZE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoZE newObject = (schemaLib.MutedInfoZE)super.clone();

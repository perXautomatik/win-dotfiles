...
// </summary>
public class MutedInfoCxP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCxP
	// </summary>
	// <remarks>
	...
	public MutedInfoCxP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCxP newObject = (schemaLib.MutedInfoCxP)super.clone();

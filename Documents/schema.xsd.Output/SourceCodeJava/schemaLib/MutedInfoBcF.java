...
// </summary>
public class MutedInfoBcF extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBcF
	// </summary>
	// <remarks>
	...
	public MutedInfoBcF(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBcF newObject = (schemaLib.MutedInfoBcF)super.clone();

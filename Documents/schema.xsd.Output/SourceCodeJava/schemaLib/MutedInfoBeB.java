...
// </summary>
public class MutedInfoBeB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBeB
	// </summary>
	// <remarks>
	...
	public MutedInfoBeB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBeB newObject = (schemaLib.MutedInfoBeB)super.clone();

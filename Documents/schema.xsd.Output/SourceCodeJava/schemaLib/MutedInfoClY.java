...
// </summary>
public class MutedInfoClY extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoClY
	// </summary>
	// <remarks>
	...
	public MutedInfoClY(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoClY newObject = (schemaLib.MutedInfoClY)super.clone();

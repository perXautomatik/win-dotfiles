...
// </summary>
public class MutedInfoC_YC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_YC
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_YC() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_YC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_YC newObject = (schemaLib.MutedInfoC_YC)super.clone();

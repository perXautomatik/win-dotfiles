...
// </summary>
public class MutedInfoBaG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBaG
	// </summary>
	// <remarks>
	...
	public MutedInfoBaG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBaG newObject = (schemaLib.MutedInfoBaG)super.clone();

...
// </summary>
public class MutedInfoPK extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoPK
	// </summary>
	// <remarks>
	...
	public MutedInfoPK(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoPK newObject = (schemaLib.MutedInfoPK)super.clone();

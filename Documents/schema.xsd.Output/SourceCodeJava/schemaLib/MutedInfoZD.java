...
// </summary>
public class MutedInfoZD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoZD
	// </summary>
	// <remarks>
	...
	public MutedInfoZD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoZD newObject = (schemaLib.MutedInfoZD)super.clone();

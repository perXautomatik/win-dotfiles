...
// </summary>
public class MutedInfoC_VA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_VA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_VA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_VA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_VA newObject = (schemaLib.MutedInfoC_VA)super.clone();

...
// </summary>
public class MutedInfoBhR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBhR
	// </summary>
	// <remarks>
	...
	public MutedInfoBhR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBhR newObject = (schemaLib.MutedInfoBhR)super.clone();

...
// </summary>
public class MutedInfoClV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoClV
	// </summary>
	// <remarks>
	...
	public MutedInfoClV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoClV newObject = (schemaLib.MutedInfoClV)super.clone();

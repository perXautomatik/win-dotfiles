...
// </summary>
public class MutedInfoDD extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDD
	// </summary>
	// <remarks>
	...
	public MutedInfoDD(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDD newObject = (schemaLib.MutedInfoDD)super.clone();

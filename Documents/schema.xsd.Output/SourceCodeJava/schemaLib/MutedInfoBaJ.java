...
// </summary>
public class MutedInfoBaJ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBaJ
	// </summary>
	// <remarks>
	...
	public MutedInfoBaJ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBaJ newObject = (schemaLib.MutedInfoBaJ)super.clone();

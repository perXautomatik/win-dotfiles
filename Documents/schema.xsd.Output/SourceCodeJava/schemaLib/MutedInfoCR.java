...
// </summary>
public class MutedInfoCR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCR
	// </summary>
	// <remarks>
	...
	public MutedInfoCR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCR newObject = (schemaLib.MutedInfoCR)super.clone();

...
// </summary>
public class MutedInfoB_TA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_TA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_TA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_TA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_TA newObject = (schemaLib.MutedInfoB_TA)super.clone();

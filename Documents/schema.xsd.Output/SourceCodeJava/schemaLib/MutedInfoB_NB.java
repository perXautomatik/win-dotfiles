...
// </summary>
public class MutedInfoB_NB extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_NB
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_NB() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_NB(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_NB newObject = (schemaLib.MutedInfoB_NB)super.clone();

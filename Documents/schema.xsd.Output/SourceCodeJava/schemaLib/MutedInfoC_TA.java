...
// </summary>
public class MutedInfoC_TA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoC_TA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoC_TA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoC_TA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoC_TA newObject = (schemaLib.MutedInfoC_TA)super.clone();

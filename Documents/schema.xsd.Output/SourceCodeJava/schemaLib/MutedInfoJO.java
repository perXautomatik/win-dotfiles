...
// </summary>
public class MutedInfoJO extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoJO
	// </summary>
	// <remarks>
	...
	public MutedInfoJO(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoJO newObject = (schemaLib.MutedInfoJO)super.clone();

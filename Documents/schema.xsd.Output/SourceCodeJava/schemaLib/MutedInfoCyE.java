...
// </summary>
public class MutedInfoCyE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCyE
	// </summary>
	// <remarks>
	...
	public MutedInfoCyE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCyE newObject = (schemaLib.MutedInfoCyE)super.clone();

...
// </summary>
public class MutedInfoBcC extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoBcC
	// </summary>
	// <remarks>
	...
	public MutedInfoBcC(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoBcC newObject = (schemaLib.MutedInfoBcC)super.clone();

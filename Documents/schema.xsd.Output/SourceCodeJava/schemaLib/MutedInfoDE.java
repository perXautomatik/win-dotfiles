...
// </summary>
public class MutedInfoDE extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDE
	// </summary>
	// <remarks>
	...
	public MutedInfoDE(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDE newObject = (schemaLib.MutedInfoDE)super.clone();

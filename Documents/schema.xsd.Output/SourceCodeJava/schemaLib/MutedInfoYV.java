...
// </summary>
public class MutedInfoYV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoYV
	// </summary>
	// <remarks>
	...
	public MutedInfoYV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoYV newObject = (schemaLib.MutedInfoYV)super.clone();

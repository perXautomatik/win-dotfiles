...
// </summary>
public class MutedInfo_V extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfo_V
	// </summary>
	// <remarks>
	...
	public MutedInfo_V(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfo_V newObject = (schemaLib.MutedInfo_V)super.clone();

...
// </summary>
public class MutedInfoMP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoMP
	// </summary>
	// <remarks>
	...
	public MutedInfoMP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoMP newObject = (schemaLib.MutedInfoMP)super.clone();

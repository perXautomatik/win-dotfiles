...
// </summary>
public class MutedInfoCuG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCuG
	// </summary>
	// <remarks>
	...
	public MutedInfoCuG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCuG newObject = (schemaLib.MutedInfoCuG)super.clone();

...
// </summary>
public class MutedInfoKP extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoKP
	// </summary>
	// <remarks>
	...
	public MutedInfoKP(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoKP newObject = (schemaLib.MutedInfoKP)super.clone();

...
// </summary>
public class MutedInfoPZ extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoPZ
	// </summary>
	// <remarks>
	...
	public MutedInfoPZ(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoPZ newObject = (schemaLib.MutedInfoPZ)super.clone();

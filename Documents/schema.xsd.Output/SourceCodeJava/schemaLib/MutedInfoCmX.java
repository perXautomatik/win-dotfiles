...
// </summary>
public class MutedInfoCmX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCmX
	// </summary>
	// <remarks>
	...
	public MutedInfoCmX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCmX newObject = (schemaLib.MutedInfoCmX)super.clone();

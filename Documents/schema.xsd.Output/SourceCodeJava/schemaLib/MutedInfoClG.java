...
// </summary>
public class MutedInfoClG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoClG
	// </summary>
	// <remarks>
	...
	public MutedInfoClG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoClG newObject = (schemaLib.MutedInfoClG)super.clone();

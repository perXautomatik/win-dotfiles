...
// </summary>
public class MutedInfoDŽV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoDŽV
	// </summary>
	// <remarks>
	...
	public MutedInfoDŽV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoDŽV newObject = (schemaLib.MutedInfoDŽV)super.clone();

...
// </summary>
public class MutedInfoCnX extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCnX
	// </summary>
	// <remarks>
	...
	public MutedInfoCnX(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCnX newObject = (schemaLib.MutedInfoCnX)super.clone();

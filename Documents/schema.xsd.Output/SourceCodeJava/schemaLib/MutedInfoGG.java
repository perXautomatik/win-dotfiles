...
// </summary>
public class MutedInfoGG extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoGG
	// </summary>
	// <remarks>
	...
	public MutedInfoGG(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoGG newObject = (schemaLib.MutedInfoGG)super.clone();

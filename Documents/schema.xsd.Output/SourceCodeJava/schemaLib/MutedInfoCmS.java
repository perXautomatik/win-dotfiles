...
// </summary>
public class MutedInfoCmS extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCmS
	// </summary>
	// <remarks>
	...
	public MutedInfoCmS(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCmS newObject = (schemaLib.MutedInfoCmS)super.clone();

...
// </summary>
public class MutedInfoCuT extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCuT
	// </summary>
	// <remarks>
	...
	public MutedInfoCuT(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCuT newObject = (schemaLib.MutedInfoCuT)super.clone();

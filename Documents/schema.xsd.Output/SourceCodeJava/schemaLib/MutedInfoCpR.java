...
// </summary>
public class MutedInfoCpR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCpR
	// </summary>
	// <remarks>
	...
	public MutedInfoCpR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCpR newObject = (schemaLib.MutedInfoCpR)super.clone();

...
// </summary>
public class MutedInfoCwH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoCwH
	// </summary>
	// <remarks>
	...
	public MutedInfoCwH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoCwH newObject = (schemaLib.MutedInfoCwH)super.clone();

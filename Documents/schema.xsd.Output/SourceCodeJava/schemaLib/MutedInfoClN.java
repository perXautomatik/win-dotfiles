...
// </summary>
public class MutedInfoClN extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoClN
	// </summary>
	// <remarks>
	...
	public MutedInfoClN(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoClN newObject = (schemaLib.MutedInfoClN)super.clone();

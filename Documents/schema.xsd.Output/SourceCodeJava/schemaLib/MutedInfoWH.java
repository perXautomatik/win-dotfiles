...
// </summary>
public class MutedInfoWH extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoWH
	// </summary>
	// <remarks>
	...
	public MutedInfoWH(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoWH newObject = (schemaLib.MutedInfoWH)super.clone();

...
// </summary>
public class MutedInfoWR extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoWR
	// </summary>
	// <remarks>
	...
	public MutedInfoWR(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoWR newObject = (schemaLib.MutedInfoWR)super.clone();

...
// </summary>
public class MutedInfoJL extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoJL
	// </summary>
	// <remarks>
	...
	public MutedInfoJL(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoJL newObject = (schemaLib.MutedInfoJL)super.clone();

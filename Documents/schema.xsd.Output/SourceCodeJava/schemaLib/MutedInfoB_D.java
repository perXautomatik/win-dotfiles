...
// </summary>
public class MutedInfoB_D extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_D
	// </summary>
	// <remarks>
	...
	public MutedInfoB_D(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_D newObject = (schemaLib.MutedInfoB_D)super.clone();

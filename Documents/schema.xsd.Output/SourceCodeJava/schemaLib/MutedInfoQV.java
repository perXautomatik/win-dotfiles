...
// </summary>
public class MutedInfoQV extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoQV
	// </summary>
	// <remarks>
	...
	public MutedInfoQV(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoQV newObject = (schemaLib.MutedInfoQV)super.clone();

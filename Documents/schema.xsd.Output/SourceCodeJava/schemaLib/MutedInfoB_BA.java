...
// </summary>
public class MutedInfoB_BA extends com.liquid_technologies.ltxmllib19.XmlGeneratedClass {
	private static final long serialVersionUID = 13L;

	// <summary>
	// 	Constructor for MutedInfoB_BA
	// </summary>
	// <remarks>
	...
	// </remarks>
	public MutedInfoB_BA() {
		setElementName("mutedInfo");
		init();
	}
	public MutedInfoB_BA(String elementName) {
	...
	public Object clone() throws CloneNotSupportedException {
		try {
			schemaLib.MutedInfoB_BA newObject = (schemaLib.MutedInfoB_BA)super.clone();

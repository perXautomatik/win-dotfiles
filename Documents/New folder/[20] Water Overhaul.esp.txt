	...
	If ( bAwaitingInput == 1 )
		...
		If ( nButton > -1 )
			...
			ElseIf ( nButton == 1 )
				...
				Set nWOxBottleGeneric To Player.GetItemCount WOxBottleGeneric;
				Set nSodaCount To Player.GetItemCount SodaBottleEmpty01;
				Set nEmptyBottleCount To ( nMilkCount + nSodaCount + nWOxBottleGeneric  );
				Player.RemoveItem Milkbottle01 nMilkCount;
				Player.RemoveItem WOxBottleGeneric nWOxBottleGeneric;
			...
			ElseIf ( nButton == 2 )
				...
				PlaySound NPCHumanDrinkingWaterSink;
				Player.CastImmediateOnSelf NVDLC03SinkDrinkSpell;
			EndIf
		EndIf
	Else
		Return;

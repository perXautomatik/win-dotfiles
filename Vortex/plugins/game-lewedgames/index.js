...
const spec = {
  "game": {
    "id": "lewedgames",
    "name": "LewedGames",
    "executable": "PortableApps\\Start.exe",
    "logo": "AppsData.jpg",
    "mergeMods": false,
    "modPath": "PortableApps",
    "modPathIsRelative": true,
    "requiredFiles": [
      "PortableApps\\Start.exe"
    ],
    "details": {
      "steamAppId": 221380,
      "nexusPageId": "AppsData"
    },
    "environment": {
      "SteamAPPId": "221380"
    }
  ...
  "modTypes": [
    {
      "id": "ageofempires-raBr0R4oc",
      "name": "FileOrganisationDedup",
      "priority": "high",
      "targetPath": "U:\\PortableApplauncher\\FileOrganisation"
    },
    {
      "id": "ageofempires-cFvaEvPUW",
      "name": "Clipboard",
      "priority": "high",
      "targetPath": "U:\\PortableApplauncher\\PortableApps\\Clipboard\\"
    },
    {
      "id": "ageofempires-YWkbqN50f",
      "name": "Images",
      "priority": "high",
      "targetPath": "U:\\PortableApplauncher\\PortableApps\\Images\\"
    },
    {
      "id": "ageofempires-WZyZ0AEGl",
      "name": "Windows",
      "priority": "high",
      "targetPath": "U:\\PortableApplauncher\\PortableApps\\Windows\\"
    },
    {
      "id": "ageofempires-uLiGMLwCy",
      "name": "CodeNTextEditing",
      "priority": "high",
      "targetPath": "U:\\PortableApplauncher\\PortableApps\\CodeNTextEditing\\"
    },
    {
      "id": "ageofempires-EKjDU6ooM",
      "name": "PdfNEbooks",
      "priority": "high",
      "targetPath": "U:\\PortableApplauncher\\PortableApps\\PdfNEbooks\\"
    },
    {
      "id": "ageofempires-gmjSFpMug",
      "name": "BrowserNetworkDatabase",
      "priority": "high",
      "targetPath": "U:\\PortableApplauncher\\PortableApps\\BrowserNetworkDatabase\\"
    },
    {
      "id": "ageofempires-IYXp_7so_",
      "name": "Unsorted",
      "priority": "high",
      "targetPath": "U:\\PortableApplauncher\\PortableApps\\Unsorted"
    }
  ],
  "discovery": {
    "ids": [

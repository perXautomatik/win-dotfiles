...
Disable-WindowsOptionalFeature -Online -FeatureName Windows-Search -NoRestart
Disable-WindowsOptionalFeature -Online -FeatureName Language-Pack-Management -NoRestart
